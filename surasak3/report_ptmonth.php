...
<div id="non-printable">
	<form id="form1" name="form1" method="post" action="report_ptmonth.php">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			...
			<tr>
				<td align="center">
					<a href="../nindex.htm">กลับเมนูหลัก</a> || <a href="report_ptformonth.php">รายงานนวดแผนไทยประจำเดือน</a> || <a href="report_pt2018.php" target="_blank">รายงานนวดแผนไทย(ใหม่)</a>
				</td>
			</tr>
		</table>
	</form>
...
if($_POST["act"]=="show"){
	...
	while($row = mysql_fetch_array($query)){
		...
		<div id="printable"> 
			...
			<div style="margin-left: 5%;"><strong>ห้วงเวลาระหว่างวันที่ : </strong><?=$showdate;?> เดือน<?=$mon;?> พ.ศ. <?=$thyear;?></div>
			<table width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse;">
				...
				<?php
				if($seldate=="1"){
					$sql1 = "SELECT b.date, b.ptname, b.hn, b.an, b.depart, b.detail, b.price, b.paid, b.row_id, b.accno, b.tvn ,b.staf_massage,b.diag,b.ptright,b.idname FROM `patdata` AS a, depart AS b WHERE b.row_id = a.idno AND ( a.code in ('58002' , '58003' ,'58004' ,'58002a','58002b','58002c','58005','58006','58007','58008','58101','58102','58130','58131','58201','58301','58301a','58130P','58131P','58130S','58131S','58133')) AND (b.date between '$thyear-$selmon-01 00:00:00' AND '$thyear-$selmon-15 23:59:59') and  a.status='Y' and a.price >0  and staf_massage='$staf_massage' Group by b.date ,b.hn,a.code";
				}else{
					$sql1 = "SELECT b.date, b.ptname, b.hn, b.an, b.depart, b.detail, b.price, b.paid, b.row_id, b.accno, b.tvn ,b.staf_massage,b.diag,b.ptright,b.idname FROM `patdata` AS a, depart AS b WHERE b.row_id = a.idno AND ( a.code in ('58002' , '58003' ,'58004' ,'58002a','58002b','58002c','58005','58006','58007','58008','58101','58102','58130','58131','58201','58301','58301a','58130P','58131P','58130S','58131S','58133')) AND (b.date between '$thyear-$selmon-16 00:00:00' AND '$thyear-$selmon-31 23:59:59') and  a.status='Y' and a.price >0  and staf_massage='$staf_massage' Group by b.date ,b.hn,a.code";	
				}
