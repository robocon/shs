...
<?php
    ...
    if (substr($sPtright,0,3)=='R03 ' OR 'R09' OR 'R07' OR 'R10' OR 'R11' OR 'R13' ){/********************************************************R03*/
          ...
          print "<form name='f1' method='POST' action='opcscd_2022.php' Onsubmit='return checkformf1()'>";
...
//////////////ต้องการเก็บเงินทั้งหมด, ออกใบเสร็จ
		...
		print "<form name='f2' method='POST' action='opbill_2022.php' Onsubmit='return checkformf2()'>";
