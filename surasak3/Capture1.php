...
<!-- แทรกไฟล์ croflash.swf ลงไปใน Code ด้านล่างครับ (หลักการเหมือนแทรกรูปภาพธรรมดา) -->
  <object width="550" height="400" type="application/x-shockwave-flash">
    <param name="movie" value="app:/croflash.swf">
    <embed src="app:/croflash.swf" width="550" height="400" type="application/x-shockwave-flash"></embed>
  </object>
  <br>
  <br>
  HN : <?=$_GET['hn'];?><br>
