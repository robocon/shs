...
<center>
<span class="tet1">พิมพ์ใบตรวจสุขภาพ อบต.นายาง</span> <br />
  <br />
...
////*runno ตรวจสุขภาพ*/////////
	...
	//ปีล่าสุด
	$select = "select * from condxofyear_out where hn='".$_POST['hn']."' order by row_id desc";
...
<table width="100%" border="0" class="text4">
  <tr>
    <td  width="50%" align="center"><strong>Authorise  LAB:</strong>
        ...
        <strong> (
          <?=$authorisedate?>
          ) CXR : </strong>พ.ต.ภูภูมิ วุฒิธาดา (ว.33906) รังสีแพทย์<strong> (04-05-2015) Doctor :พ.ต.เลอปรัชญ์ มังกรกนกพงศ์ (18-05-2015)</strong></td>
  </tr>
</table>
<?
}
