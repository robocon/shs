คิวทั่วไป number&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target=_self  href='../nindex.htm'><< ไปเมนู</a><br>
<a  href='runnoupdate1.php' onclick='return confirm("ระบบจะทำการ Reset คิวทั้งหมด\nต้องการทำงานต่อใช่หรือไม่?");'>แก้ไขคิวทั้งหมด</a>
<?php    
	include("connect.inc");
    print "<table>";
    print "<tr>";
