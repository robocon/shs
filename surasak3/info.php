...
///////
	...
	if (substr($row->part,0,3)=="DSY" && $row->medical_sup_free ==1){
	            ...
	            $aDSY[$x]=0;  //เวชภัณฑ์ไม่ใช่ยา ส่วนที่เบิกได้ $row->free
	            $aDSN[$x]=$money;  // เวชภัณฑ์ไม่ใช่ยา ส่วนที่เบิกไม่ได้ $row->salepri - $row->free
	            }
	else {
	            $aDSY[$x]=0; 
	            $aDSN[$x]=0;
	...
	////////
	   for ($n=1; $n<=$x; $n++){
	        print("<tr>\n".
	                "<td bgcolor=F5DEB3><a target='right'  href=\"opdgdele.php? Delrow=$n\"><font face='Angsana New'>ลบ</td>\n".
...
else if (substr($row->part,0,3)=="DSY" && $row->medical_sup_free == 0){ //เวชภัณฑ์ไม่ใช่ยา ส่วนที่ไม่สามารถเบิกได้
            $aDSY[$x]=0;  
            $aDSN[$x]=$money;  
            }
else {
...
<?php
     ...
     $sSlip="";
?>
    <br><br><a target=_BLANK href="slipprn.php">พิมพ์สลากยา</a>
   &nbsp;&nbsp;&nbsp;<a target=_BLANK href="rxoptranx.php">ตัดสต๊อก/ใบแจ้งหนี้</a>
   &nbsp;&nbsp;&nbsp;<a target=_BLANK href="notrxop.php">(ยกเลิก)</a>
 <br><br>
  <a target=_BLANK href="rxoptranx2.php">ตัดสต๊อก/ใบแจ้งหนี้ฉลากรุ่นใหม่</a>
&nbsp;&nbsp;&nbsp;<a target=_BLANK href="slipprntest2.php">พิมพ์สลากยารุ่นใหม่</a>

<br><BR>
  <a target=_BLANK href="slipprnopd.php">ติดOPDCARDค้างจ่าย</a>
