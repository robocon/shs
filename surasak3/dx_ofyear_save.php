...
<tr>
    <td>HN :<?php echo $_POST["hn"];?>&nbsp;&nbsp;VN: <?=$_POST["vn"];?>&nbsp;&nbsp;<?php echo $date_now;?></td>
  </tr>
  <tr>
    <td>T : <?php echo $_POST["temperature"];?> C, P : <?php echo $_POST["pause"];?> ครั้ง/นาที , R : <?php echo $_POST["rate"];?> ครั้ง/นาที </td>
  </tr>
<? if(empty($_POST["bp21"]) && empty($_POST["bp22"])){?>  
  <tr>
    <td>BP : <?php echo $_POST["bp1"];?> / <?php echo $_POST["bp2"];?> mmHg, รอบเอว  : <?php echo $_POST["round_"];?> ซม. </td>
  </tr>
<? }else{ ?>  
   <tr>
    <td>BP1 : <?php echo $_POST["bp1"];?> / <?php echo $_POST["bp2"];?> mmHg, BP2 : <?php echo $_POST["bp21"];?> / <?php echo $_POST["bp22"];?> mmHg, รอบเอว  : <?php echo $_POST["round_"];?> ซม. </td>
  </tr>
<? } ?> 
  <tr>
    <td>นน : <?php echo $_POST["weight"];?> กก., สส : <?php echo $_POST["height"];?> ซม., BMI : <?=$_POST["bmi"];?></td>
  </tr>
  <tr>
    <td>บุหรี่ : <?php echo $cigarette;?>, สุรา : <?php echo $alcohol;?></td>
  </tr>
  <tr>
