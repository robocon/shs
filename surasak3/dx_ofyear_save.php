...
$query ="UPDATE chkup_solider SET opd = '$dateopd' WHERE hn='".$_POST["hn"]."' and yearchkup='$nPrefix'";
$result = mysql_query($query) or die("Query failed");
//echo $upopday;
