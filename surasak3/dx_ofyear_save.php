...
<? }else{ ?>  
   <tr>
    <td>BP1 : <?php echo $_POST["bp1"];?> / <?php echo $_POST["bp2"];?> mmHg, BP2 : <?php echo $_POST["bp21"];?> / <?php echo $_POST["bp22"];?> mmHg, </td>
  </tr>
<? } ?> 
  <tr>
