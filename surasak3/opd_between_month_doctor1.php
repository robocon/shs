...
?>
<A HREF="..\nindex.htm">&lt;&lt; เมนู</A>  || <a href="opd_between_month_doctor.php">ช่วงเวลาส่งกรมแพทย์</a>
...
<TR>
	...
	<TR>
	  ...
	  <Option value="1">เฉพาะทหาร</Option><Option value="" <?php if($_POST["career"] != "1") echo " Selected ";?>>ดูทั้งหมด</Option></SELECT></TD>
	</TR>
	<TR>
...
$totaltime= TimeDiff($time_opd,$time_dc);		
	if(!empty($hn) && 	!empty($time_opd) && !empty($time_dc) && ($time_opd < $time_dc)){
	$i++;
	echo "
	<TR>
		<TD>".$i.".</TD>
