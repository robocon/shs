	...
	<tr>
		<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				AND hn = '$hn' AND `clinicalinfo` = 'CBC ,UA ,@stool ,HIV ,VDRL ,AMP ,' 
				GROUP BY hn 
...
<table width="100%" border="0" class="text4">
  <tr>
    <td  width="50%" align="center">
		...
		-->
		<b>ผู้รับผิดชอบผลการตรวจทางห้องปฏิบัติการ</b> พ.ท.สมยศ แสงสุข (ทน.3226) <b>ผู้รับผิดชอบผลการตรวจเอกซ์เรย์</b> พ.ท.วริทธิ์ พสุธาดล (ว.38228)
	</td>
  </tr>
</table>
