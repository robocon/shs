<?php
    print  "รายงานยาเวชภัณฑ์ที่มีเหลือจ่าย <= 1.5 เดือน  <br> ";
?>
<table>
 <tr>
  ...
  <th bgcolor=CD853F><font face='Angsana New'>เหลือ?เดือน</th>
...
<?php
    ...
    $query = "SELECT drugcode,tradname,unitpri,edpri,salepri,minimum,totalstk,mainstk,stock,rxrate,stkpmon,pack,packpri,comname FROM druglst  WHERE stkpmon <= 1.5 order by drugcode ";  
	...
	$rxrate,$stkpmon,$pack,$packing
        ...
        if($unitpri>0){
            ...
            print (" <tr>\n".
               ...
               "  <td BGCOLOR=CD853F><font face='Angsana New'>$stkpmon</td>\n".
