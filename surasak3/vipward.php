...
<link href="css/style_table.css" rel="stylesheet" type="text/css" />
   ...
   หอผู้ป่วยพิเศษ &nbsp;&nbsp;&nbsp;&nbsp;<a target=_BLANK href='ipdcost.php'>รวมเงินทุกเตียง</a>
...
<?php
	...
	$sql="SELECT * FROM bed WHERE bedcode LIKE '45%'";
...
echo"<br><table border=\"0\"  cellspacing=\"1\" cellpadding=\"1\"><tr>";
    ...
    $query = "SELECT idcard,bed,date,date_format(date,'%d- %m- %Y'),ptname,an,hn,diagnos,food,doctor,ptright,price,paid,debt,caldate,bedname,bedcode,hn,chgdate,status,age,diag1 FROM bed WHERE bedcode LIKE '45%' ORDER BY bed ASC ";
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse" bordercolor="#000000" bgcolor="<?=$color;?>" >
  <tr>
    ...
    <table width="100%" border="0">
      <tr>
        <td width="25%"><a name="<?=$bed;?>" id="<?=$bed;?>"></a><font class="bed"><? echo"<a href=\"ipbed.php? cBed=$bed&cDate=$date&cPtname=$ptname&cAn=$an&cDiagnos=$diagnos&cFood=$food&cDoctor=$doctor&cPtright=$ptright&cBedcode=$bedcode&cHn=$hn&cChgdate=$chgdate & cbedname=หอผู้ป่วยพิเศษ \" class='bed'>$bed</a>";?></font>&nbsp;&nbsp;&nbsp;
      ...
      <tr>
        ...
        <table  border="0">
          ...
          <tr style="line-height:22PX;">
            <td colspan="8"  valign="top" ><font class='tablefontt1'>โรค : </font><? echo "<a target=_blank  href=\"ipdiag.php? cBedcode=$bedcode&cBed=$bed&cFulname=$ptname&cDiag=$diagnos&cbedname=หอผู้ป่วยพิเศษ&cAn=$an\" class='tablefont3'>$diagnos</a>";?>&nbsp;&nbsp;&nbsp;<font class='tablefontt1'>แพทย์  : </font>  <? echo "<a target=_blank  href=\"ipdr.php?cBedcode=$bedcode&cBed=$bed&cFulname=$ptname&cDoctor=$doctor&cbedname=หอผู้ป่วยพิเศษ&cAn=$an\" class='tablefont3' >$doctor</a>";?>
            &nbsp;&nbsp;&nbsp;
            <font class='tablefontt1'>โรคประจำตัว  : </font>
           <font class='tablefont'> <? echo "<a target=_blank  href=\"ipdiag1.php?cBedcode=$bedcode&cBed=$bed&cFulname=$ptname&cDiag=$diag1&cbedname=หอผู้ป่วยพิเศษ&cAn=$an\">$diag1</a>";?></font>
           </td>
            </tr>
          <tr style="line-height:22PX;">
            <td colspan="8"  valign="top"><font class='tablefontt1'>อาหาร : </font><? echo "<a target=_blank  href=\"ipfood.php? cBedcode=$bedcode&cBed=$bed&cFulname=$ptname&cFood=$food&cbedname=หอผู้ป่วยพิเศษ&cAn=$an\" class='tablefont3'>$food</a>"; ?></td>
          </tr>
          <tr style="line-height:25PX;">
            ...
            <? echo "<a target=_blank href=\"wpreappoi.php?an=$an&cBed=$bed&cBedcode=$bedcode&cHn=$hn&cbedname=หอผู้ป่วยพิเศษ\" class='tablefont'>สั่ง LAB</a>"; ?> &nbsp;&nbsp; 
			...
			?>&nbsp;&nbsp; 
             ...
             <? echo "<a target=_blank  href=\"drug1a.php?Ptname=$ptname&cAn=$an&cBed=$bed& cBedcode=$bedcode&cHn=$hn&cbedname=พิเศษ \" class='tablefont3'>ยา(1 ดวง)</a>";?>&nbsp;&nbsp; 
			<? echo "<a target=_blank  href=\"ipbeddrug.php? cAn=$an &cBed=$bed & cBedcode=$bedcode & cHn=$hn & cbedname=หอผู้ป่วยพิเศษ \" class='tablefont3'>ยา(A4)</a>"; ?>&nbsp;&nbsp; 
			<? echo "<a target=_blank  href=\"ipbed1.php? cAn=$an &cBed=$bed & cBedcode=$bedcode & cHn=$hn & cbedname=หอผู้ป่วยพิเศษ \"  class='tablefont3'>ติดเอกสาร(A4)</a>";?>&nbsp;&nbsp; 
			<? echo "<a target=_blank  href=\"liststk.php?cAn=$an&cBed=$bed& cBedcode=$bedcode&cHn=$hn&cbedname=พิเศษ \" class='tablefont3'>เอกสาร(1 ดวง)</a>";?>
            </td>
          </tr>
        </table></td>
      </tr>
