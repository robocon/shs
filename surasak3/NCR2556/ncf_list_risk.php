...
<h1 class="forntsarabun" align="center">ใบรายงานเหตุการณ์สำคัญ/อุบัติการณ์/ความไม่สอดคล้อง <font color="#FF0000">เฉพาะที่ยังไม่ได้ลงบันทึกความเสี่ยง</font></h1>
...
$sql1="SELECT nonconf_id, ncr, until, date_format(nonconf_date,'%d/%m/')as date1,date_format(nonconf_date,'%Y')as date2,  left(nonconf_time,5) as time FROM  ncr2556  WHERE nonconf_date like '".$_POST['nonconf_date']."%' AND risk2='' AND risk3=''  and ( risk1=''  AND risk4='' AND risk5='' AND risk6='' AND risk7='' AND risk8='' AND risk9='' ) and risk2!='1' and risk3!='1' order by ncr asc";

}else if($_POST['ncr']!=''){
	
$sql1="SELECT nonconf_id, ncr, until, date_format(nonconf_date,'%d/%m/')as date1,date_format(nonconf_date,'%Y')as date2,  left(nonconf_time,5) as time FROM  ncr2556 WHERE ncr='".$_POST['ncr']."' and ( risk1=''  AND risk2='' AND risk3='' AND risk4='' AND risk5='' AND risk6='' AND risk7='' AND risk8='' AND risk9='' ) and risk2!='1' and risk3!='1'  order by ncr asc";	

}else{
$sql1="SELECT nonconf_id, ncr, until, date_format(nonconf_date,'%d/%m/')as date1,date_format(nonconf_date,'%Y')as date2,  left(nonconf_time,5) as time FROM  ncr2556  WHERE  ( risk1=''  AND risk2='' AND risk3='' AND risk4='' AND risk5='' AND risk6='' AND risk7='' AND risk8='' AND risk9='' )  and risk2!='1' and risk3!='1' order by ncr asc";	
}
	//WHERE  ( risk1='' AND risk2='' AND risk3='' AND risk4='' AND risk5='' AND risk6='' AND risk7='' AND risk8='' AND risk9='' ) 
