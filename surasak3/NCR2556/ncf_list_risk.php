...
<table border="1" cellpadding="0" cellspacing="0" bordercolor="#666666" style="border-collapse:collapse">
    ...
    <tr>
        <td>
            <form name="f1" class="form-search" action="ncf_list_risk.php" method="post">
                <?php
...
AND risk2 = '' AND risk3 = ''  
and ( risk1 = ''  AND risk4 = '' AND risk5 = '' AND risk6 = '' AND risk7 = '' AND risk8 = '' AND risk9 = '' ) 
and risk2 != '1' 
and risk3 != '1' 
...
FROM  ncr2556 
WHERE ncr = '".$_POST['ncr']."' 
and ( risk1 = ''  AND risk2='' AND risk3='' AND risk4='' AND risk5='' AND risk6='' AND risk7='' AND risk8='' AND risk9='' ) 
and risk2 != '1' 
and risk3 != '1'  
ORDER BY until ASC, ncr ASC";	
