...
VALUES ('".$id_max."',  'สัปดาห์ที่ 6',  '".$_POST['blood1']."',  '".$_POST['blood2']."', '".$_POST['blood3']."', '".$_POST['blood4']."');";
$query1=mysql_query($sql1)or die(mysql_error());
//2
$sql2="INSERT INTO  `ic_accident_pi` (`ref_id` ,  `after_cbc` ,  `hiv_ab` ,  `hiv_ag` ,  `hbs_ag` ,  `hbs_ab` ) 
VALUES ('".$id_max."',  'เดือนที่ 3',  '".$_POST['blood5']."',  '".$_POST['blood6']."', '".$_POST['blood7']."', '".$_POST['blood8']."');";
$query2=mysql_query($sql2)or die(mysql_error());
//3
$sql3="INSERT INTO  `ic_accident_pi` (`ref_id` ,  `after_cbc` ,  `hiv_ab` ,  `hiv_ag` ,  `hbs_ag` ,  `hbs_ab` ) 
VALUES ('".$id_max."',  'เดือนที่ 6',  '".$_POST['blood9']."',  '".$_POST['blood10']."', '".$_POST['blood11']."', '".$_POST['blood12']."');";
$query3=mysql_query($sql3)or die(mysql_error());
//4
$sql4="INSERT INTO  `ic_accident_pi` (`ref_id` ,  `after_cbc` ,  `hiv_ab` ,  `hiv_ag` ,  `hbs_ag` ,  `hbs_ab` ) 
VALUES ('".$id_max."',  'เดือนที่ 12',  '".$_POST['blood13']."',  '".$_POST['blood14']."', '".$_POST['blood15']."', '".$_POST['blood16']."');";
