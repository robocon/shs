...
if(isset($_GET['clinic'])){
	...
	$where="AND clinic='".$_GET['clinic']."' ";
}else if(isset($_GET['event'])){
	
	if($_GET['event']==1){
		$where="AND  (topic1_1 or topic1_2 or topic1_3 or topic1_4 or topic1_5 or  topic1_6 !=0  or topic1_7 !='' ) ";
	}
	if($_GET['event']==2){
		$where="AND  (topic2_1 or topic2_2 or topic2_3 or topic2_4 or topic2_5   or topic1_6 !=0  or topic2_7 !='' )";
	}
	if($_GET['event']==3){
		$where="AND (topic3_1 or topic3_2 or topic3_3 !=0 or  topic3_4 !='' )";
	}
	if($_GET['event']==4){
		$where="and   (topic4_1 or topic4_2 or topic4_3 or topic4_4 or topic4_5 !=0 or  topic4_6 !='' ) ";
	}
	if($_GET['event']==5){
		$where="and   (topic5_1 or topic5_2 or topic5_3 or topic5_4 or topic5_5 or topic5_6 or topic5_7 or topic5_8 or topic5_9 or topic5_10  !=0 or  topic5_11 !='' ) ";
	}
	if($_GET['event']==6){
		$where="and   (topic6_1 or topic6_2 or topic6_3 or topic6_4   !=0  or  topic6_5 !='' )";
	}
	if($_GET['event']==7){
		$where="and   (topic7_1 or topic7_2 or topic7_3 or topic7_4 or topic7_5 or topic7_6 !=0 or  topic7_7 !='' ) ";
	}
	if($_GET['event']==8){
...
}else if(isset($_GET['psg'])){
		$where="AND  $_GET[psg] =1 ";
}else{
		$where="";
}
...
if(isset($_GET['until'])){
	...
	$where1="";
		...
		$sql = "Select date_format(nonconf_date,'%d/%m/%Y')as nonconf_date, left(nonconf_time,5)as nonconf_time ,a.*  From  ncr2556 as a  where nonconf_date like '".$_GET["y"]."%'  $where $where1 Order by nonconf_id DESC ";
		//echo $sql;
	...
	echo "<TR bgcolor='".$bgcolor."'>";
		...
		<b>$topic4</b>".$topic4_1.$topic4_2.$topic4_3.$topic4_4.$topic4_5.$topic4_7."
