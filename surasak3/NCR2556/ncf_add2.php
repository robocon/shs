...
$q = mysql_query("SELECT `startday` FROM `runno` WHERE `title` = 'NCR';");
$item = mysql_fetch_assoc($q);

// ทำการเปรียบเทียบเดือน ถ้ามีการเปลี่ยนเดือนให้เริ่มเลข runno ใหม่
// แต่ถ้าไม่ใช่ให้เพิ่มเลข runno +1 
$unix_time = strtotime($item['startday']);
$test_month = date('m');
$runno_month = date('m', $unix_time);
if($test_month != $runno_month){
	$sql = "
	UPDATE `runno` 
	SET `runno` = '1' , `startday` = '$now' 
	WHERE `title` = 'NCR'
	";
}else{
	$sql = "
	UPDATE `runno` 
	SET `runno` = `runno` + 1 , `startday` = '$now' 
	WHERE `title` = 'NCR'
	";
}
...
$q = mysql_query("SELECT `runno`, `startday` FROM `runno` WHERE `title` = 'NCR';");
$item = mysql_fetch_assoc($q);
...
VALUES ('".$item['runno']."', '".$_POST['until']."', '".$_POST['nonconf_date']."', '".$_POST['nonconf_time']."', '".$_POST['event']."', '".$_POST['come_from_id']."','".$_POST['come_from_detail']."', '".$_POST['topic1_1']."', '".$_POST['topic1_2']."', '".$_POST['topic1_3']."', '".$_POST['topic1_4']."', '".$_POST['topic1_5']."', '".$_POST['topic1_6']."', '".nl2br(trim($_POST['topic1_7']))."', '".$_POST['topic2_1']."', '".$_POST['topic2_2']."', '".$_POST['topic2_3']."', '".$_POST['topic2_4']."', '".$_POST['topic2_5']."', '".$_POST['topic2_6']."', '".nl2br(trim($_POST['topic2_7']))."', '".$_POST['topic3_1']."', '".$_POST['topic3_2']."', '".$_POST['topic3_3']."', '".nl2br(trim($_POST['topic3_4']))."', '".$_POST['topic4_1']."', '".$_POST['topic4_2']."', '".$_POST['topic4_3']."', '".$_POST['topic4_4']."','".$_POST['topic4_5']."', '".nl2br(trim($_POST['topic4_6']))."' , '".$_POST['topic5_1']."', '".$_POST['topic5_2']."', '".$_POST['topic5_3']."', '".$_POST['topic5_4']."', '".$_POST['topic5_5']."', '".$_POST['topic5_6']."', '".$_POST['topic5_7']."', '".$_POST['topic5_8']."', '".$_POST['topic5_9']."', '".$_POST['topic5_10']."', '".nl2br(trim($_POST['topic5_11']))."', '".$_POST['topic6_1']."', '".$_POST['topic6_2']."', '".$_POST['topic6_3']."', '".$_POST['topic6_4']."', '".nl2br(trim($_POST['topic6_5']))."', '".$_POST['topic7_1']."', '".$_POST['topic7_2']."', '".$_POST['topic7_3']."', '".$_POST['topic7_4']."', '".$_POST['topic7_5']."', '".$_POST['topic7_6']."', '".nl2br(trim($_POST['topic7_7']))."', '".$_POST['topic8_1']."', '".$_POST['topic8_2']."', '".$_POST['topic8_3']."', '".$_POST['topic8_4']."', '".$_POST['topic8_5']."', '".$_POST['topic8_6']."', '".$_POST['topic8_7']."','".$_POST['topic8_8']."','".$_POST['topic8_9']."','".$_POST['topic8_10']."', '".nl2br(trim($_POST['topic8_11']))."', '".$_POST['clinic']."', '".$_POST['quality']."','".$_POST['cpno']."','".$_POST['risk1']."', '".$_POST['risk2']."','".$_POST['risk3']."','".$_POST['risk4']."','".$_POST['risk5']."','".$_POST['risk6']."','".$_POST['risk7']."', '".$_POST['risk8']."','".$_POST['risk9']."','".nl2br(trim($_POST['sum_up']))."', '".nl2br(trim($_POST['problem']))."','".nl2br(trim($_POST['protect']))."','".$_POST['head_name']."', '".$_POST['menucode']."', '".$_POST['officer']."', NOW())";
