...
<table  border="1" class="table1" cellpadding="0" cellspacing="0" align="center">
      <tr class="fontsara16b">
        <td class="fontsara16b"><strong>1.ความปลอดภัย / ตก /หกล้ม</strong></td>
...
<? } ?>
      ...
      <tr>
        <td class="fontsara16b"><strong>2.การติดต่อสื่อสาร </strong></td>
        <td >&nbsp;</td>
      </tr>
...
<? } ?>      
       ...
       <tr>
        <td class="fontsara16b" ><strong>3.เลือด</strong></td>
        <td>&nbsp;</td>
      </tr>
...
<? }else{ echo $arr[$arrtopic3[$n]]; } ?></td>
      ...
      <? } ?>
       ...
       <tr>
        <td class="fontsara16b"><strong>4.เครื่องมือ </strong></td>
        <td>&nbsp;</td>
      </tr>
...
<? }else{ echo $arr[$arrtopic4[$n]]; } ?></td>
     ...
     <? } ?> 
      ...
      <tr class="fontsara16b">
        <td><strong>5.การวินิจฉัย / รักษา</strong></td>
        <td align="center"></td>
      </tr>
...
<? } ?>
       ...
       <tr >
        <td class="fontsara16b"><strong>6.การคลอด
</strong></td>
        <td align="center" >&nbsp;</td>
		</tr>
...
<? }else{ echo $arr[$arrtopic6[$n]]; } ?></td>
     ...
     <? } ?>
       ...
       <tr>
        <td class="fontsara16b" ><strong>7.การผ่าตัด / วิสัญญี
</strong></td>
        <td align="center">&nbsp;</td>
	</tr>
