...
$sql1="SELECT nonconf_id, ncr, until, nonconf_date, date_format(nonconf_date,'%d/%m/')as date1,date_format(nonconf_date,'%Y')as date2,  left(nonconf_time,5) as time ,risk2,risk3,nonconf_dategroup ,`return` FROM  ncr2556  WHERE nonconf_date like '".$_POST['nonconf_date']."%' and risk2 ='1' or risk3 ='1' order by ncr desc";

}else if($_POST['ncr']!=''){
	
$sql1="SELECT nonconf_id, ncr, until, nonconf_date, date_format(nonconf_date,'%d/%m/')as date1,date_format(nonconf_date,'%Y')as date2,  left(nonconf_time,5) as time ,risk2,risk3,nonconf_dategroup ,`return` FROM  ncr2556 WHERE ncr='".$_POST['ncr']."'  and risk2 =1 or risk3 =1 order by ncr desc";	
