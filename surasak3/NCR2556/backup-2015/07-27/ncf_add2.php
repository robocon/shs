...
$sql = "
SELECT `runno`,`startday` FROM `runno` WHERE title='NCR'
";
$q = mysql_query($sql);
...
if($query){
	...
	$sql2 ="UPDATE runno SET runno ='$next_ncr', startday = '$now' WHERE title='NCR'";
