...
If (!empty($month)){
   $yrmn=$year."-".$month;
//   print"ภาวะแทรกซ้อนที่พบบ่อยในโรงพยาบาล  อัตราการเกิดภาวะแทรกซ้อนรายโรค/หัตถการ (หรือกลุ่มโรค/กลุ่มหัตถการ)  เดือน $month ปี$year";
    include("connect.inc");
     $query = "SELECT ptname,hn,an,diag,icd10,complica,dctype,date,dcdate,days,price,bedcode,doctor FROM ipcard  WHERE date LIKE '$yrmn%' ";  
