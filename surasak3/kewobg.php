...
global $regisdate,$an,$sex,$married,$idcard,
 ...
 $query = "SELECT title,prefix,runno FROM runno WHERE title = 'kewobg'";
...
// update kew to table runno
    $query ="UPDATE runno SET runno = $nRunno WHERE title='kewobg'";
    $result = mysql_query($query);
...
print "<center><font size=4><b>คลีนิกพิเศษสูตินารีเวช</b><br> ";
