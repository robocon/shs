...
<form method="POST" action="export_drug_ipd1.php">
<p style="font-weight:bold">ฐานข้อมูลด้านการแพทย์และสุขภาพ ในรูปแบบ 43 แฟ้มมาตรฐาน แฟ้มที่17 ตาราง DRUG_IPD แต่ละเดือน</p>
