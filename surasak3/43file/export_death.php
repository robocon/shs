...
<form method="POST" action="export_death1.php">
<p style="font-weight:bold">ฐานข้อมูลด้านการแพทย์และสุขภาพ ในรูปแบบ 43 แฟ้มมาตรฐาน แฟ้มที่3 ตาราง DEATH แต่ละเดือน</p>
