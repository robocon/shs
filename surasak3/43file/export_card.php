...
<form method="POST" action="export_card1.php">
<p style="font-weight:bold">ฐานข้อมูลด้านการแพทย์และสุขภาพ ในรูปแบบ 43 แฟ้มมาตรฐาน แฟ้มที่4 ตาราง CARD แต่ละเดือน</p>
