...
<form method="POST" action="export_drugallergy1.php">
<p style="font-weight:bold">ฐานข้อมูลด้านการแพทย์และสุขภาพ ในรูปแบบ 43 แฟ้มมาตรฐาน แฟ้มที่5 ตาราง DRUGALLERGY แต่ละเดือน</p>
