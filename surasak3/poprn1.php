...
///////End Load offisers
    ...
    $query = "SELECT date,depart,prepono,prepodate,comcode,comname,items,netprice,pono,ponoyear,podate,bounddate,row_id,chkindate FROM pocompany WHERE row_id = '$nRow_id' ";
...
print "<DIV style='left:329PX;top:46PX;width:155PX;height:34PX;TEXT-ALIGN:CENTER;'><span class='fc1-1'>บันทึกข้อความ</span></DIV>";
...
print "<DIV style='left:378PX;top:107PX;width:272PX;height:30PX;'><span class='fc1-5'>$cPodate</span></DIV>";
...
print "<DIV style='left:105PX;top:166PX;width:661PX;height:30PX;'><span class='fc1-0'>ขออนุมัติจัดซื้อเวชภัณฑ์ $cDepart </span></DIV>";
}
...
print "<DIV style='left:105PX;top:215PX;width:661PX;height:30PX;'><span class='fc1-0'>1. ระเบียบสำนักนายกรัฐมนตรี ว่าด้วย การพัสดุ พ.ศ.2535, ลง 20 ม.ค. 2535, และที่แก้ไขเพิ่มเติม</span></DIV>";

print "<DIV style='left:105PX;top:240PX;width:661PX;height:30PX;'><span class='fc1-0'>2. คำสั่ง กห (เฉพาะ) ที่ 50/50  16 มี.ค. 2550 เรื่อง การพัสดุ</span></DIV>";

print "<DIV style='left:105PX;top:265PX;width:661PX;height:30PX;'><span class='fc1-0'>3. คำสั่ง ทบ (เฉพาะ) ที่ 476/44 เรื่อง มอบอำนาจอนุมัติการเบิกจ่ายเงินรายรับสถานพยาบาล</span></DIV>";

print "<DIV style='left:105PX;top:290PX;width:661PX;height:30PX;'><span class='fc1-0'>4. หนังสือ กบ.ทบ. ด่วนมาก ที่ กห 0404/3087 ลง 7 ก.ย. 2558</span></DIV>";

print "<DIV style='left:105PX;top:315PX;width:661PX;height:30PX;'><span class='fc1-0'>5. หนังสือกรมบัญชีกลาง ด่วนที่สุด ที่ กค(กวพ.) 0421.3/299 ลง 28 ส.ค. 2558</span></DIV>";

print "<DIV style='left:105PX;top:340PX;width:661PX;height:30PX;'><span class='fc1-0'>6. หนังสือกรมบัญชีกลาง ด่วนที่สุด ที่ กค(กวพ.) 0421.3/ว 145 ลง 21 มี.ค. 2559</span></DIV>";

print "<DIV style='left:54PX;top:365PX;width:106PX;height:30PX;'><span class='fc1-5'>สิ่งที่ส่งมาด้วย</span></DIV>";

if(empty($cDepart)){
print "<DIV style='left:166PX;top:365PX;width:229PX;height:30PX;'><span class='fc1-0'>1. หนังสือกองเภสัชกรรม รพ.ค่ายฯ ที่</span></DIV>";
}else{
print "<DIV style='left:166PX;top:365PX;width:229PX;height:30PX;'><span class='fc1-0'>1. หนังสือ$showdepart รพ.ค่ายฯ ที่</span></DIV>";
}

print "<DIV style='left:394PX;top:365PX;width:110PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'><B>$cPrepono</B></span></DIV>";

print "<DIV style='left:503PX;top:365PX;width:56PX;height:30PX;'><span class='fc1-0'>ลงวันที่</span></DIV>";

print "<DIV style='left:558PX;top:365PX;width:208PX;height:30PX;'><span class='fc1-0'><B>$cPrepodate</B></span></DIV>";

print "<DIV style='left:166PX;top:390PX;width:600PX;height:30PX;'><span class='fc1-0'>2. บัญชีรายละเอียดในการ จัดซื้อ จำนวน 1 ชุด</span></DIV>";

if(empty($cDepart)){
print "<DIV style='left:105PX;top:415PX;width:661PX;height:30PX;'><span class='fc1-0'>1. เนื่องด้วยกองเภสัชกรรม รพ.ค่ายฯ มีความจำเป็นที่จะต้องจัดซื้อเวชภัณฑ์เพื่อใช้ในราชการ รพ.ค่ายฯ</span></DIV>";
}else{
print "<DIV style='left:105PX;top:415PX;width:661PX;height:30PX;'><span class='fc1-0'>1. เนื่องด้วยกองเภสัชกรรม รพ.ค่ายฯ มีความจำเป็นที่จะต้องจัดซื้อเวชภัณฑ์เพื่อใช้ใน$showdepart รพ.ค่ายฯ</span></DIV>";
}

print "<DIV style='left:61PX;top:440PX;width:705PX;height:30PX;'><span class='fc1-0'>ตามสิ่งที่ส่งมาด้วยข้อ 1.</span></DIV>";

print "<DIV style='left:105PX;top:465PX;width:661PX;height:30PX;'><span class='fc1-0'>2. รายละเอียด พัสดุที่จะจัดซื้อ ตามบัญชีรายละเอียดที่แนบตามสิ่งที่ส่งมาด้วย 2.</span></DIV>";

print "<DIV style='left:105PX;top:490PX;width:189PX;height:30PX;'><span class='fc1-0'>3. วงเงิน จัดซื้อ ครั้งนี้เป็นเงิน</span></DIV>";

print "<DIV style='left:293PX;top:490PX;width:99PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'><B>$nPriadvat</B></span></DIV>";

print "<DIV style='left:391PX;top:490PX;width:40PX;height:30PX;'><span class='fc1-0'>บาท</span></DIV>";

print "<DIV style='left:430PX;top:490PX;width:400PX;height:30PX;'><span class='fc1-0'>$cPriadvat</span></DIV>";  //จำนวนเงินตัวอักษร

print "<DIV style='left:61PX;top:515PX;width:191PX;height:30PX;'><span class='fc1-0'>(ต้องการให้งานนั้นเสร็จในวันที่</span></DIV>";

print "<DIV style='left:251PX;top:515PX;width:167PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'><B>$cBounddate</B></span></DIV>";  //วันที่ ข้อ3 แก้ไข 30-11-59

print "<DIV style='left:417PX;top:515PX;width:349PX;height:30PX;'><span class='fc1-0'>)</span></DIV>";

print "<DIV style='left:105PX;top:540PX;width:239PX;height:30PX;'><span class='fc1-0'>4. กำหนดเวลาที่ต้องการใช้วัสดุในวันที่</span></DIV>";

print "<DIV style='left:343PX;top:540PX;width:167PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'><B>$cBounddate</B></span></DIV>";  //วันที่ ข้อ 4 แก้ไข 30-11-59

print "<DIV style='left:509PX;top:540PX;width:257PX;height:30PX;'><span class='fc1-0'>ส่งที่หน่วย รพ.ค่ายสุรศักดิ์มนตรี</span></DIV>";

print "<DIV style='left:105PX;top:565PX;width:661PX;height:30PX;'><span class='fc1-0'>5. การซื้อ ครั้งนี้วงเงินไม่เกิน 500,000 บาท เห็นควรซื้อโดย $vitee ตามระเบียบฯ ที่อ้างถึง วงเงินอยู่</span></DIV>";

print "<DIV style='left:61PX;top:590PX;width:705PX;height:30PX;'><span class='fc1-0'> ในอำนาจของ ผอ.รพ.ค่ายฯ อนุมัติได้</span></DIV>";

print "<DIV style='left:105PX;top:615PX;width:661PX;height:30PX;'><span class='fc1-0'>6. การซื้อครั้งนี้เห็นควรซื้อ จาก";

if(empty($cDepart)){
print "<B>$cComname</B> เพราะสืบราคาแล้ว</span></DIV>";
print "<DIV style='left:61PX;top:640PX;width:705PX;height:30PX;'><span class='fc1-0'>เป็นราคาต่ำสุดใกล้เคียงกับราคาท้องตลาดปัจจุบัน ได้ต่อรองราคาต่ำสุดแล้ว และขออนุมัติใช้ใบสั่งซื้อเป็นข้อตกลง</span></DIV>";
}else{
print "<B>$cComname</B> เพราะหน่วยใช้เป็นผู้ระบุ</span></DIV>";
print "<DIV style='left:61PX;top:640PX;width:705PX;height:30PX;'><span class='fc1-0'>ความต้องการ จำนวนที่จะใช้ และขออนุมัติใช้ใบสั่งซื้อเป็นข้อตกลง</span></DIV>";
}

print "<DIV style='left:61PX;top:665PX;width:705PX;height:30PX;'><span class='fc1-0'>แทนการทำสัญญาและ ไม่ควร เรียกหลักประกันสัญญา</span></DIV>";

print "<DIV style='left:105PX;top:690PX;width:661PX;height:30PX;'><span class='fc1-0'>7. ข้อเสนอ</span></DIV>";

if(empty($cDepart)){
print "<DIV style='left:138PX;top:715PX;width:540PX;height:30PX;'><span class='fc1-0'>7.1 เห็นควรอนุมัติ(จัดซื้อ)ให้กองเภสัชกรรม รพ.ค่ายสุรศักดิ์มนตรีโดย$vitee รวม $nItems รายการ</span></DIV>";
}else{
print "<DIV style='left:138PX;top:715PX;width:540PX;height:30PX;'><span class='fc1-0'>7.1 เห็นควรอนุมัติ(จัดซื้อ)ให้$showdepart รพ.ค่ายสุรศักดิ์มนตรีโดย$vitee รวม $nItems รายการ</span></DIV>";
}
print "<DIV style='left:61PX;top:740PX;width:48PX;height:30PX;'><span class='fc1-0'>วงเงิน</span></DIV>";

print "<DIV style='left:108PX;top:740PX;width:99PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'><B>$nPriadvat</B></span></DIV>"; //จำนวนเงิน ตัวเลข

print "<DIV style='left:206PX;top:740PX;width:40PX;height:30PX;'><span class='fc1-0'>บาท</span></DIV>";

print "<DIV style='left:245PX;top:740PX;width:521PX;height:30PX;'><span class='fc1-0'>$cPriadvat</span></DIV>";  //จำนวนเงินตัวอักษร

print "<DIV style='left:61PX;top:765PX;width:705PX;height:30PX;'><span class='fc1-0'>จาก";
  print "<B>$cComname</B> และใช้ใบสั่งซื้อ เป็นข้อตกลงแทนการทำสัญญา</span></DIV>";

print "<DIV style='left:61PX;top:790PX;width:705PX;height:30PX;'><span class='fc1-0'> และเห็นควรงดเรียกหลักประกันสัญญา เนื่องจากผู้ขายติดต่อค้าขายกับทางราชการเป็นประจำมีความมั่นคง เป็นที่น่าเชื่อถือ</span></DIV>";

print "<DIV style='left:61PX;top:815PX;width:705PX;height:30PX;'><span class='fc1-0'>ของทางราชการ</span></DIV>";

print "<DIV style='left:138PX;top:840PX;width:120PX;height:30PX;'><span class='fc1-0'>7.2 เห็นควรแต่งตั้ง</span></DIV>";

print "<DIV style='left:257PX;top:840PX;width:150PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>$cKumkan</span></DIV>";

print "<DIV style='left:406PX;top:840PX;width:48PX;height:30PX;'><span class='fc1-0'>จำนวน</span></DIV>";

print "<DIV style='left:453PX;top:840PX;width:18PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>$nKumkan</span></DIV>";

print "<DIV style='left:470PX;top:840PX;width:295PX;height:30PX;'><span class='fc1-0'>นาย ตามระเบียบฯ ด้วยแล้วรายงานผล</span></DIV>";

print "<DIV style='left:61PX;top:865PX;width:705PX;height:30PX;'><span class='fc1-0'> ให้ทราบภายใน 5 วันทำการ</span></DIV>";

print "<DIV style='left:138PX;top:890PX;width:628PX;height:30PX;'><span class='fc1-0'>จึงเรียนมาเพื่อกรุณาทราบ และกรุณาอนุมัติตามข้อเสนอในข้อ 7.</span></DIV>";


print "<DIV style='left:466PX;top:915PX;width:71PX;height:30PX;TEXT-ALIGN:RIGHT;'><span class='fc1-0'>$aYot[2]</span></DIV>";  //ยศ

print "<DIV style='left:456PX;top:915PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>$aPost2[2]</span></DIV>"; //ลงชื่อ

print "<DIV style='left:456PX;top:940PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>($aFname[2])</span></DIV>";  //ชื่อสกุล

print "<DIV style='left:456PX;top:965PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>$aPost[2]</span></DIV>";  //ตำแหน่ง
...
print"<DIV style='left:48PX;top:1198PX;width:303PX;height:22PX;'><span class='fc1-2'>$aTradname[1]&nbsp;&nbsp;$aSnspec[1]</span></DIV>";
...
print"<DIV style='left:48PX;top:1228PX;width:303PX;height:22PX;'><span class='fc1-2'>$aTradname[2]&nbsp;&nbsp;$aSnspec[2]</span></DIV>";
...
print"<DIV style='left:48PX;top:1258PX;width:303PX;height:22PX;'><span class='fc1-2'>$aTradname[3]&nbsp;&nbsp;$aSnspec[3]</span></DIV>";
...
print"<DIV style='left:48PX;top:1288PX;width:303PX;height:22PX;'><span class='fc1-2'>$aTradname[4]&nbsp;&nbsp;$aSnspec[4]</span></DIV>";
...
print"<DIV style='left:48PX;top:1318PX;width:303PX;height:22PX;'><span class='fc1-2'>$aTradname[5]&nbsp;&nbsp;$aSnspec[5]</span></DIV>";
...
print"<DIV style='left:48PX;top:1348PX;width:303PX;height:22PX;'><span class='fc1-2'>$aTradname[6]&nbsp;&nbsp;$aSnspec[6]</span></DIV>";
...
print"<DIV style='left:48PX;top:1378PX;width:303PX;height:22PX;'><span class='fc1-2'>$aTradname[7]&nbsp;&nbsp;$aSnspec[7]</span></DIV>";
...
print"<DIV style='left:48PX;top:1408PX;width:303PX;height:22PX;'><span class='fc1-2'>$aTradname[8]&nbsp;&nbsp;$aSnspec[8]</span></DIV>";
...
print"<DIV style='left:48PX;top:1448PX;width:303PX;height:22PX;'><span class='fc1-2'>$aTradname[9]&nbsp;&nbsp;$aSnspec[9]</span></DIV>";
...
print"<DIV style='left:48PX;top:1478PX;width:303PX;height:22PX;'><span class='fc1-2'>$aTradname[10]&nbsp;&nbsp;$aSnspec[10]</span></DIV>";
...
print"<DIV style='left:48PX;top:1508PX;width:303PX;height:22PX;'><span class='fc1-2'>$aTradname[11]&nbsp;&nbsp;$aSnspec[11]</span></DIV>";
...
print"<DIV style='left:48PX;top:1538PX;width:303PX;height:22PX;'><span class='fc1-2'>$aTradname[12]&nbsp;&nbsp;$aSnspec[12]</span></DIV>";
...
print"<DIV style='left:48PX;top:1568PX;width:303PX;height:22PX;'><span class='fc1-2'>$aTradname[13]&nbsp;&nbsp;$aSnspec[13]</span></DIV>";
...
print "<DIV style='left:366PX;top:1773PX;width:384PX;height:30PX;'><span class='fc1-0'><B>$cBounddate</B></span></DIV>";  //แก้ไขวันที่ 30-11-59
...
print "<DIV style='left:138PX;top:2136PX;width:645PX;height:21PX;'><span class='fc1-3'>ข้อ 2. ผู้ขายรับรองว่าจะส่งมอบสิ่งของที่ซื้อขายตามใบสั่งซื้อนี้ให้แก่ผู้ซื้อ ณ รพ.ค่ายสุรศักดิ์มนตรี  วันที่";
  print "</span><span class='fc1-3'><B>$cBounddate</B></span></DIV>";
...
print "<DIV style='left:372PX;top:2643PX;width:71PX;height:23PX;'><span class='fc1-3'> $aYot[9]</span></DIV>";
...
print "<DIV style='left:430PX;top:2847PX;width:269PX;height:23PX;'><span class='fc1-3'><B>$cBounddate</B></span></DIV>";
print "<DIV style='left:317PX;top:2869PX;width:55PX;height:23PX;TEXT-ALIGN:RIGHT;'><span class='fc1-3'></span></DIV>";
print "<DIV style='left:371PX;top:2891PX;width:263PX;height:23PX;TEXT-ALIGN:CENTER;'><span class='fc1-3'><B>$cBounddate</B></span></DIV>";
...
print "<DIV style='left:268PX;top:4552PX;'><span class='fc1-0'>

<TABLE class='fc1-0' cellpadding='0' cellspacing='0' border='0' width='190'>
<TR>
	<TD align='right' width='50'>$aYot[5]</TD>
	<TD width='150'>&nbsp;</TD>
</TR>
<TR>
	<TD  align='right' width='50'>(</TD>
	<TD width='150'>$aFname[5])</TD>
</TR>
<TR>
	<TD align=\"center\" colspan=\"2\">$aPost[5]</TD>
</TR>
</TABLE>
</span></DIV>";
...
print "<DIV style='left:329PX;top:5146PX;width:155PX;height:34PX;TEXT-ALIGN:CENTER;'><span class='fc1-1'>บันทึกข้อความ</span></DIV>";
...
print "<img  WIDTH=73 HEIGHT=80 SRC='bird.jpg'>";
print "</DIV>";
print "<DIV style='left:378PX;top:5207PX;width:257PX;height:30PX;'><span class='fc1-0'><B>$cBounddate</B></span></DIV>";
...
//print "<DIV style='left:393PX;top:5876PX;width:55PX;height:30PX;TEXT-ALIGN:RIGHT;'><span class='fc1-0'>(ลงชื่อ)</span></DIV>";
...
print "<DIV style='left:530PX;top:5702PX;width:167PX;height:30PX;'><span class='fc1-0'><B>$cBounddate</B></span></DIV>";
...
print "<DIV style='left:105PX;top:5354PX;width:643PX;height:30PX;'><span class='fc1-0'>เรื่อง ขออนุมัติ จัดหาเวชภัณฑ์ $cDepart</span></DIV>";
}
print "<BR>";
print "</BODY></HTML>";
...
print "<DIV style='left:48PX;top:6189PX;width:246PX;height:26PX;'><span class='fc1-2'>หน่วยจ่าย กองเภสัชกรรม รพ. ค่ายฯ</span></DIV>";
print "<DIV style='left:48PX;top:6240PX;width:246PX;height:26PX;'><span class='fc1-2'>หน่วยเบิก $showdepart รพ. ค่ายฯ</span></DIV>";
}
...
print "<DIV style='left:632PX;top:6868PX;width:116PX;height:26PX;'><span class='fc1-2'><B>$cBounddate</B></span></DIV>";
print "<DIV style='left:9PX;top:6838PX;width:312PX;height:30PX;'><span class='fc1-0'>เห็นควรพิจารณาอนุมัติ</span></DIV>";
print "<DIV style='left:215PX;top:6869PX;width:116PX;height:26PX;'><span class='fc1-2'><B>$cBounddate</B></span></DIV>";
...
print "<DIV style='left:216PX;top:6959PX;width:116PX;height:26PX;'><span class='fc1-2'><B>$cBounddate</B></span></DIV>";
...
print "<DIV style='left:217PX;top:7051PX;width:116PX;height:26PX;'><span class='fc1-2'><B>$cBounddate</B></span></DIV>";
...
print "<DIV style='left:632PX;top:6959PX;width:116PX;height:26PX;'><span class='fc1-2'><B>$cBounddate</B></span></DIV>";
...
//print "<DIV style='left:409PX;top:7336PX;width:32PX;height:30PX;'><span class='fc1-5'>วันที่</span></DIV>";
print "<DIV style='z-index:15;left:78PX;top:7224PX;width:73PX;height:80PX;'>
<img  WIDTH=73 HEIGHT=80 SRC='bird.jpg'></DIV>";
print "<DIV style='left:409PX;top:7307PX;width:257PX;height:30PX;'><span class='fc1-0'><B>$cBounddate</B></span></DIV>";
...
print "<B>$nPriadvat</B> บาท&nbsp;&nbsp;$cPriadvat</span></DIV>";
...
if(empty($cDepart)){
print "<DIV style='left:88PX;top:7454PX;width:382PX;height:30PX;'><span class='fc1-0'>$vitee ให้กับ กองเภสัชกรรม รพ.ค่ายสุรศักดิ์มนตรี รวม</span></DIV>";
}else{
print "<DIV style='left:88PX;top:7454PX;width:392PX;height:30PX;'><span class='fc1-0'>$vitee ให้กับ $showdepart รพ.ค่ายสุรศักดิ์มนตรี รวม</span></DIV>";
}
...
print "<DIV style='left:191PX;top:7715PX;width:590PX;height:30PX;'><span class='fc1-0'>1.5 พัสดุที่จัดหามานี้ จะได้ให้ $showdepart รพ. ค่ายฯ เบิกรับไปใช้ในราชการต่อไป</span></DIV>";
...
print "<DIV style='left:389PX;top:8358PX;width:360PX;height:30PX;'><span class='fc1-0'><B>$cBounddate</B></span></DIV>";
...
print "<DIV style='left:212PX;top:8468PX;width:273PX;height:30PX;'><span class='fc1-0'>ค่าเวชภัณฑ์ $cDepart</span></DIV>";
}
