<?php
	...
	print "&nbsp;&nbsp;<a target=_self  href='ptperday.php'><<&#3652;&#3611;&#3648;&#3617;&#3609;&#3641;</a>";

    $appd=$thiyr.'-'.$appmo.'-'.$appdate;
    include("connect.inc");
	$query="CREATE TEMPORARY TABLE lbperday SELECT  *  FROM patdata WHERE date LIKE '$appd%' and depart='PHYSI'  ORDER BY code ASC";
