...
prepono !=  'ยกเลิก' AND prepono NOT LIKE  'DS%' AND prepono NOT LIKE 'อ.%') and pono !=''  ORDER BY pono asc, ponoyear asc";
//echo $sql;
...
?>  
  <tr>
    ...
    <td align="right"><?=$rows["senddate"];?></td>
...
prepono !=  'ยกเลิก' AND prepono LIKE  'DS%' AND prepono NOT LIKE 'อ.%') and pono !=''  ORDER BY pono asc, ponoyear asc";
//echo $sql;
