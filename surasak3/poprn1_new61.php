...
///////End Load offisers
    ...
    $query = "SELECT date,depart,prepono,prepodate,comcode,comname,items,netprice,pono,podate,bounddate,row_id ,ponoyear,chkindate,senddate,borrowdate FROM pocompany WHERE row_id = '$nRow_id' ";
...
print "<DIV style='left:105PX;top:490PX;width:661PX;height:30PX;'><span class='fc1-0'>1. เนื่องด้วยกองเภสัชกรรม รพ.ค่ายฯ มีความจำเป็นที่จะต้องจัดซื้อเวชภัณฑ์เพื่อใช้ในราชการ รพ.ค่ายฯ</span></DIV>";
