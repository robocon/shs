<?php
//ขออนุมัติจัดซื้อเวชภัณฑ์  1.รวมVATหลัง
//function baht///
...
print "<DIV style='left:74PX;top:8383PX;width:675PX;height:30PX;'><span class='fc1-0'>ข้าพเจ้า $aYot[2] $aFname[2] ตำแหน่ง$aPost[2] $aPost2[2] ขอเบิกเงินจาก</span></DIV>";
