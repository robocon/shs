...
<table  border="0" cellpadding="3" cellspacing="3">
  ...
  <tr>
    ...
    <input type="button" name="button" value="พิมพ์รายงาน"  onClick="JavaScript:window.print();" class="forntsarabun">
      ...
      <font class="font">* ตารางแรก=โรงประกอบอาหาร(R)  / ตารางสอง=โรงพยาบาล(H)</td>
  </tr>
</table>
</form>
</div>
...
//////////////////////////////////////
?>
<h1 class="font" align="center">สรุปยอดผู้ป่วยเตียงสามัญและห้องพิเศษ รอบสัปดาห์</h1>
<h1 class="font" align="center">ตั้งแต่.....<?=$showdate1;?>....ถึง.....<?=$showdate2;?>.....</h1>
...
<table border="0" align="center" class="font">
  <tr>
    <td colspan="3" align="center">ตรวจถูกต้อง</td>
  </tr>
  <tr>
    <td width="46">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td width="170">&nbsp;</td>
    <td width="179" align="center">( ชลธิชา แตงประวัติ )</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
