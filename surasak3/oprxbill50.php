...
if (empty($sAn)  && $sNetprice > 0 ){
       ...
       $sql = "INSERT INTO opacc (date,txdate,hn,an,depart,detail,price,paid,idname,
             ...
             '$sHn','$sAn','OTHER','(55020/55021)ค่าบริการผู้ป่วยนอก','0.00','0.00',
...
if (empty($sAn)  && $sNetprice < 0 ){
       ...
       $sql = "INSERT INTO opacc (date,txdate,hn,an,depart,detail,price,paid,idname,
             essd,nessdy,nessdn,dpy,dpn,dsy,dsn,ptright,credit,credit_detail ".$field_plus.") VALUES('$Thidate','$dDate',
             '$sHn','$sAn','OTHER','(55020/55021)ค่าบริการผู้ป่วยนอก','-0','-0',
...
//แก้ค่าบริการทางการแพทย์
   ...
   $netfree=$sEssd+$sNessdy+$sDPY+$sDSY+0; //เบิกได้
   $total=$sEssd+$sNessdy+$sDSY+$sDPY+$sNessdn+$sDSN+$sDPN+0; //รวมทั้งสิ้น opd case
   if (!empty($sAn)){
       $netfree=$netfree-0;
       $total    =$total-0;
	              }	
...
print "    <tr>";
print "      <td width='20%'><font face='Angsana New' TEXT-ALIGN:RIGHT>&nbsp;&nbsp;&nbsp;&nbsp;เงินสด&nbsp;HN:$sHn</td>";
print "      <td width='80%'><font face='Angsana New'>&nbsp;&nbsp;&nbsp;&nbsp;$sPtname&nbsp;&nbsp;ป่วยเป็นโรค: $sDiag &nbsp;&nbsp;$Thdate ,$billtime</font></td>";
...
print "    </tr>";
	...
	//print "      <td width='9%'></td>";
//แก้ค่าบริการทางการแพทย์
	print "      <td width='30%'><font face='Angsana New'>(55020/55021)ค่าบริการผู้ป่วยนอก</td>";
...
print "      <td width='40%'><font face='Angsana New'>(".$name.")&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;เจ้าหน้าที่เก็บเงิน</font></td>";
print "    </tr>";
print "  </table>";
print "</div>";
        }
