...
if(mysql_num_rows($result)){
  ...
  <tr bgcolor="#FFFFCC" onMouseOver="this.style.backgroundColor='#ADDFFF'" onMouseOut="this.style.backgroundColor=''">
                <td><?=$row;?></td>
                <td><?=$depart;?></td>
                <td><?=$new."..."; ?><a href="new_detail.php?row=<?=$row;?>"  title="ดูรายละเอียด" >อ่านต่อ...</a></td>
				 <td><? if($file!=""){ 
...
$query = "SELECT  row,depart,new,datetime,file FROM new   WHERE status ='$num' ORDER BY row DESC LIMIT 30";
