...
$flag_address_use = "Y";
$address_use = $_POST['flag_address_use'];

//echo $flag_address_use." | ".$address_use;exit();
...
window.onload = function(){
	opener.location.href = 'Edx_ofyear_out.php';
	window.print();
...
if($rows > 0){
	...
	`accident_surgery`  = '".$_POST["accident_surgery"]."', 
	`treat_hospital`  = '".$_POST["treat_hospital"]."', 
	`epilepsy`  = '".$_POST["epilepsy"]."', 
	`treat_other`  = '".$_POST["treat_other"]."', 
	`type`  = '".$_POST["type"]."', 
	`organ`  = '".$_POST["organ"]."', 
	`doctor` = '".$_POST["doctor"]."',  
	...
	$sql = "INSERT INTO `opd` (`row_id` ,`thidate` ,`thdatehn`, `hn`, `ptname` ,`temperature` ,`pause` ,`rate` ,`weight` ,`bp1`  ,`bp2` ,`drugreact` ,`congenital_disease`,`accident_surgery`,`treat_hospital`,`epilepsy`,`treat_other` ,`type` ,`organ` ,`doctor`, `officer`, `vn` , `toborow`, `height`, `clinic`, `cigarette`, `alcohol`, `exercise`) VALUES (NULL , '".$thidate_now."', '".$date_hn2."', '".$_POST["hn"]."', '".$_POST["ptname"]."', '".$_POST["temperature"]."', '".$_POST["pause"]."', '".$_POST["rate"]."', '".$_POST["weight"]."', '".$_POST["bp1"]."', '".$_POST["bp2"]."', '".$_POST["drugreact"]."', '".$_POST["congenital_disease"]."', '".$_POST["accident_surgery"]."', '".$_POST["treat_hospital"]."', '".$_POST["epilepsy"]."', '".$_POST["treat_other"]."', '".$_POST["type"]."', '".$_POST["organ"]."', '".$_POST["doctor"]."', '".$_SESSION["sOfficer"]."', '".$_POST["vn"]."', '".$_POST["toborow"]."', '".$_POST["height"]."', '".$_POST["clinic"]."', '".$_POST["cigarette"]."', '".$_POST["alcohol"]."', '".$_POST["exercise"]."');";
	mysql_query($sql);
}
...
$antihb = $_POST['antihb'];
$antihb_range = $_POST['ANTIHBrange'];
$antihb_flag = $_POST['ANTIHBflag'];
...
if( ( isset($_POST["row_id"]) && $_POST["row_id"] != "" ) OR $count > 0 ){ 
	...
	`upt_flag` = '$upt_flag' , 
	`antihb` = '$antihb', 
	`antihb_range` = '$antihb_range', 
	`antihb_flag` = '$antihb_flag', 
	`ldl` = '$ldl', 
	`ldl_range` = '$ldl_range', 
	`ldl_flag` = '$ldl_flag',
	`flag_address_use` = 'Y',
