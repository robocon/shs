...
$sql = "Select  a.depart, sum(a.paidcscd),sum(a.price) From opacc as a where  ( a.date between '".($start_year)."-".$start_month."-".$start_day." 00:00:00' AND '".($end_year)."-".$end_month."-".$end_day." 23:59:59' )  AND a.credit ='จ่ายตรง อปท.' group by  a.depart   ORDER by a.date";
//echo $sql;
...
echo "</table>";
			...
			*/
echo "<font face='Angsana New' size ='5'><br><br><center> <b>สรุปลูกหนี้จ่ายตรง อปท.ประจำวันที่ ".$start_day."-".$start_month."-".($start_year)." 00:00:00 ถึง  ".$end_day."-".$end_month."-".($end_year)." 23:59:59<br></b> ";
