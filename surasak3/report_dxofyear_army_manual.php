...
////*runno ตรวจสุขภาพ*/////////
	...
	?>
<div id="no-print">
<p align="left"><a href='../nindex.htm'>&lt;&lt;ไปเมนู</a>  || <a href='dt_armymanual_index.php'>ผู้ตรวจสุขภาพรายใหม่</a></p>  
</div>  
<table width="100%">
<tr>
  <td colspan="2">
...
<tr>
  ...
  <table width="100%"  bordercolor="#FFFFFF" border="0"  cellpadding="0" cellspacing="0">  
    <tr>
      ...
      <td width="6%" align="right" valign="middle" bordercolor="#000000"  class="text3"><strong><?=$nPrefix2;?></strong></td>
    ...
    <tr>
     ...
     <!-- <td width="4%" align="right" valign="top" bordercolor="#000000"><strong>
	  ...
	  ?>
    <tr>
      <td valign="middle" class="text3"><strong>ALP(การทำงานของตับ,กระดูก) :</strong></td>
     <!-- <td align="right" valign="top" bordercolor="#000000"><strong>
        <?//=$result5['alk']?>
      </strong></td>-->
      <td align="right" valign="middle" bordercolor="#000000" class="text3"><strong>
...
&nbsp;<?=$result['dx']?></td>
    ...
    <tr>
      <td colspan="2" valign="top" class="text2">
