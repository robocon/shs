...
<title>พิมพ์ใบตรวจสุขภาพการประปาส่วนภูมิภาค สาขาลำปาง</title>
<style type="text/css">
<!--
.tet {
...
<center>
<span class="tet1">พิมพ์ใบตรวจสุขภาพการประปาส่วนภูมิภาค สาขาลำปาง</span><br />
  <br />
...
<!--    <script>
	...
	include("connect.inc");	
	$sql="SELECT  * FROM opcardchk  WHERE part='ประปา60' and active='y' order by row";
	//echo $sql;
  ...
  <tr>
    <td colspan="2"><table width="100%">
      <tr>
        ...
        <td width="77%" align="center" valign="top" class="texthead"><strong>แบบรายงานการตรวจสุขภาพการประปาส่วนภูมิภาค สาขาลำปาง</strong></td>
      ...
      <tr>
        <td align="center" valign="top" class="text3"><span class="text"><span class="text1"><span class="text2">ตรวจเมื่อวันที่ 7-8 กุมภาพันธ์ 2560</span></span></span></td>
