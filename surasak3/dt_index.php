...
$sql = "SELECT a.name 
		FROM doctor as a 
		INNER JOIN inputm as b ON a.doctorcode = b.codedoctor 
		WHERE b.idname = :idname limit 1";

// list ( $doctorname ) = Mysql_fetch_row ( Mysql_Query ( $sql ) );


$item = DB::select($sql, array(':idname' => $_SESSION["sIdname"]), true);
// var_dump($item);
// exit;
					...
					<TR>
						<TD>
							<TABLE>
								...
								<TR>
									<TD>&nbsp;</TD>
									<TD><INPUT TYPE="checkbox" NAME="special" value="true"
										<?php if($_SESSION["dt_special"]) echo "Checked"; ?>> :
										ค่าบริการคลินิกพิเศษ</TD>
									<TD>&nbsp;</TD>
								</TR>
							</TABLE>
						</TD>
...
<BR>
<FONT SIZE="4" COLOR="#990033"><B>ข่าวสาร</B></FONT>
<BR>
<?php
...
<A HREF="javascript:switch_div('2');" style="text-decoration: none;">รายชื่อผู้ป่วยหน้าห้องตรวจ</A>
|
<A HREF="javascript:switch_div('1');" style="text-decoration: none;">รายชื่อผู้ป่วยตรวจโรคทั่วไป( <?php echo $num_list_pt2;?> )</A>

<div id="first"
	style="text-align: left; width: 800px; height: 350px; overflow: auto;">
	<TABLE width='600'>
		<TR class="tb_head">
...
<TR class="<?php echo $class;?>">
			<TD><A
				HREF="javascript:document.form_vn.vn_now.value='<?php echo $vn;?>';form_vn.submit();"><?php echo $vn;?></A></TD>
...
<div id="sec"
	style="text-align: left; width: 800px; height: 350px; overflow: auto; display: none;">
	<TABLE width='600'>
		<TR class="tb_head">
