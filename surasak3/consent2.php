...
<TR  style='line-height:15px;'>
	<TD colspan="2">
<A HREF="javascript:void(0);" style="text-decoration: none;color:#000000;" Onclick="window.print();">ข้าพเจ้า</A>(&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;) <U><?php echo $fullname;?>             </U>  HN<U>              <?php echo $_GET["hn"];?>          </U>  อายุ <U><?php echo substr(calcage($dbirth),0,-8);?></U><BR>
...
.tb_head {color: #3300FF;  text-align:center; text-decoration:none; font-family: Angsana New; font-size: 24px; }
...
$sql = "Select name From doctor where status = 'y' AND row_id > 0";
$result = Mysql_Query($sql);
$i=1;
while($arr = Mysql_fetch_assoc($result)){

	echo "<TD><a href='consent2.php?hn=".$_GET["hn"]."&doctor=".urlencode(substr($arr["name"],6))."' class='tb_head'> ".substr($arr["name"],6)."</TD>";
	if($i%3 == 0){
		$i=0;
		echo "</TR><TR>";
	}
