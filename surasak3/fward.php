...
echo"<br><table border=\"0\"  cellspacing=\"1\" cellpadding=\"1\"><tr>";
    ...
    $query = "SELECT idcard,bed,date,date_format(date,'%d- %m- %Y'),ptname,an,hn,diagnos,food,doctor,ptright,price,paid,debt,caldate,bedname,bedcode,hn,chgdate,status,age,diag1 FROM bed WHERE bedcode LIKE '42%' ORDER BY bed ASC ";
      ...
      <tr>
        ...
        <table  border="0">
          <tr  style="line-height:22PX;">
            <td  rowspan="4"><img src="../image_patient/<?=$idcard;?>" width="81" height="101" /></td>
          ...
          <tr style="line-height:22PX;">
            ...
            <font class='tablefontt1'>โรค : </font><? echo "<a target=_blank  href=\"ipdiag.php? cAn=$an&cBedcode=$bedcode&cBed=$bed&cFulname=$ptname&cDiag=$diagnos&cbedname=หอผู้ป่วยรวม\" class='tablefont3'>$diagnos</a>";?>&nbsp;&nbsp;&nbsp;
            <font class='tablefontt1'>แพทย์  : </font> <? echo "<a target=_blank  href=\"ipdr.php?cAn=$an&cBedcode=$bedcode&cBed=$bed&cFulname=$ptname&cDoctor=$doctor&cbedname=หอผู้ป่วยรวม\" class='tablefont3' >$doctor</a>"; ?>&nbsp;&nbsp;&nbsp;
            
            <font class='tablefontt1'>โรคประจำตัว  : </font>
           <font class='tablefont'> <? echo "<a target=_blank  href=\"ipdiag1.php?cAn=$an&cBedcode=$bedcode&cBed=$bed&cFulname=$ptname&cDiag=$diag1&cbedname=หอผู้ป่วยรวม\">$diag1</a>";?></font>
            </td>
            </tr>
          <tr style="line-height:22PX;">
            <td colspan="8"  valign="top">
            <font class='tablefontt1'>อาหาร : </font><? echo "<a target=_blank  href=\"ipfood.php? cAn=$an&cBedcode=$bedcode&cBed=$bed&cFulname=$ptname&cFood=$food&cbedname=หอผู้ป่วยรวม\" class='tablefont3'>$food</a>"; ?></td>
          </tr>
          <tr style="line-height:25PX;">
			...
			?>&nbsp;&nbsp;
            <font class='tablefontt1'>ฉลาก : </font><? echo "<a target=_blank  href=\"drug1a.php?Ptname=$ptname&cAn=$an&cBed=$bed& cBedcode=$bedcode&cHn=$hn&cbedname=รวม \" class='tablefont3'>ยา(1 ดวง)</a>";?>&nbsp;&nbsp; 
			<? echo "<a target=_blank  href=\"ipbeddrug.php? cAn=$an &cBed=$bed & cBedcode=$bedcode & cHn=$hn & cbedname=หอผู้ป่วยรวม \" class='tablefont3'>ยา(A4)</a>"; ?>&nbsp;&nbsp; 
			<? echo "<a target=_blank  href=\"ipbed1.php? cAn=$an &cBed=$bed & cBedcode=$bedcode & cHn=$hn & cbedname=หอผู้ป่วยรวม \"  class='tablefont3'>เอกสาร(A4)</a>";?>&nbsp;&nbsp; 
			<? echo "<a target=_blank  href=\"liststk.php?cAn=$an&cBed=$bed& cBedcode=$bedcode&cHn=$hn&cbedname=รวม \" class='tablefont3'>เอกสาร(1 ดวง)</a>";?>
            </td>
          </tr>
        </table></td>
      </tr>
