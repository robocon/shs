...
<?
 echo"<font face='Angsana New'>ชื่อ: $cPtname,HN: $cHn, VN: $tvn, สิทธิ: $cPtright  <br>";  
 ...
 $sqlopd = "select row_id from opday where thdatehn = '$thdatehn' and vn='$tvn'";
 //echo $sqlopd;
 $queryopd=mysql_query($sqlopd);
 $ptopd = mysql_fetch_array($queryopd);
 $row_id=$ptopd["row_id"];
...
<input name="tvn" type="hidden" value="<?php echo $tvn;?>" >
