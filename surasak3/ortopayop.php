...
$_SESSION['or_opd']
*/
// var_dump($_SESSION['or_opd']);
if(empty($_SESSION['or_opd']['vn'])){
	?>
	<p><strong>ไม่พบ VN กรุณาตรวจสอบข้อมูลอีกครั้งก่อนทำการบันทึก</strong></p>
	<?php
}
?>
<div>
	<a target="_self"  href="../nindex.htm">&lt;&lt;&nbsp;หน้าหลักโปรแกรม</a> | <a href="vnordx.php">กลับไปหน้า เก็บค่าเวชภัณฑ์และอุปกรณ์(ผป.นอก)</a>
</div>
<div>
...
<p><strong>โปรดลงรายการค่าอุปกรณ์เวชภัณฑ์ในการผ่าตัด ลงราคาที่เบิกได้/ไม่ได้</strong></p>
...
<form method="POST" action="orpaid.php" onsubmit="return checklist()" name="form11">
	<p>1.&nbsp;
		...
		<input type="reset" value="  ลบทิ้ง  " name="B2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target=_self href='../nindex.htm'>
			<< ไปเมนู</a>
	</p>
</form>
<?php
