...
-->
  ...
  ?>
<form method="POST" action="datasso/exportdatasso.php">
<p><strong>โปรแกรมส่งเบิกค่าชดเชยทางการแพทย์ผู้ป่วยนอก สิทธิประกันสังคม (SSO)<br />
ผู้พัฒนาระบบ&nbsp;&nbsp;&nbsp;ส.ต. เทวิน ศรีแก้ว เจ้าหน้าที่ศูนย์บริการคอมพิวเตอร์&nbsp;&nbsp;&nbsp;โทร. 8500<br />
<div style="color:#FF0000">เริ่มใช้ตั้งแต่วันที่ 20 เดือนกันยายน พ.ศ.2561 เป็นต้นไป</div></strong>
<div style="color:#0000FF">ค้างส่งข้อมูลของวันที่ 21,22,23,24,25,26 เดือน กันยายน พ.ศ.2561 เนื่องจากรอการลงรหัส <a href="report_diagnotfound_sso.php" target="_blank" >ICD10</a> และรหัส <a href="report_icd9cmnotfound_sso.php" target="_blank" >ICD9CM</a> ให้ผู้ป่วย</div></strong>
 </p>
