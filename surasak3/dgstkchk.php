<?php
    print  "<font face='Angsana New'>ตรวจสอบยาเวชภัณฑ์ในคลังยาตาม รหัสยา<br> ";
?>
...
<table>
 <tr>
  ...
  <th bgcolor=6495ED><font face='Angsana New'>ตรวจสต๊อก</th>
  <th bgcolor=6495ED><font face='Angsana New'>มูลค่าการเบิก</th>
 </tr>
...
If (!empty($drugcode)){
    ...
    $query = "SELECT drugcode,tradname,unitpri,salepri,part,rx1day,totalstk,mainstk,stock,rxrate,stkpmon FROM druglst  WHERE drugcode LIKE '$drugcode%' ";
     $result = mysql_query($query)
        or die("Query failed");
	...
	$profit=0;
        ...
        print (" <tr>\n".
           ...
           "  <td BGCOLOR=66CDAA><font face='Angsana New'><a target=_BLANK  href=\"stkchkgrp.php? Dgcode=$drugcode\">ตรวจสต๊อก</a></td>\n".
		"  <td BGCOLOR=66CDAA><font face='Angsana New'>".(number_format($rxrate*$unitpri,2))."</td>\n".
           " </tr>\n");
          }
