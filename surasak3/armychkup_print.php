...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="4" align="center" valign="top"><table width="100%">
      <tr>
        ...
        <td width="77%" align="center" valign="top" ><span class="style1">แบบรายงานการตรวจสุขภาพประจำปี
            <?=$nPrefix2;?>
        </span></td>
      ...
      <tr>
        <td align="center" valign="top" ><span class="style1">วันที่ 18 ตุลาคม 2559</span>        </td>
  ...
  <tr>
    <td colspan="4" align="center" valign="top"><table width="100%" class="fonthead">
      ...
      <tr>
        <td colspan="2" valign="top"><strong>ประวัติโรคประจำตัว : </strong>
			...
			echo " ".$result['congenital_disease'];
			 ?>        </td>
        <td colspan="2" valign="top"><strong>รับการรักษาที่ : </strong>
  ...
  <tr>
    <td align="center" valign="top" width="25%"><table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
      ...
      <tr>
        <td width="38%" align="center">รายการ</td>
        <td width="31%" align="center">ผล</td>
        <td width="31%" align="center">สรุป</td>
      </tr>
      <tr>
        <td>BMI</td>
        <td align="center">
    ...
    <td align="center" valign="top" width="25%"><table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
      ...
      <tr>
        ...
        <td width="27%" align="center">ผล</td>
        <td width="33%" align="center">สรุป</td>
      </tr>
      <tr>
        <td>ความดันโลหิต</td>
        <td align="center">
...
<? if($result['age'] >=35){?>      
    ...
    <td align="center" valign="top" width="35%"><table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
      ...
      <tr>
        <td width="40%" align="center">รายการ</td>
        <td width="35%" align="center">ผล</td>
        <td width="25%" align="center">สรุป</td>
      </tr>
      <tr>
        <td>โรคประจำตัว</td>
        <td><?
...
<div style="margin-left:15px;"><input name="" type="checkbox" value="" <?php if($result["gum_disease2"]==1){ echo "checked"; } ?> >
      ...
      <table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
        ...
        <tr>
          <td><div style="margin-left:5px; margin-bottom:20px;"><input name="checkbox" type="checkbox" id="checkbox" <?php if($result["xray"]=="ปกติ"){ echo "checked"; } ?> >
            ปกติ<br>
            <input type="checkbox" name="checkbox2" id="checkbox2" <?php if($result["xray"]=="ผิดปกติ"){ echo "checked"; } ?> >
            ผิดปกติ...ควรพบแพทย์</div></td>
        </tr>
      </table>      </td>
  </tr>
  <tr>
    ...
    <td align="center" valign="top"><table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
      ...
      <tr>
        ...
        if($result['ua_lab']=="ผิดปกติ"){
			echo "- การตรวจปัสสาวะ พบความผิดปกติ<br>";
		}
		
		if($result['cbc_lab']=="ผิดปกติ"){
			echo "- การตรวจเม็ดเลือด พบความผิดปกติ<br>";
		}
  ...
  <tr>
    ...
    <td align="center" valign="top"><table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
      ...
      <tr>
        ...
        if($result["uric_lab"]=="ผิดปกติ"){  //ไต
			echo "- จัดการด้านโภชนาการ<br>";
		}
		
        if($result["alp_lab"]=="ผิดปกติ" || $result["alt_lab"]=="ผิดปกติ" || $result["ast_lab"]=="ผิดปกติ"){
			echo "- ปรับพฤติกรรมการดื่มเครื่องดื่มแอลกอฮอล์<br>";
		}			
  ...
  <tr>
    <td colspan="4" align="center" valign="top"><table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
      <tr>
        <td bgcolor="#999999" class="style4">สรุป กิจกรรมที่พึงทำเพื่อสุขภาพ</td>
      </tr>
      <tr>
        ...
        if($result['result_hand']==1 || $result['result_leg']==1 || $result['result_steptest']==1){
			echo "- ควรออกกำลังกาย เพื่อเสริมสร้างสมรรถภาพ<br>";
		}else  if($result['result_hand']==2 || $result['result_leg']==2 || $result['result_steptest']==2){
			echo "- ควรออกกำลังกาย เพื่อเสริมสร้างสมรรถภาพ<br>";
		}else  if($result['result_hand']==3 || $result['result_leg']==3 || $result['result_steptest']==3){
			echo "- ควรออกกำลังกาย เพื่อเสริมสร้างสมรรถภาพ<br>";
        ...
        if($result["alp_lab"]=="ผิดปกติ" || $result["alt_lab"]=="ผิดปกติ" || $result["ast_lab"]=="ผิดปกติ"){
			echo "- ควรปรับพฤติกรรมการดื่มเครื่องดื่มแอลกอฮอล์<br>";
		}	
				
        if($result["result_dental"]=="ผิดปกติ"){
			echo "- เข้ารับการตรวจทางทันตกรรม<br>";
		}
        if($result["xray"]=="ผิดปกติ"){
			echo "- พบแพทย์เพื่อทำการรักษา หรือ X-Ray ซ้ำอีกครั้ง<br>";
		}
        if($result["prawat"]!="0"){
  ...
  <tr>
    <td colspan="4" align="center" valign="top" class="fontbig3"><div style="border-bottom:3px double; width:130px;"><strong>สรุปผลการตรวจสุขภาพ</strong></div></td>
  </tr>
  <tr>
    <td colspan="4" align="center" valign="top"><div style="margin-left:5px; margin-bottom:10px;" class="fontbig3">
      ...
      ป่วยด้วยโรคเรื้อรัง...<span style="margin-left:2px;">
  <?
        if($result['prawat']=="1"){
			echo "ความดันโลหิตสูง";
		}else if($result['prawat']=="2"){
