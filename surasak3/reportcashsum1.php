...
$sql = "Select  a.depart, sum(a.paid),sum(a.paid) From opacc as a where a.date LIKE '$date1%'  AND a.credit ='เงินสด' group by  a.depart   ORDER by a.date";
...
echo "</table>";
			...
			*/
echo "<font face='Angsana New' size ='5'><br><br><center> <b>สรุปรายรับเงินสดประจำเดือน &nbsp;$date3 <br></b> ";
...
$sql = "Select date_format( a.date, '%d-%m-%Y' ) AS date2, a.depart, sum(a.paid), sum(a.paid) From opacc as a where  a.date LIKE '$date1%'   AND a.credit ='เงินสด' group by date2, a.depart   ORDER by date";
$result = Mysql_Query($sql) or die(Mysql_Error());
