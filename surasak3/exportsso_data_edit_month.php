...
-->
  ...
  ?>
<form method="POST" action="datasso_edit_month/exportdatasso_edit.php">
<p><strong>โปรแกรมส่งเบิกค่าชดเชยทางการแพทย์ผู้ป่วยนอก สิทธิประกันสังคม (SSO) ที่ติด C รายเดือน (datasso_edit_month/...)<br />
ผู้พัฒนาระบบ&nbsp;&nbsp;&nbsp;ส.ท. เทวิน ศรีแก้ว เจ้าหน้าที่ศูนย์บริการคอมพิวเตอร์&nbsp;&nbsp;&nbsp;โทร. 8500<br />
<div style="color:#FF0000">เริ่มใช้ตั้งแต่วันที่ 27 เดือนกุมภาพันธ์ พ.ศ.2562 เป็นต้นไป (update : 01/07/64)</div>
</strong>
<div style="color:#0000FF">การลงรหัสโรค <a href="report_diagnotfound_sso.php" target="_blank" >ICD10</a> และรหัสหัตถการ <a href="report_icd9cmnotfound_sso.php" target="_blank" >ICD9CM</a> ให้ผู้ป่วย</div></strong>
 </p>
