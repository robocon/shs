...
session_register("credit_8");
    ...
    $query = "SELECT * FROM opacc WHERE date LIKE '$today%' and credit = 'จ่ายตรง'  ";
   ...
   for ($n=$x; $n>=1; $n--){
        ...
        print("<tr>\n".
          ...
          //      "<td bgcolor=$color><font face='Angsana New'>$aPaid[$n]</td>\n".  
                "<td bgcolor=$color><font face='Angsana New'><A HREF=\"edit_cashcscd.php?id=$rowid[$n]\" target='_blank'>$aCredit[$n]</A></td>\n".  
