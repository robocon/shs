...
//end  runno  for chktranx
   ...
   print "ตรวจ XRAY :$cDiag<br>";
   print "*โปรดเลือกวิธีสั่งตรวจ*<br>";
   print"<a target=_BLANK href='xrayform.php'>Check Box</a><br>";
   print"<a target=_BLANK href='lablist.php'>เลือกรายการจากห้อง XRAY</a><br>";
