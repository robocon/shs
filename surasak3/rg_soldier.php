...
if( $action === "save" ){
    ...
    $regular_number = input_post('regular_number');
    ...
    if( empty($id) ){
        ...
        (`id`,`date`,`hn`,`address`,`regular_number`,`regular`,
...
if( $action === "search_val" ){
    ...
    $regular = iconv('UTF-8', 'UTF-8', $regular);
    ...
    if( $search_hn !== false ){
            ...
            <form action="rg_soldier.php" method="post" id="inputForm" enctype="multipart/form-data">
                <table width="80%" align="center" id="echo_table" style="vertical-align: top;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="number_id" value="<?=$number_id;?>">
                        </td>
                    </tr>
                    <tr>
                        <td align="right" valign="top">วันที่ออกใบรับรอง: </td>
                        <td>
                            <input type="text" name="date_certificate" value="<?=$date_cer;?>">
                            <div style="color: red;">* <u>รูปแบบ</u> ปี(ค.ศ.)-เดือน-วัน <u>ตัวอย่างเช่น</u> 2017-12-03 เป็นตัน</div>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" valign="top">ค้นหากฏกระทรวงที่ขัด: </td>
                        <td>
                            <input type="text" id="regular_search" >
                            <input type="text" id="regular" name="regular" value="<?=$regular;?>" style="width: 100%;">
                        </td>
                    </tr>
                    <tr>
                        <td align="right">คณะกรรมการแพทย์คนที่1:</td>
                        <td>
                    ...
                    <tr>
                        <td align="right">คณะกรรมการแพทย์คนที่2:</td>
                        <td>
                    ...
                    <tr>
                        <td align="right">คณะกรรมการแพทย์คนที่3:</td>
                        <td>
                    ...
                    <tr>
                        <td align="right">โรคที่ตรวจพบ: </td>
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <div>
                                ...
                                <input type="hidden" name="regular_number" id="regular_number" value="<?=$regular_number;?>">
                            </div>
                        </td>
                    </tr>
                    <tr>
                ...
                foreach ($types as $main_number => $item_type) {
                    ...
                    if( count($item_type['items']) > 0 ){
                        foreach( $item_type['items'] AS $item_number => $item ){
                            ...
                            $txt = '<p class="from_full_detail" data-number="('.$main_number.') '.$itemNumberTxt.'">('.$main_number.') '.$itemNumberTxt.' '.$item_name.'</p>';
                            if( $sub_item === false ){
                            ...
                            if( $sub_item !== false ){
                                foreach ($sub_item as $last_key => $value) {
                                    echo '<a href="javascript:void(0)"><p class="from_full_detail" data-number="('.$main_number.') '.$itemNumberTxt.' ('.$last_key.')" >('.$main_number.') '.$itemNumberTxt.' ('.$last_key.') '.$value.'</p></a>';
                                }
                            }
        ...
        $(function() {
            ...
            $(document).on("click", ".from_full_detail", function(){
                ...
                $("#regular_number").val($(this).attr('data-number'));
            });
