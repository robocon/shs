...
<p align="center" style="margin-top: 20px;"><strong>รายงานผลทางห้องปฏิบัติการ EMR ตามห้วงเวลา</strong></p>
<div align="center">
	<form method="POST" action="lab_lst_print_opd1_emr.php" target="_blank">
		<p align="center">HN : <input name="hn" type="text" class="txt" id="hn" size="30"></p>
