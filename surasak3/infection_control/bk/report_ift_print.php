...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="100%">
  ...
  <tr>
    ...
    <td align="center"><?=$myfetch['date2'];?></td>
  </tr>
  <tr>
...
<input type="radio" name="respirator" id="Respirator2" value="เจาะคอ" <? if($myfetch['respirator']=='เจาะคอ'){ echo "checked='checked'";} ?> />
    ...
    <td align="center"><?=$myfetch['date3'];?></td>
  </tr>
  <tr>
    <td align="center">3.</td>
    <td>ประวัติการสำลักอาหาร,น้ำ</td>
    <td align="center"><?=$myfetch['date4'];?></td>
  </tr>
  <tr>
...
ไม่ใส่ Drain</td>
    <td align="center"><?=$myfetch['date5'];?></td>
  </tr>
  <tr>
...
หัตถการ</td>
    <td align="center"><?=$myfetch['date6'];?></td>
  </tr>
  <tr>
    <td align="center">6.</td>
    <td>การทำหัตถการต่างๆ...........................<?=$myfetch['procedure'];?></td>
    <td align="center"><?=$myfetch['dateproc'];?></td>
  </tr>
    </table>
<br/>
    <div class="hfont">ส่วนที่ 2 ผลการติดตามผู้ป่วย วันที่ติดตาม......<?=$myfetch['date7'];?></div>
    <table width="100%" border="1" cellpadding="0" cellspacing="0" class="hfont" style="border-collapse:collapse;" bordercolor="#000000">
  <tr>
  ...
  <tr>
    ...
    <td align="center"><?=$myfetch['date8'];?></td>
  </tr>
  <tr>
    ...
    <td align="center"><?=$myfetch['date9'];?><br /><?=$myfetch['date10'];?><br /><?=$myfetch['date11'];?></td>
  </tr>
  <tr>
    <td align="center">3.</td>
    ...
    <td align="center"><?=$myfetch['date12'];?></td>
  </tr>
  <tr>
...
<input type="radio" name="smell" id="smell2"  value="2" <? if($myfetch['smell']==2){ echo "checked='checked'";} ?>/></td>
    <td align="center"><?=$myfetch['date13'];?><br /><?=$myfetch['date14'];?><br /><?=$myfetch['date15'];?></td>
  </tr>
  <tr>
    ...
    <td align="center"><?=$myfetch['date16'];?></td>
  </tr>
    </table>
