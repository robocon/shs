    ...
    <tr bordercolor="#666666" class="forntsarabun">
      ...
      <td >
        <select name="staf_massage" class="forntsarabun" id="staf_massage">
          ...
          <option value="น.ส.ธัญญาวดี มูลรัตน์">น.ส.ธัญญาวดี มูลรัตน์</option>
          <option value="นายรัตนโชติ มหาสิทธิแพทย์">นายรัตนโชติ มหาสิทธิแพทย์</option>
          <option value="นายวีรพล อุ่นเมือง">นายวีรพล อุ่นเมือง</option>
          <option value="นางแสงระวี ไหวคิด">นางแสงระวี ไหวคิด</option>
          <option value="นางนารี ศรีหมื่น">นางนารี ศรีหมื่น</option>
          <option value="นางพิกุล ไทยกำธร">นางพิกุล ไทยกำธร</option>
          <option value="นางขวัญตา มะโนชัย">นางขวัญตา มะโนชัย</option>
          <option value="นางบัวซอน คงธนมณีอาภา">นางบัวซอน คงธนมณีอาภา</option>
           <option value="น.ส อรภัทร ละม่อม">น.ส อรภัทร ละม่อม</option>
        </select>
      </td>
    </tr>
    <tr>
...
$query = "SELECT b.date, b.ptname, b.hn, b.an, b.depart, b.detail, b.price, b.paid, b.row_id, b.accno, b.tvn ,b.staf_massage,b.diag,b.ptright FROM `patdata` AS a, depart AS b WHERE b.row_id = a.idno AND ( a.code in ('58002' , '58003' ,'58004' ,'58002a','58002b','58002c','58005','58006','58007','58008')) AND (b.date between '$date1' and '$date2' ) and  a.status='Y' and a.price >0  and staf_massage='$staf_massage' Group by b.date ,b.hn,a.code";
