...
<table width="50%" border="0" align="center" cellpadding="3" cellspacing="0">
  ...
  <tr>
    ...
    <td width="60%" bgcolor="#CCFFCC"><input name="hn" type="text" class="forntsarabun" id="hn" size="6"  /></td>
  </tr>
 <tr>
    <td align="right" bgcolor="#66CC99"><strong>ยศ : </strong></td>
    <td bgcolor="#CCFFCC"><input name="yot" type="text" class="forntsarabun" id="yot" size="6" />
      <span class="style1">เช่น พล.อ. , พ.อ. , ร.อ. , ...ฯลฯ</span></td>
  </tr>
  <tr>
    <td align="right" bgcolor="#66CC99"><strong>ชื่อ-นามสกุล : </strong></td>
    <td bgcolor="#CCFFCC"><input name="ptname" type="text" class="forntsarabun" id="name"  size="15" /></td>
  </tr>
  <tr>
