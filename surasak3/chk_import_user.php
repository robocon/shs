...
if( empty($action) ){
    ...
    <br>
    <div>
        <b><u>Lab Number</u></b><br>
        1.) รองรับการจัดในรูปของ DDMMYY[USER_NUMBER] โดยที่ DD คือวันที่ MM คือเดือน YY คือปีค.ศ. และ USER_NUMBER คือลำดับที่ของผู้ป่วย<br>
        <b>ตัวอย่าง เช่น</b> 1212200001 สามารถแบ่งข้อมูลออกเป็นได้ดังนี้<br>
        12 คือวันที่ 12<br>
        12 คือเดือน 12<br>
        20 คือปีค.ศ. 2020<br>
        0001 คือผู้ป่วยลำดับที่ 1
    </div>
    <br>
    <div>
        <b><u>วันเกิด</u></b> รองรับการจัดรูปแบบแค่ 2รูปแบบ คือ<br>
