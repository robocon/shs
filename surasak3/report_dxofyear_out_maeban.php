...
<center>
<span class="tet1">พิมพ์ใบตรวจสุขภาพ แม่บ้าน รักษ์สุขภาพ</span> <br />
  <br />
...
////*runno ตรวจสุขภาพ*/////////
	...
	//ปีล่าสุด
	$select = "select * from condxofyear_out where hn='".$_POST['hn']."' order by row_id desc limit 1";
	$row = mysql_query($select);
	$result = mysql_fetch_array($row);
	
	$sql1="CREATE TEMPORARY TABLE  result1  Select * from  resulthead  WHERE hn='".$result['hn']."' and clinicalinfo ='ตรวจสุขภาพประจำปี$nPrefix' order by labnumber desc";
...
<tr>
  ...
  <tr><td>
  <table width="100%" class="text1" style="line-height:15px;">
  ...
  <td valign="top" class="text2"><strong>อายุ :</strong>
    <?=$result['age']?></td>
  <td valign="top" class="text2"><strong>สังกัด : </strong><?=$result['camp'];?></td>
    </tr>
<tr>
...
<tr class="text3">
  <td align="center" valign="top" ><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
    <tr>
      <td align="center"><strong class="text" style="font-size:20px"><u>CBC : การตรวจเม็ดเลือด</u></strong></td>
    </tr>
    <tr>
      <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="64%" align="center" bgcolor="#CCCCCC"><strong>labcode </strong></td>
            <td width="19%" align="center" bgcolor="#CCCCCC"><strong>result</strong></td>
            <td width="17%" align="center" bgcolor="#CCCCCC"><strong>normalrange</strong></td>
          </tr>
...
/////
 ...
 ?>
  ...
  <td align="center" valign="top" ><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
    <tr>
      <td align="center"><strong class="text" style="font-size:20px"><u>UA : การตรวจการทำงานของปัสสาวะ</u></strong></td>
    </tr>
    <tr>
      <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="text31">
          <tr>
            <td width="60%" align="center" bgcolor="#CCCCCC"><strong>labcode </strong></td>
            <td width="15%" align="center" bgcolor="#CCCCCC"><strong>result</strong></td>
            <td width="25%" align="center" bgcolor="#CCCCCC"><strong>normalrange</strong></td>
          </tr>
...
<tr>
  ...
  <table width="100%"  bordercolor="#FFFFFF" border="0"  cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td valign="top" class="text3"><strong>ผลการตรวจอื่นๆ&nbsp;</strong></td>
    ...
    <tr>
      ...
      <td colspan="4" align="left" valign="top" class="text3"><strong><?="ระดับ ".$dentalstatus;?></strong></td>
      </tr>      
      </tr>
      <? 
	  if($result['pap']!=""){
