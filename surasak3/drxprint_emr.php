...
$sqlop1="select * from dphardep where hn ='".$_POST["hn"]."' AND (date >= '$chkdate1' and date <= '$chkdate2') and stkcutdate !='' and dr_cancle is null and (an ='' OR an is null)";
//echo $sqlop1;
...
-->
	...
	print "<font face='THSarabunPSK' size= 4 >&nbsp;&nbsp;";
	// โรค: $rxDiag&nbsp;&nbsp
