...
<center>
  <div class="font_title">ผลการตรวจสมรรถภาพร่างกาย</div></center>
...
<table width="857">
    <tr>
      <td class="pdxpro"><strong>ผลการตรวจสมรรถภาพร่างกาย</strong></td>
      </tr>
    <tr>
      <td class="pdx"><table width="459">
        <tr>
          <td width="90"><strong>แรงเหยียดขา</strong></td>
          <td colspan="2"><input type="radio" name="ch1" value="ดีมาก" />
            ดีมาก
              <input type="radio" name="ch1" value="ดี" />
              ดี
              <input type="radio" name="ch1" value="พอใช้" />
              พอใช้
              <input type="radio" name="ch1" value="ค่อนข้างต่ำ" />
              ค่อนข้างต่ำ
              <input type="radio" name="ch1" value="ต่ำ" />
            ต่ำ</td>
          </tr>
        <tr>
          <td><strong>แรงเหยียดหลัง</strong></td>
          <td colspan="2"><input type="radio" name="ch2" value="ดีมาก" />
ดีมาก
  <input type="radio" name="ch2" value="ดี" />
ดี
<input type="radio" name="ch2" value="พอใช้" />
พอใช้
<input type="radio" name="ch2" value="ค่อนข้างต่ำ" />
ค่อนข้างต่ำ
<input type="radio" name="ch2" value="ต่ำ" />
ต่ำ</td>
          </tr>
        <tr>
          <td align="center">&nbsp;</td>
          <td width="147" align="center"><input name="submit" type="submit" value=" ตกลง "  /></td>
...
<br /><br />
	<table width="80%" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse; font-family: AngsanaUPC; font-size: 18px;">
    	<tr><td width="29" align="center" bgcolor="#FF9966">#</td><td width="86" align="center" bgcolor="#FF9966">HN</td><td width="146" align="center" bgcolor="#FF9966">ชื่อ-สกุล</td>
    	  <td width="124" align="center" bgcolor="#FF9966">แรงเหยียดขา</td>
    	  <td width="124" align="center" bgcolor="#FF9966">แรงเหยียดหลัง</td>
	...
	?>
    	...
    	<td><?=$result['leg']?></td>
    	<td><?=$result['back']?></td>
    	<td align="center"><a href="dx_ofyear_pt.php?del=<?=$result['row_id']?>" onclick="return confirm('ยืนยันการลบ?')">ลบ</a></td>
   	    </tr>
	<?
	}
	?>
