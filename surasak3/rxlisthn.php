<?php
    $today="$d-$m-$yr";
    print "<font face='Angsana New'>วันที่ $today  HN:$hn<BR>รายการใบสั่งยา ";
...
<?php
    ...
    $query = "SELECT date,ptname,hn,an,price,paid,row_id,accno,dgtake,ptright,phapt FROM phardep WHERE date LIKE '$today%' and hn='$hn' ";
