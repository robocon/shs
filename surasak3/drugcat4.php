...
header('Content-Disposition: attachment; filename="MyXls4.xls"');#ª×èÍä¿Åì
?>
...
<?
include("connect.inc");
$sql = "select * from druglst where (drugcode='1IMDU-C' or drugcode='1APRE25-C' or drugcode='5AUG35' or drugcode='1SILD100' ) order by drugcode asc";
