...
// if(isset($_POST["row_id"]) && $_POST["row_id"] != ""){
	...
	if($_POST['other3']==""){ $_POST['normal101']=""; $_POST['ch101']="";};
	if($_POST['other4']==""){ $_POST['normal102']=""; $_POST['ch102']="";};
	if($_POST['other5']==""){ $_POST['normal103']=""; $_POST['ch103']="";};
	if($_POST['other6']==""){ $_POST['normal104']=""; $_POST['ch104']="";};
	if($_POST['other7']==""){ $_POST['normal105']=""; $_POST['ch105']="";};	
			
	if($_POST['normal53']=="ปกติ"|$_POST['normal53']=="") $_POST['ch53']="";
	if($_POST['normal54']=="ปกติ"|$_POST['normal54']=="") $_POST['ch54']="";
	if($_POST['normal101']=="ปกติ"|$_POST['normal101']=="") $_POST['ch101']="";	
	if($_POST['normal102']=="ปกติ"|$_POST['normal102']=="") $_POST['ch102']="";
	if($_POST['normal103']=="ปกติ"|$_POST['normal103']=="") $_POST['ch103']="";	
	if($_POST['normal104']=="ปกติ"|$_POST['normal104']=="") $_POST['ch104']="";
	if($_POST['normal105']=="ปกติ"|$_POST['normal105']=="") $_POST['ch105']="";					
...
if($result && isset($_POST["submit"])){
	...
	?>
	<CENTER><FONT COLOR="red">ไม่สามารถบันทึกข้อมูลได้</FONT></CENTER>
	<?php
}
