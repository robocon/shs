...
<div id="menu">
  <ul class="menu">
        ...
        <li><a href="diabetes.php"><span>ลงทะเบียน DM</span></a></li>
     	  <li><a href="diabetes_edit.php"><span>แก้ไขข้อมูลในทะเบียน</span></a></li>
         <li><a href="#"><span>รายชื่อผู้ป่วยDM</span></a></li>
         <ul>
         <li><a href="diabetes_list.php"><span>รายชื่อทั้งหมด</span></a></li>
         <li><a href="diabetes_list_so.php"><span>รายชื่อ ทหาร/ครอบครัว</span></a></li>
         </ul>
     <li><a href="report_diabetes.php"><span>สถิติ DM</span></a></li>
    </ul>
</div>
