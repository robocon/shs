...
<form name="f1" action="" method="post">
  ...
  <tr class="forntsarabun">
    <td colspan="2" align="center" bgcolor="#99CC99">ชื่อ - สกุล <strong>
      <?=$cPtname;?>
    </strong> AN: <strong>
    <?=$cAn;?>
    </strong></td>
  ...
  <tr class="forntsarabun">
    <td colspan="2" align="center" bgcolor="#99CC99">    Admit : <?= $cDate;?>
   Dc : <?=$cDcdate;?></td>
  </tr>
  <tr class="forntsarabun">
    <td colspan="2" align="center" bgcolor="#99CC99">เลือกช่วงเวลา</td>
    </tr>
  <tr class="forntsarabun">
...
*/
    ...
    $query = "SELECT * FROM ipacc WHERE an = '$cAn' and date between '$date1' and '$date2'  ";
...
print "<CENTER>โรงพยาบาลค่ายสุรศักดิ์มนตรี ลำปาง<br></CENTER>";
 $Thaidate=date("d-m-").(date("Y")+543)."  ".date("H:i:s");
   print "<CENTER>สรุปค่ารักษาพยาบาลผู้ป่วยใน&nbsp;&nbsp;เมื่อวันที่&nbsp;&nbsp;$Thaidate</CENTER>";
  
  //   print "<CENTER>&nbsp;&nbsp;เมื่อวันที่&nbsp;&nbsp;$Thaidate</CENTER>";
  ...
  $dcdate2=$dcdate1[2].'-'.$dcdate1[1].'-'.$dcdate1[0].' '.$dcdate[1];
   ...
   print "<CENTER>&nbsp;&nbsp;&nbsp;<b>ผู้ป่วยชื่อ $cPtname</b>";
   print "&nbsp;&nbsp;HN: <B>$cHn</B> &nbsp;&nbsp; AN: <B>$cAn</B> &nbsp;&nbsp;เตียง $cBed&nbsp;&nbsp; <BR>เลขบัตรประชาชน $idcard&nbsp;&nbsp;แพทย์ : $cDoctor &nbsp;&nbsp;น้ำหนัก&nbsp;&nbsp;..$sadm_w...กก.&nbsp;&nbsp;<br>";
...
////
  ...
  $query = "SELECT date,depart,detail,amount,price,paid,part,idname FROM ipacc WHERE an = '$cAn' and date between '$date1' and '$date2'  ";
...
$sql = "Select sum(price),status FROM ipacc WHERE an = '$cAn' and status='จำหน่าย'  and date between '$date1' and '$date2'  group by status ";
$result2 = Mysql_Query($sql) or die(mysql_error());
...
print "    <tr>";
print "      <td width='5%'></td>";
print "      <td width='30%'><B>สรุปค่ารักษาพยาบาล:</B><br>";
//print "รายการ<br>";
...
print "($Nessdy)<br>";
print "4. ยาที่นำไปใช้ต่อที่บ้าน($DNessdy)<br>	";
...
print "<b> ...........................รวมเงิน...........................</b></td>";//add


print "<td width='10%' valign='middle' align='right'><B>เบิกได้</B><br>";
//print "        เบิกได้<br>";
print "        $BFY<br>";
//print "        ...<br>";
print "        ...<br>";
...
print "      <td width='10%' align='right'><B>เบิกไม่ได้</B><br>";
//print "        เบิกไม่ได้<br>";
print "        $BFN<br>";
//print "        $BFN<br>";
print "        ...<br>";
...
print "<b><CENTER>รวมเงินทั้งสิ้น&nbsp;&nbsp; $Netpri1 บาท</b>&nbsp;&nbsp;&nbsp;";
...
print "<BR><BR><B>เจ้าหน้าที่ตรวจสอบ</B><BR>";
print " $yot ........................................<BR>";
print "&nbsp;&nbsp;&nbsp;($fullname)<BR>";
