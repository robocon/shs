...
if(isset($_POST['hn']) || isset($_GET['hn'])){
	...
	if(!empty($_POST['hn'])){
		$hn = $_POST['hn'];
	}else if(!empty($_GET['hn'])){
		$hn = $_GET['hn'];
	}
	$select = "select * from opcard where idcard = '".$hn."'";
	//echo "==>".$select;
	$row = mysql_query($select);
	$num = mysql_num_rows($row);
	if($num==0){
		$select = "select * from condxofyear_so where hn = '".$hn."' order by thidate desc";
		//echo $select; 
		$row = mysql_query($select);
		$num = mysql_num_rows($row);
	}else{
...
//echo $chkyear;	
$sql1="CREATE TEMPORARY TABLE  result1  Select * from  resulthead  WHERE hn='".$result['hn']."' and clinicalinfo ='ตรวจสุขภาพประจำปี$chkyear' ORDER BY `autonumber` DESC";
...
<tr>
  ...
  <tr><td>
  <table width="100%" class="text1"><tr><td width="16%" valign="top" class="text2"><strong>HN :</strong>    <?=$result['hn']?></td>
...
<tr>
  <td colspan="6" valign="top" class="text2"><strong class="text21">ค่าความดัน : </strong><?=$result['stat_pressure']?>
...
/////
 ...
 ?>
        ...
        <tr>
          <td colspan="3"><strong>HCT &nbsp;: </strong><span class="text"><strong><?=$result['stat_hct']?></strong>
              <? if($result['stat_hct']=="ผิดปกติ") echo "คำแนะนำ...".$result['reason_hct']."...";?>
          </span></td>
        </tr>
        <tr>
          <td colspan="3"><strong>WBC &nbsp;: </strong><span class="text"><strong><?=$result['stat_wbc']?></strong>
              <? if($result['stat_wbc']=="ผิดปกติ") echo "คำแนะนำ...".$result['reason_wbc']."...";?>
          </span></td>
        </tr>
        <tr>
          <td colspan="3"><strong>PLTC : </strong><span class="text"><strong><?=$result['stat_pltc']?></strong>
  ...
  <table width="100%"  bordercolor="#FFFFFF" border="0"  cellpadding="0" cellspacing="0">  
    ...
    <tr>
     ...
     <!-- <td width="4%" align="right" valign="top" bordercolor="#000000"><strong>
      ...
      <tr>
        ...
        <td valign="middle" class="text">(<?=$result['cholrange']?>)</td>
      ...
      <tr>
       ...
       <!-- <td align="right" valign="top" bordercolor="#000000"><strong>
        ...
        <td align="right" valign="middle" bordercolor="#000000" class="text3">&nbsp;</td>
        <td valign="middle" class="text">(<?=$result['tgrange']?>)</td>
        <td valign="middle" class="text"><strong>
          <?=$result['stat_tg']?>
        </strong>
      ...
      <tr>
        ...
        <td valign="middle" class="text"><strong>
          <?=$result['stat_hdl']?>
            ...
            <? if($result['stat_hdl']=="ผิดปกติ") echo "คำแนะนำ...".$result['reason_hdl']."...";?></td>
        </tr>
      ...
      <tr>
        ...
        <td valign="middle" class="text"><strong>
          <?=$result['stat_ldl']?>
            ...
            <? if($result['stat_ldl']=="ผิดปกติ") echo "คำแนะนำ...".$result['reason_ldl']."...";?></td>
        </tr>
      ...
      <tr>
        ...
        <td align="right" valign="middle" bordercolor="#000000" class="text3">&nbsp;</td>
        <td valign="middle" class="text">(<?=$result['bunrange']?>)</td>
        <td valign="middle" class="text"><strong>
          <?=$result['stat_bun']?>
        </strong>
      ...
      <tr>
       ...
       <!-- <td align="right" valign="top" bordercolor="#000000"><strong>
        ...
        <td align="right" valign="middle" bordercolor="#000000" class="text3">&nbsp;</td>
        <td valign="middle" class="text">(<?=$result['crrange']?>)</td>
        <td valign="middle" class="text"><strong>
          <?=$result['stat_cr']?>
        </strong>
    ...
    <tr>
     ...
     <!-- <td align="right" valign="top" bordercolor="#000000"><strong>
      ...
      <td align="right" valign="middle" bordercolor="#000000" class="text3">&nbsp;</td>
      <td valign="middle" class="text">(<?=$result['alkrange']?>)</td>
    ...
    <tr>
      ...
      <td align="right" valign="middle" bordercolor="#000000" class="text3">&nbsp;</td>
      <td valign="middle" class="text">(<?=$result['sgptrange']?>)</td>
      <td valign="middle" class="text"><strong>
        <?=$result['stat_sgpt']?>
      </strong>
    ...
    <tr>
      ...
      <td align="right" valign="middle" bordercolor="#000000" class="text3">&nbsp;</td>
      <td valign="middle" class="text">(<?=$result['sgotrange']?>)</td>
      <td valign="middle" class="text"><strong>
        <?=$result['stat_alk']?>
      </strong>
    ...
    <tr>
      ...
      <td align="right" valign="middle" bordercolor="#000000" class="text3">&nbsp;</td>
      <td valign="middle" class="text">(<?=$result['uricrange']?>)</td>
      <td valign="middle" class="text"><strong>
        <?=$result['stat_uric']?>
      </strong>
    ...
    <tr>
      <td valign="top" class="text3" width="23%" colspan="5"><strong>CXR การตรวจเอ็กซ์เรย์ปอด :</strong> <?=$result['cxr']?></td>        
      </strong>
...
<?php
	$thidate=substr($result["thidate"],0,10);
	list($y,$m,$d)=explode("-",$thidate);
	$y=$y+543;
	$chkdate="$y-$m-$d";
	
	$opsql="select appdate,detail2 from appoint where date LIKE '$chkdate%' and hn='$result[hn]' and apptime !='ยกเลิกการนัด'  order by row_id desc limit 1 ";
	//echo $opsql."<br>";
