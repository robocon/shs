...
print "<font face='TH SarabunPSK' size=10>ผู้ป่วยได้ลงทะเบียนเรียบร้อยแล้ว <br>ได้ VN: $nVn ได้คิวที่..$kew...<br>เปลี่ยนจาก ..$toborow..<br>เป็น ...".$_POST['case']."...</font>";
...
<br><strong style="font-size: 24px;">1...คิวตรวจโรคทั่วไป</strong>&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" onclick="addQueue('kewadd.php')">คิวตรวจโรคทั่วไป (<?php $sql = "Select runno From runno where title ='kew' ";
	$result = Mysql_Query($sql);
...
&nbsp;&nbsp;&nbsp<a target=_TOP href="kewadd4.php">ลบคิว</a><br>
...
<a target="_top" href="report_opt.php?cHn=<?=$cHn;?>">สมัครจ่ายตรง อปท.</a>
<br><br><br>&nbsp;&nbsp;&nbsp;
