...
//ลงทะเบียนใน opday table
	    $query = "INSERT INTO opday(thidate,thdatehn,hn,vn,thdatevn,ptname, ptright,goup,camp,note,toborow,time1,idcard,dxgroup,officer)VALUES('$thidate','$thdatehn','$cHn','$nVn', '$thdatevn','$cPtname','$cPtright','$cGoup','$cCamp','$cNote','$vnlab','".date("H:i:s")."','$cIdcard','21','".$_SESSION['sOfficer']."');";
...
//echo "<meta http-equiv='refresh' content='0; URL = rxform_app.php' />";
echo "<meta http-equiv='refresh' content='0; URL = vnprint.php?toborow=EX04 ผู้ป่วยนัด' />";
?>