...
/**
 * @important ใน DB ที่ปรับใหม่ file encoding มีผลกับการ select ใน mysql
 * ถ้าไฟล์เป็น Windows874/TIS620 ต้องผ่าน iconv เปลี่ยนเป็น UTF8 ก่อน
 * Statement ใน MySQL ที่มีภาษาไทยปนอยู่ด้วย ถึงจะอ่านได้
 */
$header_chk_txt = iconv('TIS620','UTF8', 'ตรวจสุขภาพประจำปี').$year_checkup;

// ดึงวันที่ที่ตรวจ lab นับเป็นวันที่ได้รับการเข้ารับบริการ
$sql = "SELECT SUBSTRING(`orderdate`,1,10) AS `lab_opd`  
FROM `resulthead` 
WHERE `hn` = '$hn' 
AND `clinicalinfo` = '$header_chk_txt' 
...
$pdf->SetXY(165, 43);
$pdf->Cell(40, 6, 'วันที่เข้ารับบริการ '.conv($lab_opd), 0, 1);
...
$pdf->SetXY(5, 73);
$pdf->Cell(46, 6, '1.ความสมบูรณ์ของเม็ดเลือด CBC', 0, 1);
$pdf->SetXY(5, 79);
...
$cbc_lists['hb']['result'] = '999';  // <<<<<<< TESTING
...
$cbc_lists['hct']['result'] = '999'; // <<<<<<< TESTING
...
$pdf->SetXY(5, 121);
$pdf->Cell(46, 6, 'Glucose', 0, 1);
$pdf->SetXY(39, 121);
$pdf->Cell(20, 6, 'xx', 0, 1);
$pdf->Line(39, 127, 59, 127); // underline
$pdf->SetXY(59, 121);
...
$pdf->SetXY(39, 127);
$pdf->Cell(20, 6, 'xx', 0, 1);
$pdf->Line(39, 133, 59, 133); // underline
$pdf->SetXY(59, 127);

$pdf->SetXY(5, 133);
$pdf->Cell(46, 6, 'WBC', 0, 1);
$pdf->SetXY(39, 133);
$pdf->Cell(20, 6, 'xx', 0, 1);
$pdf->Line(39, 139, 59, 139); // underline
$pdf->SetXY(59, 133);

$pdf->SetXY(5, 139);
$pdf->Cell(46, 6, 'Ketone', 0, 1);
$pdf->SetXY(39, 139);
$pdf->Cell(20, 6, 'xx', 0, 1);
$pdf->Line(39, 145, 59, 145); // underline
$pdf->SetXY(59, 139);
