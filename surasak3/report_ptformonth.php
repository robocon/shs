...
if($_POST["act"]=="show"){
	...
	$thyear = $year_start = $_POST['year_start'];
		...
		<div id="printable"> 
			...
			<table width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse;">
				...
				<?php
					...
					AND ( a.code IN ('58002' , '58003' ,'58004' ,'58002a','58002b','58002c','58005','58006','58007','58008','58101','58102','58130','58131','58201','58301','58301a','58130P','58131P','58130S','58131S','58133')) 
					AND (
						b.date BETWEEN 
						'$year_start-$month_start-$date_start 00:00:00' 
						AND 
