...
<head>
    ...
    <title>4.&#41; ร้อยละผู้ป่วยความดันโลหิตสูง ที่ได้การตรวจ Urine albumin</title>
...
<body>
    <div class="container mt-4">
        ...
        ?>
        <h3><?=$header;?></h3>
        <h5>4.&#41; ร้อยละผู้ป่วยความดันโลหิตสูง ที่ได้การตรวจ Urine albumin</h5>
        <?php
        $ht = new ReportHt();
        if(empty($month)){
        ...
        <div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?=$i;?></td>
                        <td><?=substr($a['thdatehn'],0,10);?></td>
                        <td><?=$a['hn'];?></td>
                        <td><?=$a['ptname'];?></td>
                        <td><?=$a['labcode'].' ('.$a['labname'].')';?></td>
                        <td><?=$a['result'];?></td>
                    </tr>
                    <?php 
                        $i++;
