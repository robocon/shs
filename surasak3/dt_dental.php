...
$sql = "Select vn, hn, ptname, toborow  From opd where thdatehn like '".$thidate."%' AND doctor in ('MD020 หนึ่งฤทัย มหายศนันท์','MD030 เกื้อกูล ผสมทรัพย์','MD043  วีระยุทธ์ วงศ์จันทร์') AND dc_diag is NULL Order by vn ASC ";
