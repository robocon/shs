...
$sql = "UPDATE ipacc SET paid=price,billno='$billno' WHERE an='$cAn' and (paid is null or paid = 0.00) and billno is null and (".$part.") ";
...
print "      <td width='15%'><font face='Angsana New'>วันที่รับป่วย&nbsp;$cAdmitALL</td>";
