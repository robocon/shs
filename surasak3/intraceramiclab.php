<p align="center">นำเข้า Lab ตรวจสุขภาพอินทราเซรามิค
...
if($_POST["act"]=="add"){
include("connect.inc"); 
$sql="select * from opcardchk where part='อินทราเซรามิค' and (HN='58.1613' || HN='58.1658' || HN='58.1776' || HN='58.1785' || HN='58.1973' || HN='58.1974') order by row asc";
//echo $sql;
...
$clinicalinfo = "ตรวจสุขภาพอินทราเซรามิค";
if($rows["yot"]=="นาย"){
$gender = "M";
}else if($rows["yot"]=="นาง" || $rows["yot"]=="นางสาว"){
$gender = "F";
}else{
$gender = "M";
}
...
if($rows['course']=="โปรแกรมที่ 1"){
$arrlab=array('UA','BS','CHOL','TRI');
}else if($rows['course']=="โปรแกรมที่ 2"){
$arrlab=array('UA','BS','CHOL','TRI');
}else if($rows['course']=="โปรแกรมที่ 3"){
$arrlab=array('UA','BS');
}
