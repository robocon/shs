...
if(isset($_POST['hn'])){
	...
	echo "<strong><span class='font1' >แบบรายงานค่าใช้จ่ายผู้ป่วยนอกระบบจ่ายตรง</span>";
	...
	echo "<br><br><span class='font1' ><a href='reportcash2.php?all&hn=$_POST[hn]'><strong>----- วันที่มารับบริการ -----</strong></a></span>";
	$sql = "select *,sum(price) as a from opacc where hn='".$_POST['hn']."' and credit ='จ่ายตรง' and date between '".$_POST['yr1']."-".$_POST['mon1']."-".$_POST['day1']." 00:00:00' and '".$_POST['yr2']."-".$_POST['mon2']."-".$_POST['day2']." 23:59:59' group by left(txdate,10) ";
		...
		?>
                <tr>
                  <td align="center"><?=$k?></td>
                    <td><a href="reportcash2.php?hn=<?=$result['hn']?>&date=<?=substr($result['txdate'],0,10)?>" target="_blank"><?=substr($result['txdate'],8,2)."-".substr($result['txdate'],5,2)."-".substr($result['txdate'],0,4)." ".substr($result['txdate'],11)?></a></td>
    ...
    echo "<br><span class='font1' ><strong>----- แสดงรายละเอียด ------</strong></span>";
		...
		<?
		$sql = "select * from opacc where hn='".$_POST['hn']."' and credit ='จ่ายตรง' and date between '".$_POST['yr1']."-".$_POST['mon1']."-".$_POST['day1']." 00:00:00' and '".$_POST['yr2']."-".$_POST['mon2']."-".$_POST['day2']." 23:59:59' ";
		$rows = mysql_query($sql);
		while($result = mysql_fetch_array($rows)){
...
<table border="1" class="font1">
		...
		<?
		$sql = "select * from opacc where hn='".$_POST['hn']."' and credit ='จ่ายตรง' and depart = 'PHAR' and date between '".$_POST['yr1']."-".$_POST['mon1']."-".$_POST['day1']." 00:00:00' and '".$_POST['yr2']."-".$_POST['mon2']."-".$_POST['day2']." 23:59:59' ";
		//echo $sql;
