<?php
session_start();
if ( !isset($sIdname) ) die('Session end');
...
?>
<!--<center>-->
<?php //echo "<a href='#$arr[bed]'>".$arr['bed'].'('.$ff.')'."$i</a>&nbsp;&nbsp;";?>
<!--		<br>-->
<!--</center>-->
<?php
/*		echo"</td>";
...
<?php if($color=="#FFFFFF" || $color=="#FF9999" || $color=="#FFFF99"){?>
$("#div<?=$i;?>").hide();
<?php } ?>
...
<tr>
<td width="25%"><a name="<?=$bed;?>" id="<?=$bed;?>"></a><font class="bed"><?php echo"<a href=\"ipbed.php? cBed=$bed&cDate=$date&cPtname=$ptname&cAn=$an&cDiagnos=$diagnos&cFood=$food&cDoctor=$doctor&cPtright=$ptright&cBedcode=$bedcode&cHn=$hn&cChgdate=$chgdate & cbedname=$wardname \" class='bed'>$bed</a>";?></font>&nbsp;&nbsp;&nbsp;
<?php echo "<a target=_blank  href=\"bedstatus.php? cBedcode=$bedcode&cBed=$bed&cFulname=$ptname&cstatus=$status\" class='tablefont'>$status</a>"; ?></td>
...
<td class="tablefontt2"> <?php echo "<a target=_blank  href=\"ipdata1.php? cBedcode=$bedcode\">$ptname</a>"; ?>&nbsp;&nbsp;&nbsp;</td>
...
<font class='tablefontt1'>โรค : </font><?php echo "<a target=_blank  href=\"ipdiag.php? cAn=$an&cBedcode=$bedcode&cBed=$bed&cFulname=$ptname&cDiag=$diagnos&cbedname=$wardname\" class='tablefont3'>$diagnos</a>";?>&nbsp;&nbsp;&nbsp;
<font class='tablefontt1'>แพทย์  : </font> <?php echo "<a target=_blank  href=\"ipdr.php?cAn=$an&cBedcode=$bedcode&cBed=$bed&cFulname=$ptname&cDoctor=$doctor&cbedname=$wardname\" class='tablefont3' >$doctor</a>"; ?>&nbsp;&nbsp;&nbsp;

<font class='tablefontt1'>โรคประจำตัว  : </font>
<font class='tablefont'> <?php echo "<a target=_blank  href=\"ipdiag1.php?cAn=$an&cBedcode=$bedcode&cBed=$bed&cFulname=$ptname&cDiag=$diag1&cbedname=$wardname\">$diag1</a>";?></font>
</td>
</tr>
<tr style="line-height:22PX;">
<td colspan="8"  valign="top">
<font class='tablefontt1'>อาหาร : </font><?php echo "<a target=_blank  href=\"ipfood.php? cAn=$an&cBedcode=$bedcode&cBed=$bed&cFulname=$ptname&cFood=$food&cbedname=$wardname\" class='tablefont3'>$food</a>"; ?></td>
</tr>
<tr style="line-height:25PX;">
<td colspan="10" valign="top" ><font class='tablefontt1'>หัตถการ  :</font>
<?php echo "<a target=_blank  href=\"ipdata.php? cBedcode=$bedcode\" class='tablefont'>บันทึกค่าใช้จ่าย/ คืนยา / จำหน่าย</a>"; ?> &nbsp;&nbsp; 

<?php echo "<a target=_blank href=\"wpreappoi.php?an=$an&cBed=$bed&cBedcode=$bedcode&cHn=$hn&cbedname=$wardname\" class='tablefont'>สั่ง LAB</a>"; ?> &nbsp;&nbsp; 
<?php echo "<a target=_blank  href=\"dt_lab_lst_in.php?hn_now=$hn\" class='tablefont'>ดูผล LAB</a>";
?>&nbsp;&nbsp; 
<?php echo "<a target=_blank  href=\"dt_xray_film_in.php?hn_now=$hn\" class='tablefont'>ดูฟิลม์ xray</a>";
?>&nbsp;&nbsp; 
<?php 
...
?>&nbsp;&nbsp;  
<?php echo "<a target=_blank  href=\"set_from_ward.php?an=$an&bedcode=$lbedcode\" class='tablefont'>ใบSETผ่าตัด</a>"; ?>
</td>
</tr>
<tr style="line-height:25PX;">
<td colspan="10" valign="top" ><font class='tablefontt1'>ฉลาก : </font><?php echo "<a target=_blank  href=\"drug1a.php?Ptname=$ptname&cAn=$an&cBed=$bed& cBedcode=$bedcode&cHn=$hn&cbedname=$sortname\" class='tablefont3'>ยา(1 ดวง)</a>";?>&nbsp;&nbsp; <?php echo "<a target=_blank  href=\"ipbeddrug.php? cAn=$an &cBed=$bed & cBedcode=$bedcode & cHn=$hn & cPtname=$ptname & cbedname=$wardname\" class='tablefont3'>ยา(A4)</a>"; ?>&nbsp;&nbsp; <?php echo "<a target=_blank  href=\"ipbed1.php? cAn=$an &cBed=$bed & cBedcode=$bedcode & cHn=$hn & cbedname=$wardname\"  class='tablefont3'>เอกสาร(A4)</a>";?>&nbsp;&nbsp; <?php echo "<a target=_blank  href=\"liststk.php?cAn=$an&cBed=$bed& cBedcode=$bedcode&cHn=$hn&cbedname=$sortname\" class='tablefont3'>เอกสาร(1 ดวง)</a>";?></td>
</tr>
</table></td>
</tr>
</table>
