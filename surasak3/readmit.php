...
If (!empty($month)){
   $yrmn=$year."-".$month;
   print"ผู้ป่วยในทั้งหมดของเดือน $month/$year , ผู้ป่วยที่admit มากกว่าหนึ่งครั้งในเดือนนี้ ดูด้านล่าง ";
    include("connect.inc");
...
//    print "</table>";
   ...
   print"<br><b>ผู้ป่วยที่admit มากกว่าหนึ่งครั้งในเดือนนี้</b><br>";
 ...
 while (list ($ptname,$hn,$an,$duplicate) = mysql_fetch_row ($result)) {
            ...
            print (" <tr>\n".
               ...
               "  <td BGCOLOR=66CDAA><font face='Angsana New'>จำนวนครั้งที่admit = $duplicate</td>\n".
               " </tr>\n<br>");
               }

   include("unconnect.inc");
print "<b>ข้อมูลการadmit  ดูตารางบน</b>";
  }
?>
