...
print "<DIV style='left:0PX;top:115PX;width:200PX;height:30PX;'><span class='fc1-6'><b>HN:</b>$labhn&nbsp;<b></b>($labtvn)&nbsp;$Thaidate</span></DIV>";
//print "<DIV style='left:0PX;top:25PX;width:200PX;height:30PX;'><span class='fc1-6'>$Thaidate</span></DIV>";
print "<DIV style='left:0PX;top:130PX;width:500PX;height:30PX;'><span class='fc1-0'>$labptname</span></DIV>";
print "<DIV style='left:0PX;top:145PX;width:500PX;height:30PX;'><span class='fc1-3'>ตรวจสุขภาพทหารปี$nPrefix อายุ $showage</span></DIV>";
$nLab21=sprintf("%03d",$nLab2);
$labno=substr(date("Y"),2,2).date("md").$nLab21."01";
print "<DIV style='left:50PX;top:170PX;width:200PX;height:10PX;'><span class='fc1-0'><img src = \"barcode/labstk.php?cLabno=$labno\"></span></DIV>";
print "<DIV style='left:0PX;top:180PX;width:500PX;height:30PX;'><span class='fc1-0'>CBC</span></DIV>";
...
for ($n=1; $n<=$x; $n++){
	If (!empty($aDgcode[$n])){
		...
		if($aDgcode[$n]=="E"){$not="*";}
print "<DIV style='left:10PX;top:190PX;width:500PX;height:30PX;'><span class='fc1-7'>$nLab2$not</span></DIV>";
	}
