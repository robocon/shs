...
// update kew to table runno
    $query ="UPDATE runno SET runno = $nRunno WHERE title='kew5'";
    $result = mysql_query($query);
...
print "<center><font size=4><b>ตรวจมวลกระดูก  </b><br> ";
print "<center><font size=2><b>วันที่$Thaidate</b><br> ";
print "<center>$cPtname<br>"; 
print "<center>HN:$cHn.....VN:$nVn<br>";
//print "<center>VN:$cVn<br>";
print "<center><b>รอรับบริการที่..........</b><br>";
