...
session_register("credit_8");
    ...
    $query = "SELECT * FROM opacc WHERE ( date between '".($start_year)."-".$start_month."-".$start_day." 00:00:00' AND '".($end_year)."-".$end_month."-".$end_day." 23:59:00' ) ";
...
//   $x++;
   ...
   for ($n=$x; $n>=1; $n--){
        ...
        print("<tr>\n".
                ...
                "<td bgcolor=F5DEB3><font face='Angsana New'><A HREF=\"edit_cash.php?id=$rowid[$n]\" target='_blank'>$aCredit[$n]</A></td>\n".  
						   "<td bgcolor=F5DEB3><font face='Angsana New'>$aCredit_d[$n]</td>\n".
		  	   "<td bgcolor=F5DEB3><font face='Angsana New'>$aBillno[$n]</td>\n".
