...
print "<DIV style='left:40PX;top:40PX;width:100PX;height:30PX;'><span class='fc1-2'>VN: $nVn</span></DIV>";
print "<DIV style='left:110PX;top:40PX;width:200PX;height:30PX;'><span class='fc1-3'>HN: $cHn</span></DIV>";
print "<DIV style='left:220PX;top:40PX;width:200PX;height:30PX;'><span class='fc1-0'>$Thaidate</span></DIV>";
print "<DIV style='left:375PX;top:40PX;width:306PX;height:30PX;'><span class='fc1-1'>สิทธิ : $cPtright</span></DIV>";
print "<DIV style='left:60PX;top:70PX;width:306PX;height:30PX;'><span class='fc1-3 '>$cPtname</span></DIV>";
...
print "<DIV style='left:550PX;top:70PX;width:300PX;height:30PX;'><span class='fc1-0'>#.$cIdguard</span></DIV>";
print "<DIV style='left:380PX;top:100PX;width:306PX;height:30PX;'><span class='fc1-0'>$cNote:</span></DIV>";
...
print "</div>";
   ...
   $query = "SELECT kew FROM opday WHERE  thdatehn = '$thdatehn' ";
    $result = mysql_query($query)
        or die("Query drugreact failed");
...
print"<table border='0' width='80%'>";
  ...
  while (list ($kew) = mysql_fetch_row ($result)) {
...
print "<DIV style='left:40PX;top:5PX;width:500PX;height:30PX;'><span class='fc1-2'>ผู้ป่วยทั่วไปลำดับที่:$kew</span></DIV>";
