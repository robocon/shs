...
<form action="pdxdr_ofyear.php" method="post">
...
$sqlvn = "Select vn From predxofyear  where  hn = '".$_POST["p_hn"]."' limit 0,1";
...
<FORM METHOD=POST ACTION="pdxdr_ofyear_save.php" target="_blank" <?php if($arr_view["vn"] ==""){echo "Onsubmit=\"alert('ผู้ป่วยยังไม่ได้ทำการลงทะเบียน');return false;\"";}?>>
