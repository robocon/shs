...
echo "</select>\n";
	...
	if($data=='clinic' && $datar =='room'){
		...
		echo "<option value='0'>----- เลือกห้อง -----</option>\n"; 
		 ...
		 echo "<option value='ห้องฉีดวัคซีนโควิด 19'>ห้องฉีดวัคซีนโควิด 19</option>\n"; 		 
		 ...
		 echo "<option value='ห้อง 10'>ห้อง 11</option>\n";	 
		 echo "<option value='ห้อง 10'>ห้อง 12</option>\n";	 
		 echo "<option value='ห้อง 10'>ห้อง 13</option>\n";	 
