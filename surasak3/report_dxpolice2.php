...
$sql1="CREATE TEMPORARY TABLE  result1  Select * from  resulthead  WHERE hn='".$result2['HN']."' and clinicalinfo ='ตรวจสุขภาพตำรวจ' ";
              ...
              <td><table width="100%"   class="text1" >
                ...
                <tr>
                  <td colspan="2" valign="top" class="text2"><span class="text3"><strong>เลขที่สอบ : </strong></span><strong>
                    <?=$result2['exam_no']?></strong>
                    ลำดับสอบ : <strong><?=$result2['row']?></strong><span class="text3"><strong>&nbsp;&nbsp;เลขประชาชน : <strong>
                      <?=$result2['idcard']?>
