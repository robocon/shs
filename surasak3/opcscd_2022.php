...
echo "<td width='45%'><b>โรค:</b></> ".$sDiag;
...
elseif(count($_SESSION['tDiag'])>1){
	/*if(in_array("ตรวจวิเคราะห์เพื่อการรักษา",$_SESSION['tDiag'])){
		echo "<td width='45%'>โรค: ตรวจวิเคราะห์เพื่อการรักษา</font></td>";
	}
	else{*/
		//$str ="<td width='45%'><b>โรค:</b> ";
...
//IF ($sDepart<>'PATHO'){  
    ...
    print "      <td width='10%' align='right'><font style='line-height:20px; size ='3'></td>";  //เดิม 28
    print "      <td width='13%' align='right'><font style='line-height:20px; size ='3'>$nprice</td>";  //
...
print "      <td width='13%'></td>";
print "      <td width='10%'align='right'>$sSumNprice</td>";
print "      <td width='30%'></td>";
print "    </tr>";
print "  </table>";
print "</div>";
...
print "      <td width='23%' align='center'><b>$sSumNprice</b></td>";
print "      <td width='30%'></td>";
print "    </tr>";
print "  </table>";
print "</div>";
...
print "<td width='20%' align=center><font style='line-height:15px; size='2'>ลงชื่อ.............................................ผู้รับเงิน</font></td>";
print "<td width='20%'></td>";
print "</tr>";
print "<tr>";
print "<td width='20%'><font style='line-height:15px; size='2'>ได้รับ $credit (".$_POST["detail_3"].",".$current.")</font></td>";
$sql = "Select name From inputm where idname = '".$_SESSION["sIdname"]."' limit 1 ";
$result = Mysql_Query($sql) or die("Query failed 721");
list($name) = Mysql_fetch_row($result);
print "<td width='20%' align=center><font face='Angsana New' style='line-height:25px; size='2'>(".$name.")</font></td>";
print "<td width='20%'></td>";
print "</tr>";
print "<tr>";
print "<td width='20%'></td>";
