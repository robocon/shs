...
<form name="form3" method="POST" action="hnnid.php" onsubmit="return checkType();">
	<p>ผู้ป่วยนอก HN (ได้จากเวชระเบียน)</p>
	<p>&nbsp;&nbsp;HN&nbsp;&nbsp;<input type="text" name="hn" id="hn" size="12">
		<br />
		<br />
		<input type="radio" value="1" name="servicd" id="servicd1" required/> <label for="servicd1">คิดค่าบริการ 50 บาท</label>
		<br />
		<br />
...
if (!empty($hn)) { 
	...
	if (mysql_num_rows($result)) {
		...
		print "HN :$cHn<br>";
		print "$cPtname<br>";
		print "สิทธิการรักษาในโรงพยาบาล : <span style='color:green;'><b>$cPtright</b></span><br>";
...
////////////คิดเงิน 50 บาท
			...
			<script>
			window.onload = function(){
				checksit('nhso','<?=$cIdcard;?>','<?=$person_id;?>','<?=$smctoken;?>');
			}
			</script>
			<?php
