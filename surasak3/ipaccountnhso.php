...
*/
$part='dpy';
    $query = "SELECT * FROM ipacc WHERE an = '$cAn'  and part ='$part' ";
    $result = mysql_query($query)
        or die("Query failed ipacc");
    for ($i = mysql_num_rows($result) - 1; $i >= 0; $i--) {
        if (!mysql_data_seek($result, $i)) {
...
print "  </table> <div style=\"page-break-before: always;\"></div>";
   ...
   print "โรค : $cDiag,&nbsp;&nbsp;  แพทย์ : $cDoctor";
      print "<font face='Angsana New' size ='4'><BR><BR><B>สรุปค่ารักษาพยาบาลผู้ป่วยในประเภทอุปกรณ์(DPY)</B> <br>";
...
//print "  </table> <div style=\"page-break-before: always;\"></div>";
   ...
   print "<font face='Angsana New' size='4'><B>สรุปค่าห้องค่าอาหารผู้ป่วยใน</B><br>";
...
////
  //  $query = "SELECT date,depart,detail,amount,price,paid,part,idname FROM ipacc WHERE an = '$cAn' and accno='$accno' ORDER BY depart,part,date ASC ";
  $query = "SELECT row_id,date,depart,detail,amount,price,paid,part,idname,code,price FROM ipacc WHERE an = '$cAn' and code like 'BF%' ";
