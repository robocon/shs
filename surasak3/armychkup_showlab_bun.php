...
<table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse;">
  <tr>
    ...
    <td width="12%" align="center" bgcolor="#FF9999"><strong>BUN</strong></td>
  </tr>
  <?
include("connect.inc");  
	$sql = "select * from armychkup where yearchkup='61' and camp !='' and age >=35 and bun_lab ='' order by age desc";	
		//echo $sql;
		...
		$labquery = "select * from resulthead as a inner join resultdetail as b on a.autonumber=b.autonumber where b.labcode='BUN' AND a.hn ='".$result["hn"]."' and a.clinicalinfo='ตรวจสุขภาพประจำปี61'";
		//echo $labquery;
		...
		$update="update armychkup set bun_result='$resultlab',
														  bun_flag='$flaglab',
														  bun_lab='$bunlab' 
						where row_id='$rowid';";
		echo $update."<br>";		
