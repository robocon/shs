...
<?php
    ...
    echo '<br>';
	print "<a target=\"_blank\" href=\"labslip4cbc.php\">สติ๊กเกอร์ CBC</a>";
	...
	print "<A HREF=\"labslip4out_from_er.php?sDate=$date&cHn=$sHn\" target=\"_blank\">พิมพ์ Stiker OUTLAB</A><br>";
