...
echo "<div style='font-size:24px'><strong>ข้อมูลประจำเดือน $showdate1</strong></div>";
	...
	if($chkdate1=="2561-09"){
		...
		echo "<div align='left'>- ส่งข้อมูลแก้ติด C ผ่าน 100% จำนวน 11 วัน คือ วันที่ 2,19 และ 25</div>";
	}else if($chkdate1=="2562-05"){
		echo "<div align='left'>- ส่งข้อมูลผ่าน 100% จำนวน 2 วัน คือ วันที่ 3 และ 18</div>";
		echo "<div align='left'>- ส่งข้อมูลแก้ติด C ผ่าน 100% จำนวน 11 วัน คือ วันที่ 5,6,8,12,17,19,20,22,24,28 และ 31</div>";
