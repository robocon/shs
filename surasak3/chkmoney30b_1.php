...
//    $chkdate=($chkdate).date(" G:i:s"); 
    ...
    print "<b>รับชำระโดย$doctor</b><A HREF='../nindex.htm'>&lt;&lt; เมนู</A> ";
...
<table>
 <tr>
  ...
  <th bgcolor=6495ED>จ่ายเงิน</th>
   <th bgcolor=6495ED>ชำระ</th>
 
 
   <th bgcolor=6495ED>เลขที่</th>
  <th bgcolor=6495ED>detail</th>
...
$prow_id     =array("prow_id");
 $query = "SELECT * FROM opacc WHERE   date LIKE '$today%' and credit = '$doctor'  ";
...
//แสดงรายการคืนเงิน
//<INPUT TYPE=\"submit\" value=\"แก้ไขข้อมูลเลขที่ใบเสร็จทั้งหมด\"
print "</table>
</FORM>";
    print "<table>";
    print " <tr>";
