...
รายการที่มีปริมาณการใช้สูงสุด 10 อันดับแรก (หน่วย)
<!--<select name="year">
...
<table width="80%" border="1" cellspacing="0" cellpadding="0">
 ...
 <?
  $sql = "SELECT drugcode,sum(price) as sum,sum(amount) as sum2 FROM drugrx WHERE ( date BETWEEN  '".($i-1)."-10-01 00:00:00' AND  '".$i."-09-30 23:59:59' ) group by drugcode order by sum2 desc limit 10";
