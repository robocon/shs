<?php
  ...
  print "รายงานประจำ เดือน $yrmonth <a target=_self  href=\"erdetel2.php? yrmonth=$yrmonth\"><<  เรียงตามอักษร</a>.......<a target=_self  href='../nindex.htm'><<ไปเมนู</a><br> ";
   $query="SELECT  erdiag ,COUNT(*) AS duplicate FROM opday1 GROUP BY erdiag HAVING duplicate > 0 ORDER BY duplicate";
