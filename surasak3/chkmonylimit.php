...
//
    ...
    print "<form method='POST' action='chkmonylimit1.php'>";
...
print "<input name='money' type='text' size=10>&nbsp;&nbsp;";
   
print " <select  name='rip'>"; 
print " <option value=''>ทั้งหมด</option>";
print " <option value='ค่ายา'>ค่ายา</option>";
print " <option value='ค่าหัตถการ'>ค่าหัตถการ</option>";
print "   </select>";
