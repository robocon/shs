...
if($_POST["seltime"]=="1"){  //ในเวลาราชการ
	if($_POST['d_start']==''){ // ถ้าไม่ได้เลือกวันที่
	$query = "SELECT b.date, b.ptname, b.hn, b.an, b.depart, b.detail, b.price, b.paid, b.row_id, b.accno, b.tvn ,b.staf_massage,b.diag,b.ptright FROM `patdata` AS a, depart AS b WHERE b.row_id = a.idno AND ( a.code in ('58002' , '58003' ,'58004' ,'58002a','58002b','58002c','58005','58006','58007','58008','58101','58102','58130','58131','58201','58301','58301a','58130P','58131P','58130S','58131S','58133')) AND (b.date BETWEEN '".$today."-01 08:00:00' AND '".$today."-31 16:00:00')  and  a.status='Y' and a.price >0 Group by b.date ,b.hn,a.code ";
	}else{  //เลือกวันที่
	$query = "SELECT b.date, b.ptname, b.hn, b.an, b.depart, b.detail, b.price, b.paid, b.row_id, b.accno, b.tvn ,b.staf_massage,b.diag,b.ptright FROM `patdata` AS a, depart AS b WHERE b.row_id = a.idno AND ( a.code in ('58002' , '58003' ,'58004' ,'58002a','58002b','58002c','58005','58006','58007','58008','58101','58102','58130','58131','58201','58301','58301a','58130P','58131P','58130S','58131S','58133')) AND (b.date BETWEEN '".$today." 08:00:00' AND '".$today." 16:00:00')  and  a.status='Y' and a.price >0 Group by b.date ,b.hn,a.code ";	
	}
}else if($_POST["seltime"]=="2"){  //นอกเวลาราชการ
	if($_POST['d_start']==''){ // ถ้าไม่ได้เลือกวันที่
	$today=($_POST['y_start']-543).'-'.$_POST['m_start'].'-'.date("d");
	$query = "SELECT b.date, b.ptname, b.hn, b.an, b.depart, b.detail, b.price, b.paid, b.row_id, b.accno, b.tvn ,b.staf_massage,b.diag,b.ptright FROM `patdata` AS a, depart AS b WHERE b.row_id = a.idno AND ( a.code in ('58002' , '58003' ,'58004' ,'58002a','58002b','58002c','58005','58006','58007','58008','58101','58102','58130','58131','58201','58301','58301a','58130P','58131P','58130S','58131S','58133')) AND (b.date BETWEEN '".$today."-01 16:00:01' AND '".$today."-31 23:59:59')  and  a.status='Y' and a.price >0 Group by b.date ,b.hn,a.code ";
	}else{  //เลือกวันที่
	$query = "SELECT b.date, b.ptname, b.hn, b.an, b.depart, b.detail, b.price, b.paid, b.row_id, b.accno, b.tvn ,b.staf_massage,b.diag,b.ptright FROM `patdata` AS a, depart AS b WHERE b.row_id = a.idno AND ( a.code in ('58002' , '58003' ,'58004' ,'58002a','58002b','58002c','58005','58006','58007','58008','58101','58102','58130','58131','58201','58301','58301a','58130P','58131P','58130S','58131S','58133')) AND (b.date BETWEEN '".$today." 16:00:01' AND '".$today." 23:59:59')  and  a.status='Y' and a.price >0 Group by b.date ,b.hn,a.code ";	
	}
}else{
	$today=(date("Y")+543).'-'.date("m").'-'.date("d");
$query = "SELECT b.date, b.ptname, b.hn, b.an, b.depart, b.detail, b.price, b.paid, b.row_id, b.accno, b.tvn ,b.staf_massage,b.diag,b.ptright FROM `patdata` AS a, depart AS b WHERE b.row_id = a.idno AND ( a.code in ('58002' , '58003' ,'58004' ,'58002a','58002b','58002c','58005','58006','58007','58008','58101','58102','58130','58131','58201','58301','58301a','58130P','58131P','58130S','58131S','58133')) AND (b.date BETWEEN '".$today." 08:00:00' AND '".$today." 23:59:59')  and  a.status='Y' and a.price >0 Group by b.date ,b.hn,a.code ";
}
	//echo $query;
