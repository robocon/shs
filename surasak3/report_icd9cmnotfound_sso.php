...
<body>
<p align="center" style="margin-top: 20px;"><strong>เลือกวันที่ต้องการดูข้อมูล ICD9CM Not Found สิทธิประกันสังคม</strong></p>
<div align="center">
  <form method="post" action="report_icd9cmnotfound_sso.php">
...
?>
<hr />
<div align="center" style="margin-top: 20px;"><strong>รายงานแสดงข้อมูล ICD9CM Not Found สิทธิประกันสังคม</strong></div>
...
<table width="97%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr>
    ...
    <td width="14%" align="center" bgcolor="#66CC99"><strong>ชื่อผู้ป่วย</strong></td>
    <td width="12%" align="center" bgcolor="#66CC99"><strong>การมาโรงพยาบาล</strong></td>
    <td width="14%" align="center" bgcolor="#66CC99"><strong>Doctor</strong></td>
    <td width="12%" align="center" bgcolor="#66CC99"><strong>Diagnosis</strong></td>
    <td width="17%" align="center" bgcolor="#66CC99"><strong>หัตถการ</strong></td>
    <td width="8%" align="center" bgcolor="#66CC99"><strong>ลูกหน</strong>ี้</td>
  </tr>
  <?
$chkdate1=$_POST["year1"]."-".$_POST["month1"]."-".$_POST["date1"]." 00:00:00";
$chkdate2=$_POST["year2"]."-".$_POST["month2"]."-".$_POST["date2"]." 23:59:59";

$sql="select date,hn,detail from patdata where (date >= '$chkdate1' and date <='$chkdate2') and part='SURG' and ptright like 'R07%' and (an='' OR an IS NULL) and amount > 0";
//echo $sql;
...
$sql1="select * from opday where thidate like '$chkdate%' and hn='$chkhn' and (icd9cm='' OR icd9cm IS NULL) and toborow !='EX10  ไตเทียม' ORDER BY ABS(vn) ASC";
//echo $sql1."<br>";
$query1=mysql_query($sql1);
$num=mysql_num_rows($query1);
$result=mysql_fetch_array($query1);

$sql2="select * from opacc where txdate = '$chktxdate' and hn='$chkhn'";
//echo $sql2."<br>";
