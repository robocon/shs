...
?>	
<body>
<div align="center"><strong>ผลการตรวจสุขภาพเจ้าหน้าที่ พูลผลการเกษตร  บริการตรวจสุขภาพ ณ โรงพยาบาลค่ายสุรศักดิ์มนตรี</strong></div>
...
<?
$sql="SELECT  *  FROM opcardchk WHERE part='พูลผลการเกษตร60' and active='y' order by row";
//echo $sql."<br>";
