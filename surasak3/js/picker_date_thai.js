...

{
   ...
   // <center>Develop By <a href='https://www.facebook.com/fordev22/' target='_blank'>fordev22.com</a></center>
   ...
   var render_cal_pic=function(element,month,year)
   {
                    ...
                    //html+="<td colspan='7' >";
                        ...
                        //html+="<button class='btn btn-sm btn-danger clear_cal_btn' >";
                            //html+="<i class='fa fa-times' ></i> à¸¥à¹‰à¸²à¸‡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸›à¸Žà¸´à¸—à¸´à¸™";
                        //html+="</button>";

                    //html+="</td>";
                    //html+="<caption><center>Develop By <a href='#' target='_blank'>fordev22.com</a></center></caption>";
                    ...
                    html+="<button class='btn btn-sm btn-danger clear_cal_btn' >";
                        html+="<i class='fa fa-times' ></i> ยกเลิก";
                    html+="</button> ";
    ...
    $("[data-picker="+ran_cal_id+"]").on("click",function (){
            ...
            if(document.querySelector("."+ran_cal_id+"_panel"))
            {
                ...
                return;
                    ...
                    $(month_select).addClass("form-control select2");
                    ...
                    $(clear_btn).html(" <i class='fa fa-times' ></i> à¸¥à¹‰à¸²à¸‡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸›à¸Žà¸´à¸—à¸´à¸™");
                    $(clear_btn).on("click",()=>{
