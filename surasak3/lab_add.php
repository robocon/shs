...
<form name="f1" action="lab_add.php" method="post" onSubmit="JavaScript:return fncSubmit();">
	...
	<table width="685" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="#666666" class="font1"
		...
		<tr>
			<td valign="top">
				รหัส Sticker
				<p style="padding: 0; margin: 0;">( Code lab )</p>
			</td>
			<td>
				<input type="text" name="codelab" class="font1" id="codelab" />
				<div style="color:red;">* จำเป็นต้องกรอกเพื่อให้เครื่อง LIS อ่านผลและส่งผลตรวจได้ถูกต้อง</div>
			</td>
		</tr>
		<tr>
			<td>รายละเอียด</td>
