...
if(isset($_GET["action"])){
	...
	$cnote = $_SESSION['cnote'];
	$cidguard = $_SESSION['cidguard'];
	$dt_doctor = $_SESSION['dt_doctor'];
	...
	$Age = $_GET['Age'];
	$ptright = $_GET['ptright'];
	$note = $_GET['note'];
	$idguard = $_GET['idguard'];
...
?> 
  ...
  &nbsp;&nbsp;&nbsp;<a target=_top  href="../nindex.htm"><< &#3648;&#3617;&#3609;<span class="t">&#3641;</span></a>&nbsp&nbsp;<<&nbsp<a target=_self  href='hnappoi1.php'>ออกใบนัดใหม่</a></p>
	...
	<input type="hidden" name="cPtname" value="<?php echo $cPtname; ?>">
	<input type="hidden" name="cptright" value="<?php echo $cptright; ?>">
	<input type="hidden" name="cnote" value="<?php echo $cnote; ?>">
	<input type="hidden" name="cidguard" value="<?php echo $cidguard; ?>">
	<input type="hidden" name="dt_doctor" value="<?php echo $dt_doctor; ?>">
</form>
