<?php
    ...
    $today="$d-$m-$yr";
    print "วันที่ $today  รายชื่อคนไข้ที่ซื้อยา เวชภัณฑ์ ";
...
<table>
 <tr>
  ...
  <th bgcolor=6495ED><font face='Angsana New'>ยานอกบัญชียาหลัก</th>
  </tr>
...
<?php
    ...
    $query = "SELECT date,ptname,ptright,hn,an,price,paid,essd,nessdy,nessdn,dsy,dpy,dsn,dpn,row_id,accno,tvn FROM phardep WHERE date LIKE '$today%' AND an != '' ORDER BY ptname ";
