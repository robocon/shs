...
$list_labcare["L23"] = "On Foleys catheter";
$list_labcare["L51"] = "Off Foleys catheter";
...
<TR>
  ...
  <TD valign="top" colspan="5"><input name="temperature" type="text" id="temperature" value="<?php echo $arr["temperature"];?>" size="3" /></TD>
  <td valign="top">&nbsp;</td>
</TR>
<TR>
  <TD  align="right" valign="top">P :</TD>
  <TD valign="top" colspan="5"><input name="pause" type="text" id="pause" value="<?php echo $arr["pause"];?>" size="3" /></TD>
  <td valign="top">&nbsp;</td>
</TR>
<TR>
  <TD  align="right" valign="top">R :</TD>
  <TD valign="top" colspan="5"><input name="rate" type="text" id="rate" value="<?php echo $arr["rate"];?>" size="3" /></TD>
  <td valign="top">&nbsp;</td>
</TR>
<TR>
  <TD  align="right" valign="top">BP :</TD>
  <TD valign="top" colspan="5"><input name="bp1" type="text" id="bp1"  value="<?php echo $arr["bp1"];?>" size="3"/> 
    / 
      <input name="bp2" type="text" id="bp2"  value="<?php echo $arr["bp2"];?>" size="3"/></TD>
  <td valign="top">&nbsp;</td>
</TR>
<TR>
  <TD  align="right" valign="top">O2sat :</TD>
  <TD valign="top" colspan="5"><input name="o2sat" type="text" id="o2sat" value="<?php echo $arr["o2sat"];?>" size="3" /></TD>
  <td valign="top">&nbsp;</td>
</TR>
<TR>
  <TD  align="right" valign="top">Painscore :</TD>
  <TD valign="top" colspan="5"><input name="painscore" type="text" id="painscore" value="<?php echo $arr["painscore"];?>" size="3" /></TD>
  <td valign="top">&nbsp;</td>
</TR>
<TR>
  <TD  align="right" valign="top">สภาพแรกรับ :</TD>
  <TD valign="top" colspan="5"><TEXTAREA name="condition" id="condition" ROWS="3" COLS="30" /><?php echo $arr["condition"];?></TEXTAREA></TD>
  <td valign="top">&nbsp;</td>
</TR>
<TR>
	...
	while($arr = Mysql_fetch_assoc($result2)){
      ...
      <tr bgcolor="<?php echo $bgcolor;?>">
		...
		<TR>
			...
			<TD><A HREF="javascript:void(0);" <?php if(strlen($arr["maintenance"]) > 18){?> onmouseover= "show_tooltip('<?php echo jschars($arr["maintenance"]);?>','left',0,0);" onMouseOut="hid_tooltip();" <?php }else{ ?> Onclick="document.getElementById('maintenance').value='<?php echo $arr["maintenance"];?>';" <?php }?>  style="color: #0000FF;text-decoration:none;"><?php echo substr($arr["maintenance"], 0, 20); if(strlen($arr["maintenance"]) > 18) echo " ...";?></A></TD>
		</TR>
		</TABLE>
