...
<?
		...
		$nPrefix2="25".$nPrefix;
?>
<p align="center" style="margin-top: 20px;"><strong>รายงานผลการตรวจสุขภาพประจำปีกองทัพบก กลุ่มเป็นโรคไตเสื่อม</strong></p>	
<form name="form1" method="post" action="report_chkuparmy_gfr.php" >
...
if($_POST["act"]=="show"){
	...
	$query=mysql_query($sql);	
?>	
<p align="center" style="margin-top: 20px;"><strong>รายงานผลการตรวจสุขภาพประจำปีกองทัพบก กลุ่มเป็นโรคไตเสื่อม (GFR < 60) ปี <?=$nPrefix2;?></strong></p>
<div align="center">
<table width="95%" border="1" align="center" cellpadding="6" cellspacing="0" bordercolor="#000000">
  ...
  <tr>
	...
	<td width="9%" align="center"><strong>ค่า GFR</strong></td>
  </tr>
