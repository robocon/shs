...
<tr>
    ...
    If (!empty($hn)){
        ...
        while (list ($hn,$yot,$name,$surname,$ptright,$ptright1,$idcard) = mysql_fetch_row ($result)) {
            ...
            "  <td align=\"center\" BGCOLOR=".$color."><input type=\"button\" name=\"button\" id=\"button\" value=\"ลงทะเบียนผู้ป่วย\" onclick=\"window.open('opworkfast.php?hn=$hn')\" class=\"txtsarabun\" /></td>\n".
            " </tr>\n");
