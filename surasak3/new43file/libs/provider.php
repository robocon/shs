...
while ($item = mysql_fetch_assoc($q)) {
    ...
    $providerTXT .= "$HOSPCODE|$PROVIDER|$REGISTERNO|$CONCIL|$CID|$PRENAME|$NAME|$LNAME|$SEX|$BIRTH|$PROVIDERTYPE|$STARTDATE|$OUTDATE|$MOVEFROM|$MOVETO|$D_UPDATE|$HOSPCODE9|$HOSPCODE9\r\n";
...
$header = "HOSPCODE|PROVIDER|REGISTERNO|CONCIL|CID|PRENAME|NAME|LNAME|SEX|BIRTH|PROVIDERTYPE|STARTDATE|OUTDATE|MOVEFROM|MOVETO|D_UPDATE|HOSPCODE9|HOSP9_MOVEFROM\r\n";
