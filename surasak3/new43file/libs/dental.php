...
while ( $item = mysql_fetch_assoc($q) ) {
    ...
    $txt .= $item['PROVIDER'].'|'.$item['D_UPDATE'];
    $txt ."\r\n";
}
...
$header .= "NEED_DEXTRACT|NPROSTHESIS|PERMANENT_PERMANENT|PERMANENT_PROSTHESIS|PROSTHESIS_PROSTHESIS|GUM|SCHOOLTYPE|CLASS|PROVIDER|D_UPDATE\r\n";
$txt = $header.$txt;
