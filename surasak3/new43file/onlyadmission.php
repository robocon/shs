...
?>
	<div>
		<h3>ส่งออก43แฟ้ม</h3>
		<p>อัพเดทเฉพาะ แฟ้ม admission </p>
	</div>
	<form action="onlyadmission.php" method="post">
		<div>
...
<?php
	...
	if( $testMatch === 0 ){
		...
		<a href="onlyadmission.php">ย้อนกลับ</a>
		<?php
		exit;
	}
	...
	echo '<p><a href="onlyadmission.php">&lt;&lt;&nbsp;กลับไปหน้ารายการ</a></p>';
}