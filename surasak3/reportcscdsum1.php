...
if(strlen($sum) > 10){
	...
	}else if($sum=="20782456.50"){
		$cbaht="**ยี่สิบล้านเจ็ดแสนแปดหมื่นสองพันสี่ร้อยห้าสิบหกบาทห้าสิบสตางค์**";
	}else if($sum=="21489076.50"){
		$cbaht="**ยี่สิบเอ็ดล้านสี่แสนแปดหมื่นเก้าพันเจ็ดสิบหกบาทห้าสิบสตางค์**";
	}else{
...
echo "</table>";
			...
			*/
echo "<font face='Angsana New' size ='5'><br><br><center> <b>สรุปลูกหนี้โครงการจ่ายตรงประจำวันที่ ".$start_day."-".$start_month."-".($start_year)." 00:00:00 ถึง  ".$end_day."-".$end_month."-".($end_year)." 23:59:59 <br></b> ";
