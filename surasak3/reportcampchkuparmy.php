...
<?
include("connect.inc");
$sql1="SELECT * FROM dxofyear WHERE camp ='$_GET[camp]' AND yearchk = '$_GET[year]' group by hn order by age DESC";
//echo $sql1;
$result=mysql_query($sql1) or die("Query dxofyear line 15 Error");
