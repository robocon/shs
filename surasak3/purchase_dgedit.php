...
<a target=_self  href='../nindex.htm'><< ไปเมนูหลัก</a>  || <a target=_self  href='purchase_dglst.php'><< ไปหน้าก่อนนี้</a>
<?php
    include("connect.inc");

    $query = "SELECT * FROM druglst WHERE drugcode = '$Dgcode' and grouptype='pc'";
...
print "<form method='POST' action='purchase_dgupdate.php' >";
...
print "  <a target=_BLANK href='purchase_part.htm'>&#3585;&#3621;&#3640;&#3656;&#3617;</a>(part)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
...
<select name="pro_drugtype">
		  ...
		  <option value='1' <? if($prodrugtype=='1'){ echo "selected"; } ?>>1 = ยาตามชื่อสามัญ (gereric name) ในบัญชียาหลักแห่งชาติ</option>
