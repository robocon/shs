...
$ptright="จ่ายตรง";
$sql = "Select a.date,a.txdate, a.hn, CONCAT(b.yot,' ',b.name,' ',b.surname) as full_name, a.depart, sum(a.paid),a.credit_detail From opacc as a, opcard as b where a.hn=b.hn AND a.date like '".$date1."%' AND a.credit ='HD' and a.credit_detail='$ptright' group by a.hn, a.depart   ORDER by a.date,a.credit_detail";
//echo $sql;
