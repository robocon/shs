...
// สำหรับค้นหาใน appoint
$today_en = ($thiyr-543)."-$rptmo-$date";

//
$date1 ="$thiyr-$rptmo-$date";

// แสดงบนหัวกระดาษกับ opday
$date2 = $for_thidatehn = "$date-$rptmo-$thiyr";

$ptright="จ่ายตรง";
$sql = "SELECT a.`date`,a.`txdate`, a.`hn`, a.`depart`, SUM(a.`paid`),a.`credit_detail` ,b.`hd_room` 
From `opacc` as a 
LEFT JOIN ( 
	SELECT `hn`,SUBSTRING(`detail`,1,4) AS `hd_room` 
	FROM `appoint` 
	WHERE `appdate_en` = '$today_en' 
...
AND a.`credit` ='HD' 
AND a.`credit_detail`='$ptright' 
GROUP BY a.`hn`, a.`depart` 
ORDER BY b.`hd_room`,a.`date`,a.`credit_detail`";
...
while(list($date1, $date, $hn, $depart, $paidcscd,$credit_detail,$hd_room) = Mysql_fetch_row($result)){ 

	$thdatehn = $for_thidatehn.$hn;
	...
	// ถ้าเป็นไตเทียม 2 ให้เก็บข้อมูลแยกออกมาต่างหาก แล้วcontinue
	if($hd_room=='FU39'){
		$hemo_room2[$hn] = $list2[$hn];
	}
...
echo "<tr><td>&nbsp;&nbsp;#&nbsp;&nbsp;</td>
<td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;วันที่&nbsp;&nbsp;</b></td>
<td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ชื่อ - สกุล&nbsp;&nbsp;</b></td>
<td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;สิทธิ์&nbsp;&nbsp;</b></td>

<td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;hn&nbsp;&nbsp;</b></td>
<td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;vn&nbsp;&nbsp;</b></td>
<td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
<td><center> <b>&nbsp;&nbsp;ยา&nbsp;&nbsp;</b></center></td>
<td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;พยาธิ&nbsp;&nbsp;</b></td>
<td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;เอกเรย์&nbsp;&nbsp;&nbsp;</b></td>
<td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ทันตกรรม&nbsp;&nbsp;&nbsp;</b></td>
<td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;กายภาพ&nbsp;&nbsp;&nbsp;</b></td>
<td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;บริการ&nbsp;&nbsp;&nbsp;</b></td>
<td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ผ่าตัด&nbsp;&nbsp;&nbsp;</b></td>
<td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ฝังเข็ม&nbsp;&nbsp;&nbsp;</b></td>
<td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ไตเทียม&nbsp;&nbsp;&nbsp;</b></td>
<td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ตรวจอื่นๆ&nbsp;&nbsp;</b></center></td>
<td>&nbsp;&nbsp;***&nbsp;&nbsp;</td>
<td><center> <b>&nbsp;&nbsp;รวม&nbsp;&nbsp;</b></center></td></tr>";
foreach ($list2 as $key => $value) {
    ...
    echo "<tr><td><font face='Angsana New' size ='2'>&nbsp;&nbsp;".$num."&nbsp;</td>
...
<td align='right'><font face='Angsana New' size ='2'><b>&nbsp;".$DENTA."&nbsp;</td>
<td align='right'><font face='Angsana New' size ='2'><b>&nbsp;".$PHYSI."&nbsp;</td>
<td align='right'><font face='Angsana New' size ='2'><b>&nbsp;".$EMER."&nbsp;</td>
<td align='right'><font face='Angsana New' size ='2'><b>&nbsp;".$SURG."&nbsp;</td>
<td align='right'><font face='Angsana New' size ='2'><b>&nbsp;".$NID."&nbsp;</td>
<td align='right'><font face='Angsana New' size ='2'><b>&nbsp;".$HEMO."&nbsp;</td>
<td align='right'><font face='Angsana New' size ='2'><b>&nbsp;".$OTHER."&nbsp;</td>
<td align='right'><font face='Angsana New' size ='2'><b>&nbsp;".$OTHER2."&nbsp;</td>
<td align='right'><font face='Angsana New' size ='3'><b>&nbsp;".$sum."&nbsp;</td></b></tr></FONT>";
echo "</table>";
...
<td>&nbsp;&nbsp;***&nbsp;&nbsp;</td>
<td><center> <b>&nbsp;&nbsp;รวม&nbsp;&nbsp;</b></center></td></tr>";
foreach ($hemo_room2 as $key => $value) {
	...
	if($i == '20'){
		...
		echo "<table  border ='1' bordercolor='#000000' cellspacing='0' cellpadding='0' style='BORDER-COLLAPSE: collapse'>";
		echo "<tr><td>&nbsp;&nbsp;#&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;วันที่&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ชื่อ - สกุล&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;สิทธิ์&nbsp;&nbsp;</td>
		<td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;hn&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;vn&nbsp;&nbsp;</td><td><center> <b>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><center> <b>&nbsp;&nbsp;ยา&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;พยาธิ&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;เอกเรย์&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ทันตกรรม&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;กายภาพ&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;บริการ&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ผ่าตัด&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ฝังเข็ม&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ไตเทียม&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b><center> <b>&nbsp;&nbsp;ตรวจอื่นๆ&nbsp;&nbsp;</td><td>&nbsp;&nbsp;***&nbsp;&nbsp;</td><td><center> <b>&nbsp;&nbsp;รวม&nbsp;&nbsp;</td></tr>";
		$i='0';
	}
