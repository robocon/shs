...
//   print "======================<br>";
 ...
 $nNprice=$BFN+$DPN+$Nessdn+$DNessdn+$DSN+$Mc+$Bloodn+$Labon+$Xrayn+$Sinvn+$Tooln+$Surgn+$Ncaren+$Dentn+$Physin+$Stxn+$Mcn+$Mcy;
   ...
   print "<b><center><FONT SIZE='5' COLOR=''><font face='Angsana New'>แจ้งชำระค่ารักษาพยาบาล(ระหว่างรักษาพยาบาล) <br>โรงพยาบาลค่ายสุรศักดิ์มนตรี ลำปาง<BR>ณ วันที่  $Thaidate </b></FONT><br>";

   print "<font face='Angsana New'><FONT SIZE='4' COLOR=''>ผู้ป่วย <B>$cPtname</B>&nbsp;&nbsp;";
...
print "    <tr>";
print "      <td width='5%'></td>";
//print "      <td width='55%'><font face='Angsana New'>ค่ารักษาพยาบาล:<br>";
print "<td width='55%'><font face='Angsana New'>รายการ<br>";
print "1. ค่าห้อง/ค่าอาหาร<br>";	
print "   .......ค่าห้อง/ค่าอาหาร(ส่วนเกิน)<br>";	
print "2. อวัยวะเทียม/อุปกรณ์ในการบำบัดรักษา<br>";	
print "3. ยาและสารอาหารทางเส้นเลือดที่ใช้ในโรงพยาบาล<br>";
...
print "<b> ...........................รวมเงินย่อย.........(เบิกไม่ได้)...........</b></font></td>";//add

//print "      <td width='16%' valign='middle'><font face='Angsana New'>รายการ<br>";
/*print "       <td width='16%' valign='middle'><font face='Angsana New'> เบิกได้<br>";
print "        $BFY<br>";
print "        ...<br>";
print "        $DPY<br>";
print "        $DDLDDY<br>";
...
//print "      <td width='24%'><font face='Angsana New'>รายการ<br>";
print "        <td width='24%'><font face='Angsana New'>เบิกไม่ได้<br>";
print "        ...<br>";
print "        $BFN<br>";
print "        $DPN<br>";
print "        $Nessdn<br>";
...
$np=number_format($nNprice,2,'.','');///เบิกไม่ได้ 
...
$cnp=baht($np);
print "<b><center><FONT SIZE='4' COLOR=''><font face='Angsana New'>ค้างจ่ายทั้งหมดประมาณ $np บาท&nbsp;&nbsp;(&nbsp;$cnp&nbsp;)</FONT></b><br>";
print "<FONT SIZE='4' COLOR=><font face='Angsana New'><U><B>ให้ติดต่อส่วนเก็บเงินรายได้เพื่อชำระค่ายาและค่าบริการ</B></U><br>";
print "***ยอดทั้งหมดเป็นยอดประมาณการอาจมีรายการเพิ่มเติม***</FONT></center><br>";
print "<font face='Angsana New'><FONT SIZE='3' COLOR=''><CENTER>ผู้แจ้ง................................................เจ้าหน้าที่เก็บเงิน.........................................เล่มที่/เลขที่...........................</CENTER></FONT>";

print "<BR><BR><font face='Angsana New'><FONT SIZE='2' COLOR=''>***เอกสารนี้ออกจากส่วนเก็บเงินรายได้ มีปัญหาหรือข้อสงสัยติดต่อที่ส่วนเก็บเงินรายได้ โทร 054-839305 ต่อ 6302</FONT>";
