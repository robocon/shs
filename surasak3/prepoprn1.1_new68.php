...
.sarabun {
  ...
  position: absolute;
  top: 3116px;
  left: 0;                 /* ✅ ต้องเริ่มจากซ้ายสุด */
  width: 90%;             /* ✅ ให้กว้างเต็มหน้ากระดาษ */
  page-break-before: always;
  text-align: center;
}

.report-title {
  display: inline-block;   /* ✅ ให้เนื้อหาอยู่กึ่งกลางได้สมบูรณ์ */
  font-weight: bold;
  margin-bottom: 20px;
  font-size: 24pt;
  margin-left:-200px;
...
///end of function convert to float number ทศนิยม 2ตำแหน่ง
	...
	$aMancode[11]='pharmacy';
	$aMancode[12]='headpharmacy';
...
print "<DIV style='left:138PX;top:198PX;width:283PX;height:30PX;'><span class='fc1-5'>ผอ.รพ.ค่ายสุรศักดิ์มนตรี&nbsp;&nbsp;ผ่าน หก.เภสัชกรรม</span></DIV>";
...
print "<DIV style='left:167PX;top:263PX;width:617PX;height:30PX;'><span class='fc1-5'>คลังยาและเวชภัณฑ์  รพ.ค่ายฯ ขออนุมัติจัดหาเวชภัณฑ์  $cDepart</span></DIV>";
print "<DIV style='left:88PX;top:292PX;width:696PX;height:30PX;'><span class='fc1-5'>รพ.ค่ายสุรศักดิ์มนตรี จำนวน $nItems รายการ การจัดหาครั้งนี้เป็นการจัดหาทดแทน</span></DIV>";
...
print "<DIV style='left:167PX;top:263PX;width:617PX;height:30PX;'><span class='fc1-5'>คลังยาและเวชภัณฑ์  รพ.ค่ายฯ ขออนุมัติจัดหาเวชภัณฑ์ เพื่อใช้ในการรักษาพยาบาลผู้ป่วยเจ็บที่เข้ามา</span></DIV>";
...
//หก.เภสัชกรรม
print "<DIV style='left:167PX;top:479PX;width:87PX;height:30PX;'><span class='fc1-5'>$aYot[12]</span></DIV>";
print "<DIV style='left:219PX;top:508PX;width:269PX;height:30PX;'><span class='fc1-5'>($aFname[12])</span></DIV>";
print "<DIV style='left:139PX;top:537PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-5'>$aPost[12]</span></DIV>";


print "<DIV style='left:138PX;top:811PX;width:55PX;height:30PX;'><span class='fc1-5'>อนุมัติ</span></DIV>";
print "<DIV style='left:167PX;top:840PX;width:87PX;height:30PX;'><span class='fc1-5'>$aYot[1]</span></DIV>";
...
print "<DIV style='left:109PX;top:935PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-5'>............/............/............</span></DIV>";


print "<DIV style='left:435PX;top:500PX;width:269PX;height:30PX;'><span class='fc1-5'>เรียน ผอ.รพ.ค่ายสุรศักดิ์มนตรี</span></DIV>";
print "<DIV style='left:472PX;top:529PX;width:269PX;height:30PX;'><span class='fc1-5'>- กรุณาพิจารณา</span></DIV>";
print "<DIV style='left:435PX;top:558PX;width:300PX;height:30PX;'><span class='fc1-5'>- เห็นควร......................../จัดซื้อยาและเวชภัณฑ์ ตามที่</span></DIV>";
print "<DIV style='left:445PX;top:587PX;width:269PX;height:30PX;'><span class='fc1-5'>มีคุณลักษณะเฉพาะ พบ. นี้</span></DIV>";
...
if($chkpono=="อ."){
print "<DIV style='left:472PX;top:790PX;width:269PX;height:30PX;'><span class='fc1-5'>ได้ตรวจสอบงบอุดหนุนแล้วมีเพียงพอ</span></DIV>";
}else{
print "<DIV style='left:472PX;top:790PX;width:269PX;height:30PX;'><span class='fc1-5'>ได้ตรวจสอบงบรายรับสถานพยาบาลแล้วมีเพียงพอ</span></DIV>";	
}	
print "<DIV style='left:435PX;top:819PX;width:269PX;height:30PX;'><span class='fc1-5'>ให้การสนับสนุน จำนวนเงิน $nPriadvat บาท</span></DIV>";
print "<DIV style='left:435PX;top:848PX;width:300PX;height:30PX;'><span class='fc1-5'>$cPriadvat</span></DIV>";
print "<DIV style='left:450PX;top:877PX;width:269PX;height:30PX;'><span class='fc1-5'>$aYot[5]</span></DIV>";
print "<DIV style='left:435PX;top:906PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-5'>($aFname[5])</span></DIV>";
print "<DIV style='left:435PX;top:935PX;width:309PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-5'>$aPost[5]</span></DIV>";
print "<DIV style='left:435PX;top:964PX;width:309PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-5'>$aPost2[5]</span></DIV>";
print "<DIV style='left:435PX;top:993PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-5'>............/............/............</span></DIV>";
...
print"<div style='left:442PX;top:1111PX;border-color:000000;border-style:dashed;border-width:0px;border-top-width:1PX;width:100PX;'></div>";
print"<div style='left:588PX;top:1111PX;border-color:000000;border-style:dashed;border-width:0px;border-top-width:1PX;width:100PX;'></div>";

print"<DIV style='left:194PX;top:1050PX;width:364PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-1'>บัญชีรายการเวชภัณฑ์ที่ขออนุมัติจัดหา </span></DIV>";


print"<DIV style='left:136PX;top:1090PX;width:800PX;height:26PX;' class='fc1-0'>
...
//$x  $tradname $packing  $pack  $amount  $price  $packpri  $specno 
	...
	array_push($aSnspec,$item['snspec']);
       }
	$x++;
    array_push($aX,"");
    ...
    array_push($aSpecno,"");
	array_push($aSnspec,"");
//มีได้ 10 รายการ+หมดรายการ(11แถว) ใส่ NULL ให้array ที่เหลือดังนี้
for ($n=$x+1; $n<=16; $n++){
    array_push($aX,"");
...
<div style="position: absolute; left:10px; top: 1130px; font-family: TH SarabunPSK; font-size: 13pt;">
	<table class="dx_tb">
...
สาย พ. ที่</th>
			...
			for ($ii=1; $ii <= 19; $ii++) { 
				...
				if( $aPart[$ii] == 'DPY' || $aPart[$ii] == 'DPN' ){
					...
					if( $aFreelimit[$ii] > 0 ){
						$cost = $aFreelimit[$ii];  //
						if($aEdpriFrom[$ii]==0){  //ถ้าแหล่งที่มาราคากลางเป็นค่าว่าง
							$from = 3;
					...
					if( $aEdpri[$ii] > 0 ){  //ถ้าราคากลางมากกว่า 0
						$cost = $aEdpri[$ii];
						if($aEdpriFrom[$ii]==0){  //ถ้าแหล่งที่มาราคากลางยังไม่มีการกำหนดค่า
							$from = 3;
						...
						$cost = $aEdpri[$ii];
						if($aEdpriFrom[$ii]==0 && $aEdpriFrom[$ii]!=""){  //ถ้าแหล่งที่มาราคากลางยังไม่มีการกำหนดค่า
							$from = 5;
						}else{  //ถ้าแหล่งที่มามีข้อมูลแล้ว
							$from = $aEdpriFrom[$ii];
						}					
...
//echo "***>".($aSnspec[$ii]);
/*				if(!empty($aSnspec[$ii])){
					$aSnspec[$ii]="<br>(หมายเลขสิ่งอุปกรณ์".$aSnspec[$ii].")";
				}else{
					$aSnspec[$ii]="&nbsp;";
				}*/
				?>
...
//  ช่องเซ็น
print"<DIV style='left:510PX;top:1895PX;width:81PX;height:27PX;'><span class='fc1-0'>ตรวจถูกต้อง</span></DIV>";
print"<DIV style='left:534PX;top:1925PX;width:87PX;height:30PX;TEXT-ALIGN:RIGHT;'><span class='fc1-0'>$aYot[2]</span></DIV>";
print"<DIV style='left:539PX;top:1955PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>($aFname[2])</span></DIV>";

//ตำแหน่ง
print"<DIV style='left:539PX;top:1985PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>$aPost[2] $aPost2[2]</span></DIV>";
...
print"<DIV style='left:57PX;top:2222PX;width:91PX;height:26PX;'><span class='fc1-0'>ขอสั่งซื้อของจาก</span></DIV>
";
print"<DIV style='left:147PX;top:2222PX;width:450PX;height:26PX;'><span class='fc1-0'>
	($cComcode)$cComname&nbsp;&nbsp;&nbsp;$fax</span></DIV>";
	
print"<DIV style='left:616PX;top:2222PX;width:104PX;height:26PX;'><span class='fc1-0'>ดังมีรายการต่อไปนี้</span></DIV>";
if($chkpono=="อ."){
print"<DIV style='left:684PX;top:2167PX;width:61PX;height:27PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>งบอุดหนุน</span></DIV>";
}else{
...
///แถวที่2 2319
print"<DIV style='left:11PX;top:2314PX;width:30PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aX[2]</span></DIV>";
print"<DIV style='left:49PX;top:2314PX;width:250PX;height:22PX;'><span class='fc1-4'> $aTradname[2]</span></DIV>";
print"<DIV style='left:306PX;top:2314PX;width:64PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aPacking[2]</span></DIV>";
print"<DIV style='left:362PX;top:2314PX;width:96PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPack[2]</span></DIV>";
print"<DIV style='left:462PX;top:2314PX;width:50PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aAmount[2]</span></DIV>";
print"<DIV style='left:597PX;top:2314PX;width:79PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPrice[2]</span></DIV>";
print"<DIV style='left:679PX;top:2314PX;width:72PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aSpecno[2]</span></DIV>";
print"<DIV style='left:519PX;top:2314PX;width:63PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPackpri[2]</span></DIV>";
///แถวที่3
print"<DIV style='left:11PX;top:2339PX;width:30PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aX[3]</span></DIV>";
print"<DIV style='left:49PX;top:2339PX;width:250PX;height:22PX;'><span class='fc1-4'> $aTradname[3]</span></DIV>";
print"<DIV style='left:306PX;top:2339PX;width:64PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aPacking[3]</span></DIV>";
print"<DIV style='left:362PX;top:2339PX;width:96PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPack[3]</span></DIV>";
print"<DIV style='left:462PX;top:2339PX;width:50PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aAmount[3]</span></DIV>";
print"<DIV style='left:597PX;top:2339PX;width:79PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPrice[3]</span></DIV>";
print"<DIV style='left:679PX;top:2339PX;width:72PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aSpecno[3]</span></DIV>";
print"<DIV style='left:519PX;top:2339PX;width:63PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPackpri[3]</span></DIV>";
///แถวที่4
	print"<DIV style='left:11PX;top:2364PX;width:30PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aX[4]</span></DIV>";
print"<DIV style='left:49PX;top:2364PX;width:250PX;height:22PX;'><span class='fc1-4'> $aTradname[4]</span></DIV>";
print"<DIV style='left:306PX;top:2364PX;width:64PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aPacking[4]</span></DIV>";
print"<DIV style='left:362PX;top:2364PX;width:96PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPack[4]</span></DIV>";
print"<DIV style='left:462PX;top:2364PX;width:50PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aAmount[4]</span></DIV>";
print"<DIV style='left:597PX;top:2364PX;width:79PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPrice[4]</span></DIV>";
print"<DIV style='left:679PX;top:2364PX;width:72PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aSpecno[4]</span></DIV>";
print"<DIV style='left:519PX;top:2364PX;width:63PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPackpri[4]</span></DIV>";
///แถวที่5
print"<DIV style='left:11PX;top:2389PX;width:30PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aX[5]</span></DIV>";
print"<DIV style='left:49PX;top:2389PX;width:250PX;height:22PX;'><span class='fc1-4'> $aTradname[5]</span></DIV>";
print"<DIV style='left:306PX;top:2389PX;width:64PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aPacking[5]</span></DIV>";
print"<DIV style='left:362PX;top:2389PX;width:96PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPack[5]</span></DIV>";
print"<DIV style='left:462PX;top:2389PX;width:50PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aAmount[5]</span></DIV>";
print"<DIV style='left:597PX;top:2389PX;width:79PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPrice[5]</span></DIV>";
print"<DIV style='left:679PX;top:2389PX;width:72PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aSpecno[5]</span></DIV>";
print"<DIV style='left:519PX;top:2389PX;width:63PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPackpri[5]</span></DIV>";
///แถวที่6
	print"<DIV style='left:11PX;top:2414PX;width:30PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aX[6]</span></DIV>";
print"<DIV style='left:49PX;top:2414PX;width:250PX;height:22PX;'><span class='fc1-4'> $aTradname[6]</span></DIV>";
print"<DIV style='left:306PX;top:2414PX;width:64PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aPacking[6]</span></DIV>";
print"<DIV style='left:362PX;top:2414PX;width:96PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPack[6]</span></DIV>";
print"<DIV style='left:462PX;top:2414PX;width:50PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aAmount[6]</span></DIV>";
print"<DIV style='left:597PX;top:2414PX;width:79PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPrice[6]</span></DIV>";
print"<DIV style='left:679PX;top:2414PX;width:72PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aSpecno[6]</span></DIV>";
print"<DIV style='left:519PX;top:2414PX;width:63PX;height:22PX;TEXT-ALIGN:RIGHT;'>
...
print"<DIV style='left:49PX;top:2439PX;width:250PX;height:22PX;'><span class='fc1-4'> $aTradname[7]</span></DIV>";
...
///แถวที่8
print"<DIV style='left:11PX;top:2464PX;width:30PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aX[8]</span></DIV>";
print"<DIV style='left:49PX;top:2464PX;width:250PX;height:22PX;'><span class='fc1-4'> $aTradname[8]</span></DIV>";
print"<DIV style='left:306PX;top:2464PX;width:64PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aPacking[8]</span></DIV>";
print"<DIV style='left:362PX;top:2464PX;width:96PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPack[8]</span></DIV>";
print"<DIV style='left:462PX;top:2464PX;width:50PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aAmount[8]</span></DIV>";
print"<DIV style='left:597PX;top:2464PX;width:79PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPrice[8]</span></DIV>";
print"<DIV style='left:679PX;top:2464PX;width:72PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aSpecno[8]</span></DIV>";
print"<DIV style='left:519PX;top:2464PX;width:63PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPackpri[8]</span></DIV>";
///แถวที่9
print"<DIV style='left:11PX;top:2489PX;width:30PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aX[9]</span></DIV>";
print"<DIV style='left:49PX;top:2489PX;width:250PX;height:22PX;'><span class='fc1-4'> $aTradname[9]</span></DIV>";
print"<DIV style='left:306PX;top:2489PX;width:64PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aPacking[9]</span></DIV>";
print"<DIV style='left:362PX;top:2489PX;width:96PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPack[9]</span></DIV>";
print"<DIV style='left:462PX;top:2489PX;width:50PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aAmount[9]</span></DIV>";
print"<DIV style='left:597PX;top:2489PX;width:79PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPrice[9]</span></DIV>";
print"<DIV style='left:679PX;top:2489PX;width:72PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aSpecno[9]</span></DIV>";
print"<DIV style='left:519PX;top:2489PX;width:63PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPackpri[9]</span></DIV>";
///แถวที่10
print"<DIV style='left:11PX;top:2514PX;width:30PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aX[10]</span></DIV>";
print"<DIV style='left:49PX;top:2514PX;width:250PX;height:22PX;'><span class='fc1-4'> $aTradname[10]</span></DIV>";
print"<DIV style='left:306PX;top:2514PX;width:64PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aPacking[10]</span></DIV>";
print"<DIV style='left:362PX;top:2514PX;width:96PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPack[10]</span></DIV>";
print"<DIV style='left:462PX;top:2514PX;width:50PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aAmount[10]</span></DIV>";
print"<DIV style='left:597PX;top:2514PX;width:79PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPrice[10]</span></DIV>";
print"<DIV style='left:679PX;top:2514PX;width:72PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aSpecno[10]</span></DIV>";
print"<DIV style='left:519PX;top:2514PX;width:63PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPackpri[10]</span></DIV>";
///แถวที่11
print"<DIV style='left:11PX;top:2539PX;width:30PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aX[11]</span></DIV>";
print"<DIV style='left:49PX;top:2539PX;width:250PX;height:22PX;'><span class='fc1-4'> $aTradname[11]</span></DIV>";
print"<DIV style='left:306PX;top:2539PX;width:64PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aPacking[11]</span></DIV>";
print"<DIV style='left:362PX;top:2539PX;width:96PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPack[11]</span></DIV>";
print"<DIV style='left:462PX;top:2539PX;width:50PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aAmount[11]</span></DIV>";
print"<DIV style='left:597PX;top:2539PX;width:79PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPrice[11]</span></DIV>";
print"<DIV style='left:679PX;top:2539PX;width:72PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aSpecno[11]</span></DIV>";
print"<DIV style='left:519PX;top:2539PX;width:63PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPackpri[11]</span></DIV>";
///แถวที่12
print"<DIV style='left:11PX;top:2564PX;width:30PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aX[12]</span></DIV>";
print"<DIV style='left:49PX;top:2564PX;width:250PX;height:22PX;'><span class='fc1-4'> $aTradname[12]</span></DIV>";
print"<DIV style='left:306PX;top:2564PX;width:64PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aPacking[12]</span></DIV>";
print"<DIV style='left:362PX;top:2564PX;width:96PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPack[12]</span></DIV>";
print"<DIV style='left:462PX;top:2564PX;width:50PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aAmount[12]</span></DIV>";
print"<DIV style='left:597PX;top:2564PX;width:79PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPrice[12]</span></DIV>";
print"<DIV style='left:679PX;top:2564PX;width:72PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aSpecno[12]</span></DIV>";
print"<DIV style='left:519PX;top:2564PX;width:63PX;height:22PX;TEXT-ALIGN:RIGHT;'>
...
print"<DIV style='left:49PX;top:2589PX;width:250PX;height:22PX;'><span class='fc1-4'> $aTradname[13]</span></DIV>";
...
///แถวที่14
print"<DIV style='left:11PX;top:2614PX;width:30PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aX[14]</span></DIV>";
print"<DIV style='left:49PX;top:2614PX;width:250PX;height:22PX;'><span class='fc1-4'> $aTradname[14]</span></DIV>";
print"<DIV style='left:306PX;top:2614PX;width:64PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aPacking[14]</span></DIV>";
print"<DIV style='left:362PX;top:2614PX;width:96PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPack[14]</span></DIV>";
print"<DIV style='left:462PX;top:2614PX;width:50PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aAmount[14]</span></DIV>";
print"<DIV style='left:597PX;top:2614PX;width:79PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPrice[14]</span></DIV>";
print"<DIV style='left:679PX;top:2614PX;width:72PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aSpecno[14]</span></DIV>";
print"<DIV style='left:519PX;top:2614PX;width:63PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPackpri[14]</span></DIV>";	
///แถวที่15
print"<DIV style='left:11PX;top:2639PX;width:30PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aX[15]</span></DIV>";
print"<DIV style='left:49PX;top:2639PX;width:250PX;height:22PX;'><span class='fc1-4'> $aTradname[15]</span></DIV>";
print"<DIV style='left:306PX;top:2639PX;width:64PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aPacking[15]</span></DIV>";
print"<DIV style='left:362PX;top:2639PX;width:96PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPack[15]</span></DIV>";
print"<DIV style='left:462PX;top:2639PX;width:50PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aAmount[15]</span></DIV>";
print"<DIV style='left:597PX;top:2639PX;width:79PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPrice[15]</span></DIV>";
print"<DIV style='left:679PX;top:2639PX;width:72PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aSpecno[15]</span></DIV>";
print"<DIV style='left:519PX;top:2639PX;width:63PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPackpri[15]</span></DIV>";	
//แถวที่16
print"<DIV style='left:11PX;top:2664PX;width:30PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aX[16]</span></DIV>";
print"<DIV style='left:49PX;top:2664PX;width:250PX;height:22PX;'><span class='fc1-4'> $aTradname[16]</span></DIV>";
print"<DIV style='left:306PX;top:2664PX;width:64PX;height:22PX;TEXT-ALIGN:CENTER;'>
	<span class='fc1-4'>$aPacking[16]</span></DIV>";
print"<DIV style='left:362PX;top:2664PX;width:96PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aPack[16]</span></DIV>";
print"<DIV style='left:462PX;top:2664PX;width:50PX;height:22PX;TEXT-ALIGN:RIGHT;'>
	<span class='fc1-4'>$aAmount[16]</span></DIV>";
print"<DIV style='left:597PX;top:2664PX;width:79PX;height:22PX;TEXT-ALIGN:RIGHT;'>
...
print"<DIV style='left:597PX;top:2739PX;width:79PX;height:26PX;TEXT-ALIGN:RIGHT;'><span class='fc1-0'>$nNetprice</span></DIV>";
...
?>
<div class="sarabun">
<div class="report-title">ยอดคงเหลือและอัตราการใช้รายการที่ต้องจัดหาย้อนหลัง 3 เดือน</div>
<br>
<br>
  <table class="table-dashed" width="100%" border="1" cellspacing="0" cellpadding="5" style="border-collapse:collapse;border-style:dashed;">
    <tr style="font-weight:bold;">
      <th width="7%">ลำดับ</th>
	  <th width="13%">รหัสยา</th>
      <th width="20%">ชื่อการค้า</th>
      <th width="12%">ยอดในคลัง</th>
      <th width="12%">ห้องจ่าย</th>
      <th width="12%">รวมทั้งหมด</th>
      <th width="12%">ใช้/เดือน</th>
	  <th width="12%">เหลือเดือน</th>
    </tr>	
    <?
	$date=date('Y-m-d');	
	...
	$date_thai = "$year-$month-$day";	
	
	list($y, $m, $d) = explode('-', $lastmonth); // แยกส่วนปี เดือน วัน
	$y += 543; // แปลงปี ค.ศ. → พ.ศ.
	$lastmonth_thai = "$y-$m-$d";	
    ...
    while($rows = mysql_fetch_array($result)){
		$i++;
		$sql1="select sum(stkcut) as amount from stktranx where drugcode = '".$rows["drugcode"]."' and getdate between '$lastmonth' and '$date' ";
		//echo $sql1;
		...
		$rows["drugcode"]=="2SUCC" || $rows["drugcode"]=="2EYLEA"){  //เอาจากเบิกจากคลังยา
			...
			$sql1="SELECT SUM(dr.amount) as total_amount
                         FROM ddrugrx dr
                         INNER JOIN dphardep dh ON dr.idno = dh.row_id
                         LEFT JOIN druglst d ON dr.drugcode = d.drugcode
                         WHERE dr.drugcode = '".$rows["drugcode"]."' and (dh.date >= '$lastmonth_thai 00:00:00' and dh.date <='$date_thai 23:59:59')
                         AND dh.stkcutdate != ''
                         AND (dh.dr_cancle IS NULL OR dh.dr_cancle = '')";
			//echo $sql1."<br>";
			$query1=mysql_query($sql1);
			list($opd_amount)=mysql_fetch_array($query1);	

			$sql2="SELECT SUM(amount) as amount
                         FROM ipacc
                         WHERE code = '".$rows["drugcode"]."' and depart='PHAR' and (date >= '$lastmonth_thai 00:00:00' and date <='$date_thai 23:59:59')";
			//echo $sql2."<br>";
			$query2=mysql_query($sql2);
			list($ipd_amount)=mysql_fetch_array($query2);	
			
			$sum_amount=$opd_amount+$ipd_amount;
			
			$rxrate3m=$sum_amount/3;		
			$nMonth_new=$rows["totalstk"]/$rxrate3m;	
		}	
    ?>
      <tr>
        ...
        <td align="right"><?=number_format($rows["stock"]);?></td>
        <td align="right"><?=number_format($rows["totalstk"]);?></td>
        <td align="right"><?=number_format($rxrate3m,2);?></td>
		<td align="right"><?=number_format($nMonth_new,2);?></td>
      </tr>
    <? } ?>
  </table>
</div>
