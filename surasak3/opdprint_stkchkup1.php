...
$query = "SELECT vn,ptright FROM opday WHERE thdatehn = '$thdatehn' Order by row_id DESC limit 0,1 ";
$result1 = mysql_query($query) or die("Query failed,opday");
...
print "<head>";print "<STYLE>"; print "A {text-decoration:none}"; print "A IMG {border-style:none; border-width:0;}"; print "DIV {position:absolute; z-index:25;}";print ".fc1-0 { COLOR:000000;FONT-SIZE:18PT;FONT-FAMILY:Cordia New;FONT-WEIGHT:BOLD;}";print ".fc1-1 { COLOR:000000;FONT-SIZE:16PT;FONT-FAMILY:Cordia New;FONT-WEIGHT:NORMAL;}";print ".fc1-2 { COLOR:000000;FONT-SIZE:14PT;FONT-FAMILY:Cordia New;FONT-WEIGHT:BOLD;}";
print ".fc1-3 { COLOR:000000;FONT-SIZE:12PT;FONT-FAMILY:Cordia New;FONT-WEIGHT:NORMAL;}";
print ".fc1-99 { COLOR:000000;FONT-SIZE:20PT;FONT-FAMILY:3 of 9 barcode;FONT-WEIGHT:NORMAL;}";print ".ad1-0 {border-color:000000;border-style:none;border-bottom-width:0PX;border-left-width:0PX;border-top-width:0PX;border-right-width:0PX;}";print ".ad1-1 {border-color:000000;border-style:none;border-bottom-width:0PX;border-left-width:0PX;border-top-width:0PX;border-right-width:0PX;}";print "</STYLE>";print "<TITLE>Crystal Report Viewer</TITLE>";print "</head>";print "<BODY BGCOLOR='FFFFFF' TOPMARGIN=0 BOTTOMMARGIN=0 RIGHTMARGIN=0 LEFTMARGIN='0'>";

print  "<DIV align='center' style='top:0PX;height:50PX;'><span class='fc1-1'>วัน/เดือน/ปี: $Thaidate</span></DIV>";
print "<DIV align='center' style='top:30PX;height:50PX;'><span class='fc1-0'>HN: $vHN</span><span class='fc1-0' style='margin-left: 50px;'>VN: $vn</span></DIV>";
print "<DIV align='center' style='top:60PX;height:50PX;'><span class='fc1-0'>$ptname</span></DIV>";
print "<DIV align='center' style='top:90PX;height:50PX;'><span class='fc1-1 '>ID:$idcard</span></DIV>";
print "<DIV align='center' style='top:110PX;height:50PX;'><span class='fc1-1'>$ptright</span></DIV>";
print "<DIV align='center' style='top:130PX;height:50PX;'><span class='fc1-1'>$camp</span></DIV>";
//print "<DIV align='center' style='top:130PX;height:60PX;'><span class='fc1-0'><img src = \"opdprintbc.php?cHn=$idcard\"></span></DIV>";
print "</BODY></HTML>";
