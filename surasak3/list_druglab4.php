...
<?php if('$sHn' != ""){
	...
	$sql = "Select hn, yot , name , surname , idcard, ptright  From opcard where hn = '$sHn' limit 1";
	$result = Mysql_Query($sql);
	list( $hn, $yot , $name , $surname , $idcard, $ptright) = Mysql_fetch_row($result);
	
echo "รายการยาทั้งหมด$sHn<BR><TABLE style=\"font-family:'MS Sans Serif'; font-size:10px;\">
<TR  style=\"font-family:'MS Sans Serif'; font-size:10px;\">
	<TD>ชื่อ : ",$yot ," ", $name," " , $surname," Hn : '$rxHn'</TD>
</TR>
<TR  style=\"font-family:'MS Sans Serif'; font-size:10px;\">
...
<?php
$sum2 = 0;
$sql = "Select a.tradname, a.amount, a.part, a.price, b.salepri, date_format(a.date,'%d-%m-%Y') as date ,a.slcode From drugrx as a LEFT JOIN druglst as b ON a.drugcode = b.drugcode where a.date like '".$select_day."%' AND a.hn ='$rxHn'' ";
