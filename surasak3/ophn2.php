...
$hn = isset($_POST['hn']) ? trim($_POST['hn']) : false ;
?>
    ...
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; HN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <table>
            ...
            if(!empty($hn)){
                ...
                $query = "SELECT `hn`,`yot`,`name`,`surname`,`ptright`,`ptright1`,`idcard` 
                FROM `opcard` 
                WHERE `hn` = '$hn'";
                ...
                while( list($hn,$yot,$name,$surname,$ptright,$ptright1,$idcard) = mysql_fetch_row($result)) {
                    ...
                    print (" <tr>\n".
                    "  <td BGCOLOR=".$color."><a onclick=\"checkIpd(this, event, '".$hn."')\" target=_BLANK  href=\"opedit.php? cHn=$hn & cName=$name &cSurname=$surname\">$hn</a></td>\n".
                                ...
                                function checkIpd(link, ev, hn){
                                    ...
                                    newSm.ajax(
                                    	...
                                    	function(res){
                                            ...
                                            if( txt.state === 400 ){
                                                alert('ผู้ป่วยยังอยู่ '+txt.msg+' กรุณาติดต่อที่ ward');
                                            }else{
