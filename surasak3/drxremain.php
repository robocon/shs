...
$num='0';
    ...
    list($salepri,$tradname,$drugcode,$amount,$price,$slcode,$drugcode,$oldpart,$drug_inject_amount,$drug_inject_unit,$drug_inject_amount2,$drug_inject_unit2,$drug_inject_time,$drug_inject_slip,$drug_inject_type,$drug_inject_etc,$reason,  $detail1, $detail2, $detail3, $detail4,$drugorderdr) = mysql_fetch_row ($result);
		$num++;
        ...
        print (" <tr>\n".
           ...
           "  <td align='right'><font face='Angsana New'  >&nbsp;ราคา&nbsp;$pricenostk<br></td>\n".
			    " </tr>\n".
		   " <tr>\n".
			  "  <td align='right'><font face='Angsana New'  size='2'>&nbsp;&nbsp;&nbsp;$oldpart</td>\n".
...
$result2 = Mysql_Query($sql3);
	...
	if($result){ 
		...
		if($drugcode=="4MET25"){
		$query = "INSERT INTO ddrugrx(date,hn,drugcode,tradname,amount,price,item,slcode,part,idno, salepri, freepri, drug_inject_amount,drug_inject_unit, drug_inject_amount2,drug_inject_unit2,drug_inject_time,drug_inject_slip, drug_inject_type, drug_inject_etc,reason,DPY , DPN ,date_notsk ) VALUES ('0000-00-00 00:00:00','".$rxHn."','".$drugcode."','".$tradname."','".$nostk."','".($nostk*$salepri)."','1','".$slcode."','".$oldpart."','".$idno."','".$salepri."','".$freepri."','".$drug_inject_amount."','".$drug_inject_unit."','".$drug_inject_amount2."','".$drug_inject_unit2."','".$drug_inject_time."','".$drug_inject_slip."','".$drug_inject_type."','".$drug_inject_etc."','".$reason."','".($dg_dsy*$nostk)."','".($dg_dsn*$nostk)."','".$today."')";
		}else{
