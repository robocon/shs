<?php
?>
<form method="POST" action="xr1day.php" >
  <p>&nbsp;<font face="Angsana New"><font size="4"><b>
 รายงานจำนวนการตรวจของแผนกรังสีต่อวัน</b></font></font></p>
  <p><font face="Angsana New"><font size="3">
 (วันที่ 01,02,....30,31  ถ้าไม่มีวันที่ จะเป็นข้อมูลต่อเดือน)</font></font></p>
  <font face="Angsana New">วันที่&nbsp;&nbsp;<input type="text" name="appdate" size="2"><? $m=date('m'); ?>
