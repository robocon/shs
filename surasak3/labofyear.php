...
<input name="pro" type="radio" id="pro3" value="3" <? if(substr($age,0,2) >= 35){ echo "checked='checked'";}?> />
 โปรแกรม 3 (อายุตั้งแต่ 35 ปีขึ้นไป)<br />
<input type="hidden" value="<?=$rep['hn']?>" name="hn" />
<input name="okbtn" type="submit" class="txtsarabun" value="  ตกลง  "/>
  </span>
&nbsp;&nbsp;<span class="tb_font">
...
//หาข้อมูลจาก opcard ของ $cHn เพื่อใช้ทั้งในกรณีลงทะเบียนแล้ว หรือยังไม่ลง
	...
	echo "<a href='labofyeartranx.php?pro=$_POST[pro]' target='_blank'>หมดรายการใบแจ้งหนี้</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='labslip4bc_chkup_solider.php' target='_blank'>สติ๊กเกอร์</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='labslip4cbc_chkup_solider.php' target='_blank'>สติ๊กเกอร์ CBC</a>
&nbsp;&nbsp;&nbsp;&nbsp;<a href='labslip4ua_chkup_solider.php' target='_blank'>สติ๊กเกอร์ UA</a><br><br></span>";
