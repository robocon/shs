...
//insert data into pocompany
       ...
       $result = mysql_query($query) or 
                ...
                -------- รายการจ่าย ---------<br> 
                $Thidate<br>
                ($cComcode)$cComname  จำนวนรายการที่สั่ง $item รวมเงินทั้งสิ้น $nNetprice บาท<br><BR><BR><BR><BR><a target=_BLANK href='podgbill.php'>พิมพ์รายการสั่งซื้อ</a>  || <a target=_BLANK href='podgbill_new61.php'>พิมพ์รายการสั่งซื้อ(แบบใหม่)</a>");
...
สาย พ. ที่</th>
		...
		<tbody>
			...
			for ($ii=1; $ii <= 14; $ii++) { 
				...
				if( $part == 'DPY' OR $part == 'DPN' ){  //อุปกรณ์
				...
				<tr>
					...
					<td align="center"><?=$showfrom;?></td>  <!--แหล่งที่มาของราคากลาง-->
					<td align="right"><?=( !empty($aPackpri_vat[$ii]) ? $aPackpri_vat[$ii] : '&nbsp;' );?></td><!--หน่วยละรวม VAT-->
					<td align="right"><?=( !empty($aTotalprice) ? number_format($aTotalprice,2) : '&nbsp;' );?></td><!--ราคารวม VAT-->
					<td class="last_child" align="center"><?=( !empty($aSpec[$ii]) ? $aSpec[$ii] : '&nbsp;' );?></td>
				</tr>
