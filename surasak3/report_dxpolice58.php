...
return $pAge;
	...
	$select = "SELECT  a.row, a.exam_no, a.idcard, a.dbirth, a.agey, b.hn, b.ptname, b.weight, b.height, b.bp1, b.bp2, b.p, b.cxr FROM opcardchk AS a INNER  JOIN out_result_chkup AS b ON a.HN = b.hn WHERE a.part ='สอบตำรวจ58-2' order by b.row_id";
	//echo $select;	
...
<table width="100%" border="0">
  <tr>
    <td colspan="2"><table width="100%">
      ...
      <tr>
        <td align="center" valign="top" class="text1">ตรวจเมื่อวันที่  25 กันยายน 2558</td>
        </tr>
    </table></td>
  </tr>
  <tr>
    ...
    <td colspan="2"  valign="top"><table width="100%" border="1" style="border-collapse:collapse;" bordercolor="#000000" cellpadding="0" cellspacing="0">
      <tr>
        <td><table width="100%"  class="text1" >
            ...
            <tr>
              <td width="219" valign="top"><span class="text3"><strong>น้ำหนัก: </strong>
                    <?=$result['weight']?>
                กก.</span></td>
              <td width="212"  valign="top"><span class="text3"><strong>ส่วนสูง:</strong>
                    <?=$result['height']?>
                ซม.</span></td>
...
<?=$authorisedate?> CXR : </strong>ร.ท.วริทธิ์ พสุธาดล (ว.38228) รังสีแพทย์<strong> (01-10-2015)</strong></td>
