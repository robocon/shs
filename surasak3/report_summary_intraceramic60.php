...
?>	
<body>
<div align="center"><strong>ผลการตรวจสุขภาพเจ้าหน้าที่ บริษัท อินทราเซรามิค จำกัด โรงพยาบาลค่ายสุรศักดิ์มนตรี บริการตรวจสุขภาพ ณ บริษัท อินทราเซรามิค จำกัด</strong></div>
<div align="center"><strong>ในวันที่ 20 กรกฎาคม 2560 จำนวน 145 ราย</strong></div>
...
<?
$sql="SELECT  *  FROM opcardchk WHERE part='อินทราเซรามิค60' and active='y' order by row";
//echo $sql."<br>";
