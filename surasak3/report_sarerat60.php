...
<?php
include("connect.inc");	
$showpart = 'สรีรัตน์เหมืองแร่60';
// $sql1 = "SELECT *
// FROM `opcardchk`
// WHERE `part` = '$showpart' and active='y'
// ORDER BY `row` ASC";

$sql1="select * from out_result_chkup where part='$showpart' #and hn != '60-5859'";
...
while($result = mysql_fetch_array($row2)){
	...
	where a.hn = '".$result["hn"]."' 
	and a.part = '".$result["part"]."'";
  ...
  <tr>
    <td colspan="2"><table width="100%">
      <tr>
        ...
        <td width="77%" align="center" valign="top" class="texthead"><strong>แบบรายงานผลการตรวจสุขภาพประจำปี 2560<br>หน่วยงาน : สรีรัตน์เหมืองแร่</strong></td>
			...
			<td height="30" width="60%">
				...
				<table>
					...
					<tr valign="middle">
						...
						<td>
							<strong class="text" style="margin-left: 9px;"> : <? if($result2["cxr"]==""){ echo "ปกติ"; }else{ echo $result2["cxr"];} ?></strong>
						</td>
					</tr>
					<? //} ?>
					<?php
