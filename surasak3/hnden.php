...
$thdatehn=$d.'-'.$m.'-'.$yr.$hn;
 ...
 list($xxx,$yyy,$zzz) = Mysql_fetch_row($result);
	...
	//print "$vnlab";
    print "<br><a href='hnden.php?hn=".$xxx."&confirm=true'>!ชื่อถูกต้อง ทำรายการต่อไป</a>";
...
//EX07 ทันตกรรม
$query = "SELECT count(hn) FROM opday2 WHERE thdatehn = '$thdatehn' AND (left(toborow,4) = 'EX07'  ) Order by row_id DESC limit 1 ";
$result = Mysql_Query($query);
