				...
				<TABLE width="903" border="0" align="center" cellpadding="0" cellspacing="2">
					...
					?>
						<TR bgcolor="<?php echo $bgcolor; ?>">
							...
							<TD align="center"><A HREF="dt_lab_lst_in1.php?lab_date=<?php echo urlencode($arr["dateresult"]); ?>&hn_now=<?php echo $hn_now; ?>&labnumber=<?= $arr['labnumber']; ?>" target="_blank">ดูข้อมูล</A></TD>
