...
<table  border="0" align="center"  width="100%">
  ...
  <tr>
    <td align="right" class="font16" >เลขที่&nbsp;&nbsp;&nbsp;<?=$arrrunno['runno'];?>/<?=$arrrunno['prefix'];?><!--เล่มที่ &nbsp;&nbsp;<?//=$arrrunno['prefix'];?>/01&nbsp;&nbsp;&nbsp;<u>ใบรับรองการใช้ยานอกบัญชียาหลักแห่งชาติ</u>-->
  ...
  <tr>
    <td><span class="font16"> <?=$cPtname;?>&nbsp;&nbsp;HN: <?=$cHn;?> AN:  <?=$an;?> &nbsp;&nbsp; ซึ่งมารับการตรวจรักษา ณ โรงพยาบาลค่ายสุรศักดิ์มนตรี <BR />
   เมื่อวันที่  <?=$cDate;?> ถึง <?=$cDcdate;?> จำนวน <?=$nDay;?> วัน</span></td>
  </tr>
  <tr>
