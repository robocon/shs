...
<?php
    ...
    $query = "SELECT date,ptname,hn,an,price,paid,row_id,accno,dgtake,borrow,tvn  FROM phardep WHERE date LIKE '$today%' and price > 0  and borrow is null  order by date   ";
	echo $query;
