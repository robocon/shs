...
-->
  ...
  $selmon=date("m");
  ?>
<form method="POST" action="databangkok/exportdatabangkok.php">
<p><strong>โปรแกรมส่งเบิกค่าชดเชยทางการแพทย์ผู้ป่วยนอก สิทธิข้าราชการ กทม. (ECD-BANGKOK)<br />
ผู้พัฒนาระบบ&nbsp;&nbsp;&nbsp;ส.อ. เทวิน ศรีแก้ว เจ้าหน้าที่ศูนย์บริการคอมพิวเตอร์&nbsp;&nbsp;&nbsp;โทร. 8500<br />
<div style="color:#FF0000">เริ่มใช้ตั้งแต่วันที่ 1 เดือนกรกฎาคม พ.ศ.2565 เป็นต้นไป (last update : 2022-07-01)</div></strong>
</p>
