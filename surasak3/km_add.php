...
<tr><td class="style51"  bgcolor="#FFFFCC" width="100%">ไฟล์เอกสาร : <input type="file" name="attach[]" id="attach_0" size="50" />
...
VALUES ('',  '".$_POST['doc_id']."',  '".$_POST['type']."',  '".$_POST['depart']."',  '".$_POST['doc_name']."',  '".$_POST['post_name']."',  '".date("Y-m-d H:i:s")."')";
