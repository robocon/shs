...
<script language="javascript">
	...
	function fncSubmit() {
		...
		if (fn.type.selectedIndex == 0) {
			alert('กรุณาระบุประเภท KM ด้วยครับ');
			fn.type.focus();
			return false;

		}
		if (fn.depart.selectedIndex == 0) {
			alert('กรุณาระบุชื่อทีมด้วยครับ');
			fn.depart.focus();
			return false;
...
?>
<form action="km_add.php" method="post" enctype="multipart/form-data" name="f1" id="f1" onSubmit="JavaScript:return fncSubmit()">
	<table width="765" border="0" align="center" class="fontthai" bgcolor="#FFCC99">
		...
		<tr>
			<td class="style51">ประเภท KM :</td>
			<td><select name="type" size="1" class="style5">
		...
		<tr class="style51">
			<td>เลขที่องค์ความรู้ :</td>
			<td><input name="doc_id" type="text" id="doc_id" size="30" maxlength="100" readonly="readonly" value="<?= $id_max; ?>" /></td>
		</tr>
		<tr class="style51">
			<td width="14%">ชื่อองค์ความรู้ :</td>
			<td width="86%"><input name="doc_name" type="text" id="doc_name" size="70" maxlength="100" />
				*</td>
		</tr>
		<tr class="style51">
			<td colspan="2">
		...
		<tr class="style51">
			<td colspan="2">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" id="tbl" onclick="init()" align="center" valign='top' bgcolor="#FFFFCC">
					<tr>
						<td class="style51" bgcolor="#FFFFCC" width="100%">ไฟล์เอกสาร : <input type="file" name="attach[]" id="attach_0" size="50" />
		...
		<tr>
			...
			<td><input name="Submit" type="submit" class="style13" value="บันทึกข้อมูล" />
				...
				<div align="center"><a href="../nindex.htm" class="forntsarabun">กลับเมนูหลัก </a> &nbsp;&nbsp; <a href="km_Search2.php" class="forntsarabun">ค้นหาเอกสาร </a> || <a href="km_index.php">เอกสารตามประเภท</a></div>
			</td>
		</tr>
	</table>
</form>
...
if (isset($_POST['doc_id'])) {
	...
	$sql = "INSERT INTO  `km` (  `row_id` ,  `doc_id` ,  `type` , `depart` ,  `doc_name` ,  `post_name` ,  `doc_date` ) 
VALUES (NULL,  '" . $_POST['doc_id'] . "',  '" . $_POST['type'] . "',  '" . $_POST['depart'] . "',  '" . $_POST['doc_name'] . "',  '" . $_POST['post_name'] . "',  '" . date("Y-m-d H:i:s") . "')";
