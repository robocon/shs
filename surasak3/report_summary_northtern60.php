...
?>	
<body>
<div align="center"><strong>ผลการตรวจสุขภาพเจ้าหน้าที่ บริษัท นอร์ทเทิร์น แมททีเรียล แอนด์ คอนกรีต จำกัด  บริการตรวจสุขภาพ ณ โรงพยาบาลค่ายสุรศักดิ์มนตรี</strong></div>
<div align="center"><strong>ระหว่างวันที่ 21-23 กรกฎาคม 2560 จำนวน 8 ราย</strong></div>
...
<?
$sql="SELECT  *  FROM opcardchk WHERE part='นอร์ทเทิร์น60' and active='y' order by row";
//echo $sql."<br>";
