...
<TABLE>
		 <TR>
		 <TD align='right'>&nbsp;&nbsp;<INPUT TYPE='radio' NAME='credit' VALUE='ติดC' onclick="document.getElementById('detail1').innerHTML='รหัสที่ติด'; detailhead1.style.display='';document.f1.detail_1.focus();"></TD>
		 	<TD>ติดC</TD>
		 	<TD align='right'>&nbsp;&nbsp;<INPUT TYPE='radio' NAME='credit' VALUE='ยกเลิกc' onclick="document.getElementById('detail1').innerHTML=''; detailhead1.style.display='none';document.f1.detail_1.value='';"></TD>
