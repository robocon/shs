...
if( $user_code !== 'ADM' ){
    ...
    $check_user = in_array($user_id, array('วนิดาดา','สงคราม','รุ่งทิวา','อมรรัตน์','ภูมิพัฒน์','กฤตย์ตนันต์','รัฐปริญญ์','ศิวาพร','ณัชชา'));  //รับคำสั่ง หน.คลังยา วันที่ 17/03/65 // เพิ่ม ศิวาพร,ณัชชา 2563-05-14
