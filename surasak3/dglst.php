...
if( $user_code !== 'ADM' ){
    ...
    $check_user = in_array($user_id, array('พรทิพา','อรัญญา','วนิดาดา','สงคราม','รุ่งทิวา','อมรรัตน์','ภูมิพัฒน์','ภัททิยา','กฤตย์ตนันต์'));  //รับคำสั่ง หน.กองเภสัชกรรม วันที่ 27/12/60 // เพิ่ม ภัททิยา 2563-05-14
