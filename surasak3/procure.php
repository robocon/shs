...
if(isset($_GET["action"]) && $_GET["action"] == "dgcode"){
	...
	$sql = "Select drugcode,tradname,genname,unit,part from druglst  where  drugcode like '%".$_GET["search1"]."%' limit 10 ";
...
<form method="POST" action="dgprocure.php">
  ...
  <p><font face="Angsana New"><b>&#3619;&#3627;&#3633;&#3626;&nbsp;&nbsp;<Div id="list" style="left:150PX;top:70PX;position:absolute;"></Div><input type="text" name="dgcode"  id="dgcode" size="15" onKeyPress="searchSuggest(this.value,2,'dgcode');">&nbsp;&nbsp;&nbsp;&nbsp;<a target=_BLANK href='drugcode.php'>(ดูรหัส)</a>&nbsp;&nbsp; </b></font></p>
