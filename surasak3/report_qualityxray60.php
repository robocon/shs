...
<center>
<span class="tet1">พิมพ์ใบตรวจสุขภาพ XRAY บริษัทควอลิตี้เซรามิค</span><br />
  <br />
...
<?
	include("connect.inc");	
	$sql="SELECT  * FROM opcardchk  WHERE part='ควอลิตี้60' and course='xray'  order by exam_no";
	//echo $sql;
...
<table width="100%" border="0">
  <tr>
    <td><table width="100%">
      <tr>
        <td width="9%" rowspan="4" align="center" valign="top" class="texthead"><img src="logo.jpg" alt="" width="101" height="96" /></td>
        <td width="77%" align="center" valign="top" class="texthead"><strong>แบบรายงานการตรวจสุขภาพประจำปี 2560</strong></td>
        <td width="14%" align="center" valign="top" class="texthead">&nbsp;</td>
      </tr>
      <tr>
        <td align="center" valign="top" class="texthead"><strong class="text2">โรงพยาบาลค่ายสุรศักดิ์มนตรี อ.เมือง จ.ลำปาง โทร.054-839305 หรือ 093-2744550</strong></td>
        <td align="center" valign="top" class="texthead">&nbsp;</td>
      </tr>
      <tr>
        <td align="center" valign="top" class="texthead"><strong class="text2">บริษัทควอลิตี้เซรามิค</strong></td>
        <td align="center" valign="top" class="texthead">&nbsp;</td>
      </tr>
      <tr>
...
?>      
      <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse; border-top-style:none;">
        ...
        <tr>
          <td><strong class="text" style="font-size:18px">ผลการตรวจเอกซ์เรย์ (X-RAY) : &nbsp;ปกติ</strong></td>
        </tr>        
        <tr>        </tr>
    </table>    </td>
  </tr>
