...
//ตัดค่าฉึดยาทิ้ง
    ...
    for ($n=1; $n<=$x; $n++){
         If (!empty($aSlipcode[$n])){
           print "<font face='AngsanaUPC' size='1'><br>$Thaidate&nbsp;(vn$tvn).NO.$n/$injcount #<br></font>";
           print "<font face='IrisUPC' size='3'>ชื่อ:&nbsp;$cPtname&nbsp;<B></B><font face='AngsanaUPC' size='2'>HN:&nbsp;</B>$cHn<br></font>";
//         print "<font face='AngsanaUPC' size='1'>$aTrade[$n],$aDgcode[$n],$aAmount[$n]<br></font>";
           $aTrade[$n]=substr($aTrade[$n],0,22);
           print "<font face='AngsanaUPC' size='2'>ยา:&nbsp;$aTrade[$n]&nbsp;<font face='Iris UPC' size='1'>($aDgcode[$n])&nbsp;<font face='Iris UPC' size='2'>จำนวน:&nbsp;<B>$aAmount[$n]</B><br></font>";
           print "<font face='IrisUPC' size='2'>$aDetail1[$n]<br></font>";
           print "<font face='IrisUPC' size='2'>$aDetail2[$n]<br></font>";

           if ($n==$x){
                      print "<font face='IrisUPC' size='2'>$aDetail3[$n]<br></font>";
			    print "<font face='IrisUPC' size='2'><B>$aDrugnote[$n]</B></font>";
		   ...
		   print "<font face='Iris UPC' size='2'>$aDetail4[$n]<br></font>";
         	}
	}
