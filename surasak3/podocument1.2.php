<?php
    $yym=$thiyr.'-'.$rptmo;
    print "<font face='Angsana New'><b>ทำเอกสารการสั่งซื้อยาและเวชภัณฑ์  ประจำเดือน $yym  </b>&nbsp;&nbsp;&nbsp;<a target=_top  href='../nindex.htm'><< ไปเมนู</a>&nbsp;&nbsp;&nbsp;<a target=_top  href='pomonth2.php'><< ไปเลือกเดือน</a><br>";
...
If (!empty($yym)){
  ...
  "  <td BGCOLOR=66CDAA><font face='Angsana New'>$comcode</td>\n".
           ...
           "  <td BGCOLOR=66CDAA><font face='Angsana New'><a target=_BLANK  href=\"poprn.php? 	nRow_id=$row_id\">หลัง</a></td>\n".
