...
if($aSnspec[$n]!=''){$aSnspec1[$n]='('.$aSnspec[$n].')';}
        ...
        print("<tr>\n".
                ...
                "<td bgcolor=F5DEB3><font face='Angsana New'>".number_format($aPrice_vat[$n],2)."</td>\n".  
...
<?php
     echo " รวมเงินสุทธิ "; echo number_format($Netprice_vat,2); echo " บาท<br>";
?>
<SCRIPT LANGUAGE="JavaScript">
   ...
   <!--<a target=_BLANK href="podgtranx.php">บันทึกรายการสั่งซื้อและพิมพ์</a>
    &nbsp;&nbsp;&nbsp;--><a target=_BLANK href="podgtranx_new61.php">บันทึกรายการสั่งซื้อและพิมพ์ (แบบใหม่)</a>
