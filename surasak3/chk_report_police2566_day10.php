...
$company['name'] = 'ตรวจสุขภาพตำรวจ 10 กรกฎาคม 2566';
...
$xraydate ="10-07-2023";
$dateCheckUp = '10 กรกฎาคม 2566';
$part = 'ศูนย์ฝึกอบรมตำรวจภูธร ภาค 5 (1)66';
$clinicalinfo = 'ตรวจสุขภาพประจำปี66';
...
$sql1="select a.*, a.`HN` AS `hn` 
from ( 
select * from opcardchk where part = '$part'  order by row asc 
) as a 
left join 
( select * 
from log_opcardchk 
where log_part = '$part'  )
as b on b.log_hn = a.HN 
...
while($result = mysql_fetch_assoc($row2)){
	...
	// ของปี 65 มันมีปัญหาก็คือ LIS ทำข้อมูลหายตอนมาซ่อมบำรุง เลยต้องดีดข้อมูลเข้าไปใหม่
	$hnLab = '6504'.substr($hn,2);
	...
	// CBC UA STOOL METAMP WET HIV VDRL
	...
	<tr>
		<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				AND hn = '$hn' AND `clinicalinfo` = '$clinicalinfo' 
				GROUP BY hn 
