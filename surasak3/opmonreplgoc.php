...
//    $chkdate=($chkdate).date(" H:i:s"); 
    ...
    $today="$d-$m-$yr";
    $repdate=$today; 
    print "<p><a href='opmonrepcscdc.php'>ติด C จ่ายตรง</a> || ติด C จ่ายตรง อปท.</p>";      	  
    print "บัญชีรายรับผู้ป่วยนอก จ่ายตรง อปท. ที่ติด C ";
...
session_register("credit_8");
    ...
    $query = "SELECT * FROM opacc WHERE  credit = 'ติดCอปท.' order by credit_detail  ";
