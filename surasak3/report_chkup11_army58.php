...
<form name="form1" method="post" action="report_chkup11_army58.php" >
...
$sql1="SELECT *
FROM `condxofyear_so`
WHERE `yearcheck` = '$nPrefix2' AND `camp1` like 'D%' group by hn ORDER BY row_id desc, camp1 ASC, substring(age,1,2) DESC";
}else{
$sql1="SELECT *
FROM `condxofyear_so`
WHERE `camp1`='$_POST[camp]' AND `yearcheck` = '$nPrefix2' AND `camp1` like 'D%'  group by hn ORDER BY row_id desc";
}
//var_dump($sql1);
