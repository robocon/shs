...
<center>
<span class="tet1">พิมพ์ใบตรวจสุขภาพบริษัท ไปรษณีย์ไทย จำกัด</span> <br />
  <br />
...
$sql1="CREATE TEMPORARY TABLE  result1  Select * from  resulthead  WHERE hn='".$result2['HN']."' and clinicalinfo ='ตรวจสุขภาพไปรษณีย์' ";
  ...
  <tr>
    <td colspan="2"><table width="100%">
      <tr>
        ...
        <td width="77%" align="center" valign="top" class="texthead"><strong>แบบรายงานการตรวจสุขภาพบริษัท ไปรษณีย์ไทย จำกัด</strong></td>
      ...
      <tr>
        <td align="center" valign="top" class="text3"><span class="text"><span class="text1"><span class="text2">ตรวจเมื่อวันที่ 18 กุมภาพันธ์ 2557</span></span></span></td>
