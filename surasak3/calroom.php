 	...
 	while(list($bed,$date,$ptname,$an,$hn,$caldate,$bedname,$bedcode,$status)=Mysql_fetch_row($result1)){
		...
		if($dcdate=="0000-00-00 00:00:00"){
			...
			if($oBedcode1=="46"){
				...
				if($chkptright=="R09" || $chkptright=="R10" || $chkptright=="R11" || $chkptright=="R12" || $chkptright=="R13" || $chkptright=="R14" || $chkptright=="R36"){
					if($cBedpri=="1500.00"){
						$claimcode="COVR07";
						$bedname="ค่าห้องสำหรับผู้ป่วยโควิดสีเขียว (ใน รพ. )";
