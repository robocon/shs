...
if( $part == 'ศูนย์ฝึกอบรมตำรวจภูธร ภาค 5 (1)' ){ 

    $sql = "SELECT * 
    FROM `log_opcardchk` 
    WHERE `log_part` = 'ศูนย์ฝึกอบรมตำรวจภูธร ภาค 5 (1)' 
    AND `type` = '$type' 
    GROUP BY `log_hn` 
    ORDER BY `log_id` ASC";
...
if( $part == 'ศูนย์ฝึกอบรมตำรวจภูธร ภาค 5 (2)' ){ 

    $sql = "SELECT * 
    FROM `log_opcardchk` 
    WHERE `log_part` = 'ศูนย์ฝึกอบรมตำรวจภูธร ภาค 5 (2)' 
    AND `type` = '$type' 
    GROUP BY `log_hn` 
    ORDER BY `log_id` ASC";
    // var_dump($sql);
