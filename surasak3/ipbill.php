...
print "      <td width='30%'><font face='Angsana New'>วันที่จำหน่าย&nbsp;$dcdateALL";
print "      <td width='40%'><font face='Angsana New'>รวม&nbsp;$cDays&nbsp;วัน";
print "       </font></td>";
print "    </tr>";
print "    <tr>";
print "      <td width='10%'></td>";
...
print "      <td width='18%' align='right'><font face='Angsana New' size='3'>".number_format($Ysubtotal,2)."</font></td>";
print "      <td width='10%'></td>";
print "    </tr>";
print "    <tr>";
print "      <td width='5%'></td>";
