...
<body>
<p align="center" style="margin-top: 20px;"><strong>เลือกวันที่ต้องการดูข้อมูล Diag Not Found สิทธิเบิกจ่ายตรง</strong></p>
<div align="center">
...
?>
<hr />
<div align="center" style="margin-top: 20px;"><strong>รายงานแสดงข้อมูล Diag Not Found สิทธิเบิกจ่ายตรง</strong></div>
...
$sql="CREATE TEMPORARY TABLE reportdiagnotfoundcscd select * from opacc where (txdate >= '$chkdate1 00:00:00' and txdate <='$chkdate2 23:59:59') AND credit =  'จ่ายตรง' AND (an='' OR an IS NULL) AND icd10_cscd!='y' group by hn,vn";
//echo $sql;
