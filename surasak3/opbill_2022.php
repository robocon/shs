...
print "    <tr>";
print "      <td width='100%'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$credit1&nbsp;&nbsp;&nbsp;<b>$sPtname</b>&nbsp;&nbsp;HN:$sHn&nbsp;VN:&nbsp;(".$_SESSION["sVn"].")&nbsp;วันที่&nbsp;$Thdate&nbsp;&nbsp;เวลา&nbsp;$billtime</td>";
print "      <td width='0%'></td>";
print "      <td width='0%'></td>";
print "    </tr>";
print "  </table>";
...
for($xx=0;$xx<$count_detail_2;$xx++){
		print "    <tr>";
		print "      <td width='60%'>".$_POST["detail_2"][$xx]."</td>"; //เดิม 63
		print "      <td width='12%' align='right'>300</td>";  //เดิม 28
		print "      <td width='12%' align='right'>0</td>";  //เดิม 28
		print "      <td width='6%'></td>";
		print "    </tr>";
}
		print "  </table>";
...
$sSumNprice = 0;
    ...
    print "      <td width='13%' align='right'><font style='line-height:20px; size ='3'>$yprice</td>";  //เดิม 28
    print "      <td width='10%' align='right'><font style='line-height:20px; size ='3'>$nprice</td>";  //เดิม 28
    ...
    $Items=1;
		...
		print "  <table border='0' cellpadding='0' cellspacing='0' width='100%'>";
		print "    <tr>";
		print "      <td width='42%'><font style='line-height:20px; size ='3'>ค่าตรวจทางพยาธิวิทยา</td>"; //เดิม 63
		print "      <td width='13%' align='right'><font style='line-height:20px; New' size ='3'>$sSumYprice</td>";  //เดิม 28
		print "      <td width='10%' align='right'><font style='line-height:20px; New' size ='3'>$sSumNprice</td>";  //เดิม 28
		print "      <td width='30%'><font  style='line-height:20px; size ='3'></td>";
		print "    </tr>";
		print "  </table>";
		print "</div>";
...
print "      <td width='13%' align='right'><B>$sSumYprice</B></td>";
print "      <td width='10%' align='right'><B>$sSumNprice</B></td>";
...
print "      <td width='23%' align='center'><B>$sNetprice</B></td>";
print "      <td width='30%'></td>";
print "    </tr>";
print "  </table>";
print "</div>";
...
print "      <td width='26%'><font style='line-height:25px; size='2'>(".$name.")</font></td>";
print "      <td width='10%'><font style='line-height:25px; size='2'>เจ้าหน้าที่เก็บเงิน</font></td>";
print "    </tr>";
print "  </table>";
print "</div>";
