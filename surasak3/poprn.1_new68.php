...
$ptname1=$rows1["yot"]." ".$rows1["fullname"];
  ...
  <tr align="left">
    ...
    <span style="margin-left:150px;" class="fc1-0">( <?=$rows1["fullname"];?> )</span>
    <? }else{ ?>
    <span style="margin-left:150px;" class="fc1-0">( <?=$rows1["fullname"];?> )</span>
    <? } ?>
    </td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="3" class="fc1-0">
  ...
  <tr>
    <td>3. คุณสมบัติของผู้ยื่นเสนอ</td>
  </tr> 
  <tr>
    <td>
  ...
  <tr>
    <td>
		<span style="margin:40px;">4. ไม่เป็นบุคคลซึ่งอยู่ระหว่างถูกระงับการยื่นข้อเสนอหรือทำสัญหากับหน่วยงานของรัฐไว้ชั่วคราวตามที่ประกาศเผยแพร่</span><br>
		<span>ในระบบเครือข่ายสารสนเทศของกรมบัญชีกลาง</span>
	</td>
  </tr>
  <tr>
    <td>
		<span style="margin:40px;">5. ไม่เป็นบุคคลซึ่งถูกระบุชื่อไว้ในบัญชีรายชื่อผู้ทิ้งงานและได้แจ้งเวียนชื่อให้เป็นผู้ทิ้งงานของหน่วยงานของรัฐในระบบเครือข่ายสารสนเทศ</span><br>
		<span>ของกรมบัญชีกลาง ซึ่งรวมถึงนิติบุคคลที่ผู้ทิ้งงานเป็นหุ้นส่วนผู้จัดการ กรรมการผู้จัดการ ผู้บริหาร ผู้มีอำนาจในการดำเนินงานในกิจการของนิติบุคคลนั้นด้วย</span><br>
		<span></span>
	</td>
  </tr> 
  <tr>
    <td>
		<span style="margin:40px;">6. มีคุณสมบัติและไม่มีลักษณะต้องห้ามตามที่คณะกรรมการนโยบายการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐ กำหนดในราชกิจจานุเบกษา</span>
	</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    <td>
		<span style="margin:40px;">9. ไม่เป็นผู้ได้รับเอกสิทธิ์หรือความคุ้มกัน ซึ่งอาจปฏิเสธไม่ยอมขึ้นศาลไทย เว้นแต่รัฐบาลของผู้เสนอราคมได้มีคำสั่งให้สละเอกสิทธิ์ความคุ้มกันเช่นว่านั้น</span>
	</td>
  </tr>    
  <tr>
    <td>
...
<div style="position: absolute; left:53px; top: 11630px;" class="fc1-0">   
<table width="100%" border="0" cellspacing="0" cellpadding="3" class="fc1-0">
  <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="3" class="fc1-0">
  ...
  <tr>
    <td><span style="margin:40px;"><input name="" type="checkbox" value="" />&nbsp;&nbsp;พิจารณาโดยใช้เกณฑ์ราคา</span></td>
  </tr>             
  <tr>
  ...
  <tr>
    <td>10. การกำหนดระยะเวลาประกันความชำรุดบกพร่อง</td>
  </tr> 
  <tr>
    <td>
		<span style="margin:40px;">ผู้ชนะการเสนอราคายอมรับประกันความชำรุดบกพร่องหรือขัดข้องของสิ่งของตามข้อตกลงนี้เนื่องจากการใช้งานตามปกติเป็นเวลา....1.....ปี</span><br>
		<span>นับถัดจากวันที่ผู้ซื้อได้รับมอบสิ่งของ โดยภายในกำหนดเวลาดังกล่าว หากสิ่งของเกิดชำรุดผู้ขายต้องจัดการซ่อมแซม หรือแก้ไขให้ใช้การได้ดีดังเดิมภายใน 7 วัน </span><br>
		<span>นับแต่ที่ได้รับแจ้งจากผู้ซื้อและไม่คิดค่าใช้จ่ายใดๆ ทั้งสิ้นกับผู้ซื้อ</span>
	</td>
  </tr>  
  <tr>
