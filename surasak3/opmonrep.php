...
if($aCredit[$n]==""){
	...
	$color="#F5DEB3";	
        ...
        print("<tr>\n".
                ...
                "<td bgcolor=$color><font face='Angsana New'><A HREF=\"edit_cash.php?id=$rowid[$n]&txdate=$txdate&depart=$aDepart[$n]&hn=$aHn[$n]&credit=$aCredit[$n]&price=$aPrice[$n]\" target='_blank'>$aPaid[$n]</A></td>\n".  
                "<td bgcolor=$color><font face='Angsana New'><A HREF=\"edit_cash.php?id=$rowid[$n]&txdate=$txdate&depart=$aDepart[$n]&hn=$aHn[$n]&credit=$aCredit[$n]&price=$aPrice[$n]\" target='_blank'>$aCredit[$n]</A></td>\n".  
