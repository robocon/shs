		...
		if(substr($zzz,0,3)=='R07'){
			...
			if(Mysql_num_rows(Mysql_Query($sql)) > 0){
				echo "<span style=\"background-color: #0033CC\"><B><FONT SIZE=\"3\"  COLOR=\"#FFFF00\"><BR>&nbsp;&nbsp;&nbsp;ตรวจสอบจากสิทธิผู้ป่วยมีสิทธิประกันสังคม&nbsp;&nbsp;&nbsp;</FONT></B></span>";
			 	print "<br><a href='labhndr.php?hn=".$xxx."&confirm=true'>!ชื่อถูกต้อง ทำรายการต่อไป</a>";
			}else{
...
// ตรวจดูว่าลงทะเบียนหรือยัง
    ...
    $result = mysql_query($query)
        ...
        if(mysql_num_rows($result)){
			$query5 = "SELECT * FROM opcard WHERE hn = '$hn'";
	    	$result5 = mysql_query($query5) or die("Query failed");
			$rep=mysql_fetch_array($result5);
			...
			echo "<META HTTP-EQUIV=\"Refresh\" CONTENT=\"0;URL=lab_orderdr.php\">";
		}
		else{
