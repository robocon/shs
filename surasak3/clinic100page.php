...
///
 ...
 $cTitle="รหัสรายการเก็บเงินอื่นๆ";
 session_register("cDepart");
 session_register("aDetail");
 session_register("cTitle");
?>
<frameset rows="13%,87%">
  <frame name="top" src="clinic100menu.php" noresize scrolling="no">
<frameset cols="40%,60%">
  <frame name="left" src="clinic100first.php" scrolling="auto">
  <frame name="right" src="UntitledFrame-2.html" scrolling="auto">
</frameset>
