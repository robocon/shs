...
&& ( $doctor_name != 'MD101 ขชล รวมทรัพย์' OR $officer_name != 'กัลยรัตน์ ตาคำ' ) ){
	...
	if( $_POST['doctor'] == 'MD100 เชาวรินทร์ อุ่นเครือ' OR $_POST['doctor'] == 'HD เชาวรินทร์ (ว.37533)' ){
		...
		$manual_lock = array( 
			'01 กุมภาพันธ์ 2562' => 0,
			'02 กุมภาพันธ์ 2562' => 0,
			'03 กุมภาพันธ์ 2562' => 0,
			'04 กุมภาพันธ์ 2562' => 0,
			'05 กุมภาพันธ์ 2562' => 0,
			'06 กุมภาพันธ์ 2562' => 0,
			'07 กุมภาพันธ์ 2562' => 0,
			'08 กุมภาพันธ์ 2562' => 0,
			'09 กุมภาพันธ์ 2562' => 0,
			'10 กุมภาพันธ์ 2562' => 0,
			'11 กุมภาพันธ์ 2562' => 0
	...
	if( $doctor_name == 'MD100 เชาวรินทร์ อุ่นเครือ' OR $doctor_name == 'HD เชาวรินทร์ (ว.37533)' ){
		if( $check_date == 2 && $dr_cheaw_test > "2017-04-01" ){
