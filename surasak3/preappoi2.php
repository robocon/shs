 ...
 <tr>
  ...
  <? }else{ ?>
    <select size="1" name="advice" id="advice" style="width: 200px;">
		...
		<option value="ไม่ต้องงดน้ำหรืออาหาร">ไม่ต้องงดน้ำหรืออาหาร</option>
		<option value="งดน้ำหวานและอาหารหลังเวลา 20:00 น.(ให้ดื่มน้ำเปล่าได้)">งดน้ำหวานและอาหารหลังเวลา 20:00 น.(ให้ดื่มน้ำเปล่าได้)</option>
		<option value="งดน้ำหวานและอาหารหลังเวลา 24:00 น.(ให้ดื่มน้ำเปล่าได้)">งดน้ำหวานและอาหารหลังเวลา 24:00 น.(ให้ดื่มน้ำเปล่าได้)</option>
		<option value="งดน้ำและอาหารหลังเวลา 20:00 น.">งดน้ำและอาหารหลังเวลา 20:00 น.</option>
		<option value="งดอาหารและเครื่องดื่มทุกชนิด หลัง 20.00 น.ยกเว้นน้ำเปล่าบริสุทธิ์ สามารถดื่มได้ปกติตลอดช่วงเวลาที่งดอาหาร">งดอาหารและเครื่องดื่มทุกชนิด หลัง 20.00 น.ยกเว้นน้ำเปล่าบริสุทธิ์ สามารถดื่มได้ปกติตลอดช่วงเวลาที่งดอาหาร</option>
		<option value="งดน้ำและอาหารหลังเวลา 20:00 น. ดื่มน้ำเปล่าได้">งดน้ำและอาหารหลังเวลา 20:00 น. ดื่มน้ำเปล่าได้</option>
		<option value="งดน้ำและอาหารหลังเวลา .............. น.">งดน้ำและอาหารหลังเวลา .............. น.</option>
		<option value="เอกซเรย์ ก่อนพบแพทย์">เอกซเรย์ ก่อนพบแพทย์</option>
		<option value="งดสวมใส่เครื่องประดับทุกชนิด งดทาโลชั่น แป้งบริเวณต้นคอ แขน และขา">งดสวมใส่เครื่องประดับทุกชนิด งดทาโลชั่น แป้งบริเวณต้นคอ แขน และขา</option>
		...
		<option value="ท่านที่ส่งอุจจาระแล้ว สำหรับสิทธิ์เบิกจ่ายตรง /เบิกคลังจังหวัด กรุณาอยู่รอเจ้าหน้าที่ห้องพยาธิเรียกเพื่อรูดบัตรประชาชนก่อนกลับทุกครั้ง">ท่านที่ส่งอุจจาระแล้ว สำหรับสิทธิ์เบิกจ่ายตรง /เบิกครังจังหวัด กรุณาอยู่รอเจ้าหน้าที่ห้องพยาธิเรียกเพื่อรูดบัตรประชาชนก่อนกลับทุกครั้ง</option>
      </select>
      <? } ?>
  </font></td>
  </tr>
