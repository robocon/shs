...
if ( $action === 'save' ) {
    ...
    redirect('med_wardv2.php',$msg.$err['msg']);
}
...
<div style="position:absolute; top:0; right:0; line-height:16px; text-align:center;">
    <img src="printQrCode.php?hn=http://192.168.131.250/sm3/surasak3/med_wardv2.php&size=3&level=2&margin=1">
...
<fieldset style="width:80%;">
    ...
    <form action="med_wardv2.php" method="post">
        <div>
...
if ( $page === 'search_an' ) {
    ...
    if ( $db->get_rows() > 0 ) { 
        ...
        <fieldset>
            ...
            <form action="med_wardv2.php" id="uploadForm" method="post" enctype="multipart/form-data">
                <div>
                    <b>AN:</b> <?=$ipt['an'];?><br>
                    <b>HN:</b> <?=$ipt['hn'];?><br>
            ...
            document.getElementById("uploadForm").onsubmit = function(ev){ 
                ...
                if(el.length > 0){
                    ...
                    for (var i=0; i < el.length; i++) {
                        ...
                        request.open('POST', 'med_wardv2.php', false);
    ...
    if ( $q->num_rows > 0 ) {
        ...
        while ($item = $q->fetch_array()) {
            ...
            <tr>
                ...
                <td>
                    <a href="med_wardv2.php?action=delete&id=<?=$id;?>" onclick="return confirmDelete();">ลบ</a>
                </td>
            </tr>
            <?php
        }
