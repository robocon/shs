...
if(isset($_POST['hn'])){
	...
	$select2 = "select * from predxofyear where hn='".$_POST['hn']."' order by row_id desc ";
	//echo $select2;
    ...
    <td width="100%"><table width="100%">
      ...
      <tr>
        <td align="center" valign="top" class="text1"><strong> <br />
         ตรวจเมื่อวันที่ <?=$result2['datechkup']?><br> โรงพยาบาลค่ายสุรศักดิ์มนตรี อ.เมือง จ.ลำปาง </strong></td>
        </tr>
    </table></td>
  </tr>
</table>
