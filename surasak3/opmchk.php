...
จนท.        วันที่
*/
print "<center>ส่วนเก็บเงินผู้ป่วยนอก: รายงานรายรับรวมทั้งหมด<br>";
print "รายงานเงินรายรับของวันที่ $repdate<br>";
print " รายงานเมื่อ&nbsp  $Thaidate<br><br></center>";
...
print "<tr><td colspan='3' align='center'>สรุปข้อมูลการรับชำระเงิน</td></tr>";
print "<tr><td width='5%'>&nbsp;</td><td width='50%'>เงินสด</td><td width='5%'>".$_SESSION["credit_1"]."</td></tr>";
print "<tr><td width='5%'>&nbsp;</td><td width='50%'>กรุงเทพ</td><td width='5%'>".$_SESSION["credit_2"]."</td></tr>";
print "<tr><td width='5%'>&nbsp;</td><td width='50%'>ทหารไทย</td><td width='5%'>".$_SESSION["credit_3"]."</td></tr>";
print "<tr><td width='5%'>&nbsp;</td><td width='50%'>จ่ายตรง</td><td width='5%'>".$_SESSION["credit_4"]."</td></tr>";
print "<tr><td width='5%'>&nbsp;</td><td width='50%'>ประกันสังคม</td><td width='5%'>".$_SESSION["credit_5"]."</td></tr>";
print "<tr><td width='5%'>&nbsp;</td><td width='50%'>30บาท</td><td width='5%'>".$_SESSION["credit_6"]."</td></tr>";
print "<tr><td width='5%'>&nbsp;</td><td width='50%'>เงินเชื่อ</td><td width='5%'>".$_SESSION["credit_7"]."</td></tr>";
print "<tr><td width='5%'>&nbsp;</td><td width='50%'>อื่นๆ</td><td width='5%'>".$_SESSION["credit_8"]."</td></tr>";
print "<tr><td width='5%'>&nbsp;</td><td width='50%'>HD</td><td width='5%'>".$_SESSION["credit_9"]."</td></tr>";
print "</table>";

print " <br>";
print " ผู้รายงาน...............................<br></center>";
