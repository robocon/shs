...
<body>
  <fieldset class="font1" style="width:50%">
    <legend>บันทึกค่าใช้จ่ายนอกโรงพยาบาล ผู้ป่วยใน ระบุ AN</legend>
    <form id="form1" name="form1" method="post" onSubmit="JavaScript:return fncSubmit();" action="drugoutside_ward.php">
