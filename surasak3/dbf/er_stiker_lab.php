...
$pdf->Cell(0,5,iconv("UTF-8","WINDOWS-874",$ptname)." Hn ".$hn,0,0,'C');
$pdf->Ln();
$pdf->SetFont('AngsanaNew', '', 13);
$pdf->Cell(0,5,"แพทย์ ".iconv("UTF-8","WINDOWS-874",$doctor),0,0,'C');
$pdf->Ln();

$pdf->Cell(0,5,"สิทธิ์ ".iconv("UTF-8","WINDOWS-874",$ptright),0,0,'C');
$pdf->Ln();
$pdf->SetFont('AngsanaNew', '', 12);
...
$pdf->MultiCell(0,5,"Lab: ".$txt_list_lab, 0 , 0 , 'C' );
$pdf->Ln();
