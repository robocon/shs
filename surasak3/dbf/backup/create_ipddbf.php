...
LIKE '%R33%'
	...
	$newcredit = "(ptright like '%ประกันสุขภาพ%' OR ptright LIKE '%R35%')";
}
...
$dbname1 = "INS".$yy.$mm.".dbf";
	...
	if (!dbase_create($dbname1, $def1)) {
	  echo "Error, can't create the database1\n";
		...
		$sqlop1 ="select hn,dcdate,an,ptright from  ipcard  where $newcredit and dcdate like '".$_POST['year']."-".$_POST['mon']."%' and $newcredit   ";	
		//echo "test-->".$sqlop3."<br>";
//echo	$sqlop1;
		...
		while($rowsop1 = mysql_fetch_array($resultop1)){
			...
			if($codeptright =="R09" || $codeptright =="R10"  || $codeptright =="R11"|| $codeptright =="R12"|| $codeptright =="R13"|| $codeptright =="R14" || $codeptright =="R35"){
				$newptright ="UCS";
