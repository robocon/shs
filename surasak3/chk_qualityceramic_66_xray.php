...
$sql = "SELECT `name`,`code`,`date_checkup` 
FROM `chk_company_list` 
WHERE ( `code` = 'บริษัท ควอลิตี้เซรามิก จำกัด 66 Day 1' OR code='บริษัท ควอลิตี้เซรามิก จำกัด 66 Day 2' ) ";
...
$companyName = toUTF('บริษัท ควอลิตี้เซรามิก จำกัด');
...
$sql = "SELECT * FROM opcardchk WHERE ( part='บริษัท ควอลิตี้เซรามิก จำกัด 66 Day 1' OR part='บริษัท ควอลิตี้เซรามิก จำกัด 66 Day 2') ORDER BY `row` ASC ";
$q = $dbi->query($sql);
// dump($sql);
$number = 1;
while ($a = $q->fetch_assoc()) {
    ...
    $pdf->Cell(60, 7, toUTF('แผนกรังสีวิทยา'), 0, 1, 'L');
    $pdf->SetXY(30, 25);
    $pdf->Cell(60, 7, toUTF('โรงพยาบาลค่ายสุรศักดิ์มนตรี'), 0, 1, 'L');
    $pdf->SetXY(30, 32);
    $pdf->Cell(60, 7, toUTF('โทร.053-839305'), 0, 1, 'L');
    ...
    $pdf->SetFont('THSarabun','',18);
    $pdf->SetXY(90, 11);
    $pdf->Cell(30, 7, toUTF('วันที่:'), 0, 1, 'R');
    $pdf->SetFont('THSarabun','B',18);
    $pdf->SetXY(120, 11);
    ...
    $pdf->SetFont('THSarabun','',18);
    $pdf->SetXY(90, 18);
    $pdf->Cell(30, 7, toUTF('ชื่อ-สกุล:'), 0, 1, 'R');
    $pdf->SetFont('THSarabun','B',18);
    $pdf->SetXY(120, 18);
    ...
    $pdf->SetFont('THSarabun','',18);
    $pdf->SetXY(90, 25);
    $pdf->Cell(30, 7, toUTF('อายุ:'), 0, 1, 'R');
    $pdf->SetFont('THSarabun','B',18);
    $pdf->SetXY(120, 25);
    $pdf->Cell(50, 7, toUTF($agey), 0, 1, 'L');

    $pdf->SetFont('THSarabun','',18);
    $pdf->SetXY(90, 32);
    $pdf->Cell(30, 7, toUTF('เลขประจำตัว:'), 0, 1, 'R');
    $pdf->SetFont('THSarabun','B',18);
    $pdf->SetXY(120, 32);
    ...
    $pdf->SetXY(9, 70);
    $pdf->SetFont('THSarabun','',18);
    $pdf->Cell(60, 7, toUTF('รายการ X-Ray'), 0, 1, 'L');

    $pdf->SetXY(9, 77);
    $pdf->SetFont('THSarabun','B',18);
    $pdf->Cell(60, 7, toUTF('การตรวจเอกซเรย์ปอด'), 0, 1, 'L');
    $pdf->Cell(60, 7, '(Chest X-Ray : CXR)', 0, 1, 'L');

    $pdf->SetXY(9, 105);
    $pdf->Cell(0, 7, toUTF('ผู้ตรวจ................................. วันที่................................. เวลา.................................'), 0, 1, 'C');


    $pdf->SetXY(89, 77);
    $pdf->SetFont('THSarabun','B',18);
    $pdf->Cell(40, 7, toUTF('เวลา X-Ray'), 0, 1, 'R');
    $pdf->SetXY(129, 77);
    $pdf->Cell(40, 7, toUTF('.................................น.'), 0, 1, 'L');


    $pdf->SetXY(89, 84);
    $pdf->SetFont('THSarabun','B',18);
    $pdf->Cell(40, 7, toUTF('เจ้าหน้าที่ X-Ray'), 0, 1, 'R');
    $pdf->SetXY(129, 84);
    $pdf->Cell(0, 7, '.................................', 0, 1, 'L');
