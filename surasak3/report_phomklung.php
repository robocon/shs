...
<center>
<span class="tet1">พิมพ์ใบตรวจสุขภาพป้อมคลัง 58</span> <br />
  <br />
...
if(isset($_POST['hn'])){
	...
	$select2 = "select * from opcardchk  where HN='".$_POST['hn']."' AND part='ป้อมคลัง58' ";
...
$sql1="CREATE TEMPORARY TABLE  result1  Select * from  resulthead  WHERE hn='".$result['HN']."' and clinicalinfo ='ตรวจสุขภาพป้อมคลัง58' ";
...
<table width="100%" border="0">
  <tr>
    <td><table width="100%">
      ...
      <tr>
        <td align="center" valign="top" class="texthead"><strong>บริษัท ป้อมคลัง จำกัด<br />
          บริษัท นำพลัง จำกัด<br />
          บริษัท ไทยเบฟเวอเรจ จำกัด</strong></td>
      ...
      <tr>
        <td align="center" valign="top" class="text3"><span class="text"><span class="text1"><span class="text2">ตรวจเมื่อวันที่ 13 ตุลาคม 2557</span></span></span></td>
...
/////
 ...
 ?>         
          <tr>
            <td height="27" colspan="3"><strong>ผลตรวจ :</strong> <? while($objResult = mysql_fetch_array($objQuery)){
																			 if($objResult["labcode"]=="WBC"){
  ...
  <tr>
    <td  valign="top"><table width="100%" border="1" style="border-collapse:collapse; border-bottom-style:none;" bordercolor="#000000" cellpadding="0" cellspacing="0">
      <tr>
        <td height="34" align="center"><strong class="text" style="font-size:22px"><u>LAB : อื่นๆ</u></strong></td>
      </tr>
      <tr>
...
if($objResult["labcode"]=='CHOL'){
	if($objResult["result"]<=200){
		...
		$app="ระดับไขมันในเลือดมีค่าสูงผิดปกติค่อนข้างมาก ควรพบแพทย์เพื่อรับการประเมินและให้การรักษา";	
	}
}
...
<table width="100%" border="0" class="text4">
  <tr>
    ...
    ) </strong><strong>Doctor :พ.ต.เลอปรัชญ์ มังกรกนกพงศ์ (22-10-2014)</strong></td>
