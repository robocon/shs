...
/*
    ...
    $vipward =  '45';
*/
    print "ค่ารักษาพยาบาลผู้ป่วยใน&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target=_self  href='../nindex.htm'><< ไปเมนู</a><br>";
    print "<font face='Angsana New'>(คลิก AN = ทยอยเก็บเงินและออกใบเสร็จ  โดยยังไม่จำหน่ายผู้ป่วย)<br>";  
    include("connect.inc");
