...
if($q->num_rows > 0 )
{
    ...
    ?>
    <h3 style="font-size: 22px; padding: 0; margin: 0; text-align:center;">แบบรายงานการตรวจสุขภาพผู้สมัครสอบเพื่อบรรจุเข้าเป็นนักเรียนนายสิบตำรวจ ประจำปีงบประมาณ 2566 ( ผลการตรวจร่างกายทั่วไป )</h3>
    ...
    <h3 style="font-size: 22px; padding: 0; margin: 0; text-align:center;">หน่วยงาน : ศูนย์ฝึกอบรมตำรวจภูธร ภาค 5 วันที่ตรวจ 16 พฤษภาคม 2567</h3>
    ...
    ?>
    <p><b>ยังไม่มีการบันทึกผลตรวจสุขภาพ</b></p>
    <?php
}
