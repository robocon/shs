...
for($i=0;$i<$count;$i++){
	...
	if($_POST["detail"] =='FU01 ตรวจตามนัด' ){ 
		...
		print "<font face='Angsana New' size='2'> 1.ผู้ป่วยนัดนวดแผนไทยให้ยื่นใบนัดที่แผนกกายภาพบำบัด(นวดแผนไทย)&nbsp;&nbsp;<BR> 
		2.หากผู้ป่วยมาไม่ตรงเวลาที่นัดเกิน 10 นาที ทางโรงพยาบาลจะถือว่าท่านสละสิทธิ์และทำการนัดครั้งต่อไป<br> หมายเลขโทรศัพท์ 054-839305-6 ต่อ 8003, 8004 </b>";  
