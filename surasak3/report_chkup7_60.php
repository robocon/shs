...
?>	
<body>
<div align="center"><strong>พิมพ์ผลตรวจสุขภาพประจำปี 7/2560</strong></div>
<p>
<form name="form1" method="post" action="report_chkup60.php" target="_blank" >
<input name="xraydate" type="hidden" value="7" />
  <table width="50%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td align="center">หน่วยงาน :
        <select name="camp" id="camp">
          <option value="สรีรัตน์เหมืองแร่60">สรีรัตน์เหมืองแร่</option>
          <option value="ดับเบิ้ลวิ้ง60">ดับเบิ้ลวิ้ง</option>
          <option value="อัลฟ่ากรุ๊ป60">อัลฟ่ากรุ๊ป</option>
          <option value="เอ็นเนอร์จีโซลูชั่น60">เอ็นเนอร์จีโซลูชั่น</option>
        </select>
        <input type="submit" name="button" id="button" value="พิมพ์ผล"></td>
    </tr>
  </table>
</form>
</p>
