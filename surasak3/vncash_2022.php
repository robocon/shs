...
<form method='POST' action='opcashvn_2022.php' onsubmit='return check();'>
<?
...
//    print "<input type='reset' value='ลบทิ้ง' name='B2'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;";
	...
	print "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;<a href='../surasak3/check_cash.php' target='_blank'><<รายการค้างจ่ายย้อนหลัง</a>";
	print "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;<a href='../surasak3/rprecipthn.php' target='_blank' ><<ค่าใช้จ่ายย้อนหลัง</a>";
	print "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;<a href='report_approvecode.php' target='_blank' >ข้อมูล Approve Code สิทธิเบิกจ่ายตรง</a>";
	print "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;<a href='report_chkup_soldier.php' target='_blank' >รายชื่อผู้เข้ารับการตรวจสุขภาพประจำปีกองทัพบกประจำวัน</a>";
    print "</form>";
?>
<?
...
<TR align="center" bgcolor=#2980B9>
	<TD bgcolor="#F5CBA7">VN</TD>
	<TD bgcolor="#F5CBA7">เวลา</TD>
	<TD bgcolor="#F5CBA7">HN</TD>
    <TD bgcolor="#F5CBA7">AN</TD>
	<TD bgcolor="#F5CBA7">ชื่อ-สกุล</TD>
	<TD bgcolor="#F5CBA7">สิทธิ์</TD>
	<TD bgcolor="#F5CBA7"><font size='1'>จำนวนเงิน</font></TD>
	<TD bgcolor="#F5CBA7">ส่วนเกิน</TD>
	<TD bgcolor="#F5CBA7"><font size='2'>เจ้าหน้าที่</font></TD>
	<TD bgcolor="#F5CBA7"><font size='2'>ออกOPCARDโดย</font></TD>
    <TD bgcolor="#F5CBA7"><font size='2'>นัดมาเพื่อ</font></TD>
</TR>
<?php 
$null='NULL';
...
?>
<TR BGCOLOR=66CDAA>
	<TD BGCOLOR="<?php echo $color ?>"><a href="opcashvn_2022.php?a=<?=$d?>&b=<?=$m?>&c=<?=$yr?>&vn=<?=$arr["tvn"]?>" ><?php echo $arr["tvn"];?></a></TD>
...
<TR align="center" bgcolor=#2980B9>
	<TD bgcolor="#2980B9">VN</TD>
	<TD bgcolor="#2980B9">เวลา</TD>
	<TD bgcolor="#2980B9">HN</TD>
    <TD bgcolor="#2980B9">AN</TD>
	<TD bgcolor="#2980B9">ชื่อ-สกุล</TD>
	<TD bgcolor="#2980B9">สิทธิ์</TD>
	<TD bgcolor="#2980B9"><font size='1'>จำนวนเงิน</font></TD>
	<TD>ส่วนเกิน</TD>
	<TD bgcolor="#2980B9"><font size='2'>เจ้าหน้าที่</font></TD>
	<TD bgcolor="#2980B9"><font size='2'>ออกOPCARDโดย</font></TD>
...
<TR align="center" bgcolor=#2980B9>
	...
	<TD bgcolor="#2980B9"><font size='1'>จำนวนเงิน</font></TD>
	<TD>ส่วนเกิน</TD>
	<TD bgcolor="#2980B9">แผนก</TD>
	<TD bgcolor="#2980B9">เจ้าหน้าที่</TD>
...
<?php
	...
	while($arr = Mysql_fetch_assoc($result)){
		...
		else{$color="#7DCEA0";};  //เขียว
		if($more>=2){
			if($arr["depart"]=="HEMO"){
				$color="#FFFF66";
			}else{
				$color="#F5B7B1";  //ชมพูอ่อน
				}
		}
		$sqlf = "select toborow,an from opday where hn='".$arr['hn']."' and thidate like '$yr-$m-$d%' ";
		list($toborow,$Tan) = mysql_fetch_array(mysql_query($sqlf));
