...
<center>
<span class="tet1">พิมพ์ใบตรวจสุขภาพบริษัท เบทาโกร จำกัด</span> <br />
  <br />
...
$sql1="CREATE TEMPORARY TABLE  result1  Select * from  resulthead  WHERE hn='".$result2['HN']."' and clinicalinfo ='ตรวจสุขภาพเบทาโกร' ";
  ...
  <tr>
    <td colspan="2"><table width="100%">
      <tr>
        ...
        <td width="77%" align="center" valign="top" class="texthead"><strong>แบบรายงานการตรวจสุขภาพบริษัท เบทาโกร จำกัด</strong></td>
      ...
      <tr>
        <td align="center" valign="top" class="text3"><span class="text"><span class="text1"><span class="text2">ตรวจเมื่อวันที่ 18-19 ธันวาคม 2556</span></span></span></td>
...
/////
 ...
 ?>         
          <tr>
            <td height="27" colspan="3">ผลตรวจ : <? while($objResult = mysql_fetch_array($objQuery)){
																			 if($objResult["labcode"]=="WBC"){
...
/////
		...
		?>
          ...
          <?  } ?>        
          <tr>             
            <td height="27" colspan="3">ผลตรวจ : ปกติ</td>
            </tr>
        </table></td>
      </tr>
    </table></td>
...
?>
  <?
$sql="SELECT * FROM result1 WHERE profilecode='GLU' or profilecode='CREA' or profilecode='URIC' or profilecode='CHOL' or profilecode='AST' or profilecode='ALT' or profilecode='LIPID' or profilecode='ALP'";
$query = mysql_query($sql);
...
if($objResult["labcode"]=='ALP'){
    ...
    <? if($result["stool"]!=''){?>
   	 <tr>
      <td>Stool  c/s for salmonella (เพาะเชื้อ Salmonella)</td>
            <td><!--<?//=$result["stool"];?>--></td>
            <td align="center">&nbsp;</td>
            <td>Non-enteric pathogen Isolated (ไม่พบ)</td>
       </tr>
   	 <tr>
   	   <td>Stool c/s for shigella (เพาะเชื้อ Shigella)</td>
   	   <td>&nbsp;</td>
   	   <td align="center">&nbsp;</td>
   	   <td>Non-enteric pathogen Isolated ไม่พบ)</td>
 	   </tr>
   	 <tr>
   	   <td>Stoolc/s for vibrio (เพาะเชื้อ Vibrio)</td>
   	   <td>&nbsp;</td>
   	   <td align="center">&nbsp;</td>
   	   <td>Non-enteric pathogen Isolated ไม่พบ)</td>
 	   </tr>
   	 <tr>
   	   <td>Stool c/s for E coli (เพาะเชื้อ E coli)</td>
   	   <td>&nbsp;</td>
   	   <td align="center">&nbsp;</td>
   	   <td>Non-enteric pathogen Isolated ไม่พบ)</td>
 	   </tr>
   	 <tr>
   	   <td>Stool examination for E coli (เพาะเชื้อ E coli)</td>
   	   <td>&nbsp;</td>
   	   <td align="center">&nbsp;</td>
   	   <td>Non-enteric pathogen Isolated (ไม่พบ)</td>
 	   </tr>
...
<table width="100%" border="0" class="text4">
  <tr>
    <td  width="50%" align="center"><strong>Authorise  LAB:</strong><?=$authorisename?> <strong> (<?=$authorisedate?>) CXR : </strong>พ.ต.ภูภูมิ วุฒิธาดา (ว.33906) รังสีแพทย์<strong> (06-01-2014) Doctor :พ.ต.เลอปรัชญ์ มังกรกนกพงศ์ (22-01-2014)</strong></td>
