...
<p align="center" style="margin-top: 20px;"><strong>เลือกวันที่ต้องการอัพเดทข้อมูลที่ส่งข้อมูลเบิกไปแล้วติด C กลับมาเพื่อแก้ไข สิทธิเบิกจ่ายตรง</strong></p>
<div align="center">
<form method="POST" action="updatestat_cscd.php">
...
?>
<hr />
<div align="center" style="margin-top: 20px;"><strong>รายงานข้อมูลติด C สิทธิเบิกจ่ายตรง</strong></div>
...
<table width="97%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr>
    ...
    <td width="7%" align="center" bgcolor="#66CC99"><strong>BillNo</strong></td>
...
$sql="select * from opacc where (txdate >= '$chkdate1 00:00:00' and txdate <='$chkdate2 23:59:59') and credit='จ่ายตรง'  order by txdate asc";
//echo $sql;
...
$sql2="select * from stat_cscd where hn='".$rows["hn"]."' and invno='$invno'";
//echo $sql2."<br>";
...
if($num2 > 0){
$edit=mysql_query("update opacc set typecscd='C' where row_id='$row_id';");
$edit1=mysql_query("update stat_cscd set stat='A' where row_id='$stat_id';");
//echo $edit1."<br>";
}			
?>  
  <tr bgcolor="<?=$bg;?>">
