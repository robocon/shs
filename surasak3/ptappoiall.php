...
while (list ($codedoctor,$duplicate,$drcode,$full_name) = mysql_fetch_row ($result)) {
	...
	"  <td BGCOLOR=66CDAA><font face='Angsana New'><a target=_BLANK href=\"ptappoiall2.php? doctor=".rawurlencode($codedoctor)."&appd=$appd_encode\">$doctor&nbsp;&nbsp;</a></td>\n".
...
$num= $duplicate+$num;
            ...
            print (" <tr>\n".
               "  <td BGCOLOR=66CDAA><font face='Angsana New'>$n&nbsp;&nbsp;</td>\n".
              "  <td BGCOLOR=66CDAA><font face='Angsana New'><a target=_BLANK href=\"ptappoiall2.php?doctor=".rawurlencode($doctor)."&appd=$appd_encode\">$doctor&nbsp;&nbsp;</a></td>\n".
