...
<title>คลินิกพิเศษ หู คอ จมูก</title>
...
<body>
<div id="no_print">
<h1 class="font1">คลินิกพิเศษนอกเวลาราชการ หู คอ จมูก</h1>
<fieldset class="font1" style="width: 80%">
  <legend>ฟอร์มค้นหา</legend>
  <form id="form1" action="clinic_report6.php" name="form1" method="post" style="text-align: center;">
  <table border="0" align="center" style="margin-left: auto; margin-right: auto;">
    <tr>
      <td>ค้นหาจากวันที่</td>
      <td>ระบุ</td>
      <td>
			...
			<select name='y_start' class='font1'>
			<?php
			   $Y=date("Y")+543;
			   $date=date("Y")+543+5;
			...
			?>
			ช่วงเวลา <select name='time' class="font1" >
			<?php
			foreach ($timeRange as $time) {
				$selected = ($time==$_POST['time']) ? 'selected="selected"' : '' ;
				?>
    ...
    <tr>
      ...
      <td style="text-align: left;">
		...
		$qDoctor = $dbi->query($sql);
		$doctorItem = array();
		while ($a = $qDoctor->fetch_assoc()) {
			$doctorItem[] = $a;
		}
		?>
		<select name="doctor" id="doctor">
			...
			<?php
			foreach($doctorItem AS $a){
				$selected = ($a['name']==$_POST['doctor']) ? 'selected="selected"' : '' ;
				?>
	...
	<tr>
		...
		<td style="text-align: left;">
			<select name="doctor2" id="doctor2">
				...
				<?php
				foreach($doctorItem AS $a){
					$selected = ($a['name']==$_POST['doctor2']) ? 'selected="selected"' : '' ;
					?>
					<option value="<?=$a['name'];?>" <?= $selected; ?>><?=$a['name'];?></option>
					<?php
				}
    ...
    <tr>
      <td colspan="3" align="center"><input name="button" type="submit" class="font1" id="button" value="แสดงข้อมูล" />
...
<h2 class="font3 shs-header" align="center">วันที่ <?=$dateshow;?> เวลา <?=$_POST['time'];?> หู คอ จมูก</h2>
...
<table class="shs-table" border="1" style="border-collapse:collapse; border-color:#000;" cellpadding="0" cellspacing="0" class="font2" width="100%" align="center">
	...
	if( $r=='31' ){
		...
		echo "<table width='100%' border='0' align='center' class='font2 footer-sign'>
			...
			<tr>
				<td align='center'>ร.อ.หญิง &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td align='center'>$yot&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			</tr>
			<tr>
				<td align='center'>( ปุณนาพร อินทรรักษ์ )</td>
		...
		echo "<h2 class='font3 shs-header' align='center'>วันที่  $dateshow เวลา $_POST[time]  ห้องตรวจโรคอายุรกรรม</h2>";
	...
	<tr>
		...
		<td>&nbsp;<?=$arr['hn']?></td>
		<td>&nbsp;<?php 
		echo str_replace('โครงการ', '', trim(iconv_substr($arr['ptright'],3)));
		 ?></td>
		<td>&nbsp;<?=$arr['an']?></td>
