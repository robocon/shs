...
print "<DIV style='left:0PX;top:35PX;width:200PX;'><span class='fc1-5'>CBC</span></DIV>";

if(trim($strdclist2) !=""){
	$strdclist2 = implode(",",$dglist[1]);
	print "<DIV style='left:0PX;top:50PX;width:200PX;'><span class='fc1-5'>CBC</span></DIV>";
}
