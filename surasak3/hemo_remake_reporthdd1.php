...
$session_user_id = $_SESSION['sRowid'];
$now = date('Y-m-d');
$sql_checkout = "SELECT * FROM `hemo_checkout` WHERE `input_id` = '$session_user_id' AND `date` = '2021-08-03' ";
$q_checkout = mysql_query($sql_checkout);
$co = mysql_fetch_assoc($q_checkout);
$depart_detail = $co['depart_detail'];
$input_name = $co['input_name'];
...
while(list($date1, $date, $hn, $depart, $paidcscd,$credit_detail) = Mysql_fetch_row($result)){ 
	...
	AND `depart` = 'HEMO' 
	AND `price` > 0 
	AND `idname` = '$input_name' ";
	// var_dump($hn);
	// echo "<br>";
	$q_depart = mysql_query($sql_depart);
	if(mysql_num_rows($q_depart) > 0)
	{
		// $dp = mysql_fetch_assoc($q_depart);
		$depart_addon = $depart_detail;
	}

	
	$list2[$hn] = $d."".$m."".$y."/".$full_name."/".$credit_detail."/".$vn.'/'.$depart_addon;
	// var_dump($list2[$hn]);
	switch($depart){
...
<td><font face='Angsana New' size ='2'><center> <b>test</td>
<td><center> <b>&nbsp;&nbsp;ยา&nbsp;&nbsp;</td>
...
$total=number_format($total,2);
	...
	<td><font face='Angsana New' size ='2'><b>&nbsp;&nbsp;".$xx[4]."&nbsp;</b></td>
...
<td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;vn&nbsp;&nbsp;</td>
<td><font face='Angsana New' size ='2'><center> <b>test</td>
<td><center> <b>&nbsp;&nbsp;ยา&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;พยาธิ&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;เอกเรย์&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ทันตกรรม&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;กายภาพ&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;บริการ&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ผ่าตัด&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ฝังเข็ม&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ไตเทียม&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b><center> <b>&nbsp;&nbsp;ตรวจอื่นๆ&nbsp;&nbsp;</td><td>&nbsp;&nbsp;***&nbsp;&nbsp;</td><td><center> <b>&nbsp;&nbsp;รวม&nbsp;&nbsp;</td></tr>";
