...
if($_POST["icd9"] != ""){
	$where = " AND icd9cm like '%".$_POST["icd9"]."%' ";
}

$query = "CREATE TEMPORARY TABLE dxgroup 
SELECT * FROM opday 
...
print "1. รายงานจำนวนผู้ป่วยนอกจำแนกตาม 22 กลุ่มโรค <a target=_self  href='../nindex.htm'><<ไปเมนู</a><br> ";
print "<table>";
print " <tr>";
...
For ($n=1; $n<=$x; $n++){
    ...
    print "  <th bgcolor=CD853F>ผู้ป่วยนอก(ครั้ง)</th>";
    print " </tr>";
	...
	$query="SELECT * FROM dxgroup WHERE goup LIKE 'G25%'";
	$result = mysql_query($query);
	$G25 = mysql_num_rows($result);
	print("<tr>\n".
	"<td bgcolor=F5DEB3>ข.5 พนักงานราชการ</td>\n".
	"<td bgcolor=F5DEB3>$G25</td>\n".
	" </tr>\n");
	...
	$query="SELECT * FROM dxgroup WHERE goup LIKE 'G40%'";
	$result = mysql_query($query);
	$G40 = mysql_num_rows($result);
	print("<tr>\n".
	"<td bgcolor=F5DEB3>ค.10 ญาติสายตรงของกำลังพล ทบ.</td>\n".
	"<td bgcolor=F5DEB3>$G40</td>\n".
	" </tr>\n");

	$query="SELECT * FROM dxgroup WHERE goup LIKE 'G41%'";
	$result = mysql_query($query);
	$G41 = mysql_num_rows($result);
	print("<tr>\n".
	"<td bgcolor=F5DEB3>ค.11 บุคคลที่มีความสัมพันธ์กับกำลังพล ทบ.</td>\n".
	"<td bgcolor=F5DEB3>$G41</td>\n".
	" </tr>\n");			  			  
	///////

	$G=$G31+$G32+$G33+$G34+$G35+$G36+$G37+$G38+$G39+$G40+$G41;
	print("<tr>\n".
	...
	/**********************************************************************************************************************/
	$G11=$G12=$G13=$G14=$G15=$G21=$G22=$G23=$G24=$G25=$G31=$G32=$G33=$G34=$G35=$G36=$G37=$G38=$G39=$G40=$G41=0;
	$G = 0;
	$Gnet = 0;
...
////////////////////////
    print "<table>";
    print " <tr>";
    print "  <th>3. รายงานจำนวนผู้ป่วยนอกจำแนกตามประเภทบุคคล(รง.ผสต.1)</th>";
    print " </tr>";
    ...
    print " </tr>";
//ประเภท ก
      $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G11%'";
      $result = mysql_query($query);
      $G11 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ก.1 นายทหารประจำการ</td>\n".
      ...
      $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G12%'";
      $result = mysql_query($query);
      $G12 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ก.2 นายสิบ พลทหารประจำการ</td>\n".
     ...
     $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G13%'";
     $result = mysql_query($query);
     $G13 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ก.3 ข้าราชการกลาโหมพลเรือน</td>\n".
      ...
      $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G14%'";
      $result = mysql_query($query);
      $G14 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ก.4 ลูกจ้างประจำ</td>\n".
     ...
     $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G15%'";
     $result = mysql_query($query);
     $G15 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ก.5 ลูกจ้างชั่วคราว</td>\n".
     ...
     $Gnet=$Gnet+$G;
        print("<tr>\n".
                ...
                " </tr>\n");
//ประเภท ข
     $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G21%'";
     $result = mysql_query($query);
     $G21 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ข.1 นายสิบ พลทหารกองประจำการ</td>\n".
      ...
      $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G22%'";
      $result = mysql_query($query);
      $G22 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ข.2 นักเรียนทหาร</td>\n".
     ...
     $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G23%'";
     $result = mysql_query($query);
     $G23 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ข.3 อาสาสมัครทหารพราน</td>\n".
     ...
     $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G24%'";
     $result = mysql_query($query);
     $G24 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ข.4 นักโทษทหาร</td>\n".
     ...
     $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G25%'";
     $result = mysql_query($query);
     $G25 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ข.5 พนักงานราชการ</td>\n".
     ...
     $Gnet=$Gnet+$G;
        print("<tr>\n".
                ...
                " </tr>\n");
//ประเภท ค
     $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G31%'";
     $result = mysql_query($query);
     $G31 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ค.1 ครอบครัวทหาร</td>\n".
      ...
      $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G32%'";
      $result = mysql_query($query);
      $G32 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ค.2 ทหารนอกประจำการ</td>\n".
     ...
     $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G33%'";
     $result = mysql_query($query);
     $G33 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ค.3 นักศึกษาวิชาทหาร(รด)</td>\n".
     ...
     $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G34%'";
     $result = mysql_query($query);
     $G34 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ค.4 วิวัฒน์พลเมือง</td>\n".
      ...
      $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G35%'";
      $result = mysql_query($query);
      $G35 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ค.5 บัตรประกันสังคม</td>\n".
     ...
     $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G36%'";
     $result = mysql_query($query);
     $G36 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ค.6 บัตรทอง30บาท</td>\n".
     ...
     $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G37%'";
     $result = mysql_query($query);
     $G37 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ค.7 ข้าราชการพลเรือน(เบิกต้นสังกัด)</td>\n".
      ...
      $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G38%'";
      $result = mysql_query($query);
      $G38 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ค.8 พลเรือน(ไม่เบิกต้นสังกัด)</td>\n".
     ...
     $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G39%'";
     $result = mysql_query($query);
     $G39 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ค.9 อื่นๆไม่ระบุ</td>\n".
     ...
     $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G40%'";
     $result = mysql_query($query);
     $G40 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ค.10 ญาติสายตรงกับกำลังพล ทบ.</td>\n".
              "<td bgcolor=F5DEB3>$G40</td>\n".
              " </tr>\n");		
			  
     $query="SELECT distinct hn FROM dxgroup WHERE goup LIKE 'G41%'";
     $result = mysql_query($query);
     $G41 = mysql_num_rows($result);
      print("<tr>\n".
              "<td bgcolor=F5DEB3>ค.11 บุคคลที่มีความสัมพันธ์กับกำลังพล ทบ.</td>\n".
