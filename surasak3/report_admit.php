  ...
  <form name="f1" action="" method="post">
    <table  border="1" cellpadding="0" cellspacing="0" bordercolor="#666666" style="border-collapse:collapse">
      <tr class="forntsarabun">
        <td colspan="2" bgcolor="#99CC99">รายงานผู้ป่วยใน</td>
        </tr>
      <tr class="forntsarabun">
...
BETWEEN  '$start_date' AND '$end_date'  AND bedcode  LIKE  '".$_POST['ward']."%' ";
...
if($row){
	 ...
	 print "<div><font class='forntsarabun' >รายงานผู้ป่วยใน  ระหว่าง  $dateshow  ถึง $dateshow2 </font></div><br>";
 ?>
