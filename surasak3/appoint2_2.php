...
print "<font face='Angsana New' size='2'><center>FR-OPD-004/1,03, 08 ก.ย. 51 </center>";
print "<b><font face='Angsana New' size='4'>ชื่อ: ".$fullname."  </b>&nbsp;&nbsp;&nbsp;<b>HN:</b> ".$_POST["list_hn"][$i]." &nbsp;<b>อายุ:</b> ".$age."&nbsp;<B>สิทธิ:".$ptright."&nbsp;:<u>".$idguard."</u></font></B><br>";
print "<b><font face='Angsana New' size='5'><U>นัดมาวันที่: ".$appd." &nbsp;&nbsp;&nbsp; </b><b> เวลา:</b> ".$_POST["capptime"]."</U></FONT><br>";
print "<font face='Angsana New' size='4'><b><U>ยื่นใบนัดที่:&nbsp; ".$_POST["room"]."</U></b><font face='Angsana New' size='3'>&nbsp;&nbsp;&nbsp;";

if($_POST["detail"] !='NA') { 
	print "<font face='Angsana New' size='4'><b>เพื่อ:</b>&nbsp; ".$_POST["detail"]."&nbsp;&nbsp;<font face='Angsana New' size='3'><b>แพทย์ผู้นัด:</b>&nbsp; ".$_POST["doctor"]."</b><br>";
}
...
if($_POST["detail"] =='FU01 ตรวจตามนัด' ){ 
	print "<font face='Angsana New' size='3'><b>หมายเหตุ:<u>".$idguard."</u></b><br>กรุณามาตรงตามวันและเวลานัด&nbsp;<b>ถ้าผิดนัด </b>ให้ยื่นใบนัดที่แผนกทะเบียน &nbsp; <br><b>กรณีเลื่อนนัด ต้องติดต่อล่วงหน้าอย่างน้อย 2 วันทำการ<br> ในวันเวลาราชการ เวลา 13.30 น. - 15.00 น. โทร 054-839305-6 ต่อ 1100 , 1125</b>"; 
} 
	...
	print "<font face='Angsana New' size='3'><b>หมายเหตุ:<u>".$idguard."</u></b><BR>1.ผู้ป่วยนัดตรวจผ่าตัดให้ยื่นใบนัดที่แผนกทะเบียน &nbsp;&nbsp; 2.กรุณามาตรงตามวันและเวลานัด&nbsp;<b> </B><br><b>กรณีเลื่อนนัด ต้องติดต่อล่วงหน้าอย่างน้อย 2 วันทำการ<br> ในวันเวลาราชการ เวลา 13.30 น. - 15.00 น. โทร 054-839305-6 ต่อ 1100 , 1125</b> "; 
} 
else if ($_POST["detail"] =='FU06 สูติ') { 
	print "<font face='Angsana New' size='3'><b>หมายเหตุ:<u>".$idguard."</u></b><BR>1.ผู้ป่วยนัดตรวจสูติให้ยื่นใบนัดที่แผนกทะเบียน &nbsp;&nbsp; 2.กรุณามาตรงตามวันและเวลานัด&nbsp;<b> </B><br><b>กรณีเลื่อนนัด ต้องติดต่อล่วงหน้าอย่างน้อย 2 วันทำการ<br> ในวันเวลาราชการ โทร 054-839305-6 ต่อ 5111 </b>";  
} 
	...
	print "<font face='Angsana New' size='3'>1.ผู้ป่วยนัดตรวจ Echo ให้ยื่นใบนัดที่จุดนัด &nbsp;&nbsp; 2.กรุณามาตรงตามวันและเวลานัด&nbsp;<b>ถ้าผิดนัด </b>ให้ใบนัดยื่นแผนกทะเบียน &nbsp; </B><br><b>กรณีเลื่อนนัด ต้องติดต่อล่วงหน้าอย่างน้อย 2 วันทำการ<br> ในวันเวลาราชการ เวลา 13.30 น. - 15.00 น. โทร 054-839305-6 ต่อ 1100 , 1125</b>";  
}
else  if($_POST["detail"] =='FU09 มวลกระดูก'){ 
	print "<font face='Angsana New' size='3'>1.ผู้ป่วยนัดตรวจมวลกระดูกให้ยื่นใบนัดที่จุดนัด&nbsp;&nbsp; 2.กรุณามาตรงตามวันและเวลานัด&nbsp;<b>ถ้าผิดนัด </b>ให้ใบนัดยื่นแผนกทะเบียน &nbsp; </B><br><b>กรณีเลื่อนนัด ต้องติดต่อล่วงหน้าอย่างน้อย 2 วันทำการ<br> ในวันเวลาราชการ เวลา 13.30 น. - 15.00 น. โทร 054-839305-6 ต่อ 1100 , 1125</b>";  
}
else  if($_POST["detail"] =='FU12 นวดแผนไทย'){ 

	print "<font face='Angsana New' size='3'> 1.ผู้ป่วยนัดนวดแผนไทยให้ยื่นใบนัดที่แผนกกายภาพบำบัด(นวดแผนไทย)&nbsp;&nbsp;<BR> 2.หากผู้ป่วยมาไม่ตรงเวลาที่นัดเกิน 10 นาที ทางโรงพยาบาลจะถือว่าท่านสละสิทธิ์และทำการนัดครั้งต่อไป<br> หมายเลขโทรศัพท์ 054-839305-6 ต่อ 8002, 8001 </b>";  
