...
<table>
 <tr>
  ...
  <th bgcolor=CD853F><font face='Angsana New'>ราคา ไม่รวมVAT</th>
  <th bgcolor=#66CC99><font face='Angsana New'>ราคา รวมVAT</th>
...
<?php
	...
	$packpri_nvat=$packpri-$nVat;
        ...
        print (" <tr>\n".
           ...
           "  <td BGCOLOR=F5DEB3><font face='Angsana New'>".number_format($packpri_nvat,2)."</td>\n".
		   "  <td BGCOLOR=66CC99><font face='Angsana New'>$packpri</td>\n".
    ...
    print "<font face='Angsana New'>$cComname;จำนวน $x รายการ;รวมงิน  $sNetprice บาท .....<b>(คลิกรายการเพื่อแก้ไขข้อมูล)</b><br><b>*** การออกใบสั่งซื้อจะใช้ราคาที่รวม Vat แล้ว ***</b>";
?>
</table>
