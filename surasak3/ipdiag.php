...
<?
    echo "เตียง $cBed<br>"; 
    echo "$cFulname&nbsp;&nbsp;HN :  $hn    AN   : $cAn<br>";
    echo "เดิมวินิจฉัยโรค : $cDiag ";
?>
</fieldset>


<form method="POST" action="ipdiagok.php" id="log">
<fieldset>
  <legend>เปลี่ยนการวินิจฉัยโรค</legend>
<BR />
...
<input type="hidden" name="lastcall" value="<?=$arr['lastcalroom'];?>" />
  ...
  <label for="diag">เปลี่ยนวินิจฉัยโรคเป็น</label>:
  <input type="text" name="diag" size="40" value=<?php echo" '$cDiag' " ?>>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
