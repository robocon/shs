...
/*	$date = explode("-",$_POST["date_diag"]);
	...
	$sql="INSERT INTO  `cancer` (thidate,`hn` ,  `id` ,`doctor_date`,  `date_diag` ,  `lab_name` ,  `lab_no`,  `position` ,  `lab_detail` ,  `stage` ,  `a` ,  `b` ,  `t` ,  `n` ,  `m` ,  `grade` ,  `side` ,  `cure_surgery` ,  `date1` ,  `cure_radiation` ,  `date2` ,  `cure_chemotherapy` ,  `date3` ,  `cure_targeted` ,  `date4` , `cure_hormone` ,  `date5` ,  `cure_immuno` ,  `date6` ,  `cure_intervention` ,  `date7` ,  `cure_other` ,  `date8` ,  `cure_support` ,  `date9` ,  `status` ,  `last_update` ,  `dead` ,  `diag_type1` ,  `diag_type2` ,  `diag_type3` ,  `diag_type4` ,  `diag_type5` , `diag_type6` ,  `diag_type7` ,  `diag_type8` ,  `diag_type9` , `register_date` ,  `officer` ) 
VALUES ('".$thidate."','".$_POST["hn"]."', '".$_POST["id"]."','".$_POST["doctor_date"]."','".$_POST["date_diag"]."' , '".$_POST["lab_name"]."' , '".$_POST["lab_no"]."' , '".$_POST["position"]."' , '".$_POST["lab_detail"]."' , '".$_POST["stage"]."' , '".$_POST["a"]."' , '".$_POST["b"]."' , '".$_POST["tnm1"]."' , '".$_POST["tnm2"]."' , '".$_POST["tnm3"]."',  '".$_POST["grade"]."',  '".$_POST["side"]."',  '".$_POST["cure_surgery"]."', '".$_POST["date1"]."',  '".$_POST["cure_radiation"]."',  '".$_POST["date2"]."',  '".$_POST["cure_chemotherapy"]."', '".$_POST["date3"]."',  '".$_POST["cure_targeted"]."', '".$_POST["date4"]."' ,  '".$_POST["cure_hormone"]."', '".$_POST["date5"]."' , '".$_POST["cure_immuno"]."', '".$_POST["date6"]."' , '".$_POST["cure_intervention"]."',  '".$_POST["date7"]."', '".$_POST["cure_other"]."',  '".$_POST["date8"]."',  '".$_POST["cure_support"]."',  '".$_POST["date9"]."', '".$_POST["status"]."' , '".$_POST["last_update"]."' , '".$_POST["dead"]."' , '".$_POST["diag_type1"]."',  '".$_POST["diag_type2"]."',  '".$_POST["diag_type3"]."',  '".$_POST["diag_type4"]."', '".$_POST["diag_type5"]."', '".$_POST["diag_type6"]."', '".$_POST["diag_type7"]."',  '".$_POST["diag_type8"]."', '".$_POST["diag_type9"]."', '".$_POST["register_date"]."', '".$_POST["officer"]."')";
...
<?
$str="select yot,name,surname,idcard, date_format(dbirth,'%d-%m-%Y'), concat(address,' ', tambol,' ', ampur,' ', changwat) as address, nation, religion, sex, married, dbirth from opcard where hn='".$_POST["hn"]."'";
