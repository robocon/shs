...
$_GET['y'] = $_GET['y']-543;
	...
	switch($_GET["druginj"]){
		...
		case "VERO RABIES 2" : $count = 2; break;
		case "VERO RABIES 3" : $count = 3; break;
...
<TR>
	<TD align="right">ยา : </TD><TD colspan="7">
		<SELECT ID="drug_inj" NAME="drug_inj"  Onchange="view_inj();">
			...
			<Option value="Hepatitis B Vaccine">Hepatitis B Vaccine (Adult ) 20 mcg/1ml (โครงการบุคลากรการแพทย์)</Option>
		</SELECT>
	</TD>
</TR>
<TR>
