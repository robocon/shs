<?php
	...
	print "<b>สรุปจำนวนทำกายภาพบำบัด วันที่ $appd</b>";
    ...
    $query = "SELECT DISTINCT code FROM lbperday1";
...
/////////นับยาที่ใช้
	...
	print " <th bgcolor=CD853F><font face='Angsana New' size='2'>รายการ</th>";
	print " <th bgcolor=CD853F><font face='Angsana New' size='2'>นอก/ครั้ง</th>";
	print " <th bgcolor=CD853F><font face='Angsana New' size='2'>รวมเป็นเงิน</th>";
	print " <th bgcolor=CD853F><font face='Angsana New' size='2'>ใน/ครั้ง</th>";
	print " <th bgcolor=CD853F><font face='Angsana New' size='2'>รวมเป็นเงิน</th>";
...
//	print " <th bgcolor=CD853F><font face='Angsana New' size='2'>ประเภท</th>";
	...
	$nNprinet=0;
	 $aAmount1t=0;
			 ...
			 $aPrice2t=0;
	for ($n=1; $n<=$x; $n++){
			$query = "SELECT detail,amount,yprice,nprice,price,part,an FROM lbperday1 WHERE code='$aCode[$n]' ";
		   ...
		   while (list ($detail,$amount,$yprice,$nprice,$price,$part,$an,$ahn) = mysql_fetch_row ($result)) {
  ...
  $sql111 = "Select price From labcare where code='$aCode[$n]' ";
	...
	list($pricefull) = Mysql_fetch_row($result111);
           ...
           "  <td BGCOLOR=F5DEB3 align=center><font face='Angsana New' size='2'>$aCode[$n]</td>\n".
	...
	print " <th bgcolor=CCFF00><font face='Angsana New' size='2'>จำนวนผู้ป่วยนอก/AN</th>";
	print "<tr>"; 
	print "<tr>";
