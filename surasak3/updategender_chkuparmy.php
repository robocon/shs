<title>โปรแกรมปรับปรุงข้อมูลเพศ</title>
<style type="text/css">
<!--
body,td,th {
...
if($_POST["act"]=="edit"){
	...
	while($rows=mysql_fetch_array($query)){
		...
		if(!empty($num)){
			$edit="update condxofyear_so set gender='$rows[gender]' where hn='$row[hn]' and yearcheck='$yearcheck'";
			mysql_query($edit);
		}
	}
		echo "<script>alert('ปรับปรุงข้อมูลเรียบร้อยแล้ว');window.location='reportgender_chkuparmy.php';</script>";	
}
?>
<form name="form1" method="post" action="updategender_chkuparmy.php" >
<input name="act" type="hidden" value="edit">
  <table width="50%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td align="center">ปี พ.ศ. (ปีงบประมาณ)
        <label>
