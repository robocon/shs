...
<tr>
	<td colspan="6" align="center"><button type='button' onclick="window.open('dt_paperLess.php?hn=<?php echo $cHn;?>') " class='txtsarabun'><img src='images/views.png' height='28px' width='28px' style='margin-top:5px;' /><div style='margin-top:5px;'>ข้อมูลประวัติการรักษา<br><?=$cHn;?></div></button></td>
</tr>
<?
...
<TR>
  ...
  <TD colspan="2" ><a target="_blank" href="printcscd1.php?sDate=<?=$cthidate;?>&nRow_id=<?=$arr2['row_id']?>"><?=$arr['detail'];?></a></TD>
  <TD align="left" >&nbsp;</TD>
  <TD align="left" >&nbsp;</TD>
  </TR>
<?
...
<TR>
  <TD colspan="6" align="center" >การตรวจ Xray</TD>
	...
	if (mysql_num_rows($result2)>0) {
		...
		<TR>
		  <TD colspan="2" align="center" >&nbsp;</TD>
		  <TD colspan="2" ><a target="_blank" href="printcscd1.php?sDate=<?=$cthidate;?>&nRow_id=<?=$arr2['row_id'];?>"><?=$arr2['diag'];?></a></TD>
		  <TD align="left" >&nbsp;</TD>
		  <TD align="left" >&nbsp;</TD>
		  </TR>
		<?
...
$date=explode(" ",$cthidate);
$date1=$date[0];
$sqllab="select * from depart where date like '$date1%' and hn='$cHn' AND ( `status` != 'n' AND `price` > 0 ) and an =''";
//echo $sqllab;
$objlab = mysql_query($sqllab) or die ("Error Query [".$sqllab."]");
$row_lab=mysql_num_rows($objlab);
