...
//
$sql = "INSERT INTO opacc (date,txdate,hn,an,depart,detail,price,paid,idname,ptright,credit)
             VALUES('$Thidate','$dDate','$sHn','$sAn','$sDepart','$sDetail',
             '$sNetprice','$paid','$sOfficer','$sPtright','$credit');";
 /*OPACC table
...
print "      <td width='30%'><font face='Angsana New'>$Thdate ,$billtime</font></td>";
print "    </tr>";
print "  </table>";
print "</div>";
print "<div align='left'>";
...
print "  <table border='0' cellpadding='0' cellspacing='0' width='100%'>";
print "    <tr>";
print "      <td width='100%'><font face='Angsana New'>$sPtname&nbsp;&nbsp;, HN:$sHn , ป่วยเป็นโรค: $sDiag</font></td>";
print "    </tr>";
print "  </table>";
print "</div>";
print "<br><br><br>";
...
print "    <tr>";
//print "      <td width='9%'></td>";
print "      <td width='71%'><font face='Angsana New'>$detail</td>"; //เดิม 63
print "      <td width='20%'><font face='Angsana New'>$price</td>";  //เดิม 28
print "    </tr>";
print "  </table>";
print "</div>";
   	   }
