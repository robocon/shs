...
<form name="form1" method="post" action="dgslip_edit.php">
    ...
    <table width="40%" border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="#FFCC99">
        ...
        <tr>
            <td align="right"><strong>จำนวนที่ใช้ต่อวัน : </strong></td>
            <td><input name="amount" type="text" id="amount" size="40" value="<?= $rows["amount"]; ?>"></td>
        </tr>
        <tr>
            <td height="52">&nbsp;</td>
            <td><label>
                    <input type="submit" name="button" id="button" value="แก้ไขข้อมูล" style="height:30px; font-family:'TH SarabunPSK'; font-size:18px;">&nbsp;&nbsp;&nbsp;<input type="button" name="button1" id="button1" value="ดูวิธีใช้ยา" style="height:30px; font-family:'TH SarabunPSK'; font-size:18px;" onclick="window.location='dgslip.php';">&nbsp;&nbsp;&nbsp;<input type="button" name="button2" id="button2" value="กลับเมนูหลัก" style="height:30px; font-family:'TH SarabunPSK'; font-size:18px;" onclick="window.location='../nindex.htm';">
                </label></td>
        </tr>
    </table>
</form>