...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr>
    ...
    <td align="center" bgcolor="#999999"><strong>เวลา 06.00 น. ถึง 07.59 น.</strong></td>
...
if($_POST["seltime"]=="1"){
	$sqltemp1="select * from resulthead as tb1 inner join resultdetail as tb2 on tb1.autonumber=tb2.autonumber where (tb1.orderdate between '$rows[neworderdate] 06:00:00' and '$rows[neworderdate] 06:59:59') group by tb1.labnumber";
}else if($_POST["seltime"]=="2"){
	$sqltemp1="select * from resulthead as tb1 inner join resultdetail as tb2 on tb1.autonumber=tb2.autonumber where (tb1.orderdate between '$rows[neworderdate] 07:00:00' and '$rows[neworderdate] 07:59:59') group by tb1.labnumber";
}	
	//echo $sqltemp1;
	...
	while($result=mysql_fetch_array($querytemp1)){
		$chktime = substr($result["checkindate"],11,8);
		if($chktime < "08:00:00"){
			$showtime1++;
		}else if($chktime >= "08:00:00" and $chktime < "09:00:00"){
			$showtime2++;
			
		}else if($chktime >= "09:00:00" and $chktime <="12:00:00"){
			$showtime3++;
		}
	}
  ...
  <tr>
    ...
    <?
	if($_POST["seltime"]=="1"){
	$sql1="select * from resulthead where orderdate between '$rows[neworderdate] 06:00:00' and '$rows[neworderdate] 06:59:59' group by labnumber";
	}else if($_POST["seltime"]=="2"){
	$sql1="select * from resulthead where orderdate between '$rows[neworderdate] 07:00:00' and '$rows[neworderdate] 07:59:59' group by labnumber";
	}
	//echo $sql1."<br>";
