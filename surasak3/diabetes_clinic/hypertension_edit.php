...
if (!empty($_POST["p_hn"]) != "") {
	...
	if (!$crow) {
		...
		<FORM METHOD="post" action="hypertension_edit.php" name="F1">
			...
			<TABLE border="1" cellpadding="2" cellspacing="0" bordercolor="#393939" bgcolor="#FFFFCE">
				<TR>
					<TD>
						<TABLE border="0" cellpadding="0" cellspacing="0">
							<TR>
								<TD align="left" bgcolor="#0000CC" class="tb_font_1">&nbsp;<span
										class="forntsarabun">&nbsp;&nbsp;ข้อมูลผู้ป่วย</span></TD>
							</TR>
							<TR>
								<TD>
									<table border="0">
									...
									<table border="0" class="forntsarabun1">
										<TR>
											<TD align="left" bgcolor="#0000CC" class="forntsarabun" colspan="12">การตรวจร่างกาย
											</TD>
										</TR>
										<tr>
