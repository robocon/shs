...
if($_SESSION["smenucode"]=="ADM" || $_SESSION["smenucode"]=="ADMCSCD"){ 
	$sql="select * from opacc where (txdate >= '$chkdate1' and txdate <='$chkdate2') and credit='จ่ายตรง'  order by hn asc";
}else{
	$sql="select * from opacc where (txdate >= '$chkdate1' and txdate <='$chkdate2') and credit='จ่ายตรง'  order by date asc";	
}
//echo $sql;
