...
<script language="javascript">
		...
		window.location.href='report_dxofyear_army_manual.php?id=<?=$id;?>';
		//setTimeout("window.close();",3000);
	</script>
   <meta http-equiv="refresh" content="3;url=dt_armymanual_index.php">
	<?
		}else{
