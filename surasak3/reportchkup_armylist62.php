...
<table width="90%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr>
    ...
    <td colspan="7" align="center" bgcolor="#66CC99"><strong>BMI</strong></td>
    <td colspan="7" align="center" bgcolor="#66CC99"><strong>รอบเอว</strong></td>
    <td colspan="7" align="center" bgcolor="#66CC99"><strong>BP</strong></td>
    <td colspan="7" align="center" bgcolor="#66CC99"><strong>BS</strong></td>
    <td colspan="7" align="center" bgcolor="#66CC99"><strong>CHOL</strong></td>
    <td colspan="7" align="center" bgcolor="#66CC99"><p><strong>TR</strong></p>    </td>
    <td colspan="7" align="center" bgcolor="#66CC99"><strong>HDL</strong></td>
    <td colspan="7" align="center" bgcolor="#66CC99"><strong>LDL</strong></td>
    <td colspan="7" align="center" bgcolor="#66CC99"><strong>CR</strong></td>
    <td colspan="7" align="center" bgcolor="#66CC99"><strong>BUN</strong></td>
    <td colspan="7" align="center" bgcolor="#66CC99"><strong>URIC</strong></td>
    <td colspan="7" align="center" bgcolor="#66CC99"><strong>SGOT</strong></td>
    <td colspan="7" align="center" bgcolor="#66CC99"><strong>SGPT</strong></td>
    <td colspan="7" align="center" bgcolor="#66CC99"><strong>ALK</strong></td>
  </tr>
  <tr>
    ...
    <td width="5%" align="center" bgcolor="#66CC99">65</td>
	<td width="5%" align="center" bgcolor="#66CC99">66</td>
    <td width="5%" align="center" bgcolor="#66CC99">60</td>
    <td width="5%" align="center" bgcolor="#66CC99">61</td>
    <td width="5%" align="center" bgcolor="#66CC99">62</td>
    <td width="5%" align="center" bgcolor="#66CC99">63</td>
    ...
    <td width="4%" align="center" bgcolor="#66CC99">65</td>
	<td width="5%" align="center" bgcolor="#66CC99">66</td>
    <td width="4%" align="center" bgcolor="#66CC99">60</td>
    <td width="4%" align="center" bgcolor="#66CC99">61</td>
    <td width="4%" align="center" bgcolor="#66CC99">62</td>
    ...
    <td width="7%" align="center" bgcolor="#66CC99">65</td>
	<td width="5%" align="center" bgcolor="#66CC99">66</td>
    <td width="4%" align="center" bgcolor="#66CC99">60</td>
    <td width="4%" align="center" bgcolor="#66CC99">61</td>
    <td width="4%" align="center" bgcolor="#66CC99">62</td>
    ...
    <td width="6%" align="center" bgcolor="#66CC99">65</td>
	<td width="5%" align="center" bgcolor="#66CC99">66</td>
    <td width="6%" align="center" bgcolor="#66CC99">60</td>
    <td width="6%" align="center" bgcolor="#66CC99">61</td>
    <td width="6%" align="center" bgcolor="#66CC99">62</td>
...
$sql3="select * from condxofyear_so where hn='$rows[hn]' and yearcheck='2562' order by row_id desc limit 1";
$query3=mysql_query($sql3);
$rows3=mysql_fetch_array($query3);

$sql4="select * from condxofyear_so where hn='$rows[hn]' and yearcheck='2563' order by row_id desc limit 1";
$query4=mysql_query($sql4);
$rows4=mysql_fetch_array($query4);

$sql5="select * from condxofyear_so where hn='$rows[hn]' and yearcheck='2564' order by row_id desc limit 1";
$query5=mysql_query($sql5);
$rows5=mysql_fetch_array($query5);

$sql6="select * from condxofyear_so where hn='$rows[hn]' and yearcheck='2565' order by row_id desc limit 1";
$query6=mysql_query($sql6);
$rows6=mysql_fetch_array($query6);
$sql7="select * from condxofyear_so where hn='$rows[hn]' and yearcheck='2566' order by row_id desc limit 1";
...
?>  
  <tr>
    ...
    <td><?=$rows6["bp1"]."/".$rows6["bp2"];?></td>
	<td><?=$rows7["bp1"]."/".$rows7["bp2"];?></td>
