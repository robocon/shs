...
<form method="POST" action="vnlab.php">
    <p>ผู้ป่วยนอก  VN (ได้จากเวชระเบียน)</p>
    <p>&nbsp;&nbsp;VN&nbsp;&nbsp;<input type="text" name="vn" size="8" id="aLink"></p>
...
If (!empty($vn)){
	...
	//กรณีลงทะเบียนแล้ว
        ...
        $ipsql="select * from ipcard where hn='".$cHn."' and ( dcdate='0000-00-00 00:00:00' AND `lock_dc` IS NULL ) AND ptname !='' AND bedcode !='' ";
        ...
        if(mysql_num_rows($ipquery) > 0){ 
            ...
            print "<META HTTP-EQUIV=\"Refresh\" CONTENT=\"0;URL=labask.php?cHn=$cHn&tvn=$tvn\">";
