...
$cbedname=$_REQUEST['cbedname'];
  $query = "SELECT hn,an,ptname,age,ptright,bedcode,doctor,bed,diagnos FROM bed WHERE an = '".$_POST['can']."' ";

    $result = mysql_query($query) or die("Query bed fail");
