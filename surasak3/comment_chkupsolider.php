...
if(isset($_POST['save2'])){
		...
		echo "<a href ='comment_chkupsolider.php' >&lt;&lt; กลับ</a>&nbsp;&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp;<a href ='chk_year.php' target='_blank' >รายชื่อทหารที่ลงทะเบียนตรวจสุขภาพ</a>";
?>		
...
<table width="50%" border="0" align="center" cellpadding="3" cellspacing="0">
  ...
  <tr>
    <td align="right" bgcolor="#66CC99"><strong>สาเหตุที่จำหน่าย : </strong></td>
    <td bgcolor="#CCFFCC"><select name="comment" class="forntsarabun" id="comment" >
        <option value="เกษียณ/เกษียนก่อนอายุราชการ">เกษียณ/เกษียนก่อนอายุราชการ</option>
        <option value="ลาออก">ลาออก</option>
        <option value="ป่วย">ป่วย</option>
        <option value="หนี/จำหน่าย">หนี/จำหน่าย</option>
        <option value="ย้ายหน่วย">ย้ายหน่วย</option>
        <option value="ตรวจที่อื่น">ตรวจที่อื่น</option>
