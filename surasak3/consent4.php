...
array_push($list_witness,'จันทร์วลัย ปราบริปู');
array_push($list_witness2,'จันทร์วลัย ปราบริปู');

array_push($list_witness,'ปิยาพัชร สุขหมื่น');
array_push($list_witness2,'ปิยาพัชร สุขหมื่น');
	...
	<TR>
		...
		<TR>
			...
			echo "&nbsp;&nbsp;ตัวช่วย&nbsp;:&nbsp;";
				...
				$sql = "Select name From doctor where status = 'y' and erstatus='y' and name not like 'HD%' AND row_id > 0";
				$result = Mysql_Query($sql);
				$i=1;
				while($arr = Mysql_fetch_assoc($result)){
