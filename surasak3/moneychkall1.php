...
if( $appd1 == '2565-04-28' ){
  ...
  $part = urlencode('ศูนย์ฝึกอบรมตำรวจภูธร ภาค 5 (1)');
  $type1 = urlencode('เงินสด');
  $appd = urlencode($appd);
  echo '<a target="_BLANK" href="chk_credit_police63.php?repdate='.$appd.'&part='.$part.'&type='.$type1.'">ตรวจสุขภาพตำรวจ - เงินสด</a> จำนวน = 517 รายการ<br>';

  $type2 = urlencode('เงินโอน');
  echo '<a target="_BLANK" href="chk_credit_police63.php?repdate='.$appd.'&part='.$part.'&type='.$type2.'">ตรวจสุขภาพตำรวจ - เงินโอน</a> จำนวน = 15 รายการ';
