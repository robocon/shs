...
$toborow=$_GET['toborow'];
	...
	$sql1="SELECT  *  FROM opday WHERE thidate like '$thidate%' and substr( toborow, 1, 4 ) =  '$toborow' AND ( date_format( `thidate` , '%H:%i:%s' )  BETWEEN '00:00:00' AND '07:59:59' ) order by thidate asc";
