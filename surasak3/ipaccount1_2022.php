...
//        $time=substr($aDay[$n],0,8);
        print("<tr>\n".
                "<td bgcolor=FCF3CF><font face='Angsana New'>$num</td>\n".
                "<td bgcolor=FCF3CF><font face='Angsana New'>$aDay[$n]</td>\n".
                "<td bgcolor=FCF3CF><font face='Angsana New'>$aDep[$n]</td>\n".
                "<td bgcolor=FCF3CF><font face='Angsana New'>$aDtail[$n]</td>\n".  
                "<td bgcolor=FCF3CF><font face='Angsana New'>$aAmt[$n]</td>\n".  
                "<td bgcolor=FCF3CF><font face='Angsana New'>$aPri[$n]</td>\n".  
                "<td bgcolor=FCF3CF><font face='Angsana New'>$aPaid[$n]</td>\n".  
                "<td bgcolor=FCF3CF><font face='Angsana New'>$aPart[$n]</td>\n".  
                "<td bgcolor=FCF3CF><font face='Angsana New'>$aIdname[$n]</td>\n".  
                " </tr>\n");
       $num++;
        }
*/
...
*/
$part='dp';
    $query = "SELECT * FROM ipacc WHERE an = '$cAn'  and part like '$part%' ";
    $result = mysql_query($query)
        or die("Query failed ipacc");
    for ($i = mysql_num_rows($result) - 1; $i >= 0; $i--) {
        if (!mysql_data_seek($result, $i)) {
...
print "  </table> <div style=\"page-break-before: always;\"></div>";
   ...
   print "<font face='Angsana New' size ='4'><b>ผู้ป่วย $cPtname</b>&nbsp;&nbsp;";
   print "HN: $cHn &nbsp;&nbsp; <B>AN: $cAn</B>&nbsp;&nbsp; เตียง $cBed<br>";
   print "สิทธิการรักษา :$cPtright&nbsp;&nbsp;<BR>";
   print "รับป่วย: $cDate,&nbsp;&nbsp; จำหน่าย: $cDcdate, &nbsp;&nbsp;วันนอน $nDay  วัน <br>";
   print "โรค : $cDiag,&nbsp;&nbsp;  แพทย์ : $cDoctor";
      print "<font face='Angsana New' size ='4'><BR><BR><B>สรุปค่ารักษาพยาบาลผู้ป่วยในประเภทอุปกรณ์</B> <br>";
...
print "<table>";
print " <tr>";
print "  <th bgcolor=73C6B6>#</th>";
//print "  <th bgcolor=73C6B6>วันที่</th>";

print "  <th bgcolor=73C6B6>แผนก</th>";
print "  <th bgcolor=73C6B6>รหัส</th>";
print "  <th bgcolor=73C6B6>รายการ</th>";
print "  <th bgcolor=73C6B6><B>DPYCODE</B></th>";
print "  <th bgcolor=73C6B6>จำนวน</th>";
print "  <th bgcolor=73C6B6>ราคา</th>";
print "  <th bgcolor=73C6B6>PART</th>";
//print "  <th bgcolor=73C6B6>เบิกไม่ได้</th>";
//print "  <th bgcolor=73C6B6>จ่ายเงิน</th>";
//print "  <th bgcolor=73C6B6>ประเภท</th>";
//print "  <th bgcolor=73C6B6>จนท.</th>";
print " </tr>";
////
  ...
  $query = "SELECT date,depart,detail,amount,price,paid,part,idname,code,price FROM ipacc WHERE an = '$cAn' and part like '$part%'    ";
...
list($dpycode) = Mysql_fetch_row($result2);
		print("<tr>\n".
                "<td bgcolor=FCF3CF><font face='Angsana New'>$num</td>\n".
             //   "<td bgcolor=FCF3CF><font face='Angsana New'>$day</td>\n".
			
                "<td bgcolor=FCF3CF><font face='Angsana New'>$depart</td>\n".
					  "<td bgcolor=FCF3CF><font face='Angsana New'>$code</td>\n".
                "<td bgcolor=FCF3CF><font face='Angsana New'>$detail</td>\n".  
					   "<td bgcolor=FCF3CF align='center'><font face='Angsana New'><B>$dpycode</B></td>\n".  
                "<td bgcolor=FCF3CF align='right'><font face='Angsana New'>$amount</td>\n".  
                "<td bgcolor=FCF3CF align='right'><font face='Angsana New'>&nbsp;$price</td>\n".  
                "<td bgcolor=FCF3CF><font face='Angsana New'>$part</td>\n".  
             //  "<td bgcolor=FCF3CF><font face='Angsana New'>$nprice</td>\n".  
          //      "<td bgcolor=FCF3CF><font face='Angsana New'>$idname</td>\n".  
                " </tr>\n");
		      }
 include("unconnect.inc");
...
// $nNprice=$BFN+$DPN+$Nessdn+$DNessdn+$DSN+$Mc;
 ...
 $nNprice=$BFN+$DPN+$Nessdn+$DNessdn+$DSN+$Mc+$Bloodn+$Labon+$Xrayn+$Sinvn+$Tooln+$Surgn+$Ncaren+$Dentn+$Physin+$Stxn+$Mcn+$Mcy;
 $alldp=$nYprice+$nNprice;
 
 print " รวมเงินค่าอุปกรณ์ <B>$alldp</B> บาท<BR>";
...
*/
$part='surg';
    $query = "SELECT * FROM ipacc WHERE an = '$cAn'  and code ='$part' ";
    $result = mysql_query($query)
        or die("Query failed ipacc");
    for ($i = mysql_num_rows($result) - 1; $i >= 0; $i--) {
        if (!mysql_data_seek($result, $i)) {
...
//print "  </table> <div style=\"page-break-before: always;\"></div>";
  ...
  // print "สิทธิการรักษา :$cPtright&nbsp;&nbsp;<BR>";
   //print "รับป่วย: $cDate,&nbsp;&nbsp; จำหน่าย: $cDcdate, &nbsp;&nbsp;วันนอน $nDay  วัน <br>";
  // print "โรค : $cDiag,&nbsp;&nbsp;  แพทย์ : $cDoctor";
      print "<font face='Angsana New' size ='4'><B>สรุปค่ารักษาพยาบาลผู้ป่วยในห้องผ่าตัด</B> <br>";
  // print "&nbsp;&nbsp;<a target=_self  href='anaccdpy.php'><<ดูคนต่อไป</a>";
//
/*
BLOOD
...
////
  //  $query = "SELECT date,depart,detail,amount,price,paid,part,idname FROM ipacc WHERE an = '$cAn' and accno='$accno' ORDER BY depart,part,date ASC ";
  $query = "SELECT date,depart,detail,amount,price,paid,part,idname,code,price FROM ipacc WHERE an = '$cAn' and code = '$part'   ";
 
  $result = mysql_query($query)
        or die("Query failed ipacc");
    $num=0;
    while (list ($date,$depart,$detail12,$amount,$price,$paid,$part,$idname,$code,$price1) = mysql_fetch_row ($result)) {
	    $num++;
		$day=substr($date,0,10);
...
list($dpycode) = Mysql_fetch_row($result2);
		print("<tr>\n".
             ...
             //   "<td bgcolor=FCF3CF><font face='Angsana New'>$day</td>\n".
                ...
                "<td bgcolor=FCF3CF><font face='Angsana New'>$depart</td>\n".
					  "<td bgcolor=FCF3CF><font face='Angsana New'>$code</td>\n".
                "<td bgcolor=FCF3CF><font face='Angsana New'>$detail12</td>\n".  
					 //  "<td bgcolor=FCF3CF align='center'><font face='Angsana New'><B>$dpycode</B></td>\n".  
                "<td bgcolor=FCF3CF align='right'><font face='Angsana New'>$amount</td>\n".  
                "<td bgcolor=FCF3CF align='right'><font face='Angsana New'>&nbsp;$price</td>\n".  
             //   "<td bgcolor=FCF3CF><font face='Angsana New'>$paid</td>\n".  
                "<td bgcolor=FCF3CF><font face='Angsana New'>$part</td>\n".  
          //      "<td bgcolor=FCF3CF><font face='Angsana New'>$idname</td>\n".  
                " </tr>\n");
		      }
...
$code1='BFY';
 //   $query = "SELECT * FROM ipacc WHERE an = '$cAn' and accno='$accno' and part ='$part' ";
  $query = "SELECT * FROM ipacc WHERE an = '$cAn' and code like '$code1%'  ";
    $result = mysql_query($query)
        or die("Query failed ipacc");
    for ($i = mysql_num_rows($result) - 1; $i >= 0; $i--) {
        if (!mysql_data_seek($result, $i)) {
...
//print "  </table> <div style=\"page-break-before: always;\"></div>";
   ...
   print "<font face='Angsana New' size='4'><B>สรุปค่าห้องค่าอาหารผู้ป่วยในเบิกได้</B><br>";
...
print "  <th bgcolor=73C6B6>รหัส</th>";
print "  <th bgcolor=73C6B6>รายการ</th>";
//print "  <th bgcolor=73C6B6>DPYCODE</th>";
print "  <th bgcolor=73C6B6>จำนวน</th>";
print "  <th bgcolor=73C6B6>ราคา</th>";
//print "  <th bgcolor=73C6B6>จ่ายเงิน</th>";
print "  <th bgcolor=73C6B6>ประเภท</th>";
print "  <th bgcolor=73C6B6>แก้ไข</th>";
print " </tr>";
////
  //  $query = "SELECT date,depart,detail,amount,price,paid,part,idname FROM ipacc WHERE an = '$cAn' and accno='$accno' ORDER BY depart,part,date ASC ";
  $query = "SELECT row_id,date,depart,detail,amount,price,paid,part,idname,code,price FROM ipacc WHERE an = '$cAn' and code like 'BFY%' ";
 
  $result = mysql_query($query)
        or die("Query failed ipacc");
    $num=0;
    while (list ($row_id,$date,$depart,$detail,$amount,$price,$paid,$part,$idname,$code,$price1) = mysql_fetch_row ($result)) {
	    $num++;
		$day=substr($date,0,10);
		if($price==300.00){$n300++;}
		else if($price==600.00){$n600++;}
		else if($price==800.00){$n800++;}
	    else if($price==1200.00){$n1200++;}
		else {$n00++;};
...
//$detail=substr($detail,0,30);
		print("<tr>\n".
                "<td bgcolor=FCF3CF><font face='Angsana New'>$num</td>\n".
                "<td bgcolor=FCF3CF><font face='Angsana New'>$date</td>\n".
			
                "<td bgcolor=FCF3CF><font face='Angsana New'>$depart</td>\n".
					  "<td bgcolor=FCF3CF><font face='Angsana New'>$code</td>\n".
                "<td bgcolor=FCF3CF><font face='Angsana New'>$detail</td>\n".  
				//	   "<td bgcolor=FCF3CF><font face='Angsana New'>$dpycode</td>\n".  
                "<td bgcolor=FCF3CF align='right'><font face='Angsana New'>$amount</td>\n".  
                "<td bgcolor=FCF3CF align='right'><font face='Angsana New'>&nbsp;$price</td>\n".  
             //   "<td bgcolor=FCF3CF><font face='Angsana New'>$paid</td>\n".  
                "<td bgcolor=FCF3CF align='right'><font face='Angsana New'>&nbsp;$part</td>\n".  
               "<td bgcolor=FCF3CF><a href=\"ipaccount_edit.php?row_id=$row_id&an=$cAn\" target=_blank><font face='Angsana New'>แก้ไข</a></td>\n".  
                " </tr>\n");
		      }
 include("unconnect.inc");
...
print "ห้อง 300 = <b>$n300</b> วัน / ห้อง 600 = <b>$n600</b> วัน / ห้อง 800 = <b>$n800</b> วัน / ห้อง 1200 = <b>$n1200</b> วัน";
print "<b><CENTER><font face='Angsana New'  size='4'>รวมเงินทั้งสิ้น&nbsp;&nbsp;  $nYprice บาท</b>&nbsp;&nbsp;";
...
//print "  </table> <div style=\"page-break-before: always;\"></div>";
   ...
   print "<font face='Angsana New' size='4'><B>สรุปค่าห้องค่าอาหารผู้ป่วยในเบิกไม่ได้</B><br>";
 //  print "<font face='Angsana New'><b><FONT SIZE='3'>ผู้ป่วย $cPtname</b>&nbsp;&nbsp;";
 //  print "HN: $cHn &nbsp;&nbsp; <B>AN: $cAn</B>&nbsp;&nbsp; เตียง $cBed</FONT><br>";
 //  print "สิทธิการรักษา :$cPtright&nbsp;&nbsp;<BR>";
  // print "รับป่วย: $cDate,&nbsp;&nbsp; จำหน่าย: $cDcdate, &nbsp;&nbsp;วันนอน $nDay  วัน <br>";
...
////
  //  $query = "SELECT date,depart,detail,amount,price,paid,part,idname FROM ipacc WHERE an = '$cAn' and accno='$accno' ORDER BY depart,part,date ASC ";
  $query = "SELECT row_id,date,depart,detail,amount,price,paid,part,idname,code,price FROM ipacc WHERE an = '$cAn' and code like 'BFN%' ";
...
//
 ...
 $allprice=$nYprice+$nNprice;
// print " รวมเงินทั้งหมด &nbsp;<B>$allprice</B> บาท<BR>";
print "<b><CENTER><font face='Angsana New'  size='4'>รวมเงินทั้งสิ้น&nbsp;&nbsp;  $nNprice บาท</b>&nbsp;&nbsp;";
//print "(จ่ายแล้ว $Netpaid บาท&nbsp;&nbsp;";
$Netpri2=number_format($Netpri,2,".","");
    $cbaht=baht($Netpri2);
	print "&nbsp;&nbsp;( $cbaht)";
...
$code1='BF';
 //   $query = "SELECT * FROM ipacc WHERE an = '$cAn' and accno='$accno' and part ='$part' ";
  $query = "SELECT * FROM ipacc WHERE an = '$cAn' and code ='NCARE'  ";
    $result = mysql_query($query)
        or die("Query failed ipacc");
    for ($i = mysql_num_rows($result) - 1; $i >= 0; $i--) {
        if (!mysql_data_seek($result, $i)) {
...
//print "  </table> <div style=\"page-break-before: always;\"></div>";
   ...
   print "<font face='Angsana New' size='4'><B>สรุปค่าบริการทางการพยาบาล</B><br>";
  // print "<font face='Angsana New'><b><FONT SIZE='3'>ผู้ป่วย $cPtname</b>&nbsp;&nbsp;";
 //  print "HN: $cHn &nbsp;&nbsp; <B>AN: $cAn</B>&nbsp;&nbsp; เตียง $cBed</FONT><br>";
   //print "สิทธิการรักษา :$cPtright&nbsp;&nbsp;<BR>";
  // print "รับป่วย: $cDate,&nbsp;&nbsp; จำหน่าย: $cDcdate, &nbsp;&nbsp;วันนอน $nDay  วัน <br>";
...
////
  //  $query = "SELECT date,depart,detail,amount,price,paid,part,idname FROM ipacc WHERE an = '$cAn' and accno='$accno' ORDER BY depart,part,date ASC ";
  $query = "SELECT row_id,date,depart,detail,amount,price,paid,part,idname,code,price FROM ipacc WHERE an = '$cAn' and code ='NCARE' ";
...
//
 ...
 $allprice=$nYprice+$nNprice;
// print " รวมเงินทั้งหมด &nbsp;<B>$allprice</B> บาท<BR>";
print "<b><CENTER><font face='Angsana New'  size='4'>รวมเงินทั้งสิ้น&nbsp;&nbsp;  $allprice บาท</b>&nbsp;&nbsp;";
//print "(จ่ายแล้ว $Netpaid บาท&nbsp;&nbsp;";
$Netpri2=number_format($Netpri,2,".","");
    $cbaht=baht($Netpri2);
	print "&nbsp;&nbsp;( $cbaht)";
...
$part='dpy';
 //   $query = "SELECT * FROM ipacc WHERE an = '$cAn' and accno='$accno' and part ='$part' ";
  $query = "SELECT * FROM ipacc WHERE an = '$cAn' and part = 'DDY'  ";
    $result = mysql_query($query)
        or die("Query failed ipacc");
    for ($i = mysql_num_rows($result) - 1; $i >= 0; $i--) {
        if (!mysql_data_seek($result, $i)) {
...
print "  </table> <div style=\"page-break-before: always;\"></div>";
   print "<font face='Angsana New' size='4'><B>สรุปค่ารักษาพยาบาลผู้ป่วยในประเภทยานอกบัญชียาหลัก</B><br>";
   print "<font face='Angsana New'><b><FONT SIZE='3'>ผู้ป่วย $cPtname</b>&nbsp;&nbsp;";
   print "HN: $cHn &nbsp;&nbsp; <B>AN: $cAn</B>&nbsp;&nbsp; เตียง $cBed</FONT><br>";
...
////
  //  $query = "SELECT date,depart,detail,amount,price,paid,part,idname FROM ipacc WHERE an = '$cAn' and accno='$accno' ORDER BY depart,part,date ASC ";
  $query = "SELECT date,depart,detail,sum(amount),sum(price),paid,part,idname,code,price FROM ipacc WHERE an = '$cAn' and part = 'DDY' group by code  ORDER by part,code ";
...
if($amount < '0' ){$color='#FF0000';}else {$color='FCF3CF';};
		print("<tr>\n".
...
$code1='n';
 //   $query = "SELECT * FROM ipacc WHERE an = '$cAn' and accno='$accno' and part ='$part' ";
  $query = "SELECT * FROM ipacc WHERE an = '$cAn' and  part  like '%$code1'  ";
    $result = mysql_query($query)
        or die("Query failed ipacc");
    for ($i = mysql_num_rows($result) - 1; $i >= 0; $i--) {
        if (!mysql_data_seek($result, $i)) {
...
print "  </table> <div style=\"page-break-before: always;\"></div>";
   print "<font face='Angsana New' size='4'><B>สรุปค่ารักษาพยาบาลผู้ป่วยในส่วนเกินที่เบิกไม่ได้</B><br>";
   print "<font face='Angsana New'><b><FONT SIZE='3'>ผู้ป่วย $cPtname</b>&nbsp;&nbsp;";
   print "HN: $cHn &nbsp;&nbsp; <B>AN: $cAn</B>&nbsp;&nbsp; เตียง $cBed</FONT><br>";
   print "สิทธิการรักษา :$cPtright&nbsp;&nbsp;";
   print "รับป่วย: $cDate,&nbsp;&nbsp; จำหน่าย: $cDcdate, &nbsp;&nbsp;วันนอน $nDay  วัน <br>";
...
$code1='n';
  //  $query = "SELECT date,depart,detail,amount,price,paid,part,idname FROM ipacc WHERE an = '$cAn' and accno='$accno' ORDER BY depart,part,date ASC ";
  $query = "SELECT date,depart,detail,sum(amount),sum(price),paid,part,idname,code,price FROM ipacc WHERE an = '$cAn' and part  like '%$code1' group by code  ORDER by part,code ";
...
$nYprice=$Nessdy;
//$nNpricen=$BFN+$DPN+$Nessdn+$DNessdn+$DSN+$Mc+$Mcn;

 $nNpricen=$BFN+$DPN+$Nessdn+$DNessdn+$DSN+$Mc+$Bloodn+$Labon+$Xrayn+$Sinvn+$Tooln+$Surgn+$Ncaren+$Dentn+$Physin+$Stxn+$Mcn;
 
$allprice=$nYprice+$nNpricen;
// print " รวมเงินทั้งหมด &nbsp;<B>$allprice</B> บาท<BR>";
print "<b><CENTER><font face='Angsana New'  size='4'>รวมเงินทั้งสิ้น&nbsp;&nbsp; $nNpricen บาท</b>&nbsp;&nbsp;&nbsp;";
//print "(จ่ายแล้ว $Netpaid บาท&nbsp;&nbsp;";
$Netpri2=number_format($nNpricen,2,".","");
    $cbaht=baht($Netpri2);
	print "&nbsp;&nbsp;( $cbaht)";
/*
print "<div align='left'>";
...
print "  </table> <div style=\"page-break-before: always;\"></div>";
   print "<font face='Angsana New' size='4'><B>สรุปค่ารักษาพยาบาลผู้ป่วยในแยกตามรายการ</B><br>";
   print "<font face='Angsana New'><b><FONT SIZE='3'>ผู้ป่วย $cPtname</b>&nbsp;&nbsp;";
   print "HN: $cHn &nbsp;&nbsp; <B>AN: $cAn</B>&nbsp;&nbsp; เตียง $cBed</FONT><br>";
   print "สิทธิการรักษา :$cPtright&nbsp;&nbsp;";
   print "รับป่วย: $cDate,&nbsp;&nbsp; จำหน่าย: $cDcdate, &nbsp;&nbsp;วันนอน $nDay  วัน <br>";
...
////
  //  $query = "SELECT date,depart,detail,amount,price,paid,part,idname FROM ipacc WHERE an = '$cAn' and accno='$accno' ORDER BY depart,part,date ASC ";
  $query = "SELECT date,depart,detail,sum(amount),sum(price),paid,part,idname,code,price FROM ipacc WHERE an = '$cAn'  group by code  ORDER by part,code ";
...
print "  </table> <div style=\"page-break-before: always;\"></div>";
   print "<font face='Angsana New' size='4'><B>สรุปค่ารักษาพยาบาลผู้ป่วยในเรียงตามวันเวลา</B><br>";
   print "<font face='Angsana New'><b><FONT SIZE='3'>ผู้ป่วย $cPtname</b>&nbsp;&nbsp;";
   print "HN: $cHn &nbsp;&nbsp; <B>AN: $cAn</B>&nbsp;&nbsp; เตียง $cBed</FONT><br>";
   print "สิทธิการรักษา :$cPtright&nbsp;&nbsp;";
   print "รับป่วย: $cDate,&nbsp;&nbsp; จำหน่าย: $cDcdate, &nbsp;&nbsp;วันนอน $nDay  วัน <br>";
...
////
  //  $query = "SELECT date,depart,detail,amount,price,paid,part,idname FROM ipacc WHERE an = '$cAn' and accno='$accno' ORDER BY depart,part,date ASC ";
  $query = "SELECT row_id,date,depart,detail,amount,price,paid,part,idname,code,price FROM ipacc WHERE an = '$cAn'  ORDER by date ";
...
//$detail=substr($detail,0,30);
		print "<tr>\n".
             ...
             //   "<td bgcolor=FCF3CF><font face='Angsana New'>$idname</td>\n".  
			 if($part=="MC"){
			 	print "<td bgcolor=FCF3CF><a href=\"ipaccount_edit.php?row_id=$row_id&an=$cAn\" target=_blank><font face='Angsana New'>แก้ไข</a></td>\n";
			 }else{
				print "<td bgcolor=FCF3CF>&nbsp;</td>";
			}
               print " </tr>\n";
		      }
 include("unconnect.inc");
