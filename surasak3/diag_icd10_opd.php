...
<table  border="0">
  <tr>
    <td colspan="6" align="center">HN : <?=$_GET['hn']?>   วันที่ : <?=$_GET['date'];?>
    <hr />
    </td>
  </tr>
  <tr>
  ...
  <tr bgcolor="#00CCFF">
    ...
    <?
  $sql="select * from diag where hn ='".$_GET['hn']."'  and svdate like '".$_GET['date']."%' and  type='PRINCIPLE' limit 1 ";
...
<td valign="top">
  ...
  <? 
  $sql1="select * from diag where hn ='".$_GET['hn']."'  and svdate like '".$_GET['date']."%' and  type='CO-MORBIDITY' ";
...
?>
  ...
  <? 
  $sql2="select * from diag where hn ='".$_GET['hn']."'  and svdate like '".$_GET['date']."%' and  type='COMPLICATION' ";
...
?>
  ...
  <? 
  $sql3="select * from diag where hn ='".$_GET['hn']."'  and svdate like '".$_GET['date']."%' and  type='OTHER' ";
...
?>
  ...
  <? 
  $sql4="select * from diag where hn ='".$_GET['hn']."'  and svdate like '".$_GET['date']."%' and  type='EXTERNAL CAUSE' ";
...
?>
    ...
    <td valign="top"><table border="0">
      ...
      <? 
  $sql5="select * from opicd9cm where hn ='".$_GET['hn']."'  and svdate   like '".$_GET['date']."%'  ";
