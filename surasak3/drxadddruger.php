...
<TR>
	...
	<TD>
		<SELECT NAME="slcode">
			<Option value="ER">คืน ER </Option>
			<Option value="B">ให้ผู้ป่วย</Option>
		</SELECT>
	</TD>
</TR>
<TR>
...
$i=1;
    while (list ($drugcode, $tradname,$genname,$salepri,$stock,$mainstk) = mysql_fetch_row ($result)) {
        print (" <FORM name= \"form".$i."\" METHOD=POST ACTION=\"drxadddruger.php?action=add&sDate=".urlencode($_GET["sDate"])."&nRow_id=".urlencode($_GET["nRow_id"])."\"><tr>\n".
