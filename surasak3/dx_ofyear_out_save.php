...
$benzene = sprintf("%s", $_POST['benzene']);
$benzene_result = sprintf("%s", $_POST['benzene_result']);
$bone_density = sprintf("%s", $_POST['bone_density']);
$occupa_health = sprintf("%s", $_POST['occupa_health']);
$outAfp = sprintf("%s", $_POST['outAfp']);
$outAfpResult = sprintf("%s", $_POST['outAfpResult']);
$outPsa = sprintf("%s", $_POST['outPsa']);
$outPsaResult = sprintf("%s", $_POST['outPsaResult']);
...
if( $dxofyear_out_rows > 0 ){ 
	...
	`alkflag`, `dx`, `officer`,`yearchk`,`labin_date`,`dental_exam`,
	`color_blind`,`audiogram`,`ekg`,`hdl`,`hdl_range`,`hdl_flag`,
	`10001`,`10001_range`,`10001_flag`,`malari`,`malari_range`,`malari_flag`,
	`metamp`,`metamp_range`,`metamp_flag`,`hbsag`,`hbsag_range`,`hbsag_flag`,
	`hcvab`,`hcvab_range`,`hcvab_flag`,`hiv`,`hiv_range`,`hiv_flag`,
	`vdrl`,`vdrl_range`,`vdrl_flag`,`parasi`,`parasi_range`,`parasi_flag`,
	`groupt`,`groupt_range`,`groupt_flag`,`rh`,`rh_range`,`rh_flag`,
	`upt`,`upt_range`,`upt_flag`,`antihb`,`antihb_flag`,`ldl`,
	`ldl_range`,`ldl_flag`,`stocc`,`stoccflag`,`HBA1CC`,`HBA1CCrange`,
	`HBA1CCflag`,`CEA`,`CEArange`,`CEAflag`,`PSA`,`PSArange`,
	`PSAflag`,`AFP`,`AFPrange`,`AFPflag`,`TP`,`TPrange`,
	`TPflag`,`ALB`,`ALBrange`,`ALBflag`,`TB`,`TBrange`,
	`TBflag`,`DB`,`DBrange`,`DBflag`) 
	VALUES 
	('".$date_now."','".$date_hn."','".$date_vn."','".$_POST["hn"]."','".$_POST["vn"]."','".$_POST["ptname"]."',
	'".$_POST["age"]."','".$_POST["camp"]."','".$_POST["camp_until"]."','".$_POST["height"]."','".$_POST["weight"]."','".$_POST["round_"]."',
	'".$_POST["temperature"]."','".$_POST["pause"]."','".$_POST["rate"]."','".$_POST["bmi"]."','".$_POST["bp1"]."','".$_POST["bp2"]."',
	'".$_POST["bp21"]."','".$_POST["bp22"]."','".$_POST["drugreact"]."','".$_POST["cigarette"]."','".$_POST["alcohol"]."','".$_POST["exercise"]."',
	'".$_POST["congenital_disease"]."','".$_POST["type"]."','".$_POST["organ"]."','".$_POST["clinic"]."','".$_POST["doctor"]."','".$_POST["ua_color"]."',
	'".$_POST["ua_appear"]."','".$_POST["ua_spgr"]."','".$_POST["ua_phu"]."','".$_POST["ua_bloodu"]."','".$_POST["ua_prou"]."','".$_POST["ua_gluu"]."',
	'".$_POST["ua_ketu"]."','".$_POST["ua_urobil"]."','".$_POST["ua_bili"]."','".$_POST["ua_nitrit"]."','".$_POST["ua_wbcu"]."','".$_POST["ua_rbcu"]."',
	'".$_POST["ua_epiu"]."','".$_POST["ua_bactu"]."','".$_POST["ua_yeast"]."','".$_POST["ua_mucosu"]."','".$_POST["ua_amopu"]."','".$_POST["ua_castu"]."',
	'".$_POST["ua_crystu"]."','".$_POST["ua_otheru"]."','".$_POST["cbc_wbc"]."','".$_POST["WBCrange"]."','".$_POST["WBCflag"]."','".$_POST["cbc_rbc"]."',
	'".$_POST["cbc_hb"]."','".$_POST["cbc_hct"]."','".$_POST["HCTrange"]."','".$_POST["HCTflag"]."','".$_POST["cbc_mcv"]."','".$_POST["cbc_mch"]."',
	'".$_POST["cbc_mchc"]."','".$_POST["cbc_pltc"]."','".$_POST["PLTCrange"]."','".$_POST["PLTCflag"]."','".$_POST["cbc_plts"]."','".$_POST["cbc_neu"]."',
	'".$_POST["cbc_lymp"]."','".$_POST["cbc_mono"]."','".$_POST["cbc_eos"]."','".$_POST["cbc_baso"]."','".$_POST["cbc_band"]."','".$_POST["cbc_atyp"]."',
	'".$_POST["cbc_nrbc"]."','".$_POST["cbc_rbcmor"]."','".$_POST["cbc_other"]."','".$_POST["cxr"]."','".$_POST["bs"]."','".$_POST["GLUrange"]."',
	'".$_POST["GLUflag"]."','".$_POST["bun"]."','".$_POST["BUNrange"]."','".$_POST["BUNflag"]."','".$_POST["cr"]."','".$_POST["CREArange"]."',
	'".$_POST["CREAflag"]."','".$_POST["uric"]."','".$_POST["URICrange"]."','".$_POST["URICflag"]."','".$_POST["chol"]."','".$_POST["CHOLrange"]."',
	'".$_POST["CHOLflag"]."','".$_POST["tg"]."','".$_POST["TRIGrange"]."','".$_POST["TRIGflag"]."','".$_POST["sgot"]."','".$_POST["ASTrange"]."',
	'".$_POST["ASTflag"]."','".$_POST["sgpt"]."','".$_POST["ALTrange"]."','".$_POST["ALTflag"]."','".$_POST["alk"]."','".$_POST["ALPrange"]."',
	'".$_POST["ALPflag"]."','".$_POST["dx"]."','$sOfficer','".$nPrefix."','".$_POST['labin_date']."','$dental_exam',
	'$color_blind','$audiogram','$ekg','$hdl','$hdl_range','$hdl_flag',
	'$ldlc','$ldlc_range','$ldlc_flag','$malari','$malari_range','$malari_flag',
	'$metamp','$metamp_range','$metamp_flag','$hbsag','$hbsag_range','$hbsag_flag',
	'$hcvab','$hcvab_range','$hcvab_flag','$hiv','$hiv_range','$hiv_flag',
	'$vdrl','$vdrl_range','$vdrl_flag','$parasi','$parasi_range','$parasi_flag',
	'$groupt','$groupt_range','$groupt_flag','$rh','$rh_range','$rh_flag',
	'$upt','$upt_range','$upt_flag', '$ANTIHB', '$ANTIHBflag','$ldl',
	'$ldl_range','$ldl_flag','$stocc','$STOCCflag','$HBA1CC','$HBA1CCrange',
	'$HBA1CCflag','$CEA','$CEArange','$CEAflag','$PSA','$PSArange',
	'$PSAflag','$AFP','$AFPrange','$AFPflag','$TP','$TPrange',
	'$TPflag','$ALB','$ALBrange','$ALBflag','$TB','$TBrange',
...
if($sendto_out_result_chkup > 0){
	...
	if( $out_result_chkup_row > 0 ){
		...
		`ekg` = '".sprintf("%s", $_POST['ekg'])."',
		`va` = '".sprintf("%s", $_POST['va'])."',
		`stool` = '',
		`cxr` = '".sprintf("%s", $_POST['cxr'])."',
		`year_chk` = '".$nPrefix."',
		`part` = '$part',
		`42702` = '".sprintf("%s", $_POST['42702'])."',
		`hpv` = '".sprintf("%s", $_POST['hpv'])."',
		`altra` = '".sprintf("%s", $_POST['altra'])."',
		`psa` = '".sprintf("%s", $_POST['psa'])."',
		`mammogram` = '".sprintf("%s", $_POST['mammogram'])."',
		...
		`pt` ='".sprintf("%s", $_POST['pt'])."',
		`pt_detail` ='".sprintf("%s", $_POST['pt_detail'])."',
		`last_officer` = '$out_result_officer',
		`last_update` = '$register', 
		`cs` = '".sprintf("%s", $_POST['cs'])."',
		`result_cs` = '".sprintf("%s", $_POST['result_cs'])."',
		`blindness` = '".sprintf("%s", $_POST['color_blind'])."', 
		`hearing` = '".sprintf("%s", $_POST['hearing'])."', 
		`metal` = '".sprintf("%s", $_POST['metal'])."', 
		`metal_result` = '".sprintf("%s", $_POST['metal_result'])."',

		`benzene` = '$benzene',
		`benzene_result` = '$benzene_result',
		...
		`bmi` = '$bmi'
		";
		$out_result_insert = mysql_query($out_result_chkup_insert) or die( mysql_error().' : '.$out_result_chkup_insert );
