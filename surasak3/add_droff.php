...
if(isset($_POST["okbtn"])){
	for($i=0;$i<=31;$i++){
		if($_POST['day'.$i]!=""){ 
			$droffinsert = "insert into dr_offline values(NULL,'".$_POST['day'.$i]."','".$_SESSION['name']."')";
...
if(!isset($_GET['id'])){
	...
	?>
	<select name="doctor" onChange="show_carlendar(encodeURIComponent(this.value))"> 
...
?>
<form name='formdr' action="add_droff.php" method="post">
<?php
echo "<TABLE>
<TR   valign=\"top\">
	<TD>";
