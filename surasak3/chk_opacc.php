...
if(isset($_POST['Chkhn'])){
 include("connect.inc");
	...
	$strsql="SELECT *,concat(yot,name,' ',surname)as ptname FROM `opcardchk` WHERE  HN = '".$_POST['Chkhn']."' and part='สอบตำรวจ59'";
...
<form name="form1" action="" method="post">
  ...
  <tr>
    ...
    <td>เลขประจำตัวสอบ:      <strong>
      <?=$arr['pid'];?>
    </strong></td>
  </tr>
  <tr>
    <td align="right" valign="top">เลขที่บิล</td>
    <td colspan="2"><input name="billno" type="text" class="fontsara" id="billno" value="" /></td>
  </tr>
  <tr>
