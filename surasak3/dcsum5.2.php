...
print "<center><font face='Angsana New' face='Angsana New' size='3' >การให้คำแนะนำที่ศูนย์ผู้ป่วยใน <b>สิทธิ์เบิกจากกรมบัญชีกลาง</b></font><br>";
...
print "<font face='Angsana New' size='2' ><input type='checkbox' >มีฐานข้อมูลกรมบัญชีกลาง ขอหนังสือรับรองสิทธิ์ผ่านระบบ ONLINE&nbsp;หรือ&nbsp;</font>";
print "<font face='Angsana New' size='2' ><input type='checkbox' >หนังสือรับรองสิทธิ์จากหน่วยงานต้นสังกัด</font><br>";
...
print "<font face='Angsana New' size='3' ><input type='checkbox' >ค่าห้องส่วนเกิน(สิทธิ์เบิกได้ 1000 บาท) จำนวน....................../คืน</font><br>";
...
print "<font face='Angsana New' size='3' ><input type='checkbox' >ค่ายา ค่าเวชภัณฑ์ ค่าบริการ ชำระส่วนที่เบิกไม่ได้จากกรมบัญชีกลาง</font><br>";
