...
if($sNetprice >= 0 && ($_POST["credit"] == "เงินสด" || $_POST["credit"] == "กรุงเทพ" || $_POST["credit"] == "กรุงไทย" || $_POST["credit"] == "ประกันสังคม" || $_POST["credit"] == "จ่ายตรง" || $_POST["credit"] == "เช็ค" || $_POST["credit"] == "เงินโอน")){
...
print "    <tr>";
print "      <td width='100%'><font  TEXT-ALIGN:RIGHT size='4'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$credit1จาก&nbsp;<b>$sPtname</b>&nbsp;&nbsp;&nbsp;HN:$sHn&nbsp;&nbsp;vn:&nbsp;(".$_SESSION["sVn"].")&nbsp;&nbsp;วันที่&nbsp;$Thdate &nbsp;&nbsp;เวลา&nbsp;$billtime </td>";
print "      <td width='0%'><font  size='4'></font></td>";
print "      <td width='0%'><font size='4'></font></td>";
...
print "      <td width='80%'><font  TEXT-ALIGN:RIGHT></font></td>";
print "    </tr>";
print "  </table>";
print "</div>";
print "<div align='left'>";
...
print "    <tr>";
print "      <td width='9%'></td>";
print "      <td width='100%'><font ></font></td>";
print "    </tr>";
print "  </table>";
print "</div>";
print "<br><br>";
...
print "    <tr>";
//print "      <td width='9%'></td>";
print "      <td width='32%'><font  size='4'>ยาในบัญชียาหลักแห่งชาติ</td>";
print "      <td width='19%' align='right'><font  size='4'>$sEssd</td>";
print "      <td width='12%' align='right'><font  size='4' ></td>";
print "      <td width='6%'><font  size='3' ></td>";
print "    </tr>";
print "    <tr>";
//print "      <td width='9%'></td>";
print "      <td width='32%'><font  size='4'>ยานอกบัญชียาหลักแห่งชาติ</td>";
print "      <td width='19%' align='right' ><font   size='4'>$sNessdy</td>";
print "      <td width='12%' align='right' ><font  size='4' >$sNessdn</td>";
print "      <td width='6%'><font ></td>";
print "    </tr>";
print "    <tr>";
//print "      <td width='9%'></td>";
print "      <td width='32%'><font  size='4'>ค่าเวชภัณฑ์ที่ไม่ใช่ยา</td>";
print "      <td width='19%' align='right'><font  size='4' >$sDSY</td>";
print "      <td width='12%' align='right'><font   size='4'>$sDSYN</td>";
print "      <td width='6%'><font ></td>";
print "    </tr>";
print "    <tr>";
//print "      <td width='9%'></td>";
print "      <td width='32%'><font  size='4'>ค่าอุปกรณ์ทางการแพทย์ ";
...
print "</td>";
print "      <td width='19%' align='right'><font  size='4'>$sDPY</td>";
print "      <td width='12%' align='right'><font  size='4' >$sDPN</td>";
print "      <td width='6%'><font ></td>";
print "    </tr>";
          /*if (empty($sAn)){
	print "    <tr>";
	//print "      <td width='9%'></td>";
//แก้ค่าบริการทางการแพทย์
	print "      <td width='32%'><font  size='4'>(55020/55021)ค่าบริการผู้ป่วยนอก</td>";
	print "      <td width='19%' align='right'><font  size='4'>50.00</td>";
	print "      <td width='12%' ><font   ></td>";
	print "      <td width='6%'><font ></td>";
	print "    </tr>";
		}*/
print "  </table>";
...
print "<font  size = '3'><br></font>";
print "<div align='left'>";
print "  <table border='0' cellpadding='0' cellspacing='0' width='100%'>";
print "    <tr>";
//print "      <td width='9%'></td>";
print "      <td width='32%'><font >โรค: $sDiag</font></td>";
print "      <td width='19%' align='right'><font  size='4' ><B>$netfree</B></td>";
print "      <td width='12%' align='right'><font  size='4' ><B>$netpay</B></td>";
	print "      <td width='6%'><font ></td>";
print "    </tr>";
print "  </table>";
print "</div>";
...
print "      <td width='32%'><font  size ='4'><B>$cbaht</B></td>";
print "      <td width='5%' ><font  size ='3'></td>";
print "      <td width='15%' align='right'><font  size ='4'><B>$total</B></td>";
	print "      <td width='6%'><font  size ='3'></td>";
print "    </tr>";
print "  </table>";
print "</div>";
...
print "      <td width='26%'><font  size='2'>(".$name.")</font></td>";
print "      <td width='10%'><font  size='2'>เจ้าหน้าที่เก็บเงิน</font></td>";
print "    </tr>";
print "  </table>";
print "</div>";
        }
