...
<?
if($_GET["opdtype"]=="ALL"){
	$sql="select * from opday where (thidate >= '$date1 00:00:00' and thidate <= '$date2 23:59:59') and (opdtype ='SI' || opdtype='HI' || opdtype='FI') order by opdtype desc";
}else{
	$sql="select * from opday where (thidate >= '$date1 00:00:00' and thidate <= '$date2 23:59:59') and opdtype='".$_GET["opdtype"]."' order by row_id asc";	
}
//echo $sql;
