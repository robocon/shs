...
<a target=_self  href='../nindex.htm'><<ไปเมนู</a>
  <table width="80%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="35" class="font1"><strong class="font2">รายงานสถิติการ Refer</strong></td>
    </tr>
    <tr>
      <td height="50" class="font1">เดือน 
      <? if(date("m")=="01") echo "selected"; ?>
      <select name="mon">
...
<table width="100%" border="1" cellpadding="0" cellspacing="0"><tr><td width="3%" align="center" class="font1"><strong>#</strong></td>
  ...
  <?
	$sql = "select * from refer where dateopd like '".$_POST['yr']."-".$_POST['mon']."%' and ward like '".$_POST['position']."%' order by refer_runno asc ";
