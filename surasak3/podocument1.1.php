...
If (!empty($yym)){
	...
	$num++;
     ...
     "  <td BGCOLOR=66CDAA><font face='Angsana New'><a target=_BLANK  href=\"prepoprn.1.php? 	nRow_id=$row_id\">$prepodate</td>\n".


                    "  <td BGCOLOR=66CDAA><font face='Angsana New'><a target=_BLANK  href=\"prepoprn1.php? 	nRow_id=$row_id\">$prepodate</td>\n".
   
                    "  <td BGCOLOR=66CDAA><font face='Angsana New'><a target=_BLANK  href=\"prepoprn1.1.php? 	nRow_id=$row_id\">$prepodate</td>\n".
