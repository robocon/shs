...
//  print "<font face='Angsana New' size= 4 ><b><CENTER>ใบรายการยากลับบ้าน</CENTER></b></font>";
    print "<br><font face='Angsana New' size= 3 ><b>ใบรายการยากลับบ้าน</b>&nbsp;ห้องจ่ายยา(ผู้ป่วยนอก)โรงพยาบาลค่ายสุรศักดิ์มนตรี ลำปาง โทร 054-839305 ต่อ 1160</font><br>";
    ...
    print "<font face='Angsana New'>โรค: $rxDiag</font><br>";
	$num1='0';
    ...
    while (list ($tradname,$drugcode,$amount,$price,$slcode,$drugcode,$part,  $detail1, $detail2, $detail3, $detail4,$dia,$dis,$dit,$die,$office,$unit) = mysql_fetch_row ($result)) {
        ...
        print (" <tr>\n".
			  "  <td><font face='Angsana New'>$num.</td>\n".
			    "  <td><font face='Angsana New' size='1'>$drugcode</td>\n".
           "  <td><font face='Angsana New' size='2'><b>$tradname</b>&nbsp;[$unit]</td>\n".
           "  <td align='right'><font face='Angsana New'>&nbsp;<b>(&nbsp;$amount&nbsp;)</b></td>\n".
...
<?php
 ...
 print "<font face='Angsana New' size='2'>แพทย์ :$rxDoctor &nbsp;&nbsp;&nbsp;";
