...
print "<form name='f1' action='ipbedfix2.php?drugcode=$drugcode&slcode=$slcode' method='post'>";
/////  1  แนวตั้ง
...
print "<DIV style='left:300PX;top:780PX;width:306PX;height:30PX;'><input type='hidden' name='an' value='$can'></DIV>";
print "<DIV style='left:320PX;top:780PX;width:306PX;height:30PX;'><input type='hidden' name='hn' value='$chn'></DIV>";
print "<DIV style='left:340PX;top:780PX;width:306PX;height:30PX;'><input type='hidden' name='tradname' value='$objarr[tradname]'></DIV>";
print "<DIV style='left:340PX;top:780PX;width:306PX;height:30PX;'><input type='hidden' name='drugcode' value='$drugcode'></DIV>";
print "<DIV style='left:360PX;top:780PX;width:306PX;height:30PX;'><input type='hidden' name='slcode' value='$slcode'></DIV>";
print "<DIV style='left:360PX;top:780PX;width:306PX;height:30PX;'><input type='hidden' name='wardname' value='$cbedname'></DIV>";
print "</form>";
print "</div>";
