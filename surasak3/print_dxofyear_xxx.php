...
.style2{ font-family: "TH SarabunPSK"; font-size: 16px; }
hr{ height: 2px;width: 100%;color: #000000;background-color: #000; }3

</style>
<?php 
$_GET["part"] = "เอ็นเนอร์จี60";
$showpart = "เอ็นเนอร์จี60";
if(isset($_GET['part'])){
	$sql = "select *  from opcardchk where part = '".$_GET['part']."' order by row asc limit 654,55";
       ...
       <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#666666">
         <tr>
           <td><table width="100%">
               ...
               <tr>
                 <td width="69%" align="left" class="pdx">คณะ : <strong>
                     <?=$course;?>
                     </strong>&nbsp;&nbsp;&nbsp;หมายเลขโทรศัพท์ : .....................................................................
