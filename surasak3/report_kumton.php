...
<title>พิมพ์ใบตรวจสุขภาพบริษัท กำธรผ้าใบ จำกัด</title>
<style type="text/css">
<!--
.tet {
...
<center>
<span class="tet1">พิมพ์ใบตรวจสุขภาพบริษัท กำธรผ้าใบ จำกัด</span> <br />
  <br />
...
if(isset($_POST['hn'])){
	...
	$select = "select * from opd  where hn='".$result2['HN']."' and thidate like '2557-09-16%'";
...
$sql1="CREATE TEMPORARY TABLE  result1  Select * from  resulthead  WHERE hn='".$result2['HN']."' and clinicalinfo ='ตรวจสุขภาพประจำปี57' ";
  ...
  <tr>
    <td colspan="2"><table width="100%">
      <tr>
        ...
        <td width="77%" align="center" valign="top" class="texthead"><strong>แบบรายงานการตรวจสุขภาพบริษัท กำธรผ้าใบ จำกัด</strong></td>
