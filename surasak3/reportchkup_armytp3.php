...
if($_POST["act"]=="show"){
	...
	$numchunyot1++;		
		...
		//-------------------------------- เช็คชั้นยศ-------------------------------//
	if($yot=="ร.ต." || $yot=="ร.ต.หญิง" || $yot=="ร.ท." || $yot=="ร.ท.หญิง" || $yot=="ร.อ." || $yot=="ร.อ.หญิง"
	|| $yot=="พ.ต." || $yot=="พ.ต.หญิง" || $yot=="พ.ท." || $yot=="พ.ท.หญิง" || $yot=="พ.อ." || $yot=="พ.อ.หญิง"
	|| $yot=="พล.ต." || $yot=="พล.ต.หญิง" || $yot=="พล.ท." || $yot=="พล.ท.หญิง" || $yot=="พล.อ." || $yot=="พล.อ.หญิง"){	
	...
	}else if($yot=="พลอาสาฯ" || $yot=="พลอาสา" || $yot=="ส.ต." || $yot=="ส.ต.หญิง" || $yot=="ส.ท." || $yot=="ส.ท.หญิง" || $yot=="ส.อ." || $yot=="ส.อ.หญิง"
	|| $yot=="จ.ส.ต." || $yot=="จ.ส.ต.หญิง" || $yot=="จ.ส.ท." || $yot=="จ.ส.ท.หญิง" || $yot=="จ.ส.อ." || $yot=="จ.ส.อ.หญิง"){
			if($chkrows["cigarette"]=="" || $chkrows["cigarette"]=="0"){
				$ch2cigarette0++;
			}
			if($chkrows["cigarette"]=="1"){
