...
print "      <td width='68%'><font face='Angsana New' size='3'>&#3648;&#3591;&#3636;&#3609;&#3588;&#3656;&#3634;&#3619;&#3633;&#3585;&#3625;&#3634;&#3614;&#3618;&#3634;&#3610;&#3634;&#3621;ผู้ป่วยใน&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font face='Angsana New'></font></td>";
print "    </tr>";
print "  </table>";
print "</div>";
print "<div align='left'>";
...
print "      <td width='20%'><font face='Angsana New'>ได้รับ&nbsp; เงินสด</td>";
print "      <td width='45%'><font face='Angsana New'>จาก$cPtname";
print "      <td width='25%'><font face='Angsana New'>วันที่$Thdate";
print "       </font></td>";
print "    </tr>";
...
print "      <td width='9%'></td>";
print "      <td width='69%'>";
print "        <p><font face='Angsana New' size='3'>1. &#3588;&#3656;&#3634;&#3627;&#3657;&#3629;&#3591;&#3649;&#3621;&#3632;&#3588;&#3656;&#3634;&#3629;&#3634;&#3627;&#3634;&#3619;&#3619;&#3623;&#3617;&nbsp;</font></td>";
print "      <td width='11%' valign='bottom'><font face='Angsana New'  size='3'></font></td>";
...
print "      <td width='11%'><font face='Angsana New'></font></td>";
...
print "      <td width='11%'><font face='Angsana New' size='3'></font></td>";
print "      <td width='11%'><font face='Angsana New' size='3'>$BNessdn</font></td>";
print "    </tr>";
print "    <tr>";
print "      <td width='9%'></td>";
print "      <td width='69%'><font face='Angsana New' size='3'>5. &#3588;&#3656;&#3634;&#3648;&#3623;&#3594;&#3616;&#3633;&#3603;&#3601;&#3660;&#3607;&#3637;&#3656;&#3652;&#3617;&#3656;&#3651;&#3594;&#3656;&#3618;&#3634;</font></td>";
print "      <td width='11%'><font face='Angsana New' size='3'></font></td>";
...
print "    <tr>";
print "      <td width='9%'></td>";
print "      <td width='69%'></td>";
print "      <td width='11%'><font face='Angsana New' size='3'></font></td>";
print "      <td width='11%'><font face='Angsana New' size='3'>$Nsubtotal</font></td>";
print "    </tr>";
print "    <tr>";
print "      <td width='9%'></td>";
print "      <td width='69%'><font face='Angsana New' size='3'>$cbaht</font></td>";
print "      <td width='11%'></td>";
print "      <td width='11%'><font face='Angsana New' size='3'>$paid</font></td>";
print "    </tr>";
print "  </table>";
print "</div>";
print "<div align='left'>";
...
print "    <tr>";
print "      <td width='10%'></td>";
print "      <td width='20%'><font face='Angsana New'>วันที่&nbsp;$Thdate</td>";
print "      <td width='45%'><font face='Angsana New'>เวลา&nbsp;$Time";
...
print "    <tr>";
print "      <td width='10%'></td>";
print "      <td width='23%'><font face='Angsana New'>ได้รับ&nbsp;$credit</td>";
print "      <td width='36%'><font face='Angsana New'>จาก&nbsp;<B>$cPtname</B>";
print "      <td width='18%'><font face='Angsana New'>HN:&nbsp;$cHn";
print "      <td width='20%'><font face='Angsana New'>AN:&nbsp;$cAn";
...
print "<td width='35%'><font face='Angsana New'>วันที่รับป่วย:&nbsp;$cAdmitALL</td>";
...
print "      <td width='37%'><font face='Angsana New'>วันที่จำหน่าย:&nbsp;$dcdateALL";
print "      <td width='33%'><font face='Angsana New'>รวม&nbsp;$cDays&nbsp;วัน";
print "       </font></td>";
print "    </tr>";
print "    <tr>";
print "      <td width='10%'></td>";
print "      <td width='30%' colspan='2'><font face='Angsana New'>โรค:&nbsp;$cDiag</td>";
...
//print "      <td width='16%' valign='middle'><font face='Angsana New'>รายการ<br>";
//print "        เบิกได้<br>";
print "        <td width='15%' valign='middle' align='right'><font face='Angsana New' size='3'><br>";
print "        <br>";
print "        <br>";
print "        <br>";
...
print "      <td width='10%'></td>";
print "      <td width='20%'></td>";
print "      <td width='10%' align='right'><font face='Angsana New' size='3'>".number_format($Nsubtotal, 2)."</font></td>";
print "      <td width='18%' align='right'><font face='Angsana New' size='3'></font></td>";
print "      <td width='10%'></td>";
print "    </tr>";
print "    <tr>";
print "      <td width='5%'></td>";
...
print "      <td width='5%'></td>";
print "      <td width='10%'><font face='Angsana New' size='4'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>".number_format($paid, 2)."</B></font></td>";
print "      <td width='5%'></td>";
print "    </tr>";
print "  </table>";
print "</div>";
