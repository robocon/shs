...
#ptrightNotify{top: 2%;left: 50%;width:600px;height:250px;margin-top: 1em;margin-left: -50px;border: 1px solid #ccc;background-color: #f3f3f3;position:fixed;}
#ptnotifyHeader{padding: 6px;background: #636363;text-align: right;}
#ptrightClose{font-size: 24px;color: #17202A;text-decoration: none;}
...
<table border="1" cellspacing="0" cellpadding="2" style="border-collapse:collapse;"  bordercolor="#000000" class="font1">
  ...
  limit 1 ";
	...
	<td><a href="#?idcard=<?=$idcard;?>" onclick="testCheckSit('<?=$idcard;?>')" >WebService สปสช</a></td>
  </tr>
  <? 
  	$i++;
	//}
