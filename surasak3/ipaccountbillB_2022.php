...
print "<CENTER>โรงพยาบาลค่ายสุรศักดิ์มนตรี ลำปาง<br></CENTER>";
 $Thaidate=date("d-m-").(date("Y")+543)."  ".date("H:i:s");
   print "<CENTER>สรุปค่ารักษาพยาบาลผู้ป่วยในส่วนเกินค่าห้องและค่าอื่นๆ&nbsp;&nbsp;<B>เลขที่ใบเสร็จ&nbsp;..................</B>&nbsp;&nbsp;เมื่อวันที่&nbsp;&nbsp;$Thaidate</CENTER>";
...
print "        0<br>";
print "       0<br>";
print "       0<br>"; //4. ยาที่นำไปใช้ต่อที่บ้าน เบิกไม่ได้
print "        0<br>";
print "       0<br>";
print "        0<br>";
print "        0<br>";
