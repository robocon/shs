    ...
    <tr>
      <td align="center">หน่วย :
        ...
        <select name="camp" id="camp">
          <option value="D01">โรงพยาบาลค่ายสุรศักดิ์มนตรี</option>
          <option value="MTB32">หน่วยขึ้นตรง มทบ.32</option>
          <option value="D30">ร.17 พัน.2</option>
          <option value="D31">ช.พัน.4 ร้อย4</option>
          <option value="D32">ร้อย.ฝรพ.3</option>
        </select>
...
<?
if($_POST["act"]=="show"){
if($_POST["camp"]=="D01"){  //โรงพยาบาลค่ายสุรศักดิ์มนตรี
$sql1="SELECT *
FROM `condxofyear_so`
WHERE `yearcheck` = '$nPrefix2' AND `camp1` like 'D01%' and camp1 !='' ORDER BY camp1 ASC, substring(age,1,2) DESC";
}else if($_POST["camp"]=="MTB32"){  //หน่วยขึ้นตรง มทบ.32
$sql1="SELECT *
FROM `condxofyear_so`
WHERE `yearcheck` = '$nPrefix2' AND (`camp1` like 'D02%' OR `camp1` like 'D03%' OR `camp1` like 'D04%' OR `camp1` like 'D05%' OR `camp1` like 'D06%' OR `camp1` like 'D07%' OR `camp1` like 'D08%' OR `camp1` like 'D09%' OR `camp1` like 'D10%' OR `camp1` like 'D11%' OR `camp1` like 'D12%' OR `camp1` like 'D13%' OR `camp1` like 'D14%' OR `camp1` like 'D15%' OR `camp1` like 'D16%' OR `camp1` like 'D17%' OR `camp1` like 'D18%' OR `camp1` like 'D19%' OR `camp1` like 'D20%' OR `camp1` like 'D21%' OR `camp1` like 'D22%' OR `camp1` like 'D23%' OR `camp1` like 'D24%' OR `camp1` like 'D25%' OR `camp1` like 'D26%' OR `camp1` like 'D27%' OR `camp1` like 'D28%' OR `camp1` like 'D29%') and camp1 !='' ORDER BY camp1 ASC, substring(age,1,2) DESC";
}else if($_POST["camp"]=="D30"){  //ร.17 พัน.2
$sql1="SELECT *
FROM `condxofyear_so`
WHERE `yearcheck` = '$nPrefix2' AND `camp1` like 'D30%' and camp1 !='' ORDER BY camp1 ASC, substring(age,1,2) DESC";
}else if($_POST["camp"]=="D31"){  //ช.พัน.4 ร้อย4
$sql1="SELECT *
FROM `condxofyear_so`
WHERE `yearcheck` = '$nPrefix2' AND `camp1` like 'D31%' and camp1 !='' ORDER BY camp1 ASC, substring(age,1,2) DESC";
}else if($_POST["camp"]=="D32"){  //ร้อย.ฝรพ.3
$sql1="SELECT *
FROM `condxofyear_so`
WHERE `yearcheck` = '$nPrefix2' AND `camp1` like 'D32%' and camp1 !='' ORDER BY camp1 ASC, substring(age,1,2) DESC";
}
...
$totalm++;
	if($rows["age"] < 35){  //เพศชาย อายุน้อยกว่า 35
		...
		//ไขมันในเลือด
		if($rows["chol"] > 240 && $rows["tg"] < 200){
			$cholage35m++;	
		}else if($rows["chol"] < 240 && $rows["tg"] > 200){
			$tgage35m++;	
		}else if($rows["chol"] > 240 && $rows["tg"] > 200){
			$bloodage35m++;	
		}	
...
<div align="left"><strong>หน่วยทหารที่มารับการตรวจ</strong> <? if($_POST["camp"]=="D01"){ echo "โรงพยาบาลค่ายสุรศักดิ์มนตรี";}else if($_POST["camp"]=="MTB32"){ echo "หน่วยขึ้นตรง มทบ.32";}else if($_POST["camp"]=="D30"){ echo "ร.17 พัน.2";}else if($_POST["camp"]=="D31"){ echo "ช.พัน.4 ร้อย4";}else if($_POST["camp"]=="D32"){ echo "ร้อย.ฝรพ.3";}?></div>
<br />
