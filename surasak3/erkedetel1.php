<?php
  ...
  print "รายงานประจำ เดือน $yrmonth <a target=_self  href='../nindex.htm'><<ไปเมนู</a><br> ";
   $query="SELECT  code,detail ,COUNT(*) AS duplicate FROM patdata1 GROUP BY code HAVING duplicate > 0 ORDER BY duplicate";
 ...
 while (list ($code,$detail,$duplicate) = mysql_fetch_row ($result)) {
            ...
            print (" <tr>\n".
              ...
              "  <td BGCOLOR=66CDAA><font face='Angsana New'><a target=_BLANK href=\"chkerkedetel.php? code=$code&yrmonth=$yrmonth\">$code&nbsp;&nbsp;</a></td>\n".
