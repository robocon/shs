...
If (!empty($yym)){
    ...
    $query = "SELECT billdate,docno,comname,price,billno,getdate,chequeok FROM duecompany WHERE billdate LIKE '$yym%' ORDER BY billdate ";
    $result = mysql_query($query) or die("Query failed");
    $num=0;
   $netprice=0;

    while (list ($billdate,$docno,$comname,$price,$billno,$getdate,$chequeok) = mysql_fetch_row ($result)) {
	$num++;
        ...
        print (" <tr>\n".
           ...
           "  <td BGCOLOR=66CDAA><font face='Angsana New'>$chequeok</td>\n".
           " </tr>\n");
          }
