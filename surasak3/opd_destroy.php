...
<TR>
	<TD colspan="2" class="tb_head">HN ที่ถูกทำลายประวัติ</TD>
</TR>
<TR class="tb_detail">
	<TD>ข้อมูลปี : </TD>
	<TD>
...
<?php
	if(isset($_POST["opcard_year"]) && $_POST["opcard_year"] != ""){
		...
		$sql = "Select hn, yot, name, surname From opcard where left(hn,2) = '".$_POST["opcard_year"]."' AND left(idguard,4) = 'MX07'  Order by regisdate ASC ";
