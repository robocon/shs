...
<?
$query = "SELECT an,hn,ptname,ptright,date,dcdate,diag,doctor,bedcode,fname FROM ipcard WHERE an = '".$an."' and fname !=' ' ";
$result = mysql_query($query)or die("Query failed2");
while (list ($ran,$rhn,$rptname,$rptright,$rdate,$rdcdate,$rdiag,$rdoctor,$rbedcode,$rfname) = mysql_fetch_row ($result)) {
...
print "<CENTER><font face='Angsana New'  size='5'>โรงพยาบาลค่ายสุรศักดิ์มนตรี ลำปาง<br></CENTER>";
 $Thaidate=date("d-m-").(date("Y")+543)."  ".date("H:i:s");
   print "<CENTER><font face='Angsana New'  size='4'>สรุปค่ารักษาพยาบาลผู้ป่วยใน&nbsp;&nbsp;เมื่อวันที่&nbsp;&nbsp;$Thaidate</CENTER>";
...
list($thaidateor,$hnor,$anor,$timein,$timeout) = Mysql_fetch_row($result2);
    ...
    print "วันที่ผ่าตัด&nbsp;&nbsp;$thaidateor&nbsp;&nbsp;&nbsp;เวลาเข้า&nbsp;$timein&nbsp;&nbsp;เวลาออก&nbsp;$timeout<BR></CENTER>";
...
print "  <th bgcolor=6495ED>รายการ</th>";
print "  <th bgcolor=6495ED><B>DPYCODE</B></th>";
print "  <th bgcolor=6495ED>จำนวน</th>";
print "  <th bgcolor=6495ED>ราคา</th>";
print "  <th bgcolor=6495ED>PART</th>";
...
list($dpycode) = Mysql_fetch_row($result2);
		print("<tr>\n".
             ...
             //   "<td bgcolor=F5DEB3><font face='Angsana New'>$day</td>\n".
                ...
                "<td bgcolor=F5DEB3><font face='Angsana New'>$depart</td>\n".
					  "<td bgcolor=F5DEB3><font face='Angsana New'>$code</td>\n".
                "<td bgcolor=F5DEB3><font face='Angsana New'>$detail12</td>\n".  
					 //  "<td bgcolor=F5DEB3 align='center'><font face='Angsana New'><B>$dpycode</B></td>\n".  
                "<td bgcolor=F5DEB3 align='right'><font face='Angsana New'>$amount</td>\n".  
                "<td bgcolor=F5DEB3 align='right'><font face='Angsana New'>&nbsp;$price</td>\n".  
             //   "<td bgcolor=F5DEB3><font face='Angsana New'>$paid</td>\n".  
...
//print "  <th bgcolor=6495ED>จ่ายเงิน</th>";
print "  <th bgcolor=6495ED>ประเภท</th>";
print "  <th bgcolor=6495ED>แก้ไข</th>";
print " </tr>";
////
  //  $query = "SELECT date,depart,detail,amount,price,paid,part,idname FROM ipacc WHERE an = '$cAn' and accno='$accno' ORDER BY depart,part,date ASC ";
...
//$detail=substr($detail,0,30);
		print("<tr>\n".
                ...
                "<td bgcolor=F5DEB3 align='right'><font face='Angsana New'>&nbsp;$price</td>\n".  
             //   "<td bgcolor=F5DEB3><font face='Angsana New'>$paid</td>\n".  
                "<td bgcolor=F5DEB3 align='right'><font face='Angsana New'>&nbsp;$part</td>\n".  
               "<td bgcolor=F5DEB3><a href=\"ipaccount_edit.php?row_id=$row_id&an=$cAn\" target=_blank><font face='Angsana New'>แก้ไข</a></td>\n".  
                " </tr>\n");
		      }
 include("unconnect.inc");
...
//$detail=substr($detail,0,30);
		print "<tr>\n".
             ...
             //   "<td bgcolor=F5DEB3><font face='Angsana New'>$idname</td>\n".  
			 if($part=="MC"){
			 	print "<td bgcolor=F5DEB3><a href=\"ipaccount_edit.php?row_id=$row_id&an=$cAn\" target=_blank><font face='Angsana New'>แก้ไข</a></td>\n";
			 }else{
				print "<td bgcolor=F5DEB3>&nbsp;</td>";
			}
               print " </tr>\n";
		      }
 include("unconnect.inc");
