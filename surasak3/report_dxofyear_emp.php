...
/*		$select1 = "select * from dxofyear_emp where hn = '".$_GET['hn']."' and yearchk='$nPrefix' order by row_id desc limit 1";
		...
		echo "<script>alert('แพทย์ยังไม่ได้ตรวจยืนยันผลของปี $nPrefix2');window.close();</script>";
		exit();
	}
...
<tr>
  ...
  <td align="center" valign="top" class="texthead"><strong>แบบรายงานการตรวจสุขภาพลูกจ้างประจำปี <?=$nPrefix2;?></strong></td>
  </tr>
<tr>
...
<tr>
  ...
  <td valign="top" class="text2"><span class="text3"><strong>สังกัด : </strong> <strong>
...
<tr>
  <td valign="top"><span class="text3"><strong>บุหรี่: </strong>
    <? if($result1['cigarette']=="1"){ echo "เคยสูบ";}else if($result1['cigarette']=="0"){ echo "ไม่สูบ";}else{ echo "สูบ";}?>
  </span></td>
  <td valign="top"><span class="text3"><strong>สุรา: </strong>
    <? if($result1['alcohol']=="1"){ echo "เคยดื่ม";}else if($result1['alcohol']=="0"){ echo "ไม่ดื่ม";}else{ echo "ดื่ม";}?>  
  </span></td>
...
<tr>
  ...
  <? if($result1['bs']!=''){?>
    <tr>
      ...
      <tr>
        <td valign="top" class="text3"><strong>LDL(การตรวจไขมัน) :</strong></td>
	...
	?>
        ...
        <? if($result1['summary']!=''){?>
    <tr>
      <td height="27" colspan="5" align="center" valign="top" class="text1"><hr /><strong>สรุปผลการตรวจสุขภาพ</strong>&nbsp;<u><?=$result1['summary']?></u>      </td>
    </tr>
    <? }?>
</table></td></tr>
    <tr>
