...
print "<DIV style='left:1PX;top:80PX;width:400PX;height:20PX;'><span class='fc1-0'><img src = \"barcode/labstk.php?cLabno=$labno\"></span></DIV>";
//print "<DIV style='left:70PX;top:75PX;width:500PX;height:30PX;'><span class='fc1-1'>$labno</span></DIV>";
//print "<DIV style='left:130PX;top:75PX;width:500PX;height:30PX;'><span class='fc1-7'>$nLab2</span></DIV>";
$i=0;
$indexx = 0;
$dglist=array();
for ($n=1; $n<=$x; $n++){
...
print "<DIV style='left:0PX;top:52PX;width:200PX;'><span class='fc1-5'>".$strdclist1."</span></DIV>";

if(trim($strdclist2) !=""){
	$strdclist2 = implode(",",$dglist[1]);
	print "<DIV style='left:0PX;top:62PX;width:200PX;'><span class='fc1-5'>".$strdclist2."</span></DIV>";
}
print "</BODY></HTML>";
