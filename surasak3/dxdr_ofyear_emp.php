...
<center>
  <div class="font_title">ตรวจสุขภาพประจำปีลูกจ้าง</div></center>
...
<FORM name="dxdrform" METHOD="post" ACTION="dxdr_ofyear_save_emp.php"   onsubmit="return check()" >
...
<table border="0" width="100%">
          <tr>
            ...
            <td width="120" class="labfont"><input name='normal31' type='radio' value='ปกติ' onclick="togglediv2('acnormal31')" <? if($result_dx['hctflag']=="N") echo "checked";?> />
              ปกติ 
              <input name='normal31' type='radio' value='ผิดปกติ' onclick="togglediv1('acnormal31')" <? if($result_dx['hctflag']!="N"&&$result_dx['hctflag']!="") echo "checked";?>/>ผิดปกติ </td>
              <td width="412">
...
<table border="1" cellpadding="2" cellspacing="0" bordercolor="#393939"  width="100%" bgcolor="#FEFBD6"><tr>
  <td>
      ...
      <td colspan="3" class="tb_font_1" bgcolor="#0033FF">ผลการตรวจ HB Profile</td>
      	...
      	<?
        $chk6 = "select * from chk_hb where hn='".$_SESSION["hn_now"]."' and yearchk='".$nPrefix."' ";
		$rowschk6 = mysql_query($chk6);
		$repchk6 = mysql_fetch_array($rowschk6);
		?>
      <tr>
      <td width="12%" align="right" class="tb_font_2">HbsAg :</td><td width="7%" class="labfont"><?=$repchk6['hbsag']?></td><td width="81%"><span class="labfont">
...
ผิดปกติ </span></td>
      ...
      <tr>
      <td align="right" class="tb_font_2">HbsAb :</td><td class="labfont"><?=$repchk6['hbsab']?></td><td><span class="labfont">
...
ผิดปกติ </span></td>
      ...
      <tr>
      <td align="right" class="tb_font_2">HbcAb :</td><td class="labfont"><?=$repchk6['hbcab']?></td><td><span class="labfont">
...
ผิดปกติ </span></td>
      ...
      <tr>
        ...
        <td class="labfont"><?=$repchk6['leadlevel']?></td>
  ...
  <tr>
    <td><table width="100%" border="0">
      ...
      <tr>
        ...
        <td class="labfont"><?=$repchk7['ova']?></td>
      </tr>
      <tr>
        <td align="right" class="tb_font_2">Please concentrated in:</td>
        <td class="labfont"><?=$repchk7['concentrated']?></td>
      </tr>
      <tr>
        <td align="right" class="tb_font_2">Stool Occult blood :</td>
        <td class="labfont"><?=$repchk7['blood']?></td>
      </tr>
      <tr>
        <td height="47" colspan="2" bgcolor="#CCCCFF" class="profile"  style="color:#000"><strong>ผลการตรวจ</strong>
          <input name='normal65' type='radio' value='ปกติ' onclick="togglediv2('acnormal81')" id="normal" />
          ปกติ
  <input name='normal81' type='radio' value='ผิดปกติ' onclick="togglediv1('acnormal81')" id="normal2" />
          ผิดปกติ </td>
        </tr>
    </table></td>
  </tr>
...
<TR>
	<TD><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FEFBD6">
	  ...
	  <tr bgcolor="#CCCCFF">
	    ...
	    <td width="25%" class="labfont"><input name='normal51' type='radio' value='ปกติ' onclick="togglediv2('acnormal51')" id="normal94"/>
	      ปกติ
	  ...
	  <tr>
		...
		?>
	    <td class="labfont">&nbsp;<?=$repchk2['stat_eye']?></td>
...
ผิดปกติ </td>
		...
		?>
	    <td class="labfont">&nbsp;<?=$repchk3['stat']?></td>
