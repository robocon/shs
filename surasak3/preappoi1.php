...
if(!checkdate  ( $month + 1, $today  , $year  )){
	...
	echo '<a href="javascript: void(0);" onclick="show_carlendar(\''.rawurlencode($dt_doctor).'&today='.date('d').'&dfMonth='.date('m').'&dfYear='.date('Y').'\')">&gt;&gt; วันปัจจุบัน</a>&nbsp;||&nbsp;';
	// echo '<a href="javascript: void(0);" onclick="show_carlendar(\'&today='.$n1mD.'&dfMonth='.$n1mM.'&dfYear='.$n1mY.'\')">&gt;&gt; นัด 1เดือน</a>&nbsp;||&nbsp;';
	echo '<a href="javascript: void(0);" onclick="show_carlendar(\''.rawurlencode($dt_doctor).'&today='.$n2mD.'&dfMonth='.$n2mM.'&dfYear='.$n2mY.'\')">&gt;&gt; นัด 2เดือน</a>&nbsp;||&nbsp;';
	echo '<a href="javascript: void(0);" onclick="show_carlendar(\''.rawurlencode($dt_doctor).'&today='.$n3mD.'&dfMonth='.$n3mM.'&dfYear='.$n3mY.'\')">&gt;&gt; นัด 3เดือน</a>';
	echo '<br>';
	echo '<a href="javascript: void(0);" onclick="show_carlendar(\''.rawurlencode($dt_doctor).'&today='.$n6mD.'&dfMonth='.$n6mM.'&dfYear='.$n6mY.'\')">&gt;&gt; นัด 6เดือน</a>&nbsp;||&nbsp;';
	echo '<a href="javascript: void(0);" onclick="show_carlendar(\''.rawurlencode($dt_doctor).'&today='.$n1yD.'&dfMonth='.$n1yM.'&dfYear='.$n1yY.'\')">&gt;&gt; นัด 1ปี</a>&nbsp;||&nbsp;';
	echo '<a href="javascript: void(0);" onclick="show_carlendar(\''.rawurlencode($dt_doctor).'&today='.$n2yD.'&dfMonth='.$n2yM.'&dfYear='.$n2yY.'\')">&gt;&gt; นัด 2ปี</a>';
	echo '<br>';
...
<a href=\"javascript:void(0);\" Onclick=\"show_carlendar('$dt_encode&today=".$today2."&dfMonth=".($month + 1)."&dfYear=".$year."');\">&gt;</a>
</td></tr>
