...
print "  ราคาขาย&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
print "  &nbsp;&nbsp; <input class='txtsarabun'  type='text' name='salepri' size='20' tabindex='7'value='$cSalepri'><strong style='color:green; margin-left:20px;'>* ราคาที่ รพ. กำหนด</strong><br>";
...
if($cPart=='DSY' || $cPart=='DPY'){
print "  ราคาอุปกรณ์เบิกได้&nbsp;&nbsp;&nbsp;<input class='txtsarabun'  type='text' name='freepri' size='10' tabindex='9'value='$cFreepri'><strong style='color:red; margin-left:20px;'>* ราคาที่ รพ.ขอเบิก</strong><br>";
print "  ('' '' เบิกได้ไม่เกิน)&nbsp;&nbsp;&nbsp;<input class='txtsarabun'  type='text' name='freelimit' size='11' tabindex='9'value='$cFreelimit'><strong style='color:blue; margin-left:20px;'>* ราคาที่กองทุนให้เบิก</strong><BR>";
}else{
...
print "   packing&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
print " &nbsp;&nbsp;&nbsp;<input class='txtsarabun'  type='text' name='pack' size='15' tabindex='17' value=$cPack><br>";
print "   pack&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
