<p align="center">คิดค่าใช้จ่าย Lab ตรวจสุขภาพลูกจ้าง 2560
...
if($_POST["act"]=="add"){
include("connect.inc"); 
$sql="select * from opcardchk as a inner join  dxofyear_emp as b on a.HN=b.hn where a.part='ลูกจ้าง60' and b.thidate like '2017-03-22%' group by b.hn order by a.exam_no asc";
//echo $sql;
