...
*/
  print "<a  href=runupdatephar.php>แก้ไขทั้งหมด</a>".
...
print "<th bgcolor=CD853F><font face='Angsana New'><b>........</b></th>";
    ...
    $query = "SELECT  title,prefix,runno FROM runno where title = 'pharin_m' ";
...
print "<th bgcolor=CD853F><font face='Angsana New'><b>........</b></th>";
    ...
    $query = "SELECT  title,prefix,runno FROM runno where title = 'pharin_l' ";
    $result = mysql_query($query) or die("Query failed");
    while (list ($title,$prefix,$runno) = mysql_fetch_row ($result)) {
        print ("<tr>\n".
           "  <td BGCOLOR=F5DEB3><font face='Angsana New'>$title</td>\n".
