...
<form name="f1" action="" method="post">
  ...
  <tr class="forntsarabun">
    <td colspan="2" bgcolor="#99CC99">รายงานประเภทผู้ป่วย   EX01&nbsp;รักษาโรคทั่วไปในเวลาราชการ และ EX02&nbsp;ผู้ป่วยฉุกเฉิน </td>
    </tr>
  <tr class="forntsarabun">
...
print "<div><font class='forntsarabun' >ยอดผู้ป่วยนอก เวรดึก  $day   $dateshow</font></div><br>";
...
echo $tsql2;*/
   ...
   <table  border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0" bordercolor="#000000" class="forntsarabun"> 
    ...
    <tr>
      ...
      <td><a href="report_exdetail.php?thidate=<?=$date1;?>&toborow=EX01" target="_blank">EX01 รักษาโรคทั่วไปในเวลาราชการ</a></td>
      <td align="right"><?=$arr1['ex01']?></td>
     </tr>
    <tr>
      <td align="center">2</td>
      <td><a href="report_exdetail.php?thidate=<?=$date1;?>&toborow=EX02" target="_blank">EX02 ผู้ป่วยฉุกเฉิน</a></td>
      <td align="right"><?=$arr2['ex02']?></td>
    </tr>
    <tr>
      <td colspan="2" align="center">รวมยอด</td>
