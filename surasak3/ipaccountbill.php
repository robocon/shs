...
ipmonrep table:
  ...
  ptright 
*/
    $query = "SELECT * FROM ipacc WHERE an = '$cAn' and billno = '$billno' ";
	// echo $query;
...
print "<CENTER><font face='Angsana New'  size='5'>โรงพยาบาลค่ายสุรศักดิ์มนตรี ลำปาง<br></CENTER>";
 $Thaidate=date("d-m-").(date("Y")+543)."  ".date("H:i:s");
   print "<CENTER><font face='Angsana New'  size='4'>สรุปค่ารักษาพยาบาลผู้ป่วยใน&nbsp;&nbsp;<B>เลขที่ใบเสร็จ&nbsp;$billno</B>&nbsp;&nbsp;เมื่อวันที่&nbsp;&nbsp;$Thaidate</CENTER>";
  ...
  //   print "<font face='Angsana New'  size='3'><CENTER>&nbsp;&nbsp;เมื่อวันที่&nbsp;&nbsp;$Thaidate</CENTER>";
   ...
   print "&nbsp;&nbsp;HN: <B>$cHn</B> &nbsp;&nbsp; AN: <B>$cAn</B> <font face='Angsana New'  size='3'>&nbsp;&nbsp;เตียง $cBed&nbsp;&nbsp; <BR>เลขบัตรประชาชน $idcard&nbsp;&nbsp;แพทย์ : $cDoctor &nbsp;&nbsp;น้ำหนัก&nbsp;&nbsp;..$sadm_w...กก.&nbsp;&nbsp;โรค : $cDiag&nbsp;,&nbsp;.......... <br>";
   print "&nbsp;&nbsp;&nbsp;สิทธิ :<B>$cPtright</B>&nbsp;&nbsp;ค่าห้องที่เบิกได้&nbsp;$sMy_food&nbsp;บาท จำหน่าย&nbsp;	$sDctype<br>";
   print "&nbsp;&nbsp;&nbsp;รับป่วย: $cDate,&nbsp;&nbsp; จำหน่าย: $cDcdate, &nbsp;&nbsp;วันนอน $nDay  วัน <br></CENTER>";
    print "<CENTER>*****************************</CENTER>";
...
////
  ...
  $query1 = "SELECT date,depart,detail,amount,price,paid,part,idname FROM ipacc WHERE an = '$cAn' and billno = '$billno' ";
 
  $result1 = mysql_query($query1)
        or die("Query failed ipacc");
    $num=0;
    while (list ($date,$depart,$detail,$amount,$price,$paid,$part,$idname) = mysql_fetch_row ($result1)) {
	    $num++;
...
if($cAn=="65/3389"){ //2565-11-15 18:42:02	
	$pricedc="0";
}
 include("unconnect.inc");
