<?php
    include("connect.inc");
    $query="CREATE TEMPORARY TABLE patdata1 SELECT * FROM patdata WHERE date LIKE '$yrmonth%' and depart = 'NID' ";
 ...
 while (list ($code,$detail,$duplicate) = mysql_fetch_row ($result)) {
            ...
            print (" <tr>\n".
              ...
              "  <td BGCOLOR=66CDAA><font face='Angsana New'><a target=_BLANK href=\"chkxraydetel.php? code=$code&yrmonth=$yrmonth\">$code&nbsp;&nbsp;</a></td>\n".
