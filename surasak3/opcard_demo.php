...
if(isset($_GET["action"]) && $_GET["action"] == "district"){
	...
	$search_txt = iconv("UTF-8", "TIS-620", $_GET["search"]);
...
function searchSuggest(str,len,getto1,getto2,getto3) {
	...
	if(str.length > 0){
		url = encodeURI('opcard_demo.php?action=district&search=' + str+'&getto1=' + getto1+'&getto2=' + getto2+'&getto3=' + getto3);
...
function searchSuggest2(str,len,getto1) {
		...
		if(str.length > 0){
			url = 'opcard_demo.php?action=hospcode&search2=' + str+'&getto1=' + getto1
