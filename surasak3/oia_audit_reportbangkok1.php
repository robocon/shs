...
$sql = "SELECT a.`date`,a.`txdate`, a.`hn`, CONCAT(b.`yot`,' ',b.`name`,' ',b.`surname`) AS full_name, a.`depart`, sum(a.`paidcscd`),
...
AND a.`credit` ='$credit' 
AND a.`paidcscd` > 0 
group by CONCAT(SUBSTRING(a.`date`,1,10),a.`hn`,a.`depart`) 
ORDER by a.`date` ASC";
...
echo "<font face='Angsana New' size ='4'><center> <b>ลูกหนี้โครงการ$credit ประจำวันที่ $date2 <br></b> ";
