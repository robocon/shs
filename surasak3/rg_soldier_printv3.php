...
class MySHSPdf extends SHSPdf { 
	function Footer1()
	{
		...
		$this->SetXY(0, 277);
		$this->Cell(0, 5, 'เอกสารนี้ประกอบการตรวจร่างกายทหารกองเกินเข้ารับราชการทหารกอบประจำการประจำปี ๒๕๖๖',0,1,'C');
...
$pdf->SetX(30);
$pdf->SetFont('THSarabun','',20);
$pdf->Cell(160, 8, 'ตรวจร่างกายทหารกองเกินเข้ารับราชการทหารกองประจำการประจำปี ๒๕๖๖', 0, 1, 'C');
