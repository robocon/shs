...
<body>
<p><a target="_top"  href="../nindex.htm">กลับสู่เมนูหลัก</a> || <a href="rphos5dg_addstartdata.php" target="_blank">บันทึกรายการตั้งต้น</a> || <a href="rphos5dg_editgetdate.php" target="_blank">แก้ไขวันที่ รพ.5</a> || <a href="rphos5dg_printmountnew.php" target="_blank">รายงาน รพ.5 ประจำเดือน</a></p>
<p align="center"><strong>บันทึกรายงาน รพ.5 ประจำเดือน</strong></p>
<form name="form1" action="<? $_SERVER['PHP_SELF']?>" method="post">
<input name="act" type="hidden" value="search" />
<p style="margin-left: 480px;"><label>รหัสยา : </label>
<input name="drugcode" type="text" />
</p>
<p style="margin-left: 480px;"><label>ปี พ.ศ. : </label>
<?
$Y=date("Y")+543;
$date=date("Y")+543+5;
		...
		if($num < 1){
			...
			if($num == 1){				
				...
				if(mysql_query($add1)){  //บันทึกยอดยกมา
					echo "<script>alert('บันทึกข้อมูลรหัสยา : $drugcode เสร็จแล้ว');</script>";
