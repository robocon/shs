<p align="center">นำเข้า Order Lab ตรวจสุขภาพนักศึกษาราชมงคล 2559
...
if($_POST["act"]=="add"){
	include("connect.inc"); 
	$sql="select hn,yot,name,surname,dbirth from opcardchk where part='ราชมงคล59' and active='y' order by row asc";
	//echo $sql;
