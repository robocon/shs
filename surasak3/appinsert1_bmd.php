...
print "  <font face='Angsana New' size='2'><center>FR-NUR-003/2,04, 25 ธ.ค. 54 </center>";
 ...
 print "<b><font face='Angsana New' size='4'>ชื่อ: $cPtname  </b>&nbsp;&nbsp;&nbsp;<b>HN:</b> $cHn &nbsp;<b>อายุ:</b> $cAge&nbsp;<B>สิทธิ:$cptright&nbsp;</font></B><br>";
...
IF ($detail !='NA') { 
 ...
 //   }
   ...
   IF (trim($xrayall) != 'NA') {
        ...
        print "<b>ตรวจเอกซเรย์:</b>&nbsp; $xrayall<br>";
...
else  if ($detail =='FU07 คลีนิกฝังเข็ม'){ print "<font face='Angsana New' size='3'>
...
3.<b>ถ้าผิดนัด </b>ให้ใบนัดยื่นแผนกทะเบียน &nbsp;<br><b>กรณีเลื่อนนัด ต้องติดต่อล่วงหน้าอย่างน้อย 1 วันทำการ<br> ในวันเวลาราชการ เวลา 09.00 น. - 15.00 น. โทร 054-839305-6 ต่อ 8001</b>"; 
...
<b>กรณีเลื่อนนัด ต้องติดต่อล่วงหน้าอย่างน้อย 1 วันทำการ<br> ในวันเวลาราชการ เวลา 09.00 น. - 15.00 น. โทร 054-839305-6 ต่อ 8002</b>"; 
	...
	for($i=1;$i<=8;$i++){
	 ...
	 print "<b>หมายเหตุ:<u>$cidguard</u></b><BR>
1.ยื่นใบนัดที่ห้องเอกซเรย์ &nbsp;&nbsp;
2.กรุณามาตรงตามวันและเวลานัด&nbsp;<BR>
3.หากมีข้อสงสัยหรือต้องการเลื่อนนัด ติดต่อ 054-839305-6 ต่อ 1140 ในเวลาราชการ</b>"; 
...
$depcode=substr($depcode,4);
  ...
  print "<b><font face='Angsana New' size='3'>ชื่อ:</b> $cPtname  &nbsp;&nbsp;&nbsp;<b>HN:</b> $cHn &nbsp;<b>อายุ:</b> $cAge&nbsp;<B>สิทธิ:$cptright<u>$cidguard</u></font></B><br>";
   ...
   print "<b><FONT SIZE=4><U>นัดมาวันที่: $appd &nbsp;&nbsp;&nbsp;</U> </FONT></b><b> เวลา:</b> $capptime<br>";
