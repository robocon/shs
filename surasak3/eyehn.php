...
if(empty($_SESSION['sIdname'])){
  ?>
  <p><b>Session หมดอายุ</b> กรุณา <a href="../index.htm">Login</a> อีกครั้งเพื่อใช้งาน</p>
  <?php
  exit;
}
...
<frameset cols="40%,60%">
  <frame name="left" src="hneye.php" scrolling="auto">
  <frame name="right" src="UntitledFrame-20" scrolling="auto">
</frameset>
