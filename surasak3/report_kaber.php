...
<table width="100%" border="0">
  <tr>
    <td colspan="2"><table width="100%">
      ...
      <tr>
        <td align="center" valign="top" class="text3"><span class="text"><span class="text1"><span class="text2">ตรวจเมื่อวันที่ 16 กันยายน 2557</span></span></span></td>
...
/////
		...
		?>
          ...
          <?  } ?>        
          <tr>             
            <td height="27" colspan="3"><strong>ผลตรวจ :</strong> <? if($result['hn']=="57-7708" || $result['hn']=="57-7695" || $result['hn']=="57-7703" || $result['hn']=="57-7706" || $result['hn']=="57-7699"  || $result['hn']=="57-7700" || $result['hn']=="57-7696"){ echo "ผิดปกติ ควรพบแพทย์เพื่อตรวจซ้ำหรือรับการรักษา";}else{ echo "ปกติ";}?></td>
            </tr>
        </table></td>
      </tr>
    </table></td>
...
if(!empty($outarr["altra"])){
	...
	echo "<tr>
				<td>ตรวจสารชี้บ่งมะเร็งตับ(AFP)</td>
				<td>2.94</td>
				<td>< 12</td>
				<td style='font-size:12px;'>ปกติ</td>
		   </tr>";
		   
	echo "<tr>
				<td>ตรวจสารชี้บ่งมะเร็งลำใส้(CEA)</td>
				<td>1.86</td>
				<td>0 - 4.7</td>
				<td style='font-size:12px;'>ปกติ</td>
		   </tr>";
	...
	echo "<tr>
				<td>ตรวจสารชี้บ่งมะเร็งต่อมลูกหมาก (PSA)</td>
				<td>1.160</td>
				<td>0 - 4</td>
				<td style='font-size:12px;'>ปกติ</td>
		   </tr>";
	...
	echo "<tr>
				<td>อัลตร้าซาวน์ช่องท้องส่วนบน-ล่าง</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td style='font-size:12px;'></td>
		   </tr>";
	...
	echo "<tr>
				<td>ความหนาแน่นของกระดูก</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td style='font-size:12px;'>ปกติ</td>
		   </tr>";
		   echo "<tr>
				<td>การตรวจสุขภาพตา/ความปิดปกติของตา</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td style='font-size:12px;'></td>
		   </tr>";
...
<table width="100%" border="0" class="text4">
  <tr>
    ...
    ) </strong><strong>Doctor :พ.ต.เลอปรัชญ์ มังกรกนกพงศ์ (16-10-2014)</strong></td>
