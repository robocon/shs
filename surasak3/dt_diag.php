...
<TABLE border="0">
<TR valign="top">
  <TD width="250" height="69" rowspan="7" align="right">ความเห็นแพทย์</TD>
  <TD ><textarea id="dt_diag_detail" name="dt_diag_detail" rows="3" cols="100" ><?php echo $_SESSION["dt_diag_detail"]?></textarea></TD>
 </TR>
<TR valign="middle" height="99">
<TD align="left"><A HREF="javascript:showremed();"><img src="images/diagnosis.png" width="36" height="36" alt="Re Diag"> Re-Diag</A>
<span style='margin-left:50px;'><font color="#FF0033" size="3"> *** การ DIAG สามารถค้นหาชื่อโรคทั้งภาษาไทยและภาษาอังกฤษได้ที่ช่องค้นหา *** <br><strong>*** ห้ามใส่สัญลักษณ์พิเศษ เช่น เครื่องหมาย ' ในการ Diag โรค จะทำให้สั่งยาไม่ได้&nbsp;***&nbsp;ใช้ตัวพิมพ์ใหญ่ในการให้รหัสICD&nbsp;***</strong></font></span></TD>
 </TR>
