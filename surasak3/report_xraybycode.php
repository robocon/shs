...
<form name="f1" action="" method="post">
  ...
  <tr class="forntsarabun">
    <td colspan="2" bgcolor="#99CC99">สถิติ</td>
    </tr>
  <tr class="forntsarabun">
  ...
  <tr class="forntsarabun">
    <td  align="right">รหัสการคิดเงิน</td>
    <td><select name="code" class="forntsarabun">
    <option value="41002">(41002)Mobile X-Rays</option>
    <option value="41003">(41003)ภาพถ่ายเอ็กซเรย์ดิจิตัล</option>
...
*/
	$i=1;
	print "<div><font class='forntsarabun' >สถิติ   ประจำ$day  $dateshow </font></div><br>";
    ...
    <!--<td align="center">รหัสการคิดเงิน</td>
