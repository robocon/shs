...
if(count($aDgcode) == 1 || trim($aDgcode[$x]) != trim($cDgcode)){

	$_SESSION["cTotal"] = $_GET["cTotal"];
	//echo count($aDgcode)," ",strlen(trim($aDgcode[$x])), ' ' ,strlen(trim($cDgcode));
...
//    print "cTotal(เบิก) $_SESSION["cTotal"]<br>";
//    print "cAmount $cAmount<br>";
print "รายการเบิกจากคลังยาใหญ่ไป$cDepcode <br>";

if ($_SESSION["cTotal"]>$cAmount){         
	$cStkcut=$cAmount;
	$cRestkcut= $_SESSION["cTotal"]-$cStkcut;
	$_SESSION["cTotal"]= $_SESSION["cTotal"]-$cStkcut;
