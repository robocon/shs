...
if(isset($_POST["Submit"]) && $_POST["Submit"] == "แก้ไขข้อมูล"){
	...
	$sql = "Update trauma set ".$_POST["name_field"]." = '".jschars($_POST["detail"])."' where row_id = '".$_POST["row_id"]."' limit 1 ";
...
$sql = "Select ".$_GET["fn"]." From trauma where row_id = '".$_GET["row_id"]."' limit 1 ";
...
<table width="450" border="1" cellpadding="2" cellspacing="0" bordercolor="#3366FF">
  ...
  <tr>
    ...
    <td ><label>
	<?php if(isset($_GET["obj"]) && $_GET["obj"] == "tb"){?>
	<INPUT TYPE="text" NAME="detail" value="<?php echo $detail_testarea;?>">
	<?php }else{?>
      <textarea name="detail" rows="8" COLS="50"><?php echo $detail_testarea;?></textarea>
	 <?php }?>
    </label></td>
  </tr>
  <tr align="center">
