...
<div class="font_title" align="left">แก้ไขข้อมูล ผู้ป่วย HIV  <!--<a href ="../../nindex.htm"  class="forntsarabun1"><----- ไปหน้าแรกสุด</a> || <a href="hiv_index.php?do=edit" class="forntsarabun1">&lt;-----เมนู</a>--></div>
...
if($_REQUEST["p_hn"] != ""){
	  ...
	  $sqlhiv="select * from hiv where hn='$hn' ";
...
<FORM METHOD="post" ACTION="hiv_edit.php?do=save" name="F1">
...
<input name="ref_id" type="hidden" id="ref_id"  value="<?php echo $arr_view["ref_id"];?>" />
<input name="claim2" type="hidden" id="claim2"  value="<?php echo $arr_view["claim"];?>" />
<br />
...
<TR>
	...
	<table border="0">
		...
		<tr>
		  ...
		  <td><span class="data_show">
		    <input name="hivnumber" type="text" class="forntsarabun1" id="hivnumber"  value="<?=$arr_view['hivnumber'];?>"/>
		  </span></td>
		...
		<tr>
		  ...
		  <td><span class="data_show">
		    <input name="napnumber" type="text" class="forntsarabun1" id="napnumber"  value="<?=$arr_view['napnumber'];?>"/>
		  </span></td>
          ...
          <select name="claim" id="claim" class="forntsarabun1">
		    ...
		    <option value="vo-ทั่วไป" <? if($arr_view['claim']=='vo-ทั่วไป'){ echo "selected"; } ?>>vo-สิทธิเบิกทั่วไป</option>
		    <option value="vp-ประกันสังคม" <? if($arr_view['claim']=='vp-ประกันสังคม'){ echo "selected"; } ?>>vp-สิทธิเบิกประกันสังคม</option>
		    <option value="nhso-สปสช" <? if($arr_view['claim']=='nhso-สปสช'){ echo "selected"; } ?>>nhso-สิทธิเบิก สปสช</option>
		    </select></td>
		  </tr>
		<tr>
  ...
  <tr>
    ...
    <?
//   $year=date("Y");
	$sql = "CREATE TEMPORARY TABLE lab01 SELECT  *  FROM  hiv_lab  WHERE  ref_id='".$arr_view['ref_id']."' and  claim = '".$_REQUEST['claim']."' ";
	$result = mysql_query($sql) or die (mysql_error());
  ...
  <tr>
    ...
    <td><textarea name="phar" cols="45" rows="5" class="table_font2" id="phar"><?php echo $arr_view["phar"];?></textarea></td>
  </tr>
  <tr>
    <td valign="top" class="tb_font_2">ผลข้างเคียง</td>
    <td><textarea name="sideefect" cols="45" rows="5" class="table_font2" id="sideefect"><?php echo $arr_view["sideefect"];?></textarea></td>
  </tr>
</table>
...
{*/ 	 
$strSQL = "UPDATE hiv  SET ";
$strSQL .="hivnumber  = '".$_POST["hivnumber"]."' ";
$strSQL .=",napnumber = '".$_POST["napnumber"]."' ";
$strSQL .=",hn = '".$_POST["hn"]."' ";
...
$strSQL .=",claim  = '".$_POST["claim"]."' ";
$strSQL .="WHERE row_id = '".$_POST['row_id']."' ";
$objQuery = mysql_query($strSQL);
// 
$max="select max(row_id)as maxid from hiv";
$query = mysql_query($max);
$ref=mysql_fetch_array($query);

 ///1 CD4  //

$strSQL1 = "UPDATE hiv_lab  SET ";
...
$strSQL1 .=",claim  = '".$_POST["claim"]."' ";
$strSQL1 .="WHERE ref_id = '".$_POST["ref_id"]."' AND claim='".$_POST['claim2']."' AND labname='CD4' ";
$objQuery1 = mysql_query($strSQL1);

 // 2 plasma VL  //
$strSQL2 = "UPDATE hiv_lab  SET ";
...
$strSQL2 .=",claim  = '".$_POST["claim"]."' ";
$strSQL2 .="WHERE ref_id = '".$_POST["ref_id"]."' AND claim='".$_POST['claim2']."' AND labname='Plasma VL' ";
$objQuery2 = mysql_query($strSQL2);

// ///  3 FBS  //

$sqladd3 = "UPDATE hiv_lab  SET ";
...
$sqladd3 .=",claim  = '".$_POST["claim"]."' ";
$sqladd3 .="WHERE ref_id = '".$_POST["ref_id"]."' AND claim='".$_POST['claim2']."' AND labname='FBS' ";
$objadd3 = mysql_query($sqladd3);
 
 

 // /// 4 ALT  //
$sqladd4 = "UPDATE hiv_lab  SET ";
...
$sqladd4 .=",claim  = '".$_POST["claim"]."' ";
$sqladd4 .="WHERE ref_id = '".$_POST["ref_id"]."' AND claim='".$_POST['claim2']."' AND labname='ALT'";
$objadd4 = mysql_query($sqladd4);
 
  //  5 Creatinine  //
  $sqladd5 = "UPDATE hiv_lab  SET ";
...
$sqladd5 .=",claim  = '".$_POST["claim"]."' ";
$sqladd5 .="WHERE ref_id = '".$_POST["ref_id"]."' AND claim='".$_POST['claim2']."' AND labname='CREA' ";
...
$sqladd61 .=",claim  = '".$_POST["claim"]."' ";
$sqladd61 .="WHERE ref_id = '".$_POST["ref_id"]."' AND claim='".$_POST['claim2']."' AND labname='CHOL' ";
$objadd61 = mysql_query($sqladd61);

 
$sqladd62 = "UPDATE hiv_lab  SET ";
...
$sqladd62 .=",claim  = '".$_POST["claim"]."' ";
$sqladd62 .="WHERE ref_id = '".$_POST["ref_id"]."' AND claim='".$_POST['claim2']."' AND labname='TRIG'";
$objadd62 = mysql_query($sqladd62);
 
 
$sqladd63 = "UPDATE hiv_lab  SET ";
...
$sqladd63 .=",claim  = '".$_POST["claim"]."' ";
$sqladd63 .="WHERE ref_id = '".$_POST["ref_id"]."' AND claim='".$_POST['claim2']."' AND labname='HDL' ";
$objadd63 = mysql_query($sqladd63);

 
$sqladd64 = "UPDATE hiv_lab  SET ";
...
$sqladd64 .=",claim  = '".$_POST["claim"]."' ";
$sqladd64 .="WHERE ref_id = '".$_POST["ref_id"]."' AND claim='".$_POST['claim2']."' AND labname='LDL' ";
$objadd64 = mysql_query($sqladd64);
 
 /// UA  
   $sqladd7 = "UPDATE hiv_lab  SET ";
...
$sqladd7 .=",claim  = '".$_POST["claim"]."' ";
$sqladd7 .="WHERE ref_id = '".$_POST["ref_id"]."' AND claim='".$_POST['claim2']."' AND labname='UA' ";
$objadd7 = mysql_query($sqladd7);


 // CXR
$sqladd8 = "UPDATE hiv_lab  SET ";
...
$sqladd8 .=",claim  = '".$_POST["claim"]."' ";
$sqladd8 .="WHERE ref_id = '".$_POST["ref_id"]."' AND claim='".$_POST['claim2']."' AND labname='CXR' ";
$objadd8 = mysql_query($sqladd8);

  // Pap smear
 $sqladd9 = "UPDATE hiv_lab  SET ";
...
$sqladd9 .=",claim  = '".$_POST["claim"]."' ";
$sqladd9 .="WHERE ref_id = '".$_POST["ref_id"]."' AND claim='".$_POST['claim2']."'  AND labname='Pap smear'";
$objadd9 = mysql_query($sqladd9);
 
if($objQuery)
{
	echo "<br><font class='forntsarabun1'>บันทึกข้อมูลเรียบร้อยแล้ว</font>";
	print "<META HTTP-EQUIV='Refresh' CONTENT='2;URL=hiv_show.php?detail=$_POST[claim2]'>";
}
else
{
	echo "<br><font class='forntsarabun1'>ไม่สามารถบันทึกได้ [".$strSQL."]</font>";
	print "<META HTTP-EQUIV='Refresh' CONTENT='2;URL=hiv_show.php'>";
}
