...
<div class="font_title" align="left">ลงทะเบียนผู้ป่วย HIV สิทธิเบิกทั่วไป <a href ="../../nindex.htm"  class="forntsarabun1"><----- ไปหน้าแรกสุด</a> || <a href="hiv_index.php?do=add" class="forntsarabun1">&lt;-----เมนู</a></div>
...
function chkSubmit()
	{
		 if(isNaN(document.F1.vo_no.value))
		 {
...
<FORM METHOD="post" ACTION="hiv_vo_form.php?do=save" name="F1" onsubmit="return fncSubmit();">
...
<TR>
	...
	<table border="0">
		...
		<tr>
		  ...
		  <td><span class="data_show">
		    <input name="vo_no" type="text" class="forntsarabun1" id="vo_no" onkeyup='return chkSubmit();'/>
		  </span></td>
...
$select="select hn from hiv_vo Where hn ='".$_POST["hn"]."' ";
...
$strSQL = "INSERT INTO  `hiv_vo` (`vo_id` ,  `hn` ,  `ptname` ,  `address` ,  `age` ,  `ptright` ,  `doctor` ,  `arv_date` ,  `symp_hiv` ,  `cd4_start` ,  `cd4_regis` ,  `phar` ,  `sideefect`,  `date_regis` ) 
VALUES ('".$_POST['vo_no']."',  '".$_POST['hn']."', '".$_POST['ptname']."',  '".$_POST['address']."',  '".$_POST['dbirth']."','".$_POST['ptright']."',  '".$_POST['doctor']."',  '".$_POST['arv_date']."',  '".$_POST['symp_hiv']."',  '".$_POST['cd4_start']."',  '".$_POST['cd4_regis']."',  '".$_POST['phar']."',  '".$_POST['sideefect']."',  '".$_POST['thaidate']."')";
$objQuery = mysql_query($strSQL);

// 
$max="select max(row_id)as maxid from hiv_vo";
$query = mysql_query($max);
$ref=mysql_fetch_array($query);

 ///1 CD4  //
 $sqladd1="INSERT INTO  `hiv_lab` (`row_id`,`ref_id`,`labname`,`m1` ,`m2`,`m3`,`m4` ,`m5`,`m6`,`m7`,`m8`,  `m9`,`m10`,`m11`,`m12`,register_date) VALUES ('','".$ref['maxid']."','cd4','".$_POST['l11']."',  '".$_POST['l12']."',  '".$_POST['l13']."',  '".$_POST['l14']."',  '".$_POST['l15']."',  '".$_POST['l16']."',  '".$_POST['l17']."',  '".$_POST['l18']."',  '".$_POST['l19']."',  '".$_POST['l110']."',  '".$_POST['l111']."','".$_POST['l112']."','".$dateN."')";
 $objadd1 = mysql_query($sqladd1);
 
 // 2 plasma VL  //
 $sqladd2="INSERT INTO  `hiv_lab` (`row_id`,`ref_id`,`labname`,`m1` ,`m2`,`m3`,`m4` ,`m5`,`m6`,`m7`,`m8`,  `m9`,`m10`,`m11`,`m12`,register_date) VALUES ('','".$ref['maxid']."','Plasma VL','".$_POST['l21']."',  '".$_POST['l22']."',  '".$_POST['l23']."',  '".$_POST['l24']."',  '".$_POST['l25']."',  '".$_POST['l26']."',  '".$_POST['l27']."',  '".$_POST['l28']."',  '".$_POST['l29']."',  '".$_POST['l210']."',  '".$_POST['l211']."','".$_POST['l212']."','".$dateN."')";
 $objadd2 = mysql_query($sqladd2);

// ///  3 FBS  //
 $sqladd3="INSERT INTO  `hiv_lab` (`row_id`,`ref_id`,`labname`,`m1` ,`m2`,`m3`,`m4` ,`m5`,`m6`,`m7`,`m8`,  `m9`,`m10`,`m11`,`m12`,register_date) VALUES ('','".$ref['maxid']."','FBS','".$_POST['l31']."',  '".$_POST['l32']."',  '".$_POST['l33']."',  '".$_POST['l34']."',  '".$_POST['l35']."',  '".$_POST['l36']."',  '".$_POST['l37']."',  '".$_POST['l38']."',  '".$_POST['l39']."',  '".$_POST['l310']."', '".$_POST['l311']."','".$_POST['l312']."','".$dateN."')";
 $objadd3 = mysql_query($sqladd3);
 
 // /// 4 ALT  //
 $sqladd4="INSERT INTO  `hiv_lab` (`row_id`,`ref_id`,`labname`,`m1` ,`m2`,`m3`,`m4` ,`m5`,`m6`,`m7`,`m8`,  `m9`,`m10`,`m11`,`m12`,register_date) VALUES ('','".$ref['maxid']."','ALT','".$_POST['l41']."',  '".$_POST['l42']."',  '".$_POST['l43']."',  '".$_POST['l44']."',  '".$_POST['l45']."',  '".$_POST['l46']."',  '".$_POST['l47']."',  '".$_POST['l48']."',  '".$_POST['l49']."',  '".$_POST['l410']."', '".$_POST['l411']."','".$_POST['l412']."','".$dateN."')";
 $objadd4 = mysql_query($sqladd4);
 
  //  5 Creatinine  //
 $sqladd5="INSERT INTO  `hiv_lab` (`row_id`,`ref_id`,`labname`,`m1` ,`m2`,`m3`,`m4` ,`m5`,`m6`,`m7`,`m8`,  `m9`,`m10`,`m11`,`m12`,register_date) VALUES ('','".$ref['maxid']."','CREA','".$_POST['l51']."',  '".$_POST['l52']."',  '".$_POST['l53']."',  '".$_POST['l54']."',  '".$_POST['l55']."',  '".$_POST['l56']."',  '".$_POST['l57']."',  '".$_POST['l58']."',  '".$_POST['l59']."',  '".$_POST['l510']."', '".$_POST['l511']."','".$_POST['l512']."','".$dateN."')";
 $objadd5 = mysql_query($sqladd5);
 
 
//  6 lipid profile  //
 $sqladd61="INSERT INTO  `hiv_lab` (`row_id`,`ref_id`,`labname`,`m1` ,`m2`,`m3`,`m4` ,`m5`,`m6`,`m7`,`m8`,  `m9`,`m10`,`m11`,`m12`,register_date) VALUES ('','".$ref['maxid']."','CHOL','".$_POST['lChol1']."',  '".$_POST['lChol2']."',  '".$_POST['lChol3']."',  '".$_POST['lChol4']."',  '".$_POST['lChol5']."',  '".$_POST['lChol6']."',  '".$_POST['lChol7']."',  '".$_POST['lChol8']."',  '".$_POST['lChol9']."',  '".$_POST['lChol10']."', '".$_POST['lChol11']."','".$_POST['lChol12']."','".$dateN."')";
 $objadd61 = mysql_query($sqladd61);
 
 $sqladd62="INSERT INTO  `hiv_lab` (`row_id`,`ref_id`,`labname`,`m1` ,`m2`,`m3`,`m4` ,`m5`,`m6`,`m7`,`m8`,  `m9`,`m10`,`m11`,`m12`,register_date) VALUES ('','".$ref['maxid']."','TRIG','".$_POST['ltg1']."',  '".$_POST['ltg2']."',  '".$_POST['ltg3']."',  '".$_POST['ltg4']."',  '".$_POST['ltg5']."',  '".$_POST['ltg6']."',  '".$_POST['ltg7']."',  '".$_POST['ltg8']."',  '".$_POST['ltg9']."',  '".$_POST['ltg10']."', '".$_POST['ltg11']."','".$_POST['ltg12']."','".$dateN."')";
 $objadd62 = mysql_query($sqladd62); 

 $sqladd63="INSERT INTO  `hiv_lab` (`row_id`,`ref_id`,`labname`,`m1` ,`m2`,`m3`,`m4` ,`m5`,`m6`,`m7`,`m8`,  `m9`,`m10`,`m11`,`m12`,register_date) VALUES ('','".$ref['maxid']."','HDL','".$_POST['lhdl1']."',  '".$_POST['lhdl2']."',  '".$_POST['lhdl3']."',  '".$_POST['lhdl4']."',  '".$_POST['lhdl5']."',  '".$_POST['lhdl6']."',  '".$_POST['lhdl7']."',  '".$_POST['lhdl8']."',  '".$_POST['lhdl9']."',  '".$_POST['lhdl10']."', '".$_POST['lhdl11']."','".$_POST['lhdl12']."','".$dateN."')";
 $objadd63 = mysql_query($sqladd63); 
 
$sqladd64="INSERT INTO  `hiv_lab` (`row_id`,`ref_id`,`labname`,`m1` ,`m2`,`m3`,`m4` ,`m5`,`m6`,`m7`,`m8`,  `m9`,`m10`,`m11`,`m12`,register_date) VALUES ('','".$ref['maxid']."','LDL','".$_POST['lldl1']."',  '".$_POST['lldl2']."',  '".$_POST['lldl3']."',  '".$_POST['lldl4']."',  '".$_POST['lldl5']."',  '".$_POST['lldl6']."',  '".$_POST['lldl7']."',  '".$_POST['lldl8']."',  '".$_POST['lldl9']."',  '".$_POST['lldl10']."', '".$_POST['lldl11']."','".$_POST['lldl12']."','".$dateN."')";
 $objadd64 = mysql_query($sqladd64); 
 
 /// UA  
$sqladd7="INSERT INTO  `hiv_lab` (`row_id`,`ref_id`,`labname`,`m1` ,`m2`,`m3`,`m4` ,`m5`,`m6`,`m7`,`m8`,  `m9`,`m10`,`m11`,`m12`,register_date) VALUES ('','".$ref['maxid']."','UA','".$_POST['l71']."',  '".$_POST['l72']."',  '".$_POST['l73']."',  '".$_POST['l74']."',  '".$_POST['l75']."',  '".$_POST['l76']."',  '".$_POST['l77']."',  '".$_POST['l78']."',  '".$_POST['l79']."',  '".$_POST['l710']."', '".$_POST['l711']."','".$_POST['l712']."','".$dateN."')";
 $objadd7 = mysql_query($sqladd7); 
 
 
 // CXR
 $sqladd8="INSERT INTO  `hiv_lab` (`row_id`,`ref_id`,`labname`,`m1` ,`m2`,`m3`,`m4` ,`m5`,`m6`,`m7`,`m8`,  `m9`,`m10`,`m11`,`m12`,register_date) VALUES ('','".$ref['maxid']."','CXR','".$_POST['l81']."',  '".$_POST['l82']."',  '".$_POST['l83']."',  '".$_POST['l84']."',  '".$_POST['l85']."',  '".$_POST['l86']."',  '".$_POST['l87']."',  '".$_POST['l88']."',  '".$_POST['l89']."',  '".$_POST['l810']."', '".$_POST['l811']."','".$_POST['l812']."','".$dateN."')";
 $objadd8 = mysql_query($sqladd8); 
 
  // Pap smear
 $sqladd9="INSERT INTO  `hiv_lab` (`row_id`,`ref_id`,`labname`,`m1` ,`m2`,`m3`,`m4` ,`m5`,`m6`,`m7`,`m8`,  `m9`,`m10`,`m11`,`m12`,register_date) VALUES ('','".$ref['maxid']."','Pap smear','".$_POST['l91']."',  '".$_POST['l92']."',  '".$_POST['l93']."',  '".$_POST['l94']."',  '".$_POST['l95']."',  '".$_POST['l96']."',  '".$_POST['l97']."',  '".$_POST['l98']."',  '".$_POST['l99']."',  '".$_POST['l910']."', '".$_POST['l911']."','".$_POST['l912']."','".$dateN."')";
