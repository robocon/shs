<html>
<head>
<title>รายชื่อผู้ป่วยสิทธิ สปสช.</title>
</head>
<style>
.forntsarabun1 {
...
<body>
<h1 class="forntsarabun1">รายชื่อผู้ป่วย HIV  สิทธิ สปสช. เรียงตามรหัส <a href="hiv_index.php?do=show" class="forntsarabun1">&lt;-----เมนู</a></h1>
<?
include("../connect.php");

$strSQL = "SELECT * FROM  hiv_nhso";
