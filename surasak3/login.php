  ...
  <table border="0" width="23%">
    ...
    <tr>
      ...
      <td width="68%"><font face="THSarabunPSK">&nbsp&nbsp;&nbsp;&nbsp; ชื่อผู้ใช้
        :<br>
        &nbsp;&nbsp;&nbsp <input type="text" name="username" size="12" class="txt"><br>
        &nbsp;&nbsp;&nbsp;&nbsp รหัสผ่าน :<br>
        &nbsp;&nbsp;&nbsp <input type="password" name="password" size="12" class="txt"></font>
        <p><font face="THSarabunPSK">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp <input type="submit" value="เข้าระบบ" name="B2" class="txt"></font></td>
    </tr>
  </table>
</form>
