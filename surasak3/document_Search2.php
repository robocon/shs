...
<form name="frmSearch" method="get" action="<?=$_SERVER['SCRIPT_NAME'];?>">
  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse"  bordercolor="#000000" class="forntsarabun" align="center">
    <tr>
      ...
      <input type="submit" class="forntsarabun" value="Search">   <a href="document_add.php">เพิ่มเอกสารใหม่</a></th>
      <th valign="bottom"><a href="document_list.php">เอกสารตามแผนก</a></th>
    </tr>
  </table>
</form>
...
<table  border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse"  bordercolor="#000000" id="box-table-a">
  <tr>
    <th> <div align="center">ชื่อเอกสาร</div></th>
...
?>
  <tr>
    ...
    <td align="center"><a href="javascript:MM_openBrWindow('document_download.php?doc_id=<?=$objResult['doc_id'];?>','','width=500,height=500')">เปิดไฟล์แนบ</a></td>
