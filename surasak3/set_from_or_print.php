...
$sql="INSERT INTO `set_or` (`ward` , `hn` , `an` , `ptname` , `age` , `ptright` , `diag` , `surg` , `doctor` , `inhalation_type` , `date_surg` ,`time` , `officer` , `comment`)
VALUES ( '".$_POST['ward']."', '".$_POST['hn']."', '".$_POST['an']."', '".$_POST['ptname']."', '".$_POST['age']."', '".$_POST['ptright']."', '".$_POST['diag']."', '".$_POST['surg']."', '".$_POST['doctor']."', '".$_POST['inhalation_type']."', '".$_POST['date_surg']."','".$time."', '".$sOfficer."', '".$_POST['comment']."')";
...
if($query)
{
	echo "<DIV id='no_print'>Save Done.</DIV>";
?>
<script>
