...
<?php
     ...
     $Thaidate=date("d-m-").(date("Y")+543)." เวลา  ".date("H:i:s")."&nbsp;&nbsp;&nbsp;<span class='fc1-1'> ผู้ป่วยนัด </span>";
...
print "<DIV style='left:300PX;top:10PX;height:30PX;'><span class='fc1-0'>$Thaidate</span></DIV>";
