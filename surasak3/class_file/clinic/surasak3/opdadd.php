...
global   $regisdate,$idcard,$mid,$hn,$yot,$name,$surname,$education,$goup,$married,$Y,$y,$m,$d,
           ...
           $sex,$camp,$race,$ptf,$ptfadd,$ptffone,$ptfmon,$blood,$drugreact,$phone2,$hospcode,$ptrcode;
...
dbirth,guardian,idguard,nation,religion,career,ptright,ptrightdetail,address,tambol,ampur,changwat,hphone,phone,father,mother,couple,note,sex,camp,race,ptf,ptfadd,ptffone,ptfmon, ptright1, officer, blood, drugreact,phone2,hospcode,ptrcode) VALUES (now(),'$idcard','$mid','$shn',
...
'$hphone','$phone','$father','$mother','$couple','$note','$sex','$camp','$race','$ptf','$ptfadd','$ptffone','$ptfmon','$ptright','".$_SESSION["sOfficer"]."','$blood', '$drugreact','$phone2','$hospcode','$ptrcode');";
/*
  regisdate
  idcard 
  hn 
...
$result = mysql_query($sql) or die("หมายเลข HN $shn ซ้ำ    ไม่สามารถบันทึกได้    โปรดทำบัตรใหม่ !");
...
print "<DIV style='left:540PX;top:30PX;width:600PX;height:30PX;'><span class='fc1-0'><a  href=\"opdprint3.php? ptname=$ptname&vHn=$vhn&birthdate=$birthdate&idcard=$idcard&ptright=$ptright\">$shn</a></span></DIV>";
