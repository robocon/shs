...
$sql = "Select a.date,a.txdate, a.hn, CONCAT(b.yot,' ',b.name,' ',b.surname) as full_name, a.depart, sum(a.price),b.idcard,b.note,sum(a.paidcscd) From opacc as a, opcard as b where a.hn=b.hn AND a.date like '".$date1."%'  AND a.credit ='30บาท' AND a.ptright LIKE '$ptright%' group by a.hn, a.depart   ORDER by a.date";
// var_dump($sql);
...
<td>&nbsp;</td>
<td>&nbsp;</td>
<td><b><font face='Angsana New' size ='2'><center>รวม</font></b></td>
<td>&nbsp;</td>
<td align='right'><font face='Angsana New' size ='2'><b>".$PHAR."</b></font></td>
<td align='right'><font face='Angsana New' size ='2'><b>".$PATHO."</b></font></td>
<td align='right'><font face='Angsana New' size ='2'><b>".$XRAY."</b></font></td>
<td align='right'><font face='Angsana New' size ='2'><b>".$OTHER1."</b></font></td>
<td align='right'><font face='Angsana New' size ='3'><b>&nbsp;".$sum."&nbsp;</b></font></td>
<!-- <td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td> -->
