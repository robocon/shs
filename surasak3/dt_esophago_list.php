...
if($_POST["POST_HN"] == "")
	exit();
	$sql = "Select row_id, date_format(date,'%d/%m/%Y') as date3, hn, an, ptname, gender, ward From dr_esophago  where hn like '".$_POST["POST_HN"]."'  ";
...
<tr bgcolor="<?php echo $bgcolor;?>">
  <td  class="tb_search"><A HREF="dt_esophago_show.php?id=<?php echo $arr["row_id"];?>" target="_blank">View</A></td>
