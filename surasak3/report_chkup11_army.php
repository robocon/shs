...
<form name="form1" method="post" action="report_chkup11_army.php" >
...
$sql1="SELECT *
FROM `condxofyear_so`
WHERE `yearcheck` = '$nPrefix' AND (camp1 !='D33 หน่วยทหารอื่นๆ' and camp1 !='D34 กทพ.33' and camp1 !='') group by hn ORDER BY row_id desc, camp1 ASC, substring(age,1,2) DESC";
}else{
$sql1="SELECT *
FROM `condxofyear_so`
WHERE `camp1`='$_POST[camp]' AND `yearcheck` = '$nPrefix' group by hn ORDER BY row_id desc";
}
//var_dump($sql1);
