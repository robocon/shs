...
if($sNetprice >=0 && ($_POST["credit"] == "เงินสด" || $_POST["credit"] == "กรุงเทพ" || $_POST["credit"] == "กรุงไทย" || $_POST["credit"] == "ทหารไทย" || $_POST["credit"] == "จ่ายตรง" || $_POST["credit"] == "เงินโอน")){
...
$cbaht=baht($xpaid);
	...
	print "<br><br><br>";
	print "<tr>";
	//print "<td width='100%'><font size='4'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$credit1&nbsp;&nbsp;จาก&nbsp;<b>$sPtname</b>&nbsp;&nbsp;&nbsp;&nbsp;HN:$sHn&nbsp;VN:&nbsp;(".$_SESSION["sVn"].")&nbsp;&nbsp;วันที่&nbsp;<b>$Thdate</b> &nbsp;&nbsp;เวลา&nbsp;$billtime</td>";
	
	print "<td width='100%'><font size='4'><b>ชื่อ:&nbsp;$sPtname</b>&nbsp;&nbsp;&nbsp;&nbsp;HN:$sHn&nbsp;VN:&nbsp;(".$_SESSION["sVn"].")&nbsp;&nbsp;วันที่&nbsp;<b>$Thdate</b> &nbsp;&nbsp;เวลา&nbsp;$billtime<br></td>";
	print "</tr>";
		print "<tr>";
//	print "<td width='100%'><font size='4'></td>";
echo "<td width='45%'><font  size ='3'><b>โรค:</b></>";
...
if(count($_SESSION['tDiag'])==1){
	...
	/*if(in_array("ตรวจวิเคราะห์เพื่อการรักษา",$_SESSION['tDiag'])){
		echo "<td width='45%'><font  size ='3'>โรค: ตรวจวิเคราะห์เพื่อการรักษา</font></td>";
	}
	else{*/
		//$str ="<td width='45%'><font  size ='3'><b>โรค:</b> ";
...
print "    <tr>";
//print "      <td width='9%'></td>";
print "      <td width='40%'>ยาในบัญชียาหลักแห่งชาติ</td>";
...
print "    <tr>";
//print "      <td width='9%'></td>";
print "      <td width='40%'>ยานอกบัญชียาหลักแห่งชาติ</td>";
print "      <td width='20%'></td>";
print "      <td width='10%'>$sNessdn</td>";
print "      <td width='20%'></td>";
print "    </tr>";
print "    <tr>";
//print "      <td width='9%'></td>";
print "      <td width='40%'>ค่าเวชภัณฑ์ที่ไม่ใช่ยา</td>";
print "      <td width='20%'></td>";
print "      <td width='10%'>$sDSYN</td>";
print "      <td width='20%'></td>";
print "    </tr>";
print "    <tr>";
//print "      <td width='9%'></td>";
print "      <td width='40%'>ค่าอุปกรณ์ทางการแพทย์</td>";
print "      <td width='20%'></td>";
print "      <td width='10%'>$sDPN</td>";
print "      <td width='20%'></td>";
print "    </tr>";
print "  </table>";
print "</div>";
...
print "      <td width='20%'></td>";
print "      <td width='10%' align='right'>$netpay</td>";
...
print "    <tr>";
print "      <td width='10%'></td>";
print "      <td width='40%'><b>$cbaht</b></td>";
print "      <td width='10%'><b>$netpay</b></td>";
print "<td width='30%'></td>";
...
print "<tr>";
print "<td width='20%'></td>";
print "<td width='20%' align=center><font style='line-height:13px; size='2'>ลงชื่อ.............................................ผู้รับเงิน</font></td>";
print "<td width='20%'></td>";
print "</tr>";
print "<tr>";
print "<td width='20%'><font style='line-height:13px; size='2'>ได้รับ $credit (".$_POST["detail_3"].",".$current.")</td>";
$sql = "Select name From inputm where idname = '".$_SESSION["sIdname"]."' limit 1 ";
$result = Mysql_Query($sql) or die("Query failed 721");
list($name) = Mysql_fetch_row($result);
print "<td width='20%' align=center><font style='line-height:25px; size='2'>(".$name.")</font></td>";
print "<td width='20%'></td>";
print "</tr>";
print "<tr>";
print "<td width='20%'></td>";
print "<td width='20%' align=center><font style='line-height:25px; size='2'>เจ้าหน้าที่เก็บเงิน</font></td>";
print "<td width='20%'></td>";
print "</tr>";
print "</table>";
print "</div>";
