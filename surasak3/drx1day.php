...
//
        ...
        echo mysql_errno() . ": " . mysql_error(). "\n";
        echo "<br>";
print "rx1day ตั้งค่า 0 เรียบร้อย, แถวที่ $n<br><br>";
/*
        $query ="UPDATE druglst SET  rx1day = 0,
                                                          stock=0,
		       	   mainstk=0,
        ...
        echo mysql_errno() . ": " . mysql_error(). "\n";
        echo "<br>";
print "rx1day ตั้งค่า 0 เรียบร้อย, แถวที่ $n<br>";
print "stock ตั้งค่า 0 เรียบร้อย, แถวที่ $n<br>";
print "mainstk ตั้งค่า 0 เรียบร้อย, แถวที่ $n<br>";
print "totalstk ตั้งค่า 0 เรียบร้อย, แถวที่ $n<br><br>";
*/
      }
  }
print "<br>rx1day ทั้งหมดตั้งค่า 0 เรียบร้อย<br>";
