<?php
    ...
    print "<form method='POST' action='lblst.php'>";
    print "<p><font face='Angsana New'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ต้องการดูรายการตรวจวิเคราะห์โรคหรือหัตถการ  ของวันที่ ?&nbsp;&nbsp;</font></p>";
    ...
    print "<input type=button onclick='history.back()' value=<<กลับไปเมนู></font></p>";
    print "</form>";
?>
