...
<p align="center">
<strong>รายชื่อทหารที่ตรวจ LAB เพิ่มเติม (HDL) จากส่วนที่เบิกไม่ได้ ปีงบประมาณ 2561<strong></strong>
...
<?
$sql="select * from opacc where credit='HDLCHKUP61' and paidcscd='100.00' group by hn order by date";
...
$sql1="select yot,ptname,camp from chkup_solider where hn='$rows[hn]' and yearchkup='61'";
