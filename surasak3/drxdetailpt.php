...
//end  runno  for chktranx
    ...
    $query = "SELECT * FROM dphardep WHERE row_id = '".$_GET["nRow_id"]."'  AND date = '".$_GET["sDate"]."' and department='pt'"; 
	//echo $query."<br>";
...
$n='0';
	...
	print "<font face='Angsana New'><b>รายการใบสั่งอุปกรณ์ PT จากแพทย์</b> <br>";
...
echo "<table><tr>";
	...
	?> 
    <td>
    <div id='cut1' style="display:block"><a target="_blank" href="drxstkcutpt.php?inject" <? if($inject==true){ ?> onclick="return confirm('ยืนยันการคิดค่าฉีดยา'); "<? }?>>ตัดสต๊อก</a></div><div id='cut2' style="display:none"><a target="_blank" href="drxstkcutpt.php">ตัดสต๊อกยา</a></div>
    </td>
	<?php }else{ ?>
...
$sql = "Select hn,ptname From dphardep WHERE hn = '".$sHn."' AND  date LIKE '$today1%'  and dr_cancle is null and department='pt'";
