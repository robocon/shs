		...
		<tr>
			...
			<td colspan="8" align="left" class="forntsarabun1">
				<label for="neuropathy">
					<input id="neuropathy" name="ht_etc" type="radio" value="Neuropathy" <?php echo ($arrdm['ht_etc'] == 'Neuropathy') ? 'checked' : '' ?>/>Neuropathy
				</label>
				
				<label for="heart">
					<input id="heart" name="ht_etc" type="radio" value="Heart Failure" <?php echo ($arrdm['ht_etc'] == 'Heart Failure') ? 'checked' : '' ?> />Heart Failure
				</label>
				<label for="nephropathy">
					<input id="nephropathy" name="ht_etc" type="radio" value="Nephropathy" <?php echo ($arrdm['ht_etc'] == 'Nephropathy') ? 'checked' : '' ?>/>Nephropathy
				</label>
				<br>
				<label for="cvd">
					<input id="cvd" name="ht_etc" type="radio" value="CVD" <?php echo ($arrdm['ht_etc'] == 'CVD') ? 'checked' : '' ?>/>CVD
				</label>
				<label for="ihd">
					<input id="ihd" name="ht_etc" type="radio" value="IHD" <?php echo ($arrdm['ht_etc'] == 'IHD') ? 'checked' : '' ?>/>IHD
				</label>
				<label for="footulcer">
					<input id="footulcer" name="ht_etc" type="radio" value="Foot ulcer" <?php echo ($arrdm['ht_etc'] == 'Foot ulcer') ? 'checked' : '' ?>/>Foot ulcer
				</label>
				<br>
				<label for="retinopathy">
					<input id="retinopathy" name="ht_etc" type="radio" value="Retinopathy" <?php echo ($arrdm['ht_etc'] == 'Retinopathy') ? 'checked' : '' ?>/>Retinopathy
				</label>
				<label for="dyslipidemia">
					<input id="dyslipidemia" name="ht_etc" type="radio" value="Dyslipidemia" <?php echo ($arrdm['ht_etc'] == 'Dyslipidemia') ? 'checked' : '' ?>/>Dyslipidemia
				</label>
			</td>
		</tr>
	  <tr>
