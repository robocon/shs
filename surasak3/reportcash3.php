...
if(isset($_GET['all'])){
	$vero=0;
	$numdrug=0;
	$sqls = "select txdate,price from opacc where hn='".$hn."' and credit = 'HD' and date between '2553-07-01 00:00:00' and '2555-09-12 23:59:59' group by left(txdate,10)";
...
$query="CREATE TEMPORARY TABLE drugrx01 SELECT * FROM phardep WHERE date like '$date%' and (an is null or an='') and cashok='HD'  ";
    $result = mysql_query($query) or die(mysql_error ());
	
$query="CREATE TEMPORARY TABLE drugrx02 SELECT * FROM drugrx WHERE date like '$date%' and (an is null or an='') ";
    $result = mysql_query($query) or die(mysql_error ());
	
	$sqls3 = "select txdate,price from opacc where hn='".$hn."' and credit = 'HD' and txdate like '".$date."%' and depart='PHAR' ";
...
//        $x++;
	...
	$have=1;
	$query="CREATE TEMPORARY TABLE depart01 SELECT * FROM depart WHERE date like '$date%' and an ='' and cashok='HD' ";
...
$query="CREATE TEMPORARY TABLE drugrx01 SELECT * FROM phardep WHERE date like '".$_GET['date']."%' and (an is null or an='') and cashok='HD'";
    $result = mysql_query($query) or die(mysql_error ());
	
$query="CREATE TEMPORARY TABLE drugrx02 SELECT * FROM drugrx WHERE date like '".$_GET['date']."%' and (an is null or an='') ";
    $result = mysql_query($query) or die(mysql_error ());

	$sqls = "select txdate,price from opacc where hn='".$hn."' and credit = 'HD' and txdate like '".$_GET['date']."%' and depart='PHAR' ";
	$rowss = mysql_query($sqls);
...
//        $x++;
	...
	////////////////////////////////////////////////////////
	$query="CREATE TEMPORARY TABLE depart01 SELECT * FROM depart WHERE date like '".$_GET['date']."%' and an ='' and cashok='HD' ";
    $result = mysql_query($query) or die("Query failed,warphar");
