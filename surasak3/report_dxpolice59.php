...
return $pAge;
	...
	$select = "SELECT  a.row, a.pid, a.idcard, a.dbirth, a.agey, b.hn, b.ptname, b.weight, b.height, b.bp1, b.bp2, b.p, b.cxr FROM opcardchk AS a INNER  JOIN out_result_chkup AS b ON a.HN = b.hn WHERE a.part ='สอบตำรวจ59' order by a.row";
	echo $select;	
...
<table width="100%" border="0">
  <tr>
    <td colspan="2"><table width="100%">
      ...
      <tr>
        <td align="center" valign="top" class="text1">ตรวจเมื่อวันที่  19 ธันวาคม 2559</td>
        </tr>
    </table></td>
  </tr>
  <tr>
