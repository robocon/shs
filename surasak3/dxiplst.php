...
//    $dc=substr($dcdate,8,8);
				$icd10sql="SELECT * FROM `diag` WHERE `an` = '$an' and type ='PRINCIPLE' ";
				$icd10result = mysql_query($icd10sql);
				$arr=mysql_fetch_array($icd10result);
				$icd10_diag=$arr['icd10'];
        ...
        print (" <tr>\n".
           ...
           "  <td BGCOLOR=F5DEB3><font face='Angsana New'>$icd10_diag</td>\n".
