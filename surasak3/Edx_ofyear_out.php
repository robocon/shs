...
<title>ทดสอบ - โปรแกรมซักประวัติตรวจสุขภาพ</title>
<style>
	...
	<tr>
		 ...
		 <tr>
           ...
           <td width="612" colspan="5" align="left"><span class="data_show">
             ...
             <input type="button"  onclick="document.getElementById('accident_surgery').value='ปฎิเสธ';" name="Submit3" value="ปฎิเสธ" />
           </span></td>
         </tr>
		 <tr>
           ...
           <td width="612" colspan="5" align="left"><span class="data_show">
             ...
             <input type="button"  onclick="document.getElementById('treat_hospital').value='ปฎิเสธ';" name="Submit3" value="ปฎิเสธ" />
           </span></td>
         </tr>
		 ...
		 <tr id="txt_epilepsy" style="display: none;">
           ...
           <td width="612" colspan="5" align="left"><span class="data_show">
             ...
             <input type="button"  onclick="document.getElementById('epilepsy').value='ปฎิเสธ';" name="Submit3" value="ปฎิเสธ" />
           </span></td>
		</tr>
		 ...
		 <tr>
           ...
           <td width="612" colspan="5" align="left"><span class="data_show">
             ...
             <input type="button"  onclick="document.getElementById('treat_other').value='ปฎิเสธ';" name="Submit3" value="ปฎิเสธ" />
           </span></td>
         </tr>
	<tr>
...
function Show() {
  ...
  if(text == "ใบรับรองแพทย์ สำหรับใบอนุญาตขับรถ"){
