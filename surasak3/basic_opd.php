		...
		<tr>
			<td colspan="6">
				<fieldset>
					...
					<table>
						<tr>
							<td><input type="checkbox" name="display_advice[]" id="form_a" value="form_a"><label for="form_a">Refer</label></td>
							<td><input type="checkbox" name="display_advice[]" id="form_e" value="form_e"><label for="form_e">คำแนะนำผู้ป่วยก่อนส่องตรวจลำไส้ใหญ่</label></td>
						</tr>
						<tr>
							<td><input type="checkbox" name="display_advice[]" id="form_b" value="form_b"><label for="form_b">คำแนะนำผู้ป่วยถ่ายอุจจาระเหลว</label></td>
							<td><input type="checkbox" name="display_advice[]" id="form_f" value="form_f"><label for="form_f">คำแนะนำผู้ป่วยก่อนส่องตรวจกระเพาะอาหาร</label></td>
						</tr>
						<tr>
							<td><input type="checkbox" name="display_advice[]" id="form_c" value="form_c"><label for="form_c">คำแนะนำผู้ป่วยมีอาการปวดท้องแบบบิด</label></td>
							<td><input type="checkbox" name="display_advice[]" id="form_g" value="form_g"><label for="form_g">คำแนะนำการปฏิบัติตัวก่อนผ่าตัด</label></td>
						</tr>
						<tr>
							<td><input type="checkbox" name="display_advice[]" id="form_d" value="form_d"><label for="form_d">คำแนะนำผู้ป่วยมีไข้</label></td>
							<td></td>
						</tr>
					</table>
				</fieldset>
