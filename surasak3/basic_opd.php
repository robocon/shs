		   ...
		   <td colspan="5" align="left" class="data_show">
				...
				<script type="text/javascript">
					...
					function open_select_doctor(){ 
						...
						var select_drug_html = '<div id="'+idKey+'">&nbsp;&nbsp;&nbsp;<span style="color: red;"><b>['+drugcode+']</b> '+genName+'</span><a href="javascript:void(0)" onclick="cancel_drugreact(\''+idKey+'\')">[?ÿÿ?]</a><input type="hidden" name="drugreact_selected[]" value="'+drugcode+'"></div>';
