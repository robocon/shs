	...
	if((isset($_POST["print_basic_opd"]) && $_POST["print_basic_opd"] != "")){
		...
		<script type="text/javascript">
			window.onload = function(){
				window.open('insert_basic_opd.php?dthn=<?=urlencode($thidatehn);?>');
			}
		</script>
		<?php
...
$query = "SELECT runno, prefix  FROM runno WHERE title = 's_chekup'";
	...
	$showyear="25".$nPrefix;
?>
<p><strong>โปรแกรมซักประวัติ OPD</strong> &nbsp;&nbsp;&nbsp;<a href='dx_ofyear.php' target="_blank">ซักประวัติตรวจสุขภาพทหารประจำปี<?=$showyear;?></a> &nbsp;&nbsp;&nbsp;<a href='dx_ofyear_out.php' target="_blank">ซักประวัติตรวจสุขภาพประจำปีตามระเบียบข้าราชการ</a> </p>
...
mmHg </td>
             ...
             <tr>
               ...
               <td align="left"><input name="bmi" type="text" size="3" maxlength="3" value="<?php echo $bmi; ?>"class="forntsarabun1" /></td>
               <td align="right"><?
