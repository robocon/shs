...
if($rows > 0){ 
	...
	else 
	{
		...
		`thdatehn`='$thidatehn', `hn`='$hn', `ptname`='$ptname', `antiplatelet`='$antiplatelet', `antiplatelet_txt`='$antiplatelet_txt', 
	...
	var_dump($opd_eye_sql);
	// var_dump($opd_eye_save);
		   ...
		   <td colspan="5" align="left">
				...
				<script type="text/javascript">
					...
					function open_select_doctor(){ 
						...
						var select_drug_html = '<div id="'+idKey+'"><span style="color: red;">'+drugcode+'</span><a href="javascript:void(0)" onclick="cancel_drugreact(\''+idKey+'\')">[ยกเลิก]</a><input type="hidden" name="drugreact[]" value="'+drugcode+'"></div>';
