...
$cHn = $_GET['cHn'];
$query = "SELECT * FROM opcard WHERE hn = '$cHn' limit 1";
...
<body bgcolor='<?=$color;?>' text='#3300FF' link='#00FFFF' vlink='#00FFFF' alink='#00FF00'>
	...
	<form name='f1' method='POST' action='opwork.php'
		onsubmit='return checkForm();' enctype="multipart/form-data">
		<fieldset>
			<legend>
				ข้อมูลประวัติส่วนตัว : HN : <a href="printpt.php" target="_blank"><font
					color="#FF0000"><?=$cHn;?></font></a>
			</legend>
			<table width="100%" border="0">
				<tr>
					<td width="15%" align="center"><a
						href='Capture1.php?id=<?=$cIdcard;?>&hn=<?=$cHn;?>&yot=<?=$cYot;?>&name1=<?=$cName;?>&name2=<?=$cSurname;?>'
						target=_blank> <IMG SRC='../image_patient/<?=$img;?>' WIDTH='100'
							HEIGHT='150' BORDER='0' ALT=''></a></td>
					<td width="85%" valign="top">
						<table border="0">
							<tr>
								<td align="right" class="fonthead">คำนำหน้า:</td>
								<td><input name="yot" type="text" id="yot" value="<?=$cYot;?>"
									size="5"></td>
								<td align="right" class="fonthead">ชื่อ:</td>
								<td><input name="name" type="text" id="name"
									value="<?=$cName;?>" size="15"></td>
								<td align="right" class="fonthead">สกุล:</td>
								<td><input name="surname" type="text" id="surname"
									value="<?=$cSurname;?>" size="15"></td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							...
							<tr>
								...
								<td><select size="1" name="sex" id="sex">
										<option value="">เลือก</option>
										<option <?php  if($cSex=='ช' ||$cSex=='1' ){ echo "selected"; }?>
											value="ช">ชาย</option>
										<option <?php  if($cSex=='ญ' ||$cSex=='2' ){ echo "selected"; }?>
											value="ญ">หญิง</option>
								</select></td>
								<td colspan="3" align="right" class="fonthead">หมายเลขประจำตัวประชาชน:</td>
								<td><input name="idcard" type="text" id="idcard"
									value="<?=$cIdcard;?>" size="15" maxlength="13"
									<?php  if(!empty($cIdcard) && $cIdcard != '-'){ echo "readonly";}?>>
								</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							...
							<tr>
								...
								<td colspan="10" class="fonthead"><input type='text' name='d'
									size='2' value='<?=$cD;?>' maxlength='2'> <input type='text'
									name='m' size='2' value='<?=$cM;?>' maxlength='2'> <input
									type='text' name='y' size='4' value='<?=$cY;?>' maxlength='4'>
									เชื้อชาติ: <select size="1" name="race" id="race">
										<option value=""><-เลือก-></option>
										<option value="ไทย" <?php  if($cRace=='ไทย'){ echo "selected";}?>>ไทย</option>
										<option value="จีน" <?php  if($cRace=='จีน'){ echo "selected";}?>>จีน</option>
										<option value="ลาว" <?php  if($cRace=='ลาว'){ echo "selected";}?>>ลาว</option>
										<option value="พม่า"
											<?php  if($cRace=='พม่า'){ echo "selected";}?>>พม่า</option>
										<option value="กัมพูชา"
											<?php  if($cRace=='กัมพูชา'){ echo "selected";}?>>กัมพูชา</option>
										<option value="อินเดีย"
											<?php  if($cRace=='อินเดีย'){ echo "selected";}?>>อินเดีย</option>
										<option value="เวียดนาม"
											<?php  if($cRace=='เวียดนาม'){ echo "selected";}?>>เวียดนาม</option>
										<option value="อื่นๆ"
											<?php  if($cRace=='อื่นๆ'){ echo "selected";}?>>อื่นๆ</option>
								</select> สัญชาติ: <select size="1" name="nation" id="nation">
										<option value=""><-เลือก-></option>
										<option value="ไทย"
											<?php  if($cNation=='ไทย'){ echo "selected";}?>>ไทย</option>
										<option value="จีน"
											<?php  if($cNation=='จีน'){ echo "selected";}?>>จีน</option>
										<option value="ลาว"
											<?php  if($cNation=='ลาว'){ echo "selected";}?>>ลาว</option>
										<option value="พม่า"
											<?php  if($cNation=='พม่า'){ echo "selected";}?>>พม่า</option>
										<option value="กัมพูชา"
											<?php  if($cNation=='กัมพูชา'){ echo "selected";}?>>กัมพูชา</option>
										<option value="อินเดีย"
											<?php  if($cNation=='อินเดีย'){ echo "selected";}?>>อินเดีย</option>
										<option value="เวียดนาม"
											<?php  if($cNation=='เวียดนาม'){ echo "selected";}?>>เวียดนาม</option>
										<option value="อื่นๆ"
											<?php  if($cNation=='อื่นๆ'){ echo "selected";}?>>อื่นๆ</option>
								</select> ศาสนา: <select size="1" name="religion" id="religion">
										<option value=""><-เลือก-></option>
										<option value="พุทธ"
											<?php  if($cReligion=='พุทธ'){ echo "selected";}?>>พุทธ</option>
										<option value="คริสต์"
											<?php  if($cReligion=='คริสต์'){ echo "selected";}?>>คริสต์</option>
										<option value="อิสลาม"
											<?php  if($cReligion=='อิสลาม'){ echo "selected";}?>>อิสลาม</option>
										<option value="อื่นๆ"
											<?php  if($cReligion=='อื่นๆ'){ echo "selected";}?>>อื่นๆ</option>
								</select></td>
							</tr>
							<tr>
								<td align="right" class="fonthead">สถานภาพ:</td>
								<td><select size="1" name="married" id="married">
										<option value=""><-เลือก-></option>
										<option value="โสด"
											<?php  if($cMarried=='โสด'){ echo "selected";}?>>โสด</option>
										<option value="สมรส"
											<?php  if($cMarried=='สมรส'){ echo "selected";}?>>สมรส</option>
										<option value="หม้าย"
											<?php  if($cMarried=='หม้าย'){ echo "selected";}?>>หม้าย</option>
										<option value="หย่า"
											<?php  if($cMarried=='หย่า'){ echo "selected";}?>>หย่า</option>
										<option value="แยก"
											<?php  if($cMarried=='แยก'){ echo "selected";}?>>แยก</option>
										<option value="สมณะ"
											<?php  if($cMarried=='สมณะ'){ echo "selected";}?>>สมณะ</option>
										<option value="อื่นๆ"
											<?php  if($cMarried=='อื่นๆ'){ echo "selected";}?>>อื่นๆ</option>
								</select></td>
								<td class="fonthead">อาชีพ:</td>
								<td colspan="3"><select size="1" name="career" id="career">
										<option value='<?=$cCareer;?>' selected><?=$cCareer;?></option>
										<option value=""><-เลือก-></option>
										<option value="01 เกษตรกร"
											<?php  if($cCareer=='01 เกษตรกร'){ echo "selected";}?>>01 เกษตรกร</option>
										<option value="02 รับจ้างทั่วไป"
											<?php  if($cCareer=='02 รับจ้างทั่วไป'){ echo "selected";}?>>02
											รับจ้างทั่วไป</option>
										<option value="03 ช่างฝีมือ"
											<?php  if($cCareer=='03 ช่างฝีมือ'){ echo "selected";}?>>03
											ช่างฝีมือ</option>
										<option value="04 ธุรกิจ"
											<?php  if($cCareer=='04 ธุรกิจ'){ echo "selected";}?>>04 ธุรกิจ</option>
										<option value="05 ทหาร/ตำรวจ"
											<?php  if($cCareer=='05 ทหาร/ตำรวจ'){ echo "selected";}?>>05
											ทหาร/ตำรวจ</option>
										<option value="06 นักวิทยาศาตร์และนักเทคนิก"
											<?php  if($cCareer=='06 นักวิทยาศาตร์และนักเทคนิก'){ echo "selected";}?>>06
											นักวิทยาศาตร์และนักเทคนิก</option>
										<option value="07 บุคลากรด้านสาธารณสุข"
											<?php  if($cCareer=='07 บุคลากรด้านสาธารณสุข'){ echo "selected";}?>>07
											บุคลากรด้านสาธารณสุข</option>
										<option value="08 นักวิชาชีพ/นักวิชาการ"
											<?php  if($cCareer=='08 นักวิชาชีพ/นักวิชาการ'){ echo "selected";}?>>08
											นักวิชาชีพ/นักวิชาการ</option>
										<option value="09 ข้าราชการทั่วไป"
											<?php  if($cCareer=='09 ข้าราชการทั่วไป'){ echo "selected";}?>>09
											ข้าราชการทั่วไป</option>
										<option value="10 รัฐวิสาหกิจ"
											<?php  if($cCareer=='10 รัฐวิสาหกิจ'){ echo "selected";}?>>10
											รัฐวิสาหกิจ</option>
										<option value="11 ผู้เยาว์ไม่มีอาชีพ"
											<?php  if($cCareer=='11 ผู้เยาว์ไม่มีอาชีพ'){ echo "selected";}?>>11
											ผู้เยาว์ไม่มีอาชีพ</option>
										<option value="12 นักบวช/งานด้านศาสนา"
											<?php  if($cCareer=='12 นักบวช/งานด้านศาสนา'){ echo "selected";}?>>12
											นักบวช/งานด้านศาสนา</option>
										<option value="13 อื่นๆ"
											<?php  if($cCareer=='13 อื่นๆ'){ echo "selected";}?>>13 อื่นๆ</option>
								</select></td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							...
							<tr>
								...
								<td colspan="4" class="fonthead"><input name="mid" type="text"
									id="mid" value="<?=$cMid;?>" size="15" maxlength="13"></td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
						...
						<p>
							...
							<!---style="display: none; -->
							<!--<input name="tmpPath" type="text" value="D:\image_patient\<?php //=$cIdcard;?>.jpg" size="50" readonly>
		  <strong><a href="#" onClick="filUpload.click();tmpPath.value=filUpload.value;" class="fonttitle">เลือกไฟล์</a></strong>-->
						</p> <input type="hidden" name="cIdcard" value="<?=$cIdcard;?>">
					</td>
				</tr>
			</table>
		...
		<fieldset>
			...
			<table border="0" align="center">
				...
				<tr>
					...
					<td><input type="text" name="father" size="15"
						value="<?=$cFather;?>"></td>
					<td align="right" class="fonthead">มารดา:</td>
					<td><input type="text" name="mother" size="15"
						value="<?=$cMother;?>"></td>
					<td align="right" class="fonthead">คู่สมรส:</td>
					<td><input type="text" name="couple" size="15"
						value="<?=$cCouple;?>"></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					...
					<td><input type='text' name="ptf" size='15' value="<?=$cPtf;?>"></td>
					<td align="right" class="fonthead">เกี่ยวข้องเป็น:</td>
					<td><input type='text' name="ptfadd" size='10'
						value="<?=$cPtfadd;?>"></td>
					<td align="right" class="fonthead">โทรศัพท์:</td>
					<td><input type='text' name="ptffone" size='10'
						value="<?=$cPtffone;?>"></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
			...
			if (substr ( $cPtright1, 0, 3 ) == 'R03' || substr ( $cPtright1, 0, 3 ) == 'R07') {
				...
				if (Mysql_num_rows ( Mysql_Query ( $sql ) ) > 0) {
					...
					if (Mysql_num_rows ( Mysql_Query ( $sql55 ) ) > 0) {
						?><option value="R03 โครงการเบิกจ่ายตรง" selected>R03
								โครงการเบิกจ่ายตรง</option><?php
					} else {
...
?>
				...
				<tr>
					...
					<td><input type='text' name="guardian" size='20'
						value="<?=$cGuardian;?>" id="guardian"></td>
					<td align="right" class="fonthead"></td>
					<td>&nbsp;</td>
				</tr>
			</table>
			...
			<table border="0" align="center" width="100%">
				<tr>
					...
					<td><SELECT NAME="blood" id="blood">
							...
							<option value="ไม่ทราบกรุ๊ปเลือด"
								<?php  if($cBlood=='ไม่ทราบกรุ๊ปเลือด'){ echo "selected";}?>>ไม่ทราบกรุ๊ปเลือด</option>
							<option value="ไม่เคยตรวจกรุ๊ปเลือด "
								<?php  if($cBlood=='ไม่เคยตรวจกรุ๊ปเลือด'){ echo "selected";}?>>ไม่เคยตรวจกรุ๊ปเลือด
							</option>
							<option value="เอ"
								<?php  if($cBlood=='เอ' || $cBlood=='A' ){ echo "selected";}?>>เอ</option>
							<option value="บี"
								<?php  if($cBlood=='บี' || $cBlood=='B' ){ echo "selected";}?>>บี</option>
							<option value="เอบี"
								<?php  if($cBlood=='เอบี' || $cBlood=='AB' ){ echo "selected";}?>>เอบี</option>
							<option value="โอ"
								<?php  if($cBlood=='โอ' || $cBlood=='O' ){ echo "selected";}?>>โอ</option>
					</SELECT></td>
					<td class="fonthead">แพ้ยา
						<div id="list3" style="position: absolute;"></div>
					</td>
					<td class="fonthead"><INPUT TYPE="text" NAME="drugreact"
						id="drugreact" value="<?=$cDrugreact;?>"> <input name="rdo1"
						type="radio" id="rdo1" value="30 บาท"
						<?php  if($hcode1=="30 บาท"){ echo "checked"; }?>> 30 บาท <input
						name="rdo1" type="radio" id="rdo2" value="ปส."
						<?php  if($hcode1=="ปส."){ echo "checked"; }?>> ประกันสังคม
						รพ.ต้นสังกัด <INPUT NAME="hospcode" TYPE="text" id="hospcode"
						onKeyPress="searchSuggest2(this.value,3,'hospcode');" size="40"
						value="<?=$cHospcode;?>"></td>
				</tr>
				<tr>
...
// 												include ("connect.inc");
            ...
            <?php 
					...
					<td><input type="text" name="note" size="50" value="<?=$cNote;?>"
						id="note"></td>
				</tr>
			</table>
		...
		<BR>
		<fieldset>
			<legend>กรุณาเลือกรายการ เพื่อที่จะเก็บสถิติผู้ป่วย
				และเลือกสิทธิของผู้ป่วยในการรักษา</legend>
<?php 
...
<table width="100%" border="0">
				<tr>
					...
					<td colspan="2" class="fonthead">
						<!--<?php //=$time;?>--> <select id='case1' name='case'>
<?php 
...
while ( list ( $rid, $typename, $typestatus ) = mysql_fetch_array ( $rows ) ) {
	...
	<option value='<?=$typename?>'
								<?php  if($toborow==$typename) echo "selected";?>><?=$typename?></option>
    <?php 
}
...
?>
					...
					<td class="fonthead"><input type="checkbox" value="lock"
						name="lockptright5" <?php  if($cPtright2!="") echo "checked";?>>
						(LOCK)&nbsp; <select name='ptright' id="ptright">
    <?php 
				// ////////////////////////////////การอัพเดทสิทธิปัจจุบัน//////////////////////////////////////
				if ($cPtright2 == "") {
					if ($cIdcard != "" || $cIdcard != "-") {
