...
$sql = "Select  a.depart, sum(a.paidcscd),sum(a.price) From opacc as a where a.date LIKE '$date1%'  AND a.credit ='กฟผ' group by  a.depart   ORDER by a.date";
...
switch($depart){
	...
	case "HEMO" : $list["HEMO"] = $list["HEMO"] + $price; break;
		...
		case "EYE" : $list["EYE"] = $list["EYE"] + $price; break;
...
$p='1';
	...
	$sum = $sum+($list["PHAR"]+$list["PATHO"]+$list["XRAY"]+$list["DENTA"]+$list["PHYSI"]+$list["EMER"]+$list["SURG"]+$list["NID"]+$list["HEMO"]+$list["OTHER"]+$list["EYE"]+$list["OTHER2"]);
...
echo "</table>";
			...
			*/
echo "<font face='Angsana New' size ='5'><br><br><center> <b>สรุปลูกหนี้กฟผ ประจำเดือน &nbsp;$date3 <br></b> ";
...
echo "<tr><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;เดือน&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><center> <b>&nbsp;&nbsp;ยา&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;พยาธิ&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;เอกเรย์&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ทันตกรรม&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;กายภาพ&nbsp;&nbsp;&nbsp;</td>
<td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ฉุกเฉิน&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ผ่าตัด&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ฝังเข็ม&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b>&nbsp;&nbsp;ไตเทียม&nbsp;&nbsp;&nbsp;</td><td><font face='Angsana New' size ='2'><center> <b><center> <b>&nbsp;&nbsp;ตา&nbsp;&nbsp;</td></td><td><font face='Angsana New' size ='2'><center> <b><center> <b>&nbsp;&nbsp;ค่าบริการ<br />
ทางการแพทย์&nbsp;&nbsp;&nbsp;</td>
<td>&nbsp;&nbsp;***&nbsp;&nbsp;</td><td><center> <b>&nbsp;&nbsp;รวม&nbsp;&nbsp;</td></tr>";

echo "<tr><td><b><font face='Angsana New' size ='3'>&nbsp;&nbsp;$date3&nbsp; </td><td><b><font face='Angsana New' size ='2'><center>รวมทั้งหมด</td><td align='right'><font face='Angsana New' size ='2'><b>&nbsp;&nbsp;".$PHAR."&nbsp;&nbsp;</td><td align='right'><font face='Angsana New' size ='2'><b>&nbsp;&nbsp;".$PATHO."&nbsp;&nbsp;</td><td align='right'><font face='Angsana New' size ='2'><b>&nbsp;&nbsp;".$XRAY."&nbsp;&nbsp;</td><td align='right'><font face='Angsana New' size ='2'><b>&nbsp;&nbsp;".$DENTA."&nbsp;&nbsp;</td><td align='right'><font face='Angsana New' size ='2'><b>&nbsp;&nbsp;".$PHYSI."&nbsp;&nbsp;</td><td align='right'><font face='Angsana New' size ='2'><b>&nbsp;&nbsp;".$EMER."&nbsp;&nbsp;</td><td align='right'><font face='Angsana New' size ='2'><b>&nbsp;&nbsp;".$SURG."&nbsp;&nbsp;</td><td align='right'><font face='Angsana New' size ='2'><b>&nbsp;&nbsp;".$NID."&nbsp;&nbsp;</td><td align='right'><font face='Angsana New' size ='2'><b>&nbsp;&nbsp;".$HEMO."&nbsp;&nbsp;</td><td align='right'><font face='Angsana New' size ='2'><b>&nbsp;&nbsp;".$EYE."&nbsp;&nbsp;</td><td align='right'><font face='Angsana New' size ='2'><b>&nbsp;&nbsp;".$OTHER."&nbsp;&nbsp;</td><td align='right'><font face='Angsana New' size ='2'><b>&nbsp;&nbsp;".$OTHER2."&nbsp;&nbsp;</td><td align='right'><font face='Angsana New' size ='3'><b>&nbsp;&nbsp;".$sum."&nbsp;&nbsp;</td></b></tr></FONT>";
echo "</table>";
...
print "      <td width='35%'><font face='Angsana New'>$yot</font></td>";
print "    </tr>";
print "  </table>";
print "<div align='left'>";
print "  <table border='0' cellpadding='0' cellspacing='0' width='100%'>";
...
print "    <tr>";
print "      <td width='50%'></td>";
print "      <td width='50%'><center><font face='Angsana New'>(&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ชฎาพร&nbsp;&nbsp;ธรรมสิทธิ์&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)</font></td>";
print "    </tr>";
print "  </table>";
print "<div align='left'>";
print "  <table border='0' cellpadding='0' cellspacing='0' width='100%'>";
...
$sql = "Select date_format( a.date, '%d-%m-%Y' ) AS date2, a.depart, sum(a.paidcscd), sum(a.price) From opacc as a where  a.date LIKE '$date1%'   AND a.credit ='กฟผ' group by date2, a.depart   ORDER by date";
// echo $sql;
$result = Mysql_Query($sql) or die(Mysql_Error());
...
$row='0';
	switch($depart){
		...
		case "EYE" : $list[$date]['EYE'] = $list[$date]['EYE'] + $paidcscd; break;
...
$row++;
	echo "<tr align=\"right\">
					...
					<td>".number_format($list[$key]['EYE'],2)."</td>
					<td>".number_format($list[$key]['OTHER'],2)."</td>
					<td>".number_format($list[$key]['OTHER2'],2)."</td>
					<td><B>".(number_format($list[$key]['PHAR']+$list[$key]['PATHO']+$list[$key]['XRAY']+$list[$key]['DENTA']+$list[$key]['PHYSI']+$list[$key]['EMER']+$list[$key]['SURG']+$list[$key]['NID']+$list[$key]['HEMO']+$list[$key]['OTHER']+$list[$key]['EYE']+$list[$key]['OTHER2'],2))."</B></td>
				</tr>";
