...
return $ageY;
	...
	$patienttype = "OPD";
	//$sourcecode = //รหัสward
	$build = array("42"=>"หอผู้ป่วยหญิง","44"=>"หอผู้ป่วย ICU","43"=>"หอผู้ป่วยสูติ","45"=>"หอผู้ป่วยพิเศษ","46"=>"หอผู้ป่วย Cohort Ward","47"=>"หอผู้ป่วย Home Isolation","48"=>"หอผู้ป่วย รพ.สนาม");
