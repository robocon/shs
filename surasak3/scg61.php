...
if ( $action === false ) {
    ...
    <ul>
        <li><a href="scg61.php?action=print_lab">Print ใบสติ๊กเกอร์</a></li>
        <li><a href="scg61.php?action=import_lab">นำเข้า Lab</a></li>
        <li><a href="scg61.php?action=print_list">พิมพ์รายชื่อ</a></li>
    </ul>
    <?php
