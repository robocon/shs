...
function check(){
	if(document.dxdrform.normal120.checked == false&document.dxdrform.normal121.checked == false){
		...
		window.location.href='dt_emp_manual_index.php';
		return false;
	}
}
...
<center>
  <div class="font_title">โปรแกรมตรวจสุขภาพลูกจ้าง</div>
  <div align="center" class="font_title">ประจำปี <?="25".$nPrefix;?> ห้วงวันที่ 7-18 มีนาคม 2559</div>
  <a href='dt_emp_manual_index.php'>&lt;&lt;ผู้ตรวจสุขภาพคนใหม่</a>
  </center>
...
//ค้นหา hn จาก opday ****************************************************************************************
	...
	*/
	...
	$sql = " SELECT vn
FROM `opday`
WHERE `hn` LIKE '".trim($_POST['p_hn'])."' and toborow ='EX16 ตรวจสุขภาพ'
...
$arr_view["age"] = calcage($arr_view["dbirth"]);
	...
	WHERE yearchk='$nPrefix' and `hn`='".$arr_view["hn"]."' ORDER BY row_id DESC LIMIT 0,1 ";
	//echo $sql;
	$result = mysql_query($sql);
...
<tr>
  <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FEFBD6" >
    <tr>
      <td align="left" bgcolor="#0099FF" class="tb_font_1" colspan="12">&nbsp;&nbsp;&nbsp;ข้อมูลผู้ป่วย</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left" class="profile">:</td>
      <td class="profilevalue">&nbsp;<? if($arr_dxofyear['cigarette']=="1"){ echo "เคยสูบ";}else if($arr_dxofyear['cigarette']=="0"){ echo "ไม่สูบ";}else{ echo "สูบ";}?></td>
      <td align="left" class="profile">สุรา</td>
      <td align="left" class="profile">:</td>
      <td class="profilevalue">&nbsp;<? if($arr_dxofyear['alcohol']=="1"){ echo "เคยดื่ม";}else if($arr_dxofyear['alcohol']=="0"){ echo "ไม่ดื่ม";}else{ echo "ดื่ม";}?></td>
    ...
    <tr bgcolor="#CCCCFF">
      <td bgcolor="#FFCCCC" class="profile"  style="color:#000"><strong>ตรวจร่างกายทั่วไป</strong></td>
	    <td bgcolor="#FFCCCC"><span class="profile">:</span></td>
	    <td colspan="3" bgcolor="#FFCCCC" class="profilevalue">
	      ...
	      ผิดปกติ </td>
	    <td colspan="7" bgcolor="#FFCCCC"><div id="acnormal20" style='display: none;'>
	      <select name="ch20" >
...
<TR>
	...
	<TR>
		<TD align="left" class="tb_font_1" bgcolor="#0099FF">&nbsp;&nbsp;&nbsp;ผลการตรวจทางพยาธิ เมื่อวันที่ <?php echo "<span style='color:yellow;'>$lab_date</span>";?></TD>
	</TR>
	<TR class="tb_font">
		<TD >
	&nbsp;&nbsp; <span class="style5">UA :</span> 
      ...
      <table width="100%" border="0">
	    ...
	    <td width="11%"  ><? if($result_dx['ua_bloodu']=="1+" || $result_dx['ua_bloodu']=="2+" || $result_dx['ua_bloodu']=="3+" || $result_dx['ua_bloodu']=="4+" || $result_dx['ua_bloodu']=="5+"){ echo "<strong style='color:red;'>$result_dx[ua_bloodu]</strong>";}else{ echo  $result_dx['ua_bloodu'];} ?></td>
	    <td width="10%" align="right" class="tb_font_2">Protien:</td><td width="9%"><? if($result_dx['ua_prou']=="1+" || $result_dx['ua_prou']=="2+" || $result_dx['ua_prou']=="3+" || $result_dx['ua_prou']=="4+" || $result_dx['ua_prou']=="5+"){ echo "<strong style='color:red;'>$result_dx[ua_prou]</strong>";}else{ echo  $result_dx['ua_prou'];} ?></td></tr>
      <tr>
      ...
      <tr bgcolor="#CCCCFF">
        <td colspan="2" align="center" bgcolor="#FFCCCC"><strong>ผลการตรวจ</strong></td>
...
<table border="0" width="100%">
      ...
      <option value='อาจเกิดจากการได้รับบางชนิด ภาวะเครียด หรือติดเชื้อในร่างกาย ควรตรวจซ้ำอีก 1 เดือน และปรึกษาแพทย์'>อาจเกิดจากการได้รับบางชนิด ภาวะเครียด หรือติดเชื้อในร่างกาย ควรตรวจซ้ำอีก 1 เดือน และปรึกษาแพทย์</option>
          ...
          <tr bgcolor="#CCCCFF">
            <td colspan="5" align="center" bgcolor="#FFCCCC"><strong>ผลการตรวจ</strong>
              ...
              ผิดปกติ </td>
            <td bgcolor="#FFCCCC"><div id="acnormal81" style='display: none;'>
            <select name='ch81'>
...
<table border="1" cellpadding="2" cellspacing="0" bordercolor="#393939"  width="100%" bgcolor="#FEFBD6"><tr><td>
	  <table width="100%" border="0">
	    <tr>
	      <td colspan="9" align="left" bgcolor="#0099FF" class="tb_font_2 style1">LAB อื่นๆ : <? if(substr($arr_view["age"],0,2) < 35){ echo "(อายุต่ำกว่า 35 ปี ไม่ได้ตรวจ)";} ?></td>
	      </tr>
	    <tr>
...
ปกติ
  ...
  ผิดปกติ </td>
        ...
        <select name='ch47'><option value=" อยู่ในกลุ่มเสี่ยงที่จะเป็นโรคเบาหวาน ควรออกกำลังกาย ลดอาหารหวานและอาหารจำพวกแป้ง">อยู่ในกลุ่มเสี่ยงที่จะเป็นโรคเบาหวาน ควรออกกำลังกาย ลดอาหารหวานและอาหารจำพวกแป้ง </option></select></div></td>
	      </tr>
...
ปกติ
  ...
  ผิดปกติ </td>
        ...
        <select name='ch44'><option value="การทำงานของไตลดลงมากอาจมีภาวะไตวายควรปรึกษาแพทย์ทันที">การทำงานของไตลดลงมากอาจมีภาวะไตวายควรปรึกษาแพทย์ทันที</option></select></div>  </td>
	      </tr>
	    <tr>
  ...
  ผิดปกติ </td>
	    ...
	    <tr>
          ...
          <td width="7%" class="labfont"><strong><?=$result_dx['alk']?></strong></td>
           ...
           <select name='ch41'><option value="การทำงานของตับผิดปกติควรงดเครื่องดื่มแอลกอฮอล์">การทำงานของตับผิดปกติควรงดเครื่องดื่มแอลกอฮอล์</option></select></div>            </td>
            </tr>
	  <tr>
...
ปกติ
  ...
  ผิดปกติ </td>
        ...
        <select name='ch42'><option value="การทำงานของตับผิดปกติควรงดเครื่องดื่มแอลกอฮอล์">การทำงานของตับผิดปกติควรงดเครื่องดื่มแอลกอฮอล์</option></select></div>  </td>
	    </tr>
	  <tr>
...
ปกติ
  ...
  ผิดปกติ </td>
        ...
        <select name='ch43'><option value="การทำงานของตับผิดปกติควรงดเครื่องดื่มแอลกอฮอล์">การทำงานของตับผิดปกติควรงดเครื่องดื่มแอลกอฮอล์</option></select></div>  </td>
	    </tr>
	  <tr>
...
ปกติ
  ...
  ผิดปกติ </td>
	    <td colspan="4">
        <div id="acnormal49" <? if($result_dx['uricflag']=="") echo "style='display: none;'"; elseif($result_dx['uricflag']=="N") echo "style='display: none;'"; else "style='display: block;'"; ?>><select name='ch49'><option value="ควรงดอาหารที่มีพิวรีนสูง เช่น เครื่องในสัตว์ สัตว์ปีก เครื่องดื่มแอลกอฮอล์">ควรงดอาหารที่มีพิวรีนสูง เช่น เครื่องในสัตว์ สัตว์ปีก เครื่องดื่มแอลกอฮอล์</option></select></div>            </td>
	    </tr>
		<tr>
			...
			<td class="labfont">
				<input name='stat_ldl' type='radio' value='ปกติ' onclick="togglediv2('acnormal50');" <? if($result_dx['ldlflag']==""  && substr($arr_view["age"],0,2) >= 35) echo "checked";?>/>
				ปกติ
...
<TR>
	<TD><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FEFBD6">
	  <tr>
	    <td align="left" class="tb_font_1" bgcolor="#0099FF" colspan="5">&nbsp;&nbsp;&nbsp;การตรวจอื่น ๆ</td>
	  </tr>
	  <tr bgcolor="#CCCCFF">
	    <td width="29%" align="right" bgcolor="#FFCCCC" class="tb_font_2">ตรวจเอ็กซ์เรย์ปอด : <a href="dxdr_xray_film.php" target="_blank">ดูฟิลม์</a> </td>
	    <td width="25%" bgcolor="#FFCCCC" class="labfont">
	    ...
	    <input name='normal51' type='radio' value='ผิดปกติ' onclick="togglediv1('acnormal51')" id="normal95"/>
	      ผิดปกติ </td>
	    <td width="46%" bgcolor="#FFCCCC" class="labfont"><div id="acnormal51" style='display: none;'>
	      <select name="ch51" >
...
<TABLE width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="#393939"  bgcolor="#FEFBD6" >
 <tr bgcolor="#CCCCFF">
	    <td height="49" align="center" bgcolor="#FFCCCC" class="sum">
