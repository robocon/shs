...
if(isset($_POST["row_id"]) && $_POST["row_id"] != ""){
	...
	$ekg = $dxdr_ofyear['ekg'];
	$res_ekg = $_POST['res_ekg'];

	$hdl = $dxdr_ofyear['hdl'];
	$hdl_range = $dxdr_ofyear['hdl_range'];
	$stat_hdl = $_POST['stat_hdl'];
	$reason_hdl = $_POST['reason_hdl'];

	$ldlc = $dxdr_ofyear['10001'];
	$ldlc_range = $dxdr_ofyear['10001_range'];
	$stat_ldlc = $_POST['stat_ldlc'];
	$reason_ldlc = $_POST['reason_ldlc'];

	$malari = $dxdr_ofyear['malari'];
	$malari_range = $dxdr_ofyear['malari_range'];
	$stat_malari = $_POST['stat_malari'];

	$metamp = $dxdr_ofyear['metamp'];
	$metamp_range = $dxdr_ofyear['metamp_range'];
	$stat_metamp = $_POST['stat_metamp'];

	$hbsag = $dxdr_ofyear['hbsag'];
	$hbsag_range = $dxdr_ofyear['hbsag_range'];
	$stat_hbsag = $_POST['stat_hbsag'];

	$hcvab = $dxdr_ofyear['hcvab'];
	$hcvab_range = $dxdr_ofyear['hcvab_range'];
	$stat_hcvab = $_POST['stat_hcvab'];

	$hiv = $dxdr_ofyear['hiv'];
	$hiv_range = $dxdr_ofyear['hiv_range'];
	$stat_hiv = $_POST['stat_hiv'];

	$vdrl = $dxdr_ofyear['vdrl'];
	$vdrl_range = $dxdr_ofyear['vdrl_range'];
	$stat_vdrl = $_POST['stat_vdrl'];

	$parasi = $dxdr_ofyear['parasi'];
	$parasi_range = $dxdr_ofyear['parasi_range'];
	$stat_parasi = $_POST['stat_parasi'];

	$groupt = $dxdr_ofyear['groupt'];
	$groupt_range = $dxdr_ofyear['groupt_range'];
	$stat_groupt = $_POST['stat_groupt'];

	$rh = $dxdr_ofyear['rh'];
	$rh_range = $dxdr_ofyear['rh_range'];
	$stat_rh = $_POST['stat_rh'];

	$upt = $dxdr_ofyear['upt'];
	$upt_range = $dxdr_ofyear['upt_range'];
	$stat_upt = $_POST['stat_upt'];

	$antihb = $dxdr_ofyear['antihb'];
	$antihb_range = $dxdr_ofyear['antihb_range'];
	$stat_antihb = $_POST['stat_antihb'];
	...
	$sql ="INSERT INTO  `condxofyear_out` ( 
		...
		`reason_sol10` ,  `status_dr` , `yearcheck`, `sol1`, `sol2`, `sol3`, 
		`sol4`, `sol41`, `sol5`, `sol51`, `sum1`, `sum2`, 
		`rs_sum21`, `rs_sum22`, `rs_sum23`, `rs_sum24`, `rs_sum25`, `sum3`, 
		`sum4`, `sum5`, `rs_sum51`, `rs_sum52`, `rs_sum53`, `sum6`, 
		`rs_sum61`,`anemia`,`cirrhosis`,`hepatitis`,`cardiomegaly`,`allergy`,
		`gout`,`waistline`,`asthma`,`muscle`,`ihd`,`thyroid`,
		`heart`,`emphysema`,`herniated`,`conjunctivitis`,`cystitis`,`epilepsy`,
		`fracture`,`cardiac`,`spine`,`dermatitis`,`degeneration`,`alcoholic`,
		`copd`,`bph`,`kidney`,`pterygium`,`tonsil`,`paralysis`,
		`blood`, `conanemia`,`ht`, `stat_pressure` ,  `reason_pressure`, `stat_bmi` ,  
		`reason_bmi`, `dental_exam`,`color_blind`,`audiogram`,`ekg`,`res_ekg`,
		`hdl`,`hdl_range`,`stat_hdl`,`reason_hdl`,`ldlc`,`ldlc_range`,
		`stat_ldlc`,`reason_ldlc`,`malari`,`malari_range`,`stat_malari`,`metamp`,
		`metamp_range`,`stat_metamp`,`hbsag`,`hbsag_range`,`stat_hbsag`,`hcvab`,
		`hcvab_range`,`stat_hcvab`,`hiv`,`hiv_range`,`stat_hiv`,`vdrl`,
		...
		`TB`,`TBPrange`,`stat_tb`,`DB`,`DBrange`,`stat_db`,`ALB`,`ALBrange`,`stat_alb`,`TP`,`TPrange`,`stat_tp`) 
	
	VALUES ( 

		'".$date_now."',  '".$date_hn."',  '".$date_vn."',  '".$dxdr_ofyear['hn']."',  '".$dxdr_ofyear['vn']."',  '".$dxdr_ofyear['ptname']."',  
		'".$dxdr_ofyear['age']."',  '".$dxdr_ofyear['camp']."',  '".$dxdr_ofyear['camp_until']."',  '".$dxdr_ofyear['height']."',  '".$dxdr_ofyear['weight']."',  '".$dxdr_ofyear['round_']."',  
		'".$dxdr_ofyear['temperature']."',  '".$dxdr_ofyear['pause']."',  '".$dxdr_ofyear['rate']."',  '".$_POST['bmi']."',  '".$dxdr_ofyear['bp1']."',  '".$dxdr_ofyear['bp2']."',  
		'".$dxdr_ofyear['drugreact']."',  '".$dxdr_ofyear['prawat']."',  '".$dxdr_ofyear['congenital_disease']."',  '".$dxdr_ofyear['type']."',  '".$dxdr_ofyear['organ']."',  '".$_POST['doctorn']."',  
		'".$dxdr_ofyear['ua_color']."',  '".$dxdr_ofyear['ua_appear']."',  '".$dxdr_ofyear['ua_spgr']."',  '".$dxdr_ofyear['ua_phu']."',  '".$dxdr_ofyear['ua_bloodu']."',  '".$dxdr_ofyear['ua_prou']."',  
		'".$dxdr_ofyear['ua_gluu']."',  '".$dxdr_ofyear['ua_ketu']."',  '".$dxdr_ofyear['ua_urobil']."',  '".$dxdr_ofyear['ua_bili']."',  '".$dxdr_ofyear['ua_nitrit']."',  '".$dxdr_ofyear['ua_wbcu']."',  
		'".$dxdr_ofyear['ua_rbcu']."',  '".$dxdr_ofyear['ua_epiu']."',  '".$dxdr_ofyear['ua_bactu']."',  '".$dxdr_ofyear['ua_yeast']."',  '".$dxdr_ofyear['ua_mucosu']."',  '".$dxdr_ofyear['ua_amopu']."',  
		'".$dxdr_ofyear['ua_castu']."',  '".$dxdr_ofyear['ua_crystu']."',  '".$dxdr_ofyear['ua_otheru']."',  '".$_POST['normal']."',  '".$_POST['ch']."',  '".$dxdr_ofyear['cbc_wbc']."',  
		'".$_POST['normal32']."',  '".$_POST['ch32']."',  '".$dxdr_ofyear['wbcrange']."',  '".$dxdr_ofyear['wbcflag']."', '".$dxdr_ofyear['cbc_rbc']."',  '".$dxdr_ofyear['cbc_hb']."',  
		'".$dxdr_ofyear['cbc_hct']."',  '".$_POST['normal31']."',  '".$_POST['ch31']."',  '".$dxdr_ofyear['hctrange']."',  '".$dxdr_ofyear['hctflag']."',  '".$dxdr_ofyear['cbc_mcv']."',  
		'".$dxdr_ofyear['cbc_mch']."',  '".$dxdr_ofyear['cbc_mchc']."',  '".$dxdr_ofyear['cbc_pltc']."',  '".$_POST['normal33']."',  '".$_POST['ch33']."',  '".$dxdr_ofyear['pltcrange']."',  
		'".$dxdr_ofyear['pltcflag']."',  '".$dxdr_ofyear['cbc_plts']."',  '".$dxdr_ofyear['cbc_neu']."',  '".$dxdr_ofyear['cbc_lymp']."',  '".$dxdr_ofyear['cbc_mono']."',  '".$dxdr_ofyear['cbc_eos']."',  
		'".$dxdr_ofyear['cbc_baso']."',  '".$dxdr_ofyear['cbc_band']."',  '".$dxdr_ofyear['cbc_atyp']."',  '".$dxdr_ofyear['cbc_nrbc']."',  '".$dxdr_ofyear['cbc_rbcmor']."',  '".$dxdr_ofyear['cbc_other']."',  
		'".$_POST['normal81']."',  '".$_POST['ch81']."',  '".$_POST['normal51']."',  '".$_POST['ch51']."',  '".$dxdr_ofyear['bs']."',  '".$_POST['normal47']."',  
		'".$_POST['ch47']."',  '".$dxdr_ofyear['bsrange']."',  '".$dxdr_ofyear['bsflag']."',  '".$dxdr_ofyear['bun']."',  '".$_POST['normal44']."',  '".$_POST['ch44']."',  
		'".$dxdr_ofyear['bunrange']."',  '".$dxdr_ofyear['bunflag']."',  '".$dxdr_ofyear['cr']."',  '".$_POST['normal45']."',  '".$_POST['ch45']."',  '".$dxdr_ofyear['crrange']."',  
		'".$dxdr_ofyear['crflag']."',  '".$dxdr_ofyear['uric']."',  '".$_POST['normal49']."',  '".$_POST['ch49']."',  '".$dxdr_ofyear['uricrange']."',  '".$dxdr_ofyear['uricflag']."',  
		'".$dxdr_ofyear['chol']."',  '".$_POST['normal46']."', '".$_POST['ch46']."',  '".$dxdr_ofyear['cholrange']."',  '".$dxdr_ofyear['cholflag']."',  '".$dxdr_ofyear['tg']."',  
		'".$_POST['normal48']."',  '".$_POST['ch48']."',  '".$dxdr_ofyear['tgrange']."',  '".$dxdr_ofyear['tgflag']."',  '".$dxdr_ofyear['sgot']."',  '".$_POST['normal41']."',  
		'".$_POST['ch41']."',  '".$dxdr_ofyear['sgotrange']."',  '".$dxdr_ofyear['sgotflag']."',  '".$dxdr_ofyear['sgpt']."',  '".$_POST['normal42']."',  '".$_POST['ch42']."',  
		'".$dxdr_ofyear['sgptrange']."',  '".$dxdr_ofyear['sgptflag']."',  '".$dxdr_ofyear['alk']."',  '".$_POST['normal43']."',  '".$_POST['ch43']."',  '".$dxdr_ofyear['alkrange']."',  
		'".$dxdr_ofyear['alkflag']."',  '".$_POST['normal20']."',  '".$_POST['ch20']."',  '".$_POST['normal52']."',  '".$_POST['ch52']."',  '".$_POST['other1']."',  
		'".$_POST['normal53']."',  '".$_POST['ch53']."',  '".$_POST['other2']."',  '".$_POST['normal54']."',  '".$_POST['ch54']."',  '".$_POST['dx']."',  
		'".$dxdr_ofyear['clinic']."',  '".$dxdr_ofyear['cigarette']."',  '".$dxdr_ofyear['alcohol']."',  '".$_POST['normal71']."',  '".$txtsm."',  '".$_POST['normal21']."',  
		'".$_POST['text21']."',  '".$_POST['normal22']."',  '".$_POST['text22']."',  '".$_POST['normal23']."',  '".$_POST['text23']."',  '".$_POST['normal24']."',  
		'".$_POST['text24']."',  '".$_POST['normal25']."',  '".$_POST['text25']."',  '".$_POST['normal26']."',  '".$_POST['text26']."',  '".$_POST['normal27']."',  
		'".$_POST['text27']."',  '".$_POST['normal28']."',  '".$_POST['text28']."',  '".$_POST['normal29']."',  '".$_POST['text29']."',  '".$_POST['normal30']."',  
		'".$_POST['text30']."',  'Y', '".$nPrefix."',  '".$_POST['normal91']."', '".$_POST['normal92']."',  '".$_POST['normal93']."',  
		'".$_POST['normal94']."', '".$_POST['normal941']."',  '".$_POST['normal95']."',  '".$_POST['normal951']."',  '".$_POST['normal61']."',  '".$_POST['normal62']."', 
		'".$rs_sum21."','".$rs_sum22."', '".$rs_sum23."', '".$rs_sum24."','".$rs_sum25."',  '".$_POST['normal63']."',  

		'".$_POST['normal64']."', '".$_POST['normal65']."', '".$rs_sum51."','".$rs_sum52."','".$rs_sum53."',  '".$_POST['normal66']."', 
		'".$rs_sum61."','".$_POST['anemia']."','".$_POST['cirrhosis']."','".$_POST['hepatitis']."','".$_POST['cardiomegaly']."','".$_POST['allergy']."',
		'".$_POST['gout']."','".$_POST['waistline']."','".$_POST['asthma']."','".$_POST['muscle']."','".$_POST['ihd']."','".$_POST['thyroid']."',
		'".$_POST['heart']."','".$_POST['emphysema']."','".$_POST['herniated']."','".$_POST['conjunctivitis']."','".$_POST['cystitis']."','".$_POST['epilepsy']."',
		'".$_POST['fracture']."','".$_POST['cardiac']."','".$_POST['spine']."','".$_POST['dermatitis']."','".$_POST['degeneration']."','".$_POST['alcoholic']."',
		'".$_POST['copd']."','".$_POST['bph']."','".$_POST['kidney']."','".$_POST['pterygium']."','".$_POST['tonsil']."','".$_POST['paralysis']."',

		'".$_POST['blood']."','".$_POST['conanemia']."','".$_POST['ht']."', '".$_POST['normal55']."',  '".$_POST['ch55']."', '".$_POST['normal56']."',  
		'".$_POST['ch56']."', '$dental_exam','$color_blind','$audiogram','$ekg','$res_ekg', 
		'$hdl','$hdl_range','$stat_hdl','$reason_hdl','$ldlc','$ldlc_range', 
		'$stat_ldlc','$reason_ldlc','$malari','$malari_range','$stat_malari','$metamp', 
		'$metamp_range','$stat_metamp','$hbsag','$hbsag_range','$stat_hbsag','$hcvab', 
		'$hcvab_range','$stat_hcvab','$hiv','$hiv_range','$stat_hiv','$vdrl', 
		...
		'$tb','$tbrange','$stat_tb','$db','$dbrange','$stat_db','$alb','$albrange','$stat_alb','$tp','$tprange','$stat_tp') ";
...
*/
		...
		$select = "select * from condxofyear_out where hn = '".$tmp_hn."' AND (camp like '%E_CERT%') ORDER BY row_id DESC LIMIT 1";
		$row = mysql_query($select);
		$num = mysql_num_rows($row);
		while($resultdx = mysql_fetch_array($row)){
		
			$tmp_row_id = $resultdx["row_id"];
...
$sql = "SELECT * FROM `condxofyear_out` WHERE hn = '".$tmp_hn."' AND row_id = '".$tmp_row_id."' ORDER BY row_id DESC LIMIT 1"; 
//echo $sql;exit();
