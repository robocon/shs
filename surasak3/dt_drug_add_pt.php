	...
	for($i=0;$i<$count;$i++){
		...
		if($part == "DDY"){
			...
			if(substr($_SESSION["list_drug_reason"][$i],0,1)=="F"){
				$sql = "Select tradname, part, salepri, freepri, unit  From druglst_pt  where drugcode = '".$_SESSION["list_drugcode"][$i]."' limit 1";
				$result = Mysql_Query($sql);
...
$_SESSION["dt_drugstk"] .= "<TABLE cellpadding=\"0\" cellspacing=\"0\">
	<TR>
		<TD colspan=\"3\"><font style=\"font-family:'MS Sans Serif'; font-size:12px\"  >&nbsp;&nbsp;&nbsp;&nbsp&nbsp;".$Thidate2.";&nbsp;&nbsp;HN:".$_SESSION["hn_now"].", &nbsp;&nbsp;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;".$_SESSION["yot_now"]." ".$_SESSION["name_now"]." ".$_SESSION["surname_now"]."&nbsp;&nbsp;โรค ".$_SESSION["dt_diag"]."</TD>
	</TR>
	";
	
	$_SESSION["dt_drugstk1"] .= "<TABLE cellpadding=\"0\" cellspacing=\"0\">
	<TR>
		<TD colspan=\"3\"><font style=\"font-family:'MS Sans Serif'; font-size:16px\"  >&nbsp;ใบรับอุปกรณ์&nbsp;<br>&nbsp;ให้ไปรับที่ตึกกายภาพ<br>&nbsp&nbsp;".$Thidate2."&nbsp;<br>&nbsp;HN:".$_SESSION["hn_now"]."&nbsp<br>&nbsp;".$_SESSION["yot_now"]." ".$_SESSION["name_now"]." ".$_SESSION["surname_now"]."&nbsp;<br>&nbsp;โรค ".$_SESSION["dt_diag"]."&nbsp;<br>&nbsp;สิทธิ ".$_SESSION["ptright_now"]."</TD>
	</TR>
	";
...
$_SESSION["dt_drugstk"] .= "
  ...
  <tr>
	...
	$query1 = "INSERT INTO ddrugrx_pt(date,hn,drugcode,tradname,amount,price,item,slcode,part,idno, salepri, freepri, drug_inject_amount,drug_inject_unit, drug_inject_amount2,drug_inject_unit2,drug_inject_time,drug_inject_slip, drug_inject_type, drug_inject_etc,reason,DPY , DPN,indicator  ) VALUES";
...
$k3=$k2+50;
	...
	//	$_SESSION['list_drugslip'][$i] = $_POST['act'.$i];
		...
		if($_SESSION["list_drugcode"][$i] != "INJ"){
			...
			$_SESSION["dt_drugstk1"] .="<TR style='line-height:14px;'>
			<TD><font style=\"font-family:'MS Sans Serif'; font-size:13px\"> ".$tradname." ".$unit."</TD>";				
			}else{
				$_SESSION["dt_drugstk"] .="<TR style='line-height:12px;'>
			<TD><font style=\"font-family:'MS Sans Serif'; font-size:10px\"> ".$tradname." ".$unit."(".substr($_SESSION['list_drug_reason'][$i],0,1).")</TD>";		
			$_SESSION["dt_drugstk1"] .="<TR style='line-height:14px;'>
			<TD><font style=\"font-family:'MS Sans Serif'; font-size:13px\"> ".$tradname." ".$unit."(".substr($_SESSION['list_drug_reason'][$i],0,1).")</TD>";	
			}
			...
			$_SESSION["dt_drugstk1"] .="<TD><font style=\"font-family:'MS Sans Serif'; font-size:13px\" >&nbsp;&nbsp;&nbsp;&nbsp;".$_SESSION["list_drugslip"][$i]."</TD>
			<TD><font style=\"font-family:'MS Sans Serif'; font-size:13px\">จำนวน&nbsp;".$_SESSION["list_drugamount"][$i]."&nbsp;".$unit."</TD>
			</TR>";
	...
	<TR>
		...
		$_SESSION["dt_drugstk1"] .= "
	<TR>
		<TD colspan=\"3\"><font style=\"font-family:'MS Sans Serif'; font-size:10px\" >".$_SESSION["dt_doctor"]."</TD>
	</TR>";
...
include("dt_menu.php");
echo "<BR><BR>
	<CENTER>บันทึกข้อมูลเรียบร้อยแล้ว<BR>ถ้าไม่มีนัดให้กดพิมพ์<BR><A HREF=\"dt_printstker_pt.php\">Print Stiker</A></CENTER>
	</body>
	</html>
