...
<form name="f1" action="" method="post">
  ...
  <tr class="forntsarabun">
    <td colspan="2" bgcolor="#99CC99">สถิติยอดผู้ป่วย หอผู้ป่วยพิเศษ</td>
    </tr>
  <tr class="forntsarabun">
...
LIKE  '$date1%' AND bedcode  LIKE  '45%' ";
...
if($row){
	 ...
	 print "<div><font class='forntsarabun' >สถิติยอดผู้ป่วย หอผู้ป่วยพิเศษ ประจำเดือน  $dateshow </font></div><br>";
 ?>
...
$i=0;
 ...
 <table  border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0" bordercolor="#000000" class="forntsarabun">
  ...
  <tr>
    ...
    <td><a href="vipdetail.php?do=view&icd10=<?=$array2['icd10'];?>&date=<?=$date1;?>" title="คลิกเพื่่อดูรายละเอียด"><?=$array2['icd10'];?></a></td>
    <td><?=$r['detail'];?></td>
