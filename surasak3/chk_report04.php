...
/**
 * รูปแบบที่4 จะไม่อ่าน labnumber ที่ขึ้นต้นด้วย 63
 */
						...
						<table width="100%" border="0" class="text3" cellpadding="0" cellspacing="0">
							...
							while($arrresult = mysql_fetch_array($query1)){
								...
								while($objResult = mysql_fetch_array($objQuery)){
									...
									}else if($objResult["labname"]=="HAV(Total)"){
									...
									// 	if($objResult["flag"]=="N"){
									// 		$app="ปกติ";	
									// 	}else if($objResult["flag"]!="N"){
									// 		$app="ผิดปกติ";	
									// 	}
									// }

									// // Anti-HAV IgG
									// if( $objResult["labname"] == 'HAV(Total)' ){
									// 	$objResult["labname"] = 'Anti-HAV IgM';
									// }
