...
<table>
 <tr>
  ...
  <th bgcolor=#ffffcc><font face='Angsana New'>กรณี HI</th>
...
<?php
	...
	if($hi_type=="in"){
        ...
        print (" <tr>\n".
		   ...
		   "  <td BGCOLOR=#ffffcc><font face='Angsana New'>$location</td>\n".
...
<table>
 <tr>
  ...
  <th bgcolor=6495ED><font face='Angsana New'>กรณี HI</th>
 ...
 <th bgcolor=6495ED><font face='Angsana New'>สรุปค่าใช้จ่าย</th>
   ...
   <th bgcolor=6495ED><font face='Angsana New'>ส่วนเกิน</th>
	...
	<th bgcolor=6495ED><font face='Angsana New'>เวลาจำหน่าย</th>
  </tr>
  </tr>
...
<?php
	...
	if($hi_type=="in"){
        ...
        print (" <tr>\n".
		   ...
		   "  <td BGCOLOR=66CDAA><font face='Angsana New'>$location</td>\n".
      ...
      //     "  <td BGCOLOR=66CDAA>$accno</td>\n".
			...
			"  <td BGCOLOR=66CDAA><font face='Angsana New'><a target=_BLANK  href=\"ipdcdate.php?vAn=$an&vHn=$hn&vDate=$date&vDcdate1=$dcdate1&vDcdate=$dcdate&vDays=$days&vPtright=$ptright&vPtname=$ptname&vDiag=$diag\">$dcdate</a></td>\n". 
           " </tr>\n");
       }
    include("unconnect.inc");
?>
...
<table>
 <tr>
  ...
  <th bgcolor=6495ED>กรณี HI</th>
  <th bgcolor=6495ED>ค่าห้อง</th>
