...
<p><strong>HA รายงานผู้ป่วยที่มารับการรักษาพยาบาล<br /></strong></strong>
</p>
  <strong>ข้อมูลเดือน : </strong>
  ...
  <? 
      ...
      <?
				...
				echo "<select>";
				?>
      <p style="margin-left: 65px;"><input type="submit" value=" ดูรายงาน " name="B1"  class="txt" />&nbsp;&nbsp;&nbsp;<input type="button" value="กลับหน้าหลัก" onclick="window.location.href='../nindex.htm' " class="txt" /></p>
</form>
<?
if($_POST["act"]=="show"){
