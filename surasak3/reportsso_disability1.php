...
$sql = "Select a.date,a.txdate, a.hn, CONCAT(b.yot,' ',b.name,' ',b.surname) as full_name, a.depart, sum(a.price),b.idcard,b.note,sum(a.paidcscd) From opacc as a, opcard as b  where a.hn=b.hn AND a.date like '".$date1."%'  AND a.credit ='ประกันสังคมทุพพลภาพ' group by a.hn, a.depart   ORDER by a.date";
...
$num='0';
$i='0';
echo "<font face='Angsana New' size ='4'><center> <b>ลูกหนี้ประกันสังคมทุพพลภาพประจำวันที่ $date2 <br></b> ";
