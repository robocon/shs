...
str_replace("MSIE 8.0;","MSIE 7.0;",$_SERVER['HTTP_USER_AGENT'],$ie_count);
...
if($_SESSION["dt_drugstk"] != ""){
		$_SESSION["dt_drugstk"].= "<TABLE id=\"stkappoint\" cellpadding=\"0\" cellspacing=\"0\" width=\"350\" font style=\"font-family:'MS Sans Serif'; font-size:14px; line-height: 20px;\">
		<TR>
			<TD>นัดวันที่ ".$_POST["date_appoint"]."<font face='Angsana New' size= 2 >&nbsp;เวลา ".$_POST["capptime"]."</TD>
		</TR>
...
$_SESSION["dt_drugstk"] .= "<TABLE id=\"appoint\" cellpadding=\"0\" cellspacing=\"0\" width=\"290\" font style=\"font-family:'MS Sans Serif'; font-size:14px; line-height: 20px;\">
			<TR>
				<TD align=\"center\" class=\"app2\"><B>ใบนัดผู้ป่วย รพ.ค่ายสุรศักดิ์มนตรี ลำปาง</B></TD>
			</TR>
			<TR>
				<TD class=\"app1\">ชื่อ : ".$cPtname." &nbsp;&nbsp; HN : ".$_SESSION["hn_now"]."</TD>
			</TR>
			<TR>
				<TD class=\"app2\"><B><U>นัดวันที่ ".$_POST["date_appoint"]."&nbsp;เวลา ".$_POST["capptime"]."</U></B></TD>
			</TR>
			<TR>
				<TD class=\"app1\"><B>เพื่อ </B> ".$_POST["detail"]." ".(trim($_POST["detail2"]) !=''?"(".$_POST["detail2"].")":"")." &nbsp;<B>แพทย์ </B> ".$doctor."</TD>
			</TR>
			<TR>
				<TD class=\"app2\"><U><B>ยื่นใบนัดที่ :</B> ".$_POST["room"]."</U></TD>
			</TR>";

if($i){

$_SESSION["dt_drugstk"] .="<TR  style=\"line-height: 14px;\">
				<TD class=\"app1\">LAB : ".$lab_appoint_implode."</TD>
			</TR>";
}

if(trim($_POST["xray"]) !=""){
$_SESSION["dt_drugstk"] .="<TR  style=\"line-height: 14px;\">
				<TD class=\"app1\">".$down_list."</TD>
			</TR>";

}

$_SESSION["dt_drugstk"] .="<TR style=\"line-height: 14px;\">
				<TD class=\"app1\">วันเวลาออกใบนัด : ".date("d/m/Y H:i:s")."</TD>
			</TR>";

$_SESSION["dt_drugstk"] .= "<TR style=\"line-height: 14px;\">
				<TD class=\"app1\">มีข้อสงสัยติดต่อจุดบริการนัด โทร 054-839305 ต่อ 1125</TD>
			</TR>
			</TABLE>
			";
...
$_SESSION["dt_drugstk"] .= "<TABLE id=\"labs\" cellpadding=\"0\" cellspacing=\"0\" width=\"290\"  style=\"font-family:'MS Sans Serif'; font-size:14px; line-height: 20px;\">
			<TR>
				<TD align=\"center\"><font face='Angsana New' size= 3 >ใบนัดตรวจทางพยาธิ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
			</TR>
			<TR>
				<TD class=\"app1\">HN ".$_SESSION["hn_now"]."&nbsp;&nbsp;ชื่อผู้ป่วย ".$cPtname."</TD>
			</TR>
			<TR>
				<TD class=\"app2\"><B><U>นัดวันที่ : ".$_POST["date_appoint"]."</U></B></TD>
			</TR>
			<TR>
				<TD class=\"app1\">แพทย์ : ".$doctor."</TD>
			</TR>
			<TR>
				<TD class=\"app1\">ข้อควรปฏิบัติ : <U>".$_POST["advice"]."</U></TD>
			</TR>
			<TR>
				<TD class=\"app1\">รายการ : <B>".$lab_appoint_implode."</B></TD>
			</TR>
			<TR>
				<TD class=\"app1\">".$other2."</TD>
			</TR>
			</TABLE>
			";
}
...
$_SESSION["dt_drugstk"] .= "<TABLE id=\"xray\" cellpadding=\"0\" cellspacing=\"0\" width=\"290\"  style=\"font-family:'MS Sans Serif'; font-size:14px; line-height: 20px;\">
			<TR>
				<TD align=\"center\" class=\"app1\">ใบนัด X-Ray&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
			</TR>
			<TR>
				<TD class=\"app1\">ชื่อผู้ป่วย : ".$cPtname." &nbsp;&nbsp; HN : ".$_SESSION["hn_now"]."</TD>
			</TR>
			<TR>
				<TD class=\"app1\"><B><U>นัดวันที่ : ".$_POST["date_appoint"]."</U></B></TD>
			</TR>
			<TR>
				<TD class=\"app1\">แพทย์ : ".$doctor."</TD>
			</TR>
			<TR>
				<TD class=\"app1\">X-Ray : <B>".$_POST["xray"]."</B></TD>
			</TR>
			<TR>
				<TD class=\"app1\">".$other2."</TD>
			</TR>
