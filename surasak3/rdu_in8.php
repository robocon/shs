...
$sqlTraumaB = "CREATE TEMPORARY TABLE `tmp_trauma_b` 
SELECT a.*, b.`ptname` 
FROM `tmp_base_trauma` AS a 
LEFT JOIN `tmp_base_opday` AS b ON a.`thdatehn` = b.`thdatehn` 
