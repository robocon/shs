...
<table class="forntsarabun">
  ...
  <tr>
    ...
    <option value="เพลิงพายุ" <? if($dbarr['programmer']=="เพลิงพายุ"){ echo "selected"; } ?>>เพลิงพายุ</option>
    <option value="ภูมินทร์" <? if($dbarr['programmer']=="ภูมินทร์"){ echo "selected"; } ?>>ภูมินทร์</option>
