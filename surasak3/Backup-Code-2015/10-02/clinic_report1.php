...
switch($_POST['m_start']){
 ...
 $dateshow=$_POST['d_start'].' '.$printmonth." ".$_POST['y_start'];
	...
	$sql="select * from clinic_vip ".$where."";
...
<?//} ?>-->
<table border="1" style="border-collapse:collapse; border-color:#000;" cellpadding="0" cellspacing="0" class="font2" width="80%" align="center">
  <tr bgcolor="#999999">
    <td align="center"  width="7%">ลำดับ</td>
    <td colspan="2" align="center">ชื่อ - สกุล</td>
    <td align="center" width="20%">HN</td>
    <td align="center" width="20%">AN</td>
...
echo "<table width='80%' border='0' align='center' class='font2'>
  <tr>
  ...
  <tr>
    ...
    <td align='center'>........./............/.........</td>
		...
		echo "<table width=\"80%\" border=\"1\" style=\"border-collapse:collapse; border-color:#000;\" cellpadding=\"0\" cellspacing=\"0\" class=\"font2\" align='center'>
  <tr bgcolor=\"#999999\">
    <td align=\"center\" width=\"7%\">ลำดับ</td>
    <td colspan='2' align='center'>ชื่อ - สกุล</td>
    <td align=\"center\" width=\"20%\">HN</td>
...
<BR />
<table width="80%" border="0" align="center" class="font2">
  <tr>
