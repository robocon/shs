...
<?
		...
		$thaidate=array();
		$diag1=array();
		$sql = "Create Temporary table opd2 Select * From opd where hn='".$_GET["hn"]."' order by thidate desc limit 10";
		...
		while($arr2 = mysql_fetch_assoc($result2)){
			...
			$sql = "Select diag From opday where hn='".$_GET["hn"]."' and thidate like '".$ym[0]."-".$ym[1]."-".$d[0]."%'";
