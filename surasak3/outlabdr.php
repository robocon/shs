...
if(file_exists("vaccine1/Lab_upload/dcorder/$filename")){		
	    ...
	    echo   "<td BGCOLOR=F5DEB3><a href=\"vaccine1/Lab_upload/dcorder/$filename\" target='_blank'>ดูไฟล์</a></td>";
		
}elseif(file_exists("vaccine1/Lab_upload/dcorder/$filename1")){
		echo " <tr>
				 <td BGCOLOR=F5DEB3>$dbarr[date]</td>
				  <td BGCOLOR=F5DEB3>$dbarr[detail]</td>";
		  echo   "<td BGCOLOR=F5DEB3><a href=\"vaccine1/Lab_upload/dcorder/$filename1\" target='_blank'>ดูไฟล์</a></td>";
}
echo "</tr>";
}
?>
