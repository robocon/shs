...
$sql = "SELECT drugcode, tradname, amount, slcode, statcon, row_id,part 
		...
		(
			...
			(
				#OR statcon = 'STAT1'
				`date` like '" . (date("Y") + 543) . date("-m-d") . "%' AND (statcon = 'STAT' ) 
			) 
		) Order by row_id ASC ";
			...
			<TD>
				<TABLE width="100%" align="center">
					...
					<TR valign="top">
						...
						<TD bgcolor="#FFFFBC" colspan="5"><?php echo $arr["diagnos"]; ?><font color="#FF0033">
								<div style='margin-left:10px;'>*** ห้ามมีสัญลักษณ์พิเศษ เช่น เครื่องหมาย ' ในการ Diag โรค จะทำให้สั่งจ่ายยาในระบบไม่ได้ <span style='color:blue;'>แก้ไขชื่อโรคกรุณาติดต่อหอผู้ป่วย</span> ***</div>
							</font>
						</TD>
					</TR>
				</TABLE>
