...
<title>พิมพ์ใบตรวจสุขภาพเทศบาลเมืองพิชัย</title>
<style type="text/css">
<!--
.tet {
...
<center>
<span class="tet1">พิมพ์ใบตรวจสุขภาพเทศบาลเมืองพิชัย</span><br />
  <br />
...
<!--    <script>
	...
	include("connect.inc");	
	$sql="SELECT  * FROM opcardchk  WHERE part='เทศบาลพิชัย60' order by row";
	//echo $sql;
  ...
  <tr>
    <td colspan="2"><table width="100%">
      <tr>
        ...
        <td width="77%" align="center" valign="top" class="texthead"><strong>แบบรายงานการตรวจสุขภาพเทศบาลเมืองพิชัย</strong></td>
...
mmHg. </u></strong><span class="text3"><strong>P: </strong> <u>
 ...
 <? $sql="SELECT * FROM resulthead WHERE profilecode='CBC' and hn='".$result2['HN']."' and clinicalinfo ='ตรวจสุขภาพเทศบาลพิชัย60' ";
    ...
    <td width="50%"  valign="top"><table width="100%" height="111" border="1" cellpadding="3" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse">
      ...
      <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="text3">
          ...
          <? $sql="SELECT * FROM resulthead WHERE profilecode='UA' and hn='".$result2['HN']."' and clinicalinfo ='ตรวจสุขภาพเทศบาลพิชัย60'";
	$query = mysql_query($sql);
	$arrresult = mysql_fetch_array($query);
/////
...
if($objResult["labcode"]=='HBSAG'){  //HBSAG
	if($objResult["result"]=="Negative"){
		...
		?>
          <tr height="25">
            <td width="34%" valign="top"><strong><?=$objResult["labname"]." ".$labmean;?></strong></td>
