...
echo"<br>เลขที่บัตรประชาชน: $arr[idcard]<br>";
echo"ที่อยู่: $arr[address]  ต.$arr[tambol]  อ.$arr[ampur]  จ.$arr[changwat]<br>";
echo"บิดา: $arr[father]     มารดา:  $arr[mother]<br>";

echo"ผู้ที่สามารถติดต่อได้:  $arr[ptf]     เกี่ยวข้องกับผู้ป่วย:  $arr[ptfadd]  <br>";
echo"โทรศัพท์:  $arr[ptffone]<br>";
  ...
  /* print " <br><a target=_self href='wardpage.php'>บันทึกค่าบริการทางการแพทย์</a>";
   ...
   if($dcdate == '' || $dcdate =='0000-00-00 00:00:00'){ print "<br><BR><a target=_self href='ipdc_confirm.php'>จำหน่าย(discharge)เท่านั้น</a>";}else{print " <br><BR><BR><FONT SIZE='' COLOR='FF0000'>คำเตือน! หอผู้ป่วยได้ทำการจำหน่ายผู้ป่วยแล้ว <BR>ถ้าจำหน่ายอีกครั้งจะทำให้คิดค่าบริการและค่าห้องเพิ่มขึ้น ให้ทำการลบข้อมูลแทน</FONT> ";}
