...
-->
  ...
  $selmon=date("m");
  ?>
<form method="POST" action="update_exportdatacscd1.php">
<p><strong>โปรแกรมอัพเดทสถานะ ICD10 เพื่อส่งเบิกค่าชดเชยทางการแพทย์ผู้ป่วยนอก สิทธิเบิกจ่ายตรง (CSOP)<br />
ผู้พัฒนาระบบ&nbsp;&nbsp;&nbsp;ส.ท. เทวิน ศรีแก้ว เจ้าหน้าที่ศูนย์บริการคอมพิวเตอร์&nbsp;&nbsp;&nbsp;โทร. 8500<br />
<div style="color: #0000FF;">เริ่มใช้ตั้งแต่วันที่ 28 เดือนมีนาคม พ.ศ.2562 เป็นต้นไป</div></strong>
</p>
<div style="color:#FF0000; font-size:26px;">คำเตือน!!!...หากส่งข้อมูลไปยัง สกส. เรียบร้อยแล้ว ห้ามกดอัพเดทสถานะ ICD10 เด็ดขาด</div></strong>
<p><a href="report_exportdatacscd.php" target="_blank">ข้อมูลที่จัดเตรียมเพื่อส่งเบิก สกส.</a></p>
  ...
  <? 
      ...
      <?
				...
				echo "<select>";
				?>
      <p style="margin-left: 65px;"><input type="submit" value="อัพเดทข้อมูล" name="B1"  class="txt" />&nbsp;&nbsp;&nbsp;<input type="button" value="กลับหน้าหลัก" onclick="window.location.href='../nindex.htm' " class="txt" /></p>
</form>
