...
<body>
<p align="center" style="margin-top: 20px;"><strong>เลือกวันที่ต้องการดูข้อมูล Diag Not Found สิทธิประกันสังคม</strong></p>
<div align="center">
  <form method="post" action="report_diagnotfound_sso.php">
...
?>
<hr />
<div align="center" style="margin-top: 20px;"><strong>รายงานแสดงข้อมูล Diag Not Found สิทธิประกันสังคม</strong></div>
...
<table width="97%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr>
    ...
    <td width="13%" align="center" bgcolor="#66CC99"><strong>วัน/เดือน/ปี</strong></td>
    <td width="6%" align="center" bgcolor="#66CC99"><strong>VN</strong></td>
    <td width="8%" align="center" bgcolor="#66CC99"><strong>HN</strong></td>
    <td width="19%" align="center" bgcolor="#66CC99"><strong>ชื่อผู้ป่วย</strong></td>
    <td width="16%" align="center" bgcolor="#66CC99"><strong>การมาโรงพยาบาล</strong></td>
...
$sql="CREATE TEMPORARY TABLE reportdiagnotfoundcscd select * from opacc where (txdate >= '$chkdate1 00:00:00' and txdate <='$chkdate2 23:59:59') AND credit =  'ประกันสังคม' AND (an='' OR an IS NULL)  group by hn,vn";
//echo $sql;
$query=mysql_query($sql);

$querytmp="SELECT * FROM reportdiagnotfoundcscd";
