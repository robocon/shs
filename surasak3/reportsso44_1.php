...
$sql = "Select a.date,a.txdate, a.hn, CONCAT(b.yot,' ',b.name,' ',b.surname) as full_name, a.depart, sum(a.paid),a.ptright From opacc as a, opcard as b where a.hn=b.hn AND a.date like '".$date1."%' AND a.credit='กท44' group by a.hn, a.depart   ORDER BY a.date asc, a.ptright asc";
//echo $sql;
...
echo "<font face='Angsana New' size ='4'><center> <b>ลูกหนี้ประกันสังคม กท.44 ประจำวันที่ $date2 <br></b> ";
