...
$year1=$_POST['y_start']-1;
$year2=$_POST['y_start'];
 
$sqlicd10 = "CREATE TEMPORARY TABLE ipcard01 SELECT *  FROM  ipcard  WHERE (dcdate >= '$year1-10-01 00:00:00' and dcdate <= '$year2-09-30 23:59:59')  and bedcode  like '$lbedcode%' and icd10 !='' ";
//echo $sqlicd10;
...
<td colspan="13" align="center" bgcolor="#66CC66" class="texticd"><strong>ปีงบประมาณ <?=$_POST['y_start']?>
</strong></td>
</tr>
<tr>
...
<?		
	for($n=10;$n<=21;$n++){
		...
		$selectsql1 = "SELECT count(icd10)as count1 FROM ipcard01 where dcdate like '".$startyear."-$m-%' and icd10='".$arr['icd10']."' ";
