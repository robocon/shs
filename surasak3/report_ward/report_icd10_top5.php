...
*/
 ...
 $arrm1=array();
	for($n=10;$n<=21;$n++){
		...
		//$endyear=$_POST['y_start'];
		$selectsql1 = "SELECT  icd10, COUNT(`icd10`) AS  `top`  FROM ipcard WHERE dcdate like '".$startyear."-$m-%' and bedcode like '$lbedcode%' and icd10!='' GROUP BY icd10 ORDER BY  `top` DESC  limit 5";
		//$selectsql1 = "SELECT  icd10, COUNT(`icd10`) AS  `top`  FROM ipcard WHERE (dcdate >= '$startyear-10-01 00:00:00' and dcdate >= '$endyear-09-30 23:59:59') and bedcode like '$lbedcode%' and icd10!='' GROUP BY icd10 ORDER BY  `top` DESC  limit 5";  //ปรับเป็นปีงบประมาณ รับคำสั่ง หน.หนุ่ย ward รวม 16-08-62
		//echo $selectsql1."<br>";
