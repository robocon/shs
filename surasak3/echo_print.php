    ...
    <tr>
        <td valign="top" width="50%" style="border-right: 1px solid #000000;">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td align="center"><?=$a['ao'];?></td>
                    <td width="19%">&nbsp;mm. (20-32)</td>

                    <td>&nbsp;</td>
                    <td align="right" width="10%">LVEDV&nbsp;</td>
                    <td align="center"><?=$a['lvedv'];?></td>
                    <td width="19%">&nbsp;ml. (90-140)</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td align="right">LA&nbsp;</td>
                    <td align="center"><?=$a['la'];?></td>
                    <td>mm. (18-40)</td>
                    
                    <td>&nbsp;</td>
                    <td align="right">LVESV&nbsp;</td>
                    <td align="center"><?=$a['lvesv'];?></td>
                    <td>ml. (27-95)</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td align="right">IVSd&nbsp;</td>
                    <td align="center"><?=$a['ivsd'];?></td>
                    <td>mm. (6-11)</td>
                    
                    <td>&nbsp;</td>
                    <td align="right">SV&nbsp;</td>
                    <td align="center"><?=$a['sv'];?></td>
                    <td>ml. (50-100)</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td align="right">IVSs&nbsp;</td>
                    <td align="center"><?=$a['ivss'];?></td>
                    <td>mm. (9-16)</td>
                    
                    <td>&nbsp;</td>
                    <td align="right">CO&nbsp;</td>
                    <td align="center"><?=$a['co'];?></td>
                    <td>L/min</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td align="right">LVDd&nbsp;</td>
                    <td align="center"><?=$a['lvdd'];?></td>
                    <td>mm. (37-55)</td>
                    
                    <td>&nbsp;</td>
                    <td align="right">EF&nbsp;</td>
                    <td align="center"><?=$a['ed'];?></td>
                    <td>% (50-80)</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td align="right">LVDs&nbsp;</td>
                    <td align="center"><?=$a['lvds'];?></td>
                    <td>mm. (22-45)</td>
                    
                    <td>&nbsp;</td>
                    <td align="right">peak E&nbsp;</td>
                    <td align="center"><?=$a['peake'];?></td>
                    <td></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td align="right">Pwd&nbsp;</td>
                    <td align="center"><?=$a['pwd'];?></td>
                    <td>mm. (7-11)</td>
                    
                    <td>&nbsp;</td>
                    <td align="right">peak A&nbsp;</td>
                    <td align="center"><?=$a['peaka'];?></td>
                    <td></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td align="right">Pws&nbsp;</td>
                    <td align="center"><?=$a['pws'];?></td>
                    <td>mm. (11-17)</td>
                    
                    <td>&nbsp;</td>
                    <td align="right">E/A&nbsp;</td>
                    <td align="center"><?=$a['ea'];?></td>
                    <td></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td align="right">FS&nbsp;</td>
                    <td align="center"><?=$a['fs'];?></td>
                    <td>% (25-44)</td>
                    
                    <td>&nbsp;</td>
                    <td align="right">DT&nbsp;</td>
                    <td align="center"><?=$a['dt'];?></td>
                    <td></td>
                </tr>
            </table>
            <table width="100%">
                ...
                <tr>
                    ...
                    <td style="width:96px;" align="center"><?=$a['ms'];?></td>
                    <td>&nbsp;</td>

                    <td align="right" width="16%">MnGRAD&nbsp;</td>
                    <td style="width:96px;" align="center"><?=$a['ms_mngrad'];?></td>
                    <td>mmHg</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td align="right">MVA(PHT)&nbsp;</td>
                    <td align="center"><?=$a['ms_mvapht'];?></td>
                    <td>cm<sup>2</sup></td>

                    <td align="right">MVA(2-D)&nbsp;</td>
                    <td align="center"><?=$a['ms_mva2d'];?></td>
                    <td>cm<sup>2</sup></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td align="right">MR&nbsp;</td>
                    <td align="center"><?=$a['ms_mr'];?></td>
                    <td>mmHg</td>
                ...
                <tr>
                    ...
                    <td align="center"><?=$a['as'];?></td>
                    <td>&nbsp;</td>

                    <td align="right">PGRAD&nbsp;</td>
                    <td  align="center"><?=$a['as_pgrad'];?></td>
                    <td>mmHg</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td align="right">MnGRAD&nbsp;</td>
                    <td align="center"><?=$a['as_mngrad'];?></td>
                    <td>mmHg</td>
                ...
                <tr>
                    ...
                    <td align="center"><?=$a['as_ar'];?></td>
                    <td></td>
                    
                    <td align="right">AI PHT&nbsp;</td>
                    <td align="center"><?=$a['as_aipht'];?></td>
                    <td>ms.</td>
                </tr>
                ...
                <tr>
                    ...
                    <td align="center"><?=$a['ps'];?></td>
                    <td>&nbsp;</td>

                    <td align="right">PGRAD&nbsp;</td>
                    <td align="center"><?=$a['ps_pgrad'];?></td>
                    <td>mmHg</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td align="right">MnGRAD&nbsp;</td>
                    <td align="center"><?=$a['ps_mngrad'];?></td>
                    <td>mmHg</td>
                ...
                <tr>
                    ...
                    <td align="center"><?=$a['ps_pr'];?></td>
                    <td>&nbsp;</td>
                    
                    <td align="right">PGRAD&nbsp;</td>
                    <td align="center"><?=$a['ps_pr_pgrad'];?></td>
                    <td>mmHg</td>
                </tr>
                ...
                <tr>
                    ...
                    <td align="center"><?=$a['ts'];?></td>
                    <td>&nbsp;</td>

                    <td align="right">MnGRAD&nbsp;</td>
                    <td align="center"><?=$a['ts_mngrad'];?></td>
                    <td>mmHg</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td align="right">TVA(PHT)&nbsp;</td>
                    <td align="center"><?=$a['ts_tvapht'];?></td>
                    <td>cm<sup>2</sup></td>

                    <td align="right">TVA(2-D)&nbsp;</td>
                    <td align="center"><?=$a['ts_tva2d'];?></td>
                    <td>cm<sup>2</sup></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td align="right">TR&nbsp;</td>
                    <td align="center"><?=$a['ts_tr'];?></td>
                    <td>&nbsp;</td>
                    
                    <td align="right">RVSP&nbsp;</td>
                    <td align="center"><?=$a['ts_rvsp'];?></td>
                    <td>mmHg</td>
                </tr>
            </table>
        </td>
        <td valign="top" width="50%" style="padding-left: 4px;">
            <table width="100%">
                ...
                <tr>
                    <td>DIAGNOSIS: <b style="font-size: 20px;"><?=$a['diag'];?></b></td>
                </tr>
                <tr>
                    <td align="right">
