...
?>	
<body>
<div align="center"><strong>ผลการตรวจสุขภาพเจ้าหน้าที่ เขลางค์ทรานสปอร์ต แอนด์ คอนตรัคชั่น  บริการตรวจสุขภาพ ณ โรงพยาบาลค่ายสุรศักดิ์มนตรี</strong></div>
<div align="center"><strong>ระหว่างวันที่ 21-23 กรกฎาคม 2560 จำนวน 13 ราย</strong></div>
...
<?
$sql="SELECT  *  FROM opcardchk WHERE part='เขลางค์ทรานสปอร์ต60' and active='y' order by row";
//echo $sql."<br>";
