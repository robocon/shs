...
<form method="POST" action="moneychkall1.php">
  <p><strong>วันที่ : </strong>
    <input name="appdate" type="text" id="appdate" size="1" value="<?=date("d");?>" class="txt">
    <strong>เดือน : </strong><select size="1" name="appmo" class="txt">
