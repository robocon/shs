...
if( $action === false ){
	...
	$age=$user['age'];
	?>
	<div id="sticker-contain1" style="margin-left:260px;">	
<table border="0" align="center" width="100%" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<div style="margin-left:10px; line-height: 20px; font-size:20px; font-weight:bold; ">AN: <?php echo $an;?></div>
	<div style="margin-left:10px; line-height: 20px; font-size:20px; font-weight:bold; ">HN: <?php echo $hn;?></div>
	<div><strong style="margin-left:10px; line-height: 20px; font-size:20px;"><?php echo $ptname;?></strong></div>
	<div style="margin-left:10px; line-height: 20px; font-size:20px;">อายุ: <?=$age;?></div>
	</th>
  </tr>  
</table>		
	</div>
