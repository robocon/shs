...
print "<center><font face='Angsana New' face='Angsana New' size='3' >การให้คำแนะนำที่ศูนย์ผู้ป่วยใน <b>สิทธิ์เบิก&nbsp;บัตรประกันสังคม</b></font><br>";
...
print "<font face='Angsana New' size='2' ><input type='checkbox' >สำเนาบัตรประจำตัวประชาชน</font><br>";
print "<font face='Angsana New' size='2' ><input type='checkbox' >สำเนาบัตรรับรองสิทธิประกันสังคม</font><br>";
...
print "<font face='Angsana New' size='3' ><input type='checkbox' >ค่ายา ค่าเวชภัณฑ์ ค่าบริการ ชำระส่วนที่เบิกไม่ได้จากสิทธิประกันสังคม</font><br>";
