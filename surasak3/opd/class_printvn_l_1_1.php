...
<?php
 date_default_timezone_set('Asia/Bangkok');
	...
	{ echo "this :".$strDate;
		//$strMonth= date("n",strtotime($strDate));//echo "this :".$strMonth;
		$strMonth = $strDate;
...
<tr>
	...
	<? echo "<b>วันที่</b> ".date('d')." <b>เดือน</b> พฤษภาคม <b>พ.ศ</b> ".(date('Y')+543); ?></font>
   </td>
</tr> 
</table>
<table width="900" border="0" align="center" cellpadding="5" cellspacing="0">
<tr>
   ...
   <td width="450" align='right'><font size='5'>
	...
	$pt_address = iconv("UTF-8", "UTF-8", $pt_address);

	$pt_phone = $data->result->person->mobile_phone;
	$pt_phone = iconv("UTF-8", "UTF-8", $pt_phone);
