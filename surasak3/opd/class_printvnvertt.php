	...
	function outputprint(){
		...
		print "<font style='line-height:24px;' face='Angsana New' size= 2 >ใบตรวจ โรงพยาบาลค่ายสุรศักดิ์มนตรี<br>";
			print "<font style='line-height:24px;' face='Angsana New' size= 3 ><center>".date("d-m-").(date("Y")+543)." เวลา  ".date("G:i:s")."<br>";
				print "<font  style='line-height:24px;' face='Angsana New' size= 4 ><b><u>นัดฉีดยาต่อเนื่อง</b></u><br>";
					print "<font  style='line-height:24px;' face='Angsana New' size= 5 ><b><u>VERORAB</b></u><br>";
					print "<font  style='line-height:24px;' face='Angsana New' size= 5 ><b><u>Tetanus Toxoid</b></u><br>";
		print "<font style='line-height:24px;' face='Angsana New' size= 5 ><b>VN:&nbsp; ".$this->vn." </b>&nbsp;&nbsp; ".$this->kew."";
...
//		print "<font  style='line-height:24px;' face='Angsana New' size= 4 ><b>ลำดับที่&nbsp;".$this->kew."</b><BR>";
		...
		print "<font  style='line-height:24px;' face='Angsana New' size= 1 >หมายเหตุ ".$this->note."</font><BR>";
		print "<img src = \"printbcpha.php?cHn=".$this->hn."\"><BR>";
print "<font face='Angsana New' size= 3 >".$this->inrxform."&nbsp;&nbsp;".$this->drugreact."</font><BR>";
...
print "<font  style='line-height:24px;' face='Angsana New' size= 2 >แพทย์..............................................</font><BR>";
print "<font  style='line-height:24px;' face='Angsana New' size= 4 ><u>รับยายื่นที่ช่องหมายเลข 6</u></font><BR><BR>";
/*
...
print "<font style='line-height:24px;' face='Angsana New' size= 2 >ใบตรวจ โรงพยาบาลค่ายสุรศักดิ์มนตรี<br>";
			print "<font style='line-height:24px;' face='Angsana New' size= 3 ><center>".date("d-m-").(date("Y")+543)." เวลา  ".date("G:i:s")."<br>";
				print "<font  style='line-height:24px;' face='Angsana New' size= 4 ><b><u>นัดฉีดยา</b></u><br>";
					print "<font  style='line-height:24px;' face='Angsana New' size= 4 ><b><u>VERORAB</b></u><br>";
