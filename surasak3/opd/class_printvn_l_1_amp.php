...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
  <tr>
    <td width="1019" valign="bottom"><div style="margin-top:30px;"><? echo "<img src ='printbcpha.php?cHn=".$this->hn."'>"; ?></div></td>
    <td width="482" valign="bottom"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;โรงพยาบาลค่ายสุรศักดิ์มนตรี</strong><br />
    <div>
    <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
  <tr>
    <td width="114">23</td>
    <td width="231">เมษายน</td>
    <td width="107">2564</td>
  </tr>
</table>
</div></td>
  </tr>
