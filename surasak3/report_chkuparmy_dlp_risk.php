...
<?
		...
		$nPrefix2="25".$nPrefix;
?>
<p align="center" style="margin-top: 20px;"><strong>รายงานผลการตรวจสุขภาพประจำปีกองทัพบก กลุ่มที่มีไขมันในเลือดสูงผิดปกติ</strong></p>	
<form name="form1" method="post" action="report_chkuparmy_dlp_risk.php" >
...
if($_POST["act"]=="show"){
	if($_POST["camp"]=="all"){
		$sql="select * from condxofyear_so where yearcheck='".$_POST["year1"]."' and (stat_chol ='ผิดปกติ' || stat_tg ='ผิดปกติ') and camp NOT LIKE 'M07%' group by hn order by camp, age, row_id desc";
	}else{
		$sql="select * from condxofyear_so where yearcheck='".$_POST["year1"]."' and (stat_chol ='ผิดปกติ' || stat_tg ='ผิดปกติ')  and camp NOT LIKE 'M07%' and camp='".$_POST["camp"]."' group by hn order by camp, age, row_id desc";
	}
	//echo $sql;
	$query=mysql_query($sql);	
?>	
<p align="center" style="margin-top: 20px;"><strong>รายงานผลการตรวจสุขภาพประจำปีกองทัพบก กลุ่มที่มีไขมันในเลือดสูงผิดปกติ ปี <?=$_POST["year1"];?></strong></p>
<div align="center">
<table width="95%" border="1" align="center" cellpadding="6" cellspacing="0" bordercolor="#000000">
  ...
  <tr>
	...
	<td width="9%" align="center"><strong>cholesterol</strong></td>
	<td width="9%" align="center"><strong>triglyceride</strong></td>
