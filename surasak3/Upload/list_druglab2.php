...
<?php
$sum2 = 0;
$sql = "Select a.tradname, a.amount, a.part, a.price, b.salepri, date_format(a.date,'%d-%m-%Y') as date  From drugrx as a LEFT JOIN druglst as b ON a.drugcode = b.drugcode where a.date like '".$select_day."%' AND a.hn = '".$_REQUEST["search_hn"]."' ";
