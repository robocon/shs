...
<span class="font1"><a href="stat_timepha.php">โปรแกรมสรุปเวลาประจำวันทั้งหมด</a> || <a href="stat_timephaarmy.php">โปรแกรมสรุปเวลาประจำวันทหารและครอบครัว</a>  || สรุปเวลาประจำเดือนทหารและครอบครัว<br />
<br />
<?
$d=date("d");
$m=date("m");
...
?>
<center>โปรแกรมสรุปเวลาห้องจ่ายยาประจำวันเดือน <?=$m1?>/<?=$yr1?></center> 
...
<?
$sql = "SELECT * FROM opday as tb1 inner join opcard as tb2 on tb1.hn=tb2.hn where tb1.thidate like '".$_POST['yr1']."-".$_POST['m1']."%' and substring(tb2.idguard,1,4)='MX01' order by tb1.thidate asc ";
...
$sql2 = "select thidate,dc_diag from opd  where thidate like '".$_POST['yr1']."-".$_POST['m1']."%' and hn='".$result['hn']."' ";

$rows2 = mysql_query($sql2);
$result2 = mysql_fetch_array($rows2);

$sql3 = "select date,pharin,stkcutdate,pharout,pharout1 from dphardep where  dr_cancle is null and date like '".$_POST['yr1']."-".$_POST['m1']."%' and hn='".$result['hn']."' ";
