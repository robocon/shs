...
print "<DIV style='left:105PX;top:340PX;width:661PX;height:30PX;'><span class='fc1-0'>5. คำสั่งกระทรวงกลาโหม (เฉพาะ) ที่ 265/65 เรื่องการจัดซื้อจัดจ้างและการบริหารพัสดุของกระทรวงกลาโหม ลง 5 ก.ค. 65</span></DIV>";
...
print "<DIV style='left:166PX;top:415PX;width:600PX;height:30PX;'><span class='fc1-0'>3. ร่างขอบเขตของงานและรายละเอียดคุณลักษณะของพัสดุที่จะซื้อหรือจ้าง จำนวน 1 ชุด</span></DIV>";

print "<DIV style='left:105PX;top:440PX;width:661PX;height:30PX;'><span class='fc1-0'>1. เนื่องด้วยกองเภสัชกรรม รพ.ค่ายฯ มีความจำเป็นที่จะต้องจัดซื้อเวชภัณฑ์เพื่อใช้ในราชการ รพ.ค่ายฯ</span></DIV>";

print "<DIV style='left:61PX;top:465PX;width:705PX;height:30PX;'><span class='fc1-0'>ตามสิ่งที่ส่งมาด้วย 1.</span></DIV>";

print "<DIV style='left:105PX;top:490PX;width:661PX;height:30PX;'><span class='fc1-0'>2. รายละเอียด พัสดุที่จะจัดซื้อ ตามบัญชีรายละเอียดที่แนบ ตามสิ่งที่ส่งมาด้วย 2.</span></DIV>";

print "<DIV style='left:105PX;top:515PX;width:661PX;height:30PX;'><span class='fc1-0'>3. ขอบเขตของงานหรือรายละเอียดคุณลักษณะเฉพาะของพัสดุ ตามสิ่งที่ส่งมาด้วย 3.</span></DIV>";

print "<DIV style='left:105PX;top:540PX;width:661PX;height:30PX;'><span class='fc1-0'>4. ราคากลางของพัสดุที่จะซื้อ และรายละเอียดของราคากลาง &nbsp;&nbsp;จำนวน &nbsp;<B>$nPriadvat</B> &nbsp;บาท</span></DIV>";
print "<DIV style='left:61PX;top:565PX;width:661PX;height:30PX;'><span class='fc1-0'> $cPriadvat&nbsp;&nbsp;แหล่งที่มาของราคากลาง</span></DIV>";
...
if($result["edpri_from"]=="1"){
			print "<DIV style='left:120PX;top:590PX;width:661PX;height:30PX;'><span class='fc1-0'>4.1 ใช้ราคาที่ได้มาจากการคำนวณตามหลักเกณฑ์ที่คณะกรรมการราคากลางกำหนด</span></DIV>";
		}else if($result["edpri_from"]=="2"){
			print "<DIV style='left:120PX;top:590PX;width:661PX;height:30PX;'><span class='fc1-0'>4.1 ใช้ราคาที่ได้มาจากฐานข้อมูลราคาอ้างอิงของพัสดุที่กรมบัญชีกลางจัดทำ</span></DIV>";
		}else if($result["edpri_from"]=="3"){
			print "<DIV style='left:120PX;top:590PX;width:661PX;height:30PX;'><span class='fc1-0'>4.1 ใช้ราคาที่คณะกรรมการพัฒนาระบบยาแห่งชาติกำหนด</span></DIV>";
		}else if($result["edpri_from"]=="4"){
			print "<DIV style='left:120PX;top:590PX;width:661PX;height:30PX;'><span class='fc1-0'>4.1 ใช้ราคาที่ได้มาจากการสืบราคาจากท้องตลาด โดยสืบราคาจากท้องตลาด 3 ราย</span></DIV>";
		}else if($result["edpri_from"]=="5"){
			print "<DIV style='left:120PX;top:590PX;width:661PX;height:30PX;'><span class='fc1-0'>4.1 ใช้ราคาที่เคยซื้อหรือจ้างครั้งหลังสุดภายในระยะเวลา 2 ปีงบประมาณ</span></DIV>";
		}else if($result["edpri_from"]=="6"){
			print "<DIV style='left:120PX;top:590PX;width:661PX;height:30PX;'><span class='fc1-0'>- ใช้ราคาตามหลักเกณฑ์ วิธีการ หรือแนวทางปฏิบัติของหน่วยงานกำหนด</span></DIV>";
		}
	
print "<DIV style='left:105PX;top:615PX;width:189PX;height:30PX;'><span class='fc1-0'>5. วงเงิน จัดซื้อ ครั้งนี้เป็นเงิน</span></DIV>";
...
print "<DIV style='left:61PX;top:715PX;width:705PX;height:30PX;'><span class='fc1-0'>ให้บริการทั่วไป และมีวงเงินในการจัดซื้อจัดจ้างครั้งหนึ่งไม่เกินวงเงินตามที่กำหนดในกฎกระทรวง ตามอ้างถึง1 มาตรา56 (2)</span></DIV>";
print "<DIV style='left:61PX;top:740PX;width:705PX;height:30PX;'><span class='fc1-0'>(ข) และตามอ้างถึง2 ข้อ1</span></DIV>";
...
print "<DIV style='left:61PX;top:815PX;width:705PX;height:30PX;'><span class='fc1-0'>และขออนุมัติใช้ใบสั่งซื้อเป็นข้อตกลงแทนการทำสัญญา และไม่ควรเรียกหลักประกันสัญญา เนื่องจากผู้รับจ้างรายนี้</span></DIV>";
		print "<DIV style='left:61PX;top:840PX;width:705PX;height:30PX;'><span class='fc1-0'>เคยติดต่อค้าขายกับทางราชการอยู่เป็นประจำพฤติการณ์เป็นที่เชื่อถือไว้ใจได้ และได้จดทะเบียนการค้าอย่างถูกต้องตามกฎหมาย</span></DIV>";	
...
print "<DIV style='left:61PX;top:815PX;width:705PX;height:30PX;'><span class='fc1-0'>เป็นข้อตกลงแทนการทำสัญญา และไม่ควรเรียกหลักประกันสัญญา เนื่องจากผู้รับจ้างรายนี้เคยติดต่อค้าขายกับทางราชการอยู่เป็นประจำ</span></DIV>";
print "<DIV style='left:61PX;top:840PX;width:705PX;height:30PX;'><span class='fc1-0'>พฤติการณ์เป็นที่เชื่อถือไว้ใจได้และได้จดทะเบียนการค้าอย่างถูกต้องตามกฎหมาย มีวัตถุประสงค์ หรือชนิดแห่งพาณิชย์ที่จดทะเบียนไว้</span></DIV>";	
print "<DIV style='left:61PX;top:865PX;width:705PX;height:30PX;'><span class='fc1-0'>สามารถจำหน่ายสิ่งของที่ทางราชการต้องการจ้างได้</span></DIV>";	
...
}else if($chkrows==2){  //มี 2 แหล่งที่มา
	while($result=mysql_fetch_array($query11)){
		if($result["edpri_from"]=="3"){
			print "<DIV style='left:120PX;top:590PX;width:661PX;height:30PX;'><span class='fc1-0'>4.1 ใช้ราคามาตรฐานของคณะกรรมการพัฒนาระบบยาแห่งชาติกำหนด</span></DIV>";
		}else if($result["edpri_from"]=="5"){
			print "<DIV style='left:120PX;top:615PX;width:661PX;height:30PX;'><span class='fc1-0'>4.2 ใช้ราคาที่เคยซื้อหรือจ้างครั้งหลังสุดภายในระยะเวลา 2 ปีงบประมาณ</span></DIV>";		
		}	//close if		
	}  //close while
	
	
print "<DIV style='left:105PX;top:640PX;width:189PX;height:30PX;'><span class='fc1-0'>5. วงเงิน จัดซื้อ ครั้งนี้เป็นเงิน</span></DIV>";

print "<DIV style='left:293PX;top:640PX;width:99PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'><B>$nPriadvat</B></span></DIV>";

print "<DIV style='left:391PX;top:640PX;width:40PX;height:30PX;'><span class='fc1-0'>บาท</span></DIV>";

print "<DIV style='left:430PX;top:640PX;width:400PX;height:30PX;'><span class='fc1-0'>$cPriadvat</span></DIV>";  //จำนวนเงินตัวอักษร
...
print "<DIV style='left:105PX;top:715PX;width:661PX;height:30PX;'><span class='fc1-0'>7. การซื้อครั้งนี้เป็นการจัดซื้อโดยวิธีเฉพาะเจาะจง เนื่องจากเป็นการจัดซื้อจัดจ้างพัสดุที่มีการผลิต จำหน่าย ก่อสร้าง หรือ</span></DIV>";
print "<DIV style='left:61PX;top:740PX;width:705PX;height:30PX;'><span class='fc1-0'>ให้บริการทั่วไป และมีวงเงินในการจัดซื้อจัดจ้างครั้งหนึ่งไม่เกินวงเงินตามที่กำหนดในกฎกระทรวง ตามอ้างถึง1 มาตรา56 (2)</span></DIV>";
print "<DIV style='left:61PX;top:765PX;width:705PX;height:30PX;'><span class='fc1-0'>(ข) และตามอ้างถึง2 ข้อ1</span></DIV>";
...
print "<DIV style='left:61PX;top:840PX;width:705PX;height:30PX;'><span class='fc1-0'>และขออนุมัติใช้ใบสั่งซื้อเป็นข้อตกลงแทนการทำสัญญา และไม่ควรเรียกหลักประกันสัญญา เนื่องจากผู้รับจ้างรายนี้</span></DIV>";
		print "<DIV style='left:61PX;top:865PX;width:705PX;height:30PX;'><span class='fc1-0'>เคยติดต่อค้าขายกับทางราชการอยู่เป็นประจำพฤติการณ์เป็นที่เชื่อถือไว้ใจได้ และได้จดทะเบียนการค้าอย่างถูกต้องตามกฎหมาย</span></DIV>";	
...
print "<DIV style='left:61PX;top:840PX;width:705PX;height:30PX;'><span class='fc1-0'>เป็นข้อตกลงแทนการทำสัญญา และไม่ควรเรียกหลักประกันสัญญา เนื่องจากผู้รับจ้างรายนี้เคยติดต่อค้าขายกับทางราชการอยู่เป็นประจำ</span></DIV>";
print "<DIV style='left:61PX;top:865PX;width:705PX;height:30PX;'><span class='fc1-0'>พฤติการณ์เป็นที่เชื่อถือไว้ใจได้และได้จดทะเบียนการค้าอย่างถูกต้องตามกฎหมาย มีวัตถุประสงค์ หรือชนิดแห่งพาณิชย์ที่จดทะเบียนไว้</span></DIV>";	
print "<DIV style='left:61PX;top:890PX;width:705PX;height:30PX;'><span class='fc1-0'>สามารถจำหน่ายสิ่งของที่ทางราชการต้องการจ้างได้</span></DIV>";	
...
<? if($chkprice < 100000){ ?>    
  <tr>
    <td height="30" colspan="4"><span class='fc1-5'>อ้างถึง&nbsp;&nbsp;</span><span class='fc1-0'>1. คำสั่ง รพ.ค่ายสุรศักดิ์มนตรี ที่ 165/64 ลง 23 ก.ย. 2564</span></td>

    </tr>
<? }else{ ?>
  <tr>
    <td height="30" colspan="4"><span class='fc1-5'>อ้างถึง&nbsp;&nbsp;</span><span class='fc1-0'>1. คำสั่ง รพ.ค่ายสุรศักดิ์มนตรี ที่ 164/64 ลง 23 ก.ย. 2564</span></td>
    </tr>
<? } ?>
  <tr>
