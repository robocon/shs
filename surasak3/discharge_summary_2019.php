  ...
  <tr>
    <td colspan="5">
        ...
        <tr>
            <td>àÅ¢ »ªª.&nbsp;<?=$idcard;?></td>
            <td></td>
            <td>Ç/´/».à¡Ô´:&nbsp;<?=$birthdate;?></td>
            <td> ÊÔ·¸Ô:&nbsp;<?=$ptright;?></td>
        </tr>
        <tr>
            <td>ºéÒ¹àÅ¢·Õè <?=$address;?>&nbsp;µÓºÅ<?=$tambol;?>&nbsp;ÍÓàÀÍ <?=$ampur;?>&nbsp;</td>
            <td></td>
            <td>¨Ñ§ËÇÑ´: <?=$changwat;?></td>
            <td>â·Ã: <?=$phone;?></td>
        </tr>
        <tr>
            <td>¼Ùé·ÕèµÔ´µèÍä´é:&nbsp;<?=$ptf;?></td>
            <td>à¡ÕèÂÇ¢éÍ§à»ç¹:&nbsp;<?=$ptfadd;?></td>
            <td>&nbsp;â·ÃÈÑ¾·ì:&nbsp;<?=$ptffone;?></td>
            <td>ËÍÃÑº&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ËÍ¨ÓË¹èÒÂ</td>
        </tr>
        </table>
    </td>
  </tr>
