...
if(isset($_POST["row_id"]) && $_POST["row_id"] != ""){
	...
	$hba1c = $dxdr_ofyear['HBA1CC'];
	$hba1c_range = $dxdr_ofyear['HBA1CCrange'];
	$stat_hba1c = $_POST['stat_hba1c'];
	$reason_hba1c = $_POST['reason_hba1c'];

	$CEA = $dxdr_ofyear['CEA'];
	$CEArange = $dxdr_ofyear['CEArange'];
	$stat_cea = $_POST['stat_cea'];

	$PSA = $dxdr_ofyear['PSA'];
	$PSArange = $dxdr_ofyear['PSArange'];
	$stat_psa = $_POST['stat_psa'];

	$AFP = $dxdr_ofyear['AFP'];
	$AFPrange = $dxdr_ofyear['AFPrange'];
	$stat_afp = $_POST['stat_afp'];
