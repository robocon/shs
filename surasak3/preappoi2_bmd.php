...
// print "<p><b><font face='Angsana New' size = '3'>โรงพยาบาลค่ายสุรศักดิ์มนตรี</font></b></p>";
 ...
 $appd=$cdate_appoint;
    ...
    $query="CREATE TEMPORARY TABLE appoint1 SELECT * FROM appoint WHERE appdate = '$appd' and detail = 'FU32 นัดตรวจBMD' ";
 ...
 print "<br><font face='Angsana New' size = '5'><b>จำนวนผู้ป่วยทั้งหมด&nbsp;&nbsp; $num&nbsp;&nbsp;คน</b></a> ";
    ...
    print "<fieldset><font face='Angsana New' size = '4'><strong>เหตุผลการส่งตรวจ :</strong><br>";
...
<table border="0">
  <tr><td><font face="Angsana New">นัดมาเพื่อ&nbsp;&nbsp;&nbsp;</font></td>
	...
	<option value="FU32 นัดตรวจBMD" selected="selected">นัดตรวจ BMD</option>
	 </select>
...
<option value="ส่องกระเพาะอาหาร+ส่องลำไส้ใหญ่">ส่องกระเพาะอาหาร+ส่องลำไส้ใหญ่</option>
  ...
  <tr>
    <td width="115"><font face="Angsana New" size = '4'>ยื่นใบนัดที่</font></td>
    <td colspan="2"><font face="Angsana New" size = '4'>
      <select size="1" name="room" id="room">
        ...
        <option selected="selected">แผนกเอกชเรย์</option>
      ...
      </font><font face="Angsana New" size = '4'>เวลา
...
<tr>
  <td><font face="Angsana New" size = '4'>ข้อควรปฏิบัติก่อนพบแพทย์</font></td>
  <td colspan="2"><font face="Angsana New" size = '4'>
