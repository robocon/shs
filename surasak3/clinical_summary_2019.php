...
<table border="0" align="center" width="100%" cellpadding="0">
  <tr>
    ...
    <div style="position: absolute; top: 10px; left: 10px;">MR  IPD - 002 (2)</div>
    ...
    <div>
        <p style="word-wrap: break-word;">Comorbidities <?=create_dot(203);?></p>
    </div>
    <div>
        <p style="word-wrap: break-word;">Complication <?=create_dot(204);?></p>
    </div>
    <div>
        <p style="word-wrap: break-word;">Hospital course <?=create_dot(200);?></p>
    </div>
    ...
    <div><p style="word-wrap: break-word;"><?=create_dot(230);?></p></div>
    <div><p style="word-wrap: break-word;"><?=create_dot(230);?></p></div>
    <div><p>LAB <?=create_dot(222);?></p></div>
    <div><p style="word-wrap: break-word;"><?=create_dot(230);?></p></div>
    <div><p style="word-wrap: break-word;"><?=create_dot(230);?></p></div>
    <div><p>Treatment  &  Operation <?=create_dot(185);?></p></div>
    <div><p style="word-wrap: break-word;"><?=create_dot(230);?></p></div>
    <div><p style="word-wrap: break-word;"><?=create_dot(230);?></p></div>
    <div><p style="word-wrap: break-word;"><?=create_dot(230);?></p></div>
