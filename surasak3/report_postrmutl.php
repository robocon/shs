...
<center>
<span class="tet1">พิมพ์ซองผลตรวจสุขภาพนักศึกษาใหม่ราชมงคล</span><br />
...
if(isset($_POST['ok'])){
	...
	$select2 = "SELECT  a.course, a.branch, b.hn, b.ptname, b.weight, b.height, b.bp1, b.bp2, b.p FROM opcardchk AS a INNER  JOIN out_result_chkup AS b ON a.HN = b.hn WHERE a.part ='ราชมงคล58' order by b.hn limit 0,100";
...
<table width="100%" border="0">
  <tr>
    <td width="100%"><table width="100%">
      ...
      <tr>
        <td align="center" valign="top" class="texthead"><?=$result2['course']?>&nbsp;&nbsp;<?=$result2['branch']?></td>
      </tr>
    
      <tr>
        <td align="center" valign="top" class="text1"><strong> <br />
         ตรวจเมื่อวันที่ 13-14 สิงหาคม 2558<br> โรงพยาบาลค่ายสุรศักดิ์มนตรี อ.เมือง จ.ลำปาง </strong></td>
        </tr>
    </table></td>
  </tr>
</table>
