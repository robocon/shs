<?php
    ...
    $today="$d-$m-$yr";
    print "วันที่ $today  รายชื่อคนไข้ที่ทำหัตถการหรือตรวจวิเคราะห์โรค";
...
//    $detail="ค่ายา";
    ...
    $query = "SELECT date,ptname,hn,an,ptright,depart,detail,price,sumnprice,paid,row_id,accno FROM depart WHERE date LIKE '$today%'  and an !='' ORDER BY ptname";
