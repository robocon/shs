...
?>
<p><strong>ช่วงเวลาในการให้บริการผู้ป่วย ประจำเดือน <?=$_POST['mon']."/".$_POST['year'];?> ประเภท : <? if($_POST['career']=="1"){ echo "ทหาร/ครอบครัวทหาร";}else if($_POST['career']=="2"){ echo "บุคคลทั่วไป";}else{ echo "ทั้งหมด";}?></strong></p>
