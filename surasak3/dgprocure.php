...
if(!empty($dgcode)){
	$chkmonth=date("Y-m");
	$sql1 = "SELECT * FROM combill WHERE drugcode = '$dgcode' and date like '$chkmonth%'";
    $query1 = mysql_query($sql1);
	$num1=mysql_num_rows($query1);
	if($num1 > 0){
		echo "<script>alert('แจ้งเตือน...มีการนำเข้ายา $dgcode ในเดือนนี้แล้ว');</script>";
	}	
...
<form name="f1" action="stkadd.php" method="post" onsubmit="return checkForm();">
    <table width="100%" border="0">
      ...
      <tr>
        ...
        <td align="left"><input type="text" name="drugcode" value="<?=$cDrugcode;?>" tabindex="7" readonly="readonly"></td>
        <td align="right">&nbsp;</td>
