...
<form name="f1" action="" method="post">
  ...
  <tr class="forntsarabun">
    <td colspan="2" bgcolor="#99CC99">สถิติยอดผู้ป่วย หอผู้ป่วยรวม</td>
    </tr>
  <tr class="forntsarabun">
...
LIKE  '$date1%' AND bedcode  LIKE  '42%' ";
...
if($row){
	 ...
	 print "<div><font class='forntsarabun' >สถิติยอดผู้ป่วย หอผู้ป่วยรวม ประจำเดือน  $dateshow </font></div><br>";
 ?>
