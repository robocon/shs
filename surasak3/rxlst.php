...
<?php
    ...
    $query = "SELECT date,ptname,hn,an,price,paid,row_id,accno,dgtake FROM phardep WHERE date LIKE '$today%' ";
    ...
    while (list ($date,$ptname,$hn,$an,$price,$paid,$row_id,$accno,$dgtake) = mysql_fetch_row ($result)) {
        ...
        print (" <tr>\n".
           ...
           "  <td BGCOLOR=66CDAA><a target=_BLANK  href=\"rxtail.php? sDate=$date&nRow_id=$row_id&nAccno=$accno\">$ptname</a></td>\n".
