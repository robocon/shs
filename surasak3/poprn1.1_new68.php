<?php
//ขออนุมัติจัดซื้อเวชภัณฑ์  2.รวมVATก่อน
//function baht///
...
///////End Load offisers
    ...
    $query = "SELECT date,prepono,prepodate,comcode,comname,items,netprice,pono,podate,bounddate,row_id ,ponoyear,chkindate,senddate,borrowdate,pobillno,pobilldate,fixdate,reportdate FROM pocompany WHERE row_id = '$nRow_id' ";
...
$nNetprice=$nNetprice-$nVat;
  ...
  $nTaxs=.01*$nNetprice;
  //echo "==>".$nTaxs;
  $nTax=number_format($nTaxs,2);
  //echo "==>".$nTax;
  $nNetpaid=$nPriadvat-$nTaxs;
  //echo "$nNetpaid=$nPriadvat-$nTaxs";
...
print "<TITLE>จัดซื้อเวชภัณฑ์ (รวมVATก่อน) V.2568</TITLE>";
print "</head>";
...
print "<DIV style='left:305PX;top:46PX;width:200PX;height:34PX;TEXT-ALIGN:CENTER;'><span class='fc1-1'>บันทึกข้อความ</span></DIV>";

print "<DIV style='z-index:15;left:54PX;top:24PX;width:73PX;height:80PX;'>";
print "<img  WIDTH=73 HEIGHT=80 SRC='bird.jpg'>";
print "</DIV>";

print "<DIV style='left:54PX;top:107PX;width:905PX;height:30PX;'><span class='fc1-5'>ส่วนราชการ</span><span class='fc1-0'>&nbsp;&nbsp;กองเภสัชกรรม&nbsp;&nbsp;&nbsp;&nbsp;รพ.ค่ายสุรศักดิ์มนตรี</span></DIV>";
...
print "<DIV style='left:378PX;top:136PX;width:82PX;height:30PX;'><span class='fc1-5'>วันที่</span></DIV>";
print "<DIV style='left:440PX;top:136PX;width:272PX;height:30PX;'><span class='fc1-0'>$cPodate</span></DIV>";

print "<DIV style='left:54PX;top:167PX;width:36PX;height:30PX;'><span class='fc1-5'>เรื่อง</span></DIV>";

print "<DIV style='left:105PX;top:166PX;width:905PX;height:30PX;'><span class='fc1-0'>ขออนุมัติจัดซื้อเวชภัณฑ์</span></DIV>";
...
print "<DIV style='left:105PX;top:215PX;width:905PX;height:30PX;'><span class='fc1-0'>1. พระราชบัญญัติการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐ พ.ศ.2560 ลง 24 ก.พ. 60</span></DIV>";

print "<DIV style='left:105PX;top:240PX;width:905PX;height:30PX;'><span class='fc1-0'>2. กฎกระทรวง กำหนดวงเงินการจัดซื้อจัดจ้างโดยวิธีเฉพาะเจาะจง วงเงินการจัดซื้อจัดจ้างที่ไม่ทำข้อตกลงเป็นหนังสือ</span></DIV>";

print "<DIV style='left:105PX;top:265PX;width:905PX;height:30PX;'><span class='fc1-0'>และวงเงินการจัดซื้อจัดจ้างในการแต่งตั้งผู้ตรวจรับพัสดุ พ.ศ.2560 ลง 23 ส.ค. 60</span></DIV>";

print "<DIV style='left:105PX;top:290PX;width:905PX;height:30PX;'><span class='fc1-0'>3. กฎกระทรวง พัสดุที่รัฐต้องส่งเสริมหรือสนับสนุน หมวด 6 พัสดุส่งเสริมสุขภาพและสาธารณสุข พ.ศ.2560 ลง 23 ส.ค. 60</span></DIV>";

print "<DIV style='left:105PX;top:315PX;width:905PX;height:30PX;'><span class='fc1-0'>4. ระเบียบกระทรวงการคลังว่าด้วยการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐ พ.ศ.2560 ลง 23 ส.ค. 60</span></DIV>";

print "<DIV style='left:105PX;top:340PX;width:905PX;height:30PX;'><span class='fc1-0'>5. คำสั่งกระทรวงกลาโหม (เฉพาะ) ที่ 265/65 เรื่องการจัดซื้อจัดจ้างและการบริหารพัสดุของกระทรวงกลาโหม ลง 5 ก.ค. 65</span></DIV>";

print "<DIV style='left:105PX;top:365PX;width:905PX;height:30PX;'><span class='fc1-0'>6. คำสั่งกองทัพบก (เฉพาะ) ที่ 1042/65 เรื่องการกำหนดอำนาจการจัดซื้อจัดจ้าง การทำนิติกรรมสัญญา</span></DIV>";

print "<DIV style='left:105PX;top:390PX;width:905PX;height:30PX;'><span class='fc1-0'>และการบริหารสัญญาของกองทัพบก ลง 31 ส.ค. 65</span></DIV>";

print "<DIV style='left:105PX;top:415PX;width:905PX;height:30PX;'><span class='fc1-0'>7. คำสั่งกองทัพบก (เฉพาะ) ที่ 1043/65 เรื่องการแต่งตั้งคณะกรรมการการจัดซื้อจัดจ้าง</span></DIV>";

print "<DIV style='left:105PX;top:440PX;width:905PX;height:30PX;'><span class='fc1-0'>และการบริหารสัญญาของกองทัพบก ลง 31 ส.ค. 65</span></DIV>";

print "<DIV style='left:54PX;top:465PX;width:126PX;height:30PX;'><span class='fc1-5'>สิ่งที่ส่งมาด้วย</span></DIV>";

print "<DIV style='left:166PX;top:465PX;width:279PX;height:30PX;'><span class='fc1-0'>1. หนังสือกองเภสัชกรรม รพ.ค่ายฯ ที่</span></DIV>";

print "<DIV style='left:370PX;top:465PX;width:110PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'><B>$cPrepono</B></span></DIV>";

print "<DIV style='left:483PX;top:465PX;width:56PX;height:30PX;'><span class='fc1-0'>ลงวันที่</span></DIV>";

print "<DIV style='left:540PX;top:465PX;width:208PX;height:30PX;'><span class='fc1-0'><B>$cPrepodate</B></span></DIV>";
...
print "<DIV style='left:105PX;top:540PX;width:905PX;height:30PX;'><span class='fc1-0'>1. เนื่องด้วยกองเภสัชกรรม รพ.ค่ายฯ มีความจำเป็นที่จะต้องจัดซื้อยาเพื่อใช้ในราชการ รพ.ค่ายฯ ตามสิ่งที่ส่งมาด้วย 1.</span></DIV>";

print "<DIV style='left:105PX;top:565PX;width:905PX;height:30PX;'><span class='fc1-0'>2. รายละเอียด พัสดุที่จะจัดซื้อ ตามบัญชีรายละเอียดที่แนบ ตามสิ่งที่ส่งมาด้วย 2.</span></DIV>";

print "<DIV style='left:105PX;top:590PX;width:905PX;height:30PX;'><span class='fc1-0'>3. ขอบเขตของงานหรือรายละเอียดคุณลักษณะเฉพาะของพัสดุ ตามสิ่งที่ส่งมาด้วย 3.</span></DIV>";

print "<DIV style='left:105PX;top:615PX;width:905PX;height:30PX;'><span class='fc1-0'>4. ราคากลางของพัสดุที่จะซื้อ และรายละเอียดของราคากลาง &nbsp;&nbsp;จำนวน &nbsp;<B>$nPriadvat</B> &nbsp;บาท</span></DIV>";
print "<DIV style='left:61PX;top:640PX;width:905PX;height:30PX;'><span class='fc1-0'> $cPriadvat&nbsp;&nbsp;แหล่งที่มาของราคากลาง</span></DIV>";

$sql11="SELECT b.edpri_from FROM poitems as a inner join druglst as b on a.drugcode=b.drugcode WHERE a.idno = '$nRow_id' group by b.edpri_from";
//print $sql11;
$query11=mysql_query($sql11);
$chkrows=mysql_num_rows($query11);
if($chkrows==1){  //มี 1 แหล่งที่มา
while($result=mysql_fetch_array($query11)){
if($result["edpri_from"]=="1"){
			print "<DIV style='left:120PX;top:665PX;width:905PX;height:30PX;'><span class='fc1-0'>4.1 ใช้ราคาที่ได้มาจากการคำนวณตามหลักเกณฑ์ที่คณะกรรมการราคากลางกำหนด</span></DIV>";
		}else if($result["edpri_from"]=="2"){
			print "<DIV style='left:120PX;top:665PX;width:905PX;height:30PX;'><span class='fc1-0'>4.1 ใช้ราคาที่ได้มาจากฐานข้อมูลราคาอ้างอิงของพัสดุที่กรมบัญชีกลางจัดทำ</span></DIV>";
		}else if($result["edpri_from"]=="3"){
			print "<DIV style='left:120PX;top:665PX;width:905PX;height:30PX;'><span class='fc1-0'>4.1 ใช้ราคาที่คณะกรรมการพัฒนาระบบยาแห่งชาติกำหนด</span></DIV>";
		}else if($result["edpri_from"]=="4"){
			print "<DIV style='left:120PX;top:665PX;width:905PX;height:30PX;'><span class='fc1-0'>4.1 ใช้ราคาที่ได้มาจากการสืบราคาจากท้องตลาด โดยสืบราคาจากท้องตลาด 3 ราย</span></DIV>";
		}else if($result["edpri_from"]=="5"){
			print "<DIV style='left:120PX;top:665PX;width:905PX;height:30PX;'><span class='fc1-0'>4.1 ใช้ราคาที่เคยซื้อหรือจ้างครั้งหลังสุดภายในระยะเวลา 2 ปีงบประมาณ</span></DIV>";
		}else if($result["edpri_from"]=="6"){
			print "<DIV style='left:120PX;top:665PX;width:905PX;height:30PX;'><span class='fc1-0'>- ใช้ราคาตามหลักเกณฑ์ วิธีการ หรือแนวทางปฏิบัติของหน่วยงานกำหนด</span></DIV>";
		}
	
print "<DIV style='left:105PX;top:690PX;width:189PX;height:30PX;'><span class='fc1-0'>5. วงเงิน จัดซื้อ ครั้งนี้เป็นเงิน</span></DIV>";
print "<DIV style='left:293PX;top:690PX;width:99PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'><B>$nPriadvat</B></span></DIV>";
print "<DIV style='left:391PX;top:690PX;width:40PX;height:30PX;'><span class='fc1-0'>บาท</span></DIV>";
print "<DIV style='left:430PX;top:690PX;width:400PX;height:30PX;'><span class='fc1-0'>$cPriadvat</span></DIV>";  //จำนวนเงินตัวอักษร
if($cComcode=="G003.1" || $cComcode=="M001" || $cComcode=="F007"){
	print "<DIV style='left:61PX;top:715PX;width:905PX;height:30PX;'><span class='fc1-0'>ต้องการให้งานนั้นเสร็จภายใน 60 วันทำการ อยู่ในอำนาจการสั่งซื้อสั่งจ้างของ ผอ.รพ.ค่ายฯ ตามอ้างถึง 5.</span></DIV>";
}else{
...
print "<DIV style='left:61PX;top:940PX;width:905PX;height:30PX;'><span class='fc1-0'>มีวัตถุประสงค์ หรือชนิดแห่งพาณิชย์ที่จดทะเบียนไว้สามารถจำหน่ายสิ่งของที่ทางราชการต้องการจ้างได้</span></DIV>";	
	...
	while($result=mysql_fetch_array($query11)){
		if($result["edpri_from"]=="3"){
			print "<DIV style='left:120PX;top:665PX;width:905PX;height:30PX;'><span class='fc1-0'>4.1 ใช้ราคามาตรฐานของคณะกรรมการพัฒนาระบบยาแห่งชาติกำหนด</span></DIV>";
		}else if($result["edpri_from"]=="5"){
			print "<DIV style='left:120PX;top:690PX;width:905PX;height:30PX;'><span class='fc1-0'>4.2 ใช้ราคาที่เคยซื้อหรือจ้างครั้งหลังสุดภายในระยะเวลา 2 ปีงบประมาณ</span></DIV>";		
		}	//close if		
	}  //close while
...
if($cComcode=="G003.1" || $cComcode=="M001" || $cComcode=="F007"){
	print "<DIV style='left:61PX;top:740PX;width:905PX;height:30PX;'><span class='fc1-0'>ต้องการให้งานนั้นเสร็จภายใน 60 วัน อยู่ในอำนาจการสั่งซื้อสั่งจ้างของ ผอ.รพ.ค่ายฯ ตามอ้างถึง 5.</span></DIV>";
}else{
	print "<DIV style='left:61PX;top:740PX;width:905PX;height:30PX;'><span class='fc1-0'>ต้องการให้งานนั้นเสร็จภายใน 30 วัน อยู่ในอำนาจการสั่งซื้อสั่งจ้างของ ผอ.รพ.ค่ายฯ ตามอ้างถึง 5.</span></DIV>";
}	
print "<DIV style='left:105PX;top:765PX;width:239PX;height:30PX;'><span class='fc1-0'>6. กำหนดเวลาที่ต้องการใช้วัสดุภายในวันที่</span></DIV>";
...
print "<DIV style='left:105PX;top:790PX;width:905PX;height:30PX;'><span class='fc1-0'>7. การซื้อครั้งนี้เป็นการจัดซื้อโดยวิธีเฉพาะเจาะจง เนื่องจากเป็นการจัดซื้อจัดจ้างพัสดุที่มีการผลิต จำหน่าย ก่อสร้าง หรือ</span></DIV>";
print "<DIV style='left:61PX;top:815PX;width:905PX;height:30PX;'><span class='fc1-0'>ให้บริการทั่วไป และมีวงเงินในการจัดซื้อจัดจ้างครั้งหนึ่งไม่เกินวงเงินตามที่กำหนดในกฎกระทรวง ตามอ้างถึง1 มาตรา56 (2)</span></DIV>";
print "<DIV style='left:61PX;top:840PX;width:905PX;height:30PX;'><span class='fc1-0'>(ข) และตามอ้างถึง2 ข้อ1</span></DIV>";

//print "===>$prodrugtype";
if($prodrugtype=="" || $prodrugtype=="1"){
//print "===>".strlen($cComname);
	if(strlen($cComname) <= 37){
		print "<DIV style='left:105PX;top:865PX;width:690PX;height:30PX;'><span class='fc1-0'>8. การซื้อครั้งนี้เห็นควรซื้อ จาก";
		print " <B>$cComname</B> ซึ่งเป็นผู้ประกอบการที่มีอาชีพขายยา</span></DIV>";
		print "<DIV style='left:61PX;top:890PX;width:710PX;height:30PX;'><span class='fc1-0'>และเวชภัณฑ์ ที่เสนอความต้องการจัดซื้อในครั้งนี้โดยตรง โดยใช้เกณฑ์ราคาต่ำสุดในการพิจารณาคัดเลือก และขออนุมัติใช้ใบสั่งซื้อ</span></DIV>";	
		print "<DIV style='left:61PX;top:915PX;width:905PX;height:30PX;'><span class='fc1-0'>เป็นข้อตกลงแทนการทำสัญญา และไม่ควรเรียกหลักประกันสัญญา เนื่องจากผู้รับจ้างรายนี้เคยติดต่อค้าขายกับทางราชการอยู่เป็นประจำ</span></DIV>";	
		print "<DIV style='left:61PX;top:940PX;width:905PX;height:30PX;'><span class='fc1-0'>พฤติการณ์เป็นที่เชื่อถือไว้ใจได้ และได้จดทะเบียนการค้าอย่างถูกต้องตามกฎหมาย มีวัตถุประสงค์ หรือชนิดแห่งพาณิชย์</span></DIV>";	
		print "<DIV style='left:61PX;top:965PX;width:905PX;height:30PX;'><span class='fc1-0'>ที่จดทะเบียนไว้สามารถจำหน่ายสิ่งของที่ทางราชการต้องการจ้างได้</span></DIV>";	

	}else if(strlen($cComname) > 37 && strlen($cComname) <= 43){ 
		print "<DIV style='left:105PX;top:865PX;width:690PX;height:30PX;'><span class='fc1-0'>8. การซื้อครั้งนี้เห็นควรซื้อ จาก";
		print " <B>$cComname</B> ซึ่งเป็นผู้ประกอบการที่มีอาชีพ</span></DIV>";
		print "<DIV style='left:61PX;top:890PX;width:710PX;height:30PX;'><span class='fc1-0'>ขายยาและเวชภัณฑ์ที่เสนอความต้องการจัดซื้อในครั้งนี้โดยตรง โดยใช้เกณฑ์ราคาต่ำสุดในการพิจารณาคัดเลือกและขออนุมัติใช้ใบสั่งซื้อ</span></DIV>";
		print "<DIV style='left:61PX;top:915PX;width:905PX;height:30PX;'><span class='fc1-0'>เป็นข้อตกลงแทนการทำสัญญา และไม่ควรเรียกหลักประกันสัญญา เนื่องจากผู้รับจ้างรายนี้เคยติดต่อค้าขายกับทางราชการอยู่เป็นประจำ</span></DIV>";	
		print "<DIV style='left:61PX;top:940PX;width:905PX;height:30PX;'><span class='fc1-0'>พฤติการณ์เป็นที่เชื่อถือไว้ใจได้ และได้จดทะเบียนการค้าอย่างถูกต้องตามกฎหมาย มีวัตถุประสงค์ หรือชนิดแห่งพาณิชย์</span></DIV>";	
		print "<DIV style='left:61PX;top:965PX;width:905PX;height:30PX;'><span class='fc1-0'>ที่จดทะเบียนไว้สามารถจำหน่ายสิ่งของที่ทางราชการต้องการจ้างได้</span></DIV>";	
	}else{
		print "<DIV style='left:105PX;top:865PX;width:690PX;height:30PX;'><span class='fc1-0'>8. การซื้อครั้งนี้เห็นควรซื้อ จาก";
		print " <B>$cComname</B> ซึ่งเป็นผู้ประกอบการ</span></DIV>";
		print "<DIV style='left:61PX;top:890PX;width:710PX;height:30PX;'><span class='fc1-0'>ที่มีอาชีพขายยาและเวชภัณฑ์ที่เสนอความต้องการจัดซื้อในครั้งนี้โดยตรง โดยใช้เกณฑ์ราคาต่ำสุดในการพิจารณาคัดเลือก</span></DIV>";
		print "<DIV style='left:61PX;top:915PX;width:905PX;height:30PX;'><span class='fc1-0'>และขออนุมัติใช้ใบสั่งซื้อเป็นข้อตกลงแทนการทำสัญญา และไม่ควรเรียกหลักประกันสัญญา เนื่องจากผู้รับจ้างรายนี้</span></DIV>";
		print "<DIV style='left:61PX;top:940PX;width:905PX;height:30PX;'><span class='fc1-0'>เคยติดต่อค้าขายกับทางราชการอยู่เป็นประจำพฤติการณ์เป็นที่เชื่อถือไว้ใจได้ และได้จดทะเบียนการค้าอย่างถูกต้องตามกฎหมาย</span></DIV>";	
		print "<DIV style='left:61PX;top:965PX;width:905PX;height:30PX;'><span class='fc1-0'>มีวัตถุประสงค์ หรือชนิดแห่งพาณิชย์ที่จดทะเบียนไว้สามารถจำหน่ายสิ่งของที่ทางราชการต้องการจ้างได้</span></DIV>";	
	}
}else if($prodrugtype=="2"){
print "<DIV style='left:105PX;top:865PX;width:690PX;height:30PX;'><span class='fc1-0'>8. การซื้อครั้งนี้เห็นควรซื้อ จาก";
print " <B>$cComname</B> ซึ่งเป็นการสั่งซื้อระหว่างหน่วยงานราชการกับหน่วยงานราชการ</span></DIV>";
print "<DIV style='left:61PX;top:890PX;width:710PX;height:30PX;'><span class='fc1-0'>ตามอ้างถึง 3. โดยใช้เกณฑ์ราคาต่ำสุดในการพิจารณาคัดเลือก และขออนุมัติใช้ใบสั่งซื้อเป็นข้อตกลงแทนการทำสัญญา</span></DIV>";
print "<DIV style='left:61PX;top:915PX;width:905PX;height:30PX;'><span class='fc1-0'>และไม่ควรเรียกหลักประกันสัญญา เนื่องจากผู้รับจ้างรายนี้เคยติดต่อค้าขายกับทางราชการอยู่เป็นประจำพฤติการณ์เป็นที่เชื่อถือไว้ใจได้</span></DIV>";
print "<DIV style='left:61PX;top:940PX;width:905PX;height:30PX;'><span class='fc1-0'>และได้จดทะเบียนการค้าอย่างถูกต้องตามกฎหมาย มีวัตถุประสงค์ หรือชนิดแห่งพาณิชย์ที่จดทะเบียนไว้สามารถจำหน่ายสิ่งของ</span></DIV>";	
print "<DIV style='left:61PX;top:965PX;width:905PX;height:30PX;'><span class='fc1-0'>ที่ทางราชการต้องการจ้างได้</span></DIV>";	
...
print "<DIV style='left:105PX;top:865PX;width:690PX;height:30PX;'><span class='fc1-0'>8. การซื้อครั้งนี้เห็นควรซื้อ จาก";
print " <B>$cComname</B> ซึ่งเป็นยาและเวชภัณฑ์</span></DIV>";
print "<DIV style='left:61PX;top:890PX;width:710PX;height:30PX;'><span class='fc1-0'>ที่ได้ขึ้นบัญชีนวัตกรรมไทย ตามอ้างถึง 3. โดยใช้เกณฑ์ราคาต่ำสุดในการพิจารณาคัดเลือกและขออนุมัติใช้ใบสั่งซื้อ</span></DIV>";
print "<DIV style='left:61PX;top:915PX;width:905PX;height:30PX;'><span class='fc1-0'>เป็นข้อตกลงแทนการทำสัญญา และไม่ควรเรียกหลักประกันสัญญา เนื่องจากผู้รับจ้างรายนี้เคยติดต่อค้าขายกับทางราชการอยู่เป็นประจำ</span></DIV>";
print "<DIV style='left:61PX;top:940PX;width:905PX;height:30PX;'><span class='fc1-0'>พฤติการณ์เป็นที่เชื่อถือไว้ใจได้และได้จดทะเบียนการค้าอย่างถูกต้องตามกฎหมาย มีวัตถุประสงค์ หรือชนิดแห่งพาณิชย์ที่จดทะเบียนไว้</span></DIV>";	
print "<DIV style='left:61PX;top:965PX;width:905PX;height:30PX;'><span class='fc1-0'>สามารถจำหน่ายสิ่งของที่ทางราชการต้องการจ้างได้</span></DIV>";	


}else if($prodrugtype=="5"){
print "<DIV style='left:105PX;top:865PX;width:690PX;height:30PX;'><span class='fc1-0'>8. การซื้อครั้งนี้เห็นควรซื้อ จาก";
print " <B>$cComname</B> ซึ่งเป็นวัคซีนโรคตับอักเสบบี</span></DIV>";
print "<DIV style='left:61PX;top:890PX;width:710PX;height:30PX;'><span class='fc1-0'>และผลิตภัณฑ์อื่นๆ ที่สภากาชาดไทยผลิตเอง และไม่อยู่ในบัญชี ตามอ้างถึง 3. โดยใช้เกณฑ์ราคาต่ำสุดในการพิจารณาคัดเลือก</span></DIV>";
print "<DIV style='left:61PX;top:915PX;width:905PX;height:30PX;'><span class='fc1-0'>และขออนุมัติใช้ใบสั่งซื้อเป็นข้อตกลงแทนการทำสัญญา และไม่ควรเรียกหลักประกันสัญญา เนื่องจากผู้รับจ้างรายนี้</span></DIV>";
print "<DIV style='left:61PX;top:940PX;width:905PX;height:30PX;'><span class='fc1-0'>เคยติดต่อค้าขายกับทางราชการอยู่เป็นประจำพฤติการณ์เป็นที่เชื่อถือไว้ใจได้ และได้จดทะเบียนการค้าอย่างถูกต้องตามกฎหมาย</span></DIV>";	
print "<DIV style='left:61PX;top:965PX;width:905PX;height:30PX;'><span class='fc1-0'>มีวัตถุประสงค์ หรือชนิดแห่งพาณิชย์ที่จดทะเบียนไว้สามารถจำหน่ายสิ่งของที่ทางราชการต้องการจ้างได้</span></DIV>";	
}
...
print "<DIV style='left:105PX;top:4165PX;width:661PX;height:30PX;'><span class='fc1-0'>9. ข้อเสนอ</span></DIV>";

print "<DIV style='left:138PX;top:4190PX;width:600PX;height:30PX;'><span class='fc1-0'>9.1 เห็นควรอนุมัติให้กองเภสัชกรรม รพ.ค่ายสุรศักดิ์มนตรี ดำเนินการจัดซื้อโดยวิธีการเฉพาะเจาะจง</span></DIV>";

print "<DIV style='left:61PX;top:4215PX;width:705PX;height:30PX;'><span class='fc1-0'>ตามรายละเอียดในรายงานข้างต้น</span></DIV>";

print "<DIV style='left:138PX;top:4240PX;width:120PX;height:30PX;'><span class='fc1-0'>9.2 เห็นควรแต่งตั้ง</span></DIV>";

print "<DIV style='left:257PX;top:4240PX;width:150PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>$cKumkan</span></DIV>";

print "<DIV style='left:406PX;top:4240PX;width:48PX;height:30PX;'><span class='fc1-0'>จำนวน</span></DIV>";

print "<DIV style='left:453PX;top:4240PX;width:18PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>$nKumkan</span></DIV>";

print "<DIV style='left:470PX;top:4240PX;width:295PX;height:30PX;'><span class='fc1-0'>นาย ตามระเบียบฯ ด้วยแล้วรายงานผล</span></DIV>";

print "<DIV style='left:61PX;top:4265PX;width:705PX;height:30PX;'><span class='fc1-0'> ให้ทราบภายใน 5 วันทำการ</span></DIV>";

print "<DIV style='left:138PX;top:4290PX;width:628PX;height:30PX;'><span class='fc1-0'>จึงเรียนมาเพื่อกรุณาทราบ และกรุณาอนุมัติตามข้อเสนอในข้อ 9.</span></DIV>";

//ระยะบรรทัด 25
print "<DIV style='left:466PX;top:4340PX;width:71PX;height:30PX;TEXT-ALIGN:RIGHT;'><span class='fc1-0'>$aYot[2]</span></DIV>";  //ยศ

print "<DIV style='left:456PX;top:4340PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>$aPost2[2]</span></DIV>"; //ลงชื่อ

print "<DIV style='left:456PX;top:4365PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>($aFname[2])</span></DIV>";  //ชื่อสกุล

print "<DIV style='left:456PX;top:4390PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>$aPost[2]</span></DIV>";  //ตำแหน่ง



//ระยะบรรทัด 25
print "<DIV style='left:152PX;top:4440PX;width:71PX;height:30PX;TEXT-ALIGN:LEFT;'><span class='fc1-0'>$aYot[18]</span></DIV>";  //ยศ

print "<DIV style='left:152PX;top:4440PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>$aPost2[18]</span></DIV>"; //ลงชื่อ

print "<DIV style='left:152PX;top:4465PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>($aFname[18])</span></DIV>";  //ชื่อสกุล

print "<DIV style='left:152PX;top:4490PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>$aPost[18]</span></DIV>";  //ตำแหน่ง



//เพิ่มใหม่ 1/10/2561
print "<DIV style='left:88PX;top:4565PX;width:245PX;height:30PX;'><span class='fc1-0'>เรียน ผอ.รพ.ค่ายสุรศักดิ์มนตรี</span></DIV>";
if($chkpono=="อ."){
print "<DIV style='left:152PX;top:4590PX;width:520PX;height:30PX;'><span class='fc1-0'>-ได้ตรวจสอบงบอุดหนุนแล้วมีเพียงพอให้การสนับสนุนได้  จำนวนเงิน $nPriadvat บาท  $cPriadvat</span></DIV>";
}else{
print "<DIV style='left:152PX;top:4590PX;width:520PX;height:30PX;'><span class='fc1-0'>-ได้ตรวจสอบงบรายรับสถานพยาบาลแล้วมีเพียงพอให้การสนับสนุนได้  จำนวนเงิน $nPriadvat บาท  $cPriadvat</span></DIV>";
}
// 4552PX;
print "<DIV style='left:208PX;top:4640PX;width:87PX;height:30PX;TEXT-ALIGN:RIGHT;'><span class='fc1-0'>$aYot[5]</span></DIV>";
...
if($chkprice >= 100000){
print "<DIV style='left:158PX;top:4840PX;width:17PX;height:30PX;'><span class='fc1-0'>1.</span></DIV>";
print "<DIV style='left:178PX;top:4840PX;width:354PX;height:30PX;'><span class='fc1-0'>$aYot[6] $aFname[6]</span></DIV>";
print "<DIV style='left:535PX;top:4840PX;width:150PX;height:30PX;'><span class='fc1-0'>$aPost[6]</span></DIV>";

print "<DIV style='left:158PX;top:4865PX;width:17PX;height:30PX;'><span class='fc1-0'>2.</span></DIV>";
print "<DIV style='left:178PX;top:4865PX;width:354PX;height:30PX;'><span class='fc1-0'>$aYot[7] $aFname[7]</span></DIV>";
print "<DIV style='left:535PX;top:4865PX;width:73PX;height:30PX;'><span class='fc1-0'>$aPost[7]</span></DIV>";

print "<DIV style='left:158PX;top:4890PX;width:17PX;height:30PX;'><span class='fc1-0'>3.</span></DIV>";
print "<DIV style='left:178PX;top:4890PX;width:354PX;height:30PX;'><span class='fc1-0'>$aYot[8] $aFname[8]</span></DIV>";
print "<DIV style='left:535PX;top:4890PX;width:73PX;height:30PX;'><span class='fc1-0'>$aPost[8]</span></DIV>";
}else{
print "<DIV style='left:158PX;top:4840PX;width:17PX;height:30PX;'><span class='fc1-0'>1.</span></DIV>";
print "<DIV style='left:178PX;top:4840PX;width:354PX;height:30PX;'><span class='fc1-0'>$aYot[6] $aFname[6]</span></DIV>";
print "<DIV style='left:535PX;top:4840PX;width:150PX;height:30PX;'><span class='fc1-0'>$aPost[6]</span></DIV>";
...
print "<DIV style='left:88PX;top:4915PX;width:500PX;height:30PX;'><span class='fc1-0'>เป็นกรรมการตรวจรับพัสดุ และรายงานผลให้ทราบภายใน 5 วันทำการ นับจากวันส่งมอบ</span></DIV>";

print "<DIV style='left:480PX;top:4965PX;width:56PX;height:30PX;'><span class='fc1-0'>$aYot[1]</span></DIV>";
...
print "<DIV style='left:417PX;top:5050PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>........../........../..........</span></DIV>";
...
print "<STYLE>";
 ...
 print "DIV {position:absolute; z-index:25;}";
print "</STYLE>";
print "<TITLE>จัดซื้อเวชภัณฑ์ (รวมVATก่อน)</TITLE>";
print "</head>";
print "<BODY BGCOLOR='FFFFFF' TOPMARGIN=0 BOTTOMMARGIN=0 RIGHTMARGIN=0 LEFTMARGIN='0'>";
print "<DIV style='z-index:0'> &nbsp; </div>";
...
/*				if(!empty($snspec)){
				...
				<tr>
                    ...
                    <td><? if(!empty($aTradname[$ii])){ echo $aTradname[$ii]; }else{ echo "&nbsp;";}?></td>
...
<?   
print "<DIV style='left:46PX;top:1673PX;width:77PX;height:30PX;'><span class='fc1-0'>หมายเหตุ</span></DIV>";
print "<DIV style='left:122PX;top:1673PX;width:245PX;height:30PX;'><span class='fc1-0'>- สป. ตามบัญชีต้องการของภายในวันที่</span></DIV>";
print "<DIV style='left:366PX;top:1673PX;width:384PX;height:30PX;'><span class='fc1-0'><B>$cBounddate</B></span></DIV>";

print "<DIV style='left:122PX;top:1702PX;width:245PX;height:30PX;'><span class='fc1-0'>- บริษัทที่จะซื้อตามที่ได้สืบราคาแล้ว</span></DIV>";
print "<DIV style='left:366PX;top:1702PX;width:384PX;height:30PX;'><span class='fc1-0'><B>$cComname</B></span></DIV>";

$sql11="SELECT b.edpri_from FROM poitems as a inner join druglst as b on a.drugcode=b.drugcode WHERE a.idno = '$nRow_id' AND b.edpri_from='5' group by b.edpri_from";
//print $sql11;
$query11=mysql_query($sql11);
$chkrows=mysql_num_rows($query11);
if($chkrows==1){  //มี 1 แหล่งที่มา
	print "<DIV style='left:46PX;top:1740PX;width:245PX;height:30PX;'><span class='fc1-0'>แหล่งที่มาของราคากลาง (5)</span></DIV>";
	print "<DIV style='left:80PX;top:1765PX;width:384PX;height:30PX;'><span class='fc1-0'>ใช้ราคาที่เคยซื้อหรือจ้างครั้งหลังสุดภายในระยะเวลา 2 ปีงบประมาณ</span></DIV>";	
	
	$sql11="SELECT b.drugcode, b.edpri_from FROM poitems as a inner join druglst as b on a.drugcode=b.drugcode WHERE a.idno = '$nRow_id' and  b.edpri_from='5' ";
	//print $sql11;
	$query11=mysql_query($sql11);
	$chkrows=mysql_num_rows($query11);
	$top=1765;
	...
	while($result=mysql_fetch_array($query11)){
		...
		$prepono=$rows["prepono"];
		$prepodate=$rows["prepodate"];
		//echo $toppx."<br>";
		print "<DIV style='left:80PX;top:$toppx;width:384PX;height:30PX;'><span class='fc1-0'>$i. ตามสัญญา เลขที่ $prepono ลงวันที่ $prepodate</span></DIV>";
	}
}


print "<DIV style='left:487PX;top:1896PX;width:87PX;height:30PX;TEXT-ALIGN:RIGHT;'><span class='fc1-0'>ตรวจถูกต้อง</span></DIV>";
print "<DIV style='left:540PX;top:1926PX;width:279PX;height:30PX;'><span class='fc1-0'>$aYot[2]</span></DIV>";
print "<DIV style='left:528PX;top:1947PX;width:279PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>($aFname[2])</span></DIV>";
print "<DIV style='left:528PX;top:1968PX;width:279PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>$aPost[2]</span></DIV>";
print "<DIV style='left:528PX;top:1990PX;width:279PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>$aPost2[2]</span></DIV>";
print "<BR>";
print "</BODY></HTML>";
...
print "</STYLE>";
print "<TITLE>จัดซื้อเวชภัณฑ์ (รวมVATหลัง)</TITLE>";
print "</head>";
print "<BODY BGCOLOR='FFFFFF' TOPMARGIN=0 BOTTOMMARGIN=0 RIGHTMARGIN=0 LEFTMARGIN='0'>";
print "<DIV style='z-index:0'> &nbsp; </div>";
/*
...
print "<DIV style='left:138PX;top:2136PX;width:645PX;height:21PX;'><span class='fc1-3'>ข้อ 2. ผู้ขายรับรองว่าจะส่งมอบสิ่งของที่ซื้อขายตามใบสั่งซื้อนี้ให้แก่ผู้ซื้อ ณ คลังยาและเวชภัณฑ์ รพ.ค่ายสุรศักดิ์มนตรี  ภายในวันที่ ";
...
print "<DIV style='left:105PX;top:5354PX;width:643PX;height:30PX;'><span class='fc1-0'>เรื่อง ขออนุมัติจัดหาเวชภัณฑ์</span></DIV>";
...
print "<DIV style='left:54PX;top:5470PX;width:412PX;height:30PX;'><span class='fc1-0'>ได้ตรวจรับพัสดุ ณ คลังยาและเวชภัณฑ์ รพ.ค่ายสุรศักดิ์มนตรี</span></DIV>";
...
<TR>
	<TD align='right' width='70'>$aYot[4]</TD>
	<TD width='270'>&nbsp;</TD>
</TR>
<TR>
	<TD colspan=\"2\" width='270' align='center'>($aFname[4])</TD>
</TR>
<TR>
	<TD colspan=\"2\" width='270' align='center'>$aPost[4]</TD>
</TR>
<TR>
	<TD colspan=\"2\" width='270' align='center'>$aPost2[4]</TD>
</TR>
</TABLE>
</span></DIV>";
...
<TR>
	<TD colspan=\"2\" width='180' align='center'>$aPost[1]</TD>
</TR>
<TR>
...
print "<DIV style='left:207PX;top:5818PX;width:95PX;height:30PX;'><span class='fc1-0'>$aYot[2]</span></DIV>";
...
print "<DIV style='left:499PX;top:7890PX;width:101PX;height:30PX;TEXT-ALIGN:LEFT;'><span class='fc1-0'>$aYot[18]</span></DIV>";
print "<DIV style='left:485PX;top:7915PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>($aFname[18])</span></DIV>";
print "<DIV style='left:485PX;top:7940PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>$aPost[18]</span></DIV>";
print "<DIV style='left:485PX;top:7965PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>$aPost2[18]</span></DIV>";

print "<DIV style='left:163PX;top:7940PX;width:618PX;height:30PX;'><span class='fc1-0'>เรียน&nbsp;&nbsp;ผอ.รพ.ค่ายสุรศักดิ์มนตรี</span></DIV>";  
...
print "<DIV style='left:148PX;top:8070PX;width:87PX;height:30PX;TEXT-ALIGN:RIGHT;'><span class='fc1-0'>$aYot[1]</span></DIV>";
...
print "<DIV style='left:74PX;top:8383PX;width:675PX;height:30PX;'><span class='fc1-0'>ข้าพเจ้า $aYot[18] $aFname[18] ตำแหน่ง$aPost[18] $aPost2[18] ขอเบิกเงินจาก</span></DIV>";
...
// ช่องผู้ตรวจ
print "<DIV style='left:105PX;top:8966PX;width:310PX;height:30PX;'><span class='fc1-0'>$aYot[13]</span></DIV>";
print "<DIV style='left:355PX;top:8966PX;width:310PX;height:30PX;'><span class='fc1-0'>ผู้ตรวจ</span></DIV>";
$positionHeadmoney2 = '';
if(!empty($aPost2[13])){
	$positionHeadmoney2 = '<br>'.$aPost2[13];
}
print "<DIV style='left:125PX;top:8992PX;width:107PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>($aFname[13])</span></DIV>";
print "<DIV style='left:24PX;top:9011PX;width:310PX;text-align:center;'><span class='fc1-0'>$aPost[13]$positionHeadmoney2</span></DIV>";


// สี่เหลี่ยมช่องขวา
print "<DIV style='left:444PX;top:8968PX;width:310PX;height:30PX;'><span class='fc1-0'>ชื่อผู้รับเงิน...............................................</span></DIV>";
print "<DIV style='left:501PX;top:8997PX;width:310PX;height:30PX;'TEXT-ALIGN:CENTER;' ><span class='fc1-0'>(..............................................)</span></DIV>";
print "<DIV style='left:501PX;top:9022PX;width:310PX;height:30PX;'TEXT-ALIGN:CENTER;'><span class='fc1-0'>..............................................</span></DIV>";
...
print "<DIV style='left:115PX;top:8787PX;width:269PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>($aFname[18])</span></DIV>";
print "<DIV style='left:128PX;top:8758PX;width:110PX;height:30PX;'><span class='fc1-0'>$aYot[18]</span></DIV>";
print "<DIV style='left:424PX;top:8758PX;width:63PX;height:30PX;TEXT-ALIGN:RIGHT;'><span class='fc1-0'>ตำแหน่ง</span></DIV>";
print "<DIV style='left:493PX;top:8758PX;width:256PX;height:30PX;'><span class='fc1-0'>$aPost[18]</span></DIV>";
...
print "<DIV style='left:105PX;top:9100PX;width:310PX;height:30PX;'><span class='fc1-0'>$aYot[1]</span></DIV>";
print "<DIV style='left:35PX;top:9125PX;width:274PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>($aFname[1])</span></DIV>";
...
// ช่องขวาล่าง
print "<DIV style='left:440PX;top:9100PX;width:310PX;height:30PX;'><span class='fc1-0'>ชื่อผู้จ่ายเงิน&nbsp;&nbsp;$aYot[11]</span></DIV>";
print "<DIV style='left:470PX;top:9127PX;width:227PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>($aFname[11])</span></DIV>";
print "<DIV style='left:430PX;top:9149PX;width:310PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>$aPost[11]$positionHeadmoney</span></DIV>";
print "<DIV style='left:450PX;top:9202PX;width:227PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>............/............/............</span></DIV>";
...
print "$cNetpaid</span></DIV>";
print "<DIV style='left:212PX;top:8468PX;width:273PX;height:30PX;'><span class='fc1-0'>ค่าเวชภัณฑ์</span></DIV>";
...
print"<DIV style='left:88PX;top:10315PX;width:600PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-1'>ขอบเขตของงาน</span></DIV>";

print"<DIV style='left:88PX;top:10340PX;width:600PX;height:30PX;TEXT-ALIGN:CENTER;'><span class='fc1-0'>
<span>การจัดซื้อสิ่งอุปกรณ์สิ้นเปลืองสายแพทย์ เลขที่ $cPrepono</span>
</DIV>";
?>
<style>
.dx_tb{
...
<div style="position: absolute; left:53px; top: 10380px;" class="fc1-0">
<table width="100%" border="0" cellspacing="0" cellpadding="3" class="fc1-0">
  <tr>
    <td width="100%">1. ความเป็นมา</td>
  </tr>
  <tr>
    <td><span style="margin:40px;">โรงพยาบาลค่ายสุรศักดิ์มนตรีมีความต้องการในการจัดหาสิ่งอุปกรณ์สิ้นเปลืองสายแพทย์  เพื่อใช้ในการบริการผู้ป่วย</span></td>
  </tr>
  <tr>
    <td>ทั้งที่ต้องจัดหาเพิ่มเติ่มหรือทดแทนของเดิมที่ใช้ไป โดยใช้เงินรายรับสถานพยาบาล สำหรับการจัดหาครั้งนี้เป็นการจัดหาสิ่ง</td>
  </tr>
  <tr>
    <td>อุปกรณ์สิ้นเปลืองสายแพทย์ จำนวน 
      <?=$nItems;?> 
    รายการ</td>
  </tr>
  <tr>
    <td>2. วัตถุประสงค์</td>
  </tr>
  <tr>
    <td><span style="margin:40px;">เพื่อใช้ในการบริการผู้ป่วยในโรงพยาบาลค่ายสุรศักดิ์มนตรี</span></td>
  </tr>
  <tr>
    <td>3. คุณสมบัติของผู้ยื่นข้อเสนอ</td>
  </tr> 
  <tr>
    <td>
		<span style="margin:40px;">1. มีความสามารถตามกฎหมาย</span>
	</td>
  </tr>
  <tr>
    <td>
		<span style="margin:40px;">2. ไม่เป็นบุคคลล้มละลาย</span>
	</td>
  </tr>
  <tr>
    <td>
		<span style="margin:40px;">3. ไม่อยู่ระหว่างเลิกกิจการ</span>
	</td>
  </tr>
  <tr>
    <td>
		<span style="margin:40px;">4. ไม่เป็นบุคคลซึ่งอยู่ระหว่างถูกระงับการยื่นข้อเสนอหรือทำสัญญากับหน่วยงานของรัฐไว้ชั่วคราวตามที่ประกาศเผยแพร่</span><br>
		<span>ในระบบเครือข่ายสารสนเทศของกรมบัญชีกลาง</span>
	</td>
  </tr>
  <tr>
    <td>
		<span style="margin:40px;">5. ไม่เป็นบุคคลซึ่งถูกระบุชื่อไว้ในบัญชีรายชื่อผู้ทิ้งงานและได้แจ้งเวียนชื่อให้เป็นผู้ทิ้งงานของหน่วยงานของรัฐ</span><br>
		<span>ในระบบเครือข่ายสารสนเทศของกรมบัญชีกลาง ซึ่งรวมถึงนิติบุคคลที่ผู้ทิ้งงานเป็นหุ้นส่วนผู้จัดการ กรรมการผู้จัดการ ผู้บริหาร </span><br>
		<span>ผู้มีอำนาจในการดำเนินงานในกิจการของนิติบุคคลนั้นด้วย</span>
	</td>
  </tr> 
  <tr>
    <td>
		<span style="margin:40px;">6. มีคุณสมบัติและไม่มีลักษณะต้องห้ามตามที่คณะกรรมการนโยบายการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐ</span><br>
		<span> กำหนดในราชกิจจานุเบกษา</span>
	</td>
  </tr>
  <tr>
    <td>
		<span style="margin:40px;">7. เป็นบุคคลธรรมดาหรือนิติบุคคลผู้มีอาชีพขายพัสดุงานดังกล่าว</span>
	</td>
  </tr> 
  <tr>
    <td>
		<span style="margin:40px;">8. ไม่เป็นผู้มีผลประโยชน์ร่วมกันกับผู้ยื่นข้อเสนอราคารายอื่นที่เข้ายื่นข้อเสนอให้แก่รพ.ค่ายสุรศักดิ์มนตรี ณ วันเสนอราคา </span><br>
		<span>หรือไม่เป็นผู้กระทำการอันเป็นการขัดขวางการแข่งขันราคาอย่างเป็นธรรม ในการเสนอราคาครั้งนี้</span>
	</td>
  </tr>  
  <tr>
    <td>
		<span style="margin:40px;">9. ไม่เป็นผู้ได้รับเอกสิทธิ์หรือความคุ้มกัน ซึ่งอาจปฏิเสธไม่ยอมขึ้นศาลไทย เว้นแต่รัฐบาลของผู้เสนอราคาได้มีคำสั่ง</span><br>
		<span> ให้สละเอกสิทธิ์ความคุ้มกันเช่นว่านั้น</span>
	</td>
  </tr>    
  <tr>
    <td>
		<span style="margin:40px;">10. ไม่เป็นผู้ที่ไม่ผ่านเกณฑ์การประเมินผลการปฏิบัติงานตามระเบียบที่รัฐมนตรีว่าการกระทรวงการคลังกำหนด</span>
	</td>
  </tr>   
</table>
</div>
<div style="position: absolute; left:53px; top: 11320px;" class="fc1-0">   
<table width="100%" border="0" cellspacing="0" cellpadding="3" class="fc1-0">
  <tr>
    <td>4. แบบรูปรายการ หรือคุณลักษณะเฉพาะ</td>
  </tr> 
</table>  
	<table width="90%" class="dx_tb">
		<thead>
			<tr>
				<th width="8%" align="center">ลำดับ</th>
				<th width="62%" align="center">รายการ</th>
				<th width="30%" align="center" class="last_child">คุณลักษณะเฉพาะสป. สาย พ. ที่</th>
			</tr>
		</thead>
		<tbody>		
			<?php
			...
			for ($ii=1; $ii <= 19; $ii++) { 
				...
				//echo $sql1."<br>";
				$chkquery=mysql_query($sql1);
				list($drugcode,$tradname,$unitpri,$part,$freelimit,$edpri,$edprifrom,$specno,$snspec)=mysql_fetch_array($chkquery);				
				// ราคากลาง
				//echo "==>".$edpri;
...
<table width="100%" border="0" cellspacing="0" cellpadding="3" class="fc1-0">
  <tr>
    <td>5. หลักเกณฑ์การพิจารณาคัดเลือก</td>
  </tr>        
  <tr>
    <td><span style="margin:40px;"><input name="" type="checkbox" value="" />&nbsp;&nbsp;พิจารณาโดยใช้เกณฑ์ราคา</span>
	</td>
  </tr>             
  <tr>
    <td>6. ระยะเวลาส่งมอบของหรืองาน</td>
  </tr>        
  <tr>
    <td><span style="margin:40px;">ภายใน 30 วันทำการ นับถัดจากวันลงนามในใบสั่งซื้อ</span></td>
  </tr>   <tr>
    <td>7. วงเงินในการจัดหา</td>
  </tr>        
  <tr>
    <td><span style="margin:40px;">วงเงินในการจัดหาครั้งนี้ รวม <?=$nItems;?> รายการ  เป็นเงิน <?=$nPriadvat;?> บาท</span></td>
  </tr>
  <tr>
    <td>8. งวดงานและการจ่ายเงิน</td>
  </tr>        
  <tr>
    <td>
		<span style="margin:40px;">โรงพยาบาลค่ายสุรศักดิ์มนตรี จะจ่ายค่าสิ่งของซึ่งได้รวมภาษีมูลค่าเพิ่ม ตลอดจนภาษีอากรอื่นๆ</span><br>
		<span>และค่าใช้จ่ายทั้งปวงแล้วให้แก่ผู้ยื่นข้อเสนอที่ได้รับการคัดเลือกให้เป็นผู้ขาย เมื่อผู้ขายได้ส่งมอบสิ่งของได้ครบถ้วนตาม</span><br>
		<span>สัญญาซื้อขายหรือข้อตกลงเป็นหนังสือ และโรงพยาบาลค่ายสุรศักดิ์มนตรีได้ตรวจรับมอบสิ่งของไว้เรียบร้อยแล้ว</span>
	</td>
  </tr>  
  <tr>
    <td>9. อัตราค่าปรับ</td>
  </tr>        
  <tr>
    <td>
		<span style="margin:40px;">โดยคิดค่าปรับเป็นรายวันในอัตราร้อยละ 0.20 ของราคาสิ่งของที่ยังไม่ได้รับมอบ</span>
	</td>
  </tr>
</table>
</div>
<div style="position: absolute; left:53px; top: 12370px;" class="fc1-0">   
<table width="100%" border="0" cellspacing="0" cellpadding="3" class="fc1-0">
  <tr>
    <td>10. การกำหนดระยะเวลารับประกันความชำรุดบกพร่อง</td>
  </tr> 
  <tr>
    <td>
		<span style="margin:40px;">ผู้ชนะการเสนอราคายอมรับประกันความชำรุดบกพร่องหรือขัดข้องของสิ่งของตามข้อตกลงนี้เนื่องจากการใช้งานตามปกติ</span><br>
		<span>เป็นเวลา....1.....ปี นับถัดจากวันที่ผู้ซื้อได้รับมอบสิ่งของ โดยภายในกำหนดเวลาดังกล่าว หากสิ่งของเกิดชำรุดผู้ขายต้องจัดการซ่อมแซม </span><br>
		<span>หรือแก้ไขให้ใช้การได้ดีดังเดิมภายใน 7 วัน นับแต่ที่ได้รับแจ้งจากผู้ซื้อและไม่คิดค่าใช้จ่ายใดๆ ทั้งสิ้นกับผู้ซื้อ</span>
	</td>
  </tr>  
  <tr>
    <td>11. สถานที่ส่งมอบ</td>
  </tr>        
  <tr>
    <td>
		<span style="margin:40px;">คลังยาและเวชภัณฑ์  โรงพยาบาลค่ายสุรศักดิ์มนตรี เลขที่ 1 หมู่ 1 ต.พิชัย อ.เมืองลำปาง จ.ลำปาง</span>
	</td>
  </tr>   
</table>
<p>&nbsp;</p>
...
$ptname1=$rows1["yot"]." ".$rows1["fullname"];
  ...
  <tr align="left">
    <td height="30">&nbsp;</td>
    <td height="30" colspan="2"><span style="margin-left:120px;" class="fc1-0">( <?=$rows1["fullname"];?> )</span></td>
    <td height="30">&nbsp;</td>
  </tr>
  <tr>
    <td height="30">&nbsp;</td>
