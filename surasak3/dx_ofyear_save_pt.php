...
$sql ="insert into chk_pt (date,hn,ptname,age,leg,back,yearchk) value('$daten','$hn','$ptname','$age','$ch1','$ch2','$prefix')";

$result = mysql_query($sql);
if($result){
	echo "บันทึกข้อมูลเรียบร้อยแล้วคะ";
	echo "<META HTTP-EQUIV=\"Refresh\" CONTENT=\"2;URL=dx_ofyear_pt.php\">";
}
?>