...
$sql = "Select date_format(orderdate,'%Y-%m-%d'),patientname,labnumber,sex From resulthead where hn = '".$_SESSION["hn_now"]."' AND orderdate like '".$date_now."%' Order by  `autonumber` DESC limit 0,1";
...
.tb_head3 {background-color:#FFFFFF; color:#000000; font-size:22px; font-weight: bold;font-family:"Angsana New"; text-align:center;  }
.tb_head3_2 {background-color:0000A0; color:#FFFF00; font-size:15px; font-weight: bold;font-family:"Angsana New"; text-align:center; font-weight: bold;width: 200px; }
...
.tb_head4 {background-color: #99FFCC; color:#000099; font-size:15px;   font-family:"Angsana New";}
.tb_head4_1 {background-color: #99FFCC; color:#FF0033; font-size:15px;  font-weight: bold; font-family:"Angsana New";}
...
$list_code_lab = array();
$lab_title = array();
$sql = "Select a.profilecode, count(b.labcode) From (Select * From resulthead where hn='".$_SESSION["hn_now"]."' AND orderdate like '".$date_now."%' ) as a INNER JOIN resultdetail as b ON a.autonumber = b.autonumber group by a.profilecode  Order by count(b.labcode) DESC , testgroupcode ASC";
//echo $sql;
...
?>
	<TABLE border="1" bordercolor="#0046D7" width="100%" cellpadding="0" cellspacing="0">
	<TR>
		<TD>
	...
	<TR bgcolor="<?php echo $bgcolor;?>">
		<TD width="250"><FONT COLOR="#000000" size ="4"><font face='Angsana New' style='line-height:20px;;' ><?php echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;",$arr2["labname"];?></FONT></TD>
		
		<TD align="center" width="200"><FONT  size ="4"><font face='Angsana New' style='line-height:20px;;'><?php if($arr2["flag"] != 'N'){ echo "<B>";};?><?php echo $arr2["result"];?><?php if($arr2["flag"] != 'N'){ echo "</B>";};?></FONT></TD>
		...
		<TD align="center" width="200"><FONT  size ="2"><font face='Angsana New' style='line-height:20px;;'><?php echo "". ($arr2["unit"] !=""?"".$arr2["unit"]."":"")."";?></FONT></TD>
		<TD align="center" width="180"><FONT  size ="2"><font face='Angsana New' style='line-height:20px;;'><?php if($arr2["normalrange"] != ""){ echo "[",$arr2["normalrange"],"]" ;};?></FONT></TD>
...
<?php echo "<FONT SIZE='2'><CENTER><B>Authorise name : </B>".$authorisename."&nbsp;&nbsp;&nbsp;<B>Authorise date :</B> ".$authorisedate."</CENTER></FONT>"; ?>
</body>
