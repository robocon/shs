...
<form method="post" action="<?php echo $PHP_SELF ?>">
  <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ตรวจสอบหมายเลข  AN ผู้ป่วยสิทธิจ่ายตรง อปท.</p>
  <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; AN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
If (!empty($an)){
   ...
   "  <td BGCOLOR=F5DEB3 align='center'><a href=\"anchkpay1.php?an=$an&act=show&days=$days\" >แก้ไขค่าห้อง</td>\n".
           " </tr>\n");
       }
}
?>
...
$sql="select * from ipmonrep where an='".$_GET["an"]."' and credit_detail LIKE '%อปท%' order by row_id desc limit 1";
...
?>
<br><hr><br>
<form name="f2" method="post" action="anchkpay1.php">
...
if($_POST["act"]=="edit"){
	...
	if(mysql_query($edit1)){
		...
		echo "<meta http-equiv=\"refresh\" content=\"1;url=anchkpay1.php?an=$chkan\">";
	}else{
