...
//ยาที่ใช้ใน รพ.
if ($row->part=="DDL" and $row->status!="จำหน่าย"){//substr($row->date,0,10)!="$sDiscdate"
            array_push($aEssd,$row->price);
            array_push($aBEssd,$row->price-$row->paid);
            } 
if ($row->part=="DDY" and $row->status!="จำหน่าย"){//substr($row->date,0,10)!="$sDiscdate"
            array_push($aNessdy,$row->price);
            array_push($aBNessdy,$row->price-$row->paid);
            } 
if ($row->part=="DDN" and $row->status!="จำหน่าย"){//substr($row->date,0,10)!="$sDiscdate"
