...
if( empty($page) ){
    ...
    <div class="claearfix" style="height: 50px;">
        <ul class="topnav">
            <li><a href="http://192.168.1.2/sm3/nindex.htm">หน้าหลัก รพ.</a></li>
            <li><a href="http://192.168.1.2/sm3/surasak3/rg_soldier.php">หน้าหลัก ตรช</a></li>
            <li><a href="http://192.168.1.2/sm3/surasak3/rg_soldier.php?page=form">เพิ่มข้อมูล</a></li>
