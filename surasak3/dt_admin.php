...
$thidate = "2565-03-23";
$sql = "Select vn, hn, ptname, toborow  From opd where thdatehn like '".$thidate."%' AND doctor in ('MD020 หนึ่งฤทัย มหายศนันท์','MD030 เกื้อกูล ผสมทรัพย์') AND dc_diag is NULL Order by vn ASC ";
...
<table width="100%" border="0">
  <tr>
    <td>
	<FORM name="form_vn" METHOD=POST ACTION="dt_add_patient_admin.php">
<TABLE>
<TR>
	<TD>
		<TABLE>
		<TR>
		  <TD align="center">&nbsp;</TD>
		  <TD colspan="2" align="left"><strong>เมนูสำหรับ Adminstrator วันที่ <?=$thidate;?></strong></TD>
		  </TR>
		<TR>
		...
		<TR>
			...
			<TD align="left">
			<?php
				$sql = "Select a.name From doctor as a where status = 'y' AND left(a.name,2) = 'MD' AND a.name <> '' ";
				//echo $sql;
