...
session_unregister("aCredit_d");
	...
	session_unregister("aCredit_9");
	session_unregister("aCredit_10");
	...
	session_unregister("aCredit_10pd");
   ...
   $doctor="";
    ...
    $aCredit =array("credit");
	 ...
	 $aCredit_10 =array("credit_10");
	 $aCredit_10pd =array("credit_10pd");	 	 
...
session_register("aCredit_10");
session_register("aCredit_10pd");
...
//
    ...
    print "<form method='POST' action='checkmonyuser1.php'>";
...
/*print " <select  name='doctor1'>";
print " <option value='0' ><-เลือก-></option>";
print " <option value='นางสาว ชฎาพร'>ชฎาพร</option>";
print " <option value='นาง จินดา'>จินดา</option>";
print " <option value='นาง พวงเพ็ชร'>พวงเพ็ชร</option>";
print " <option value='นางสาว อรทัย'>อรทัย</option>";
print " <option value='นาง ศันสนีย์'>ศันสนีย์</option>";
print " <option value='ประเทือง'>ประเทือง</option>";
print " <option value='นางสาว วัลยา'>วัลยา</option>";
print " <option value='เทวินทร์'>เทวินทร์</option>";
print " <option value='นางสาว นทีพร'>นทีพร</option>";
print " <option value='ร.ต.หญิงสุภาภรณ์'>สุภาภรณ์</option>";
print " <option value='นางสาว นพวรรณ'>นพวรรณ</option>";
print "   </select>";*/


	 
print "&nbsp;&nbsp;&nbsp;ประเภทเงิน&nbsp;";
print " <select  name='detail1'>";
print " <option value='ทั้งหมด'>ทั้งหมด</option>";
$sqlw = "select distinct(credit) from opacc";
$row2 = mysql_query($sqlw);
while($result2 = mysql_fetch_array($row2)){
	print " <option value='$result2[credit]'>$result2[credit]</option>";
}
print "   </select>";
/*print " <select  name='detail1'>";
print " <option value='ทั้งหมด'>ทั้งหมด</option>";
