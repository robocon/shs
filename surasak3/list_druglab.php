...
<?php
$sum2 = 0;
$sql = "Select a.tradname, a.amount, a.part, a.price, b.salepri, a.date,a.slcode  From drugrx as a LEFT JOIN druglst as b ON a.drugcode = b.drugcode where a.date like '".$select_day."%' AND a.hn = '".$_REQUEST["search_hn"]."' ";
...
$sql = "Select a.code,a.date, a.detail, a.amount, a.price, b.price as price2, a.part , a.yprice, a.nprice From patdata as a LEFT JOIN labcare as b ON a.code = b.code where a.date like '".$select_day."%' AND a.hn = '".$_REQUEST["search_hn"]."' ";
...
while($arr = Mysql_fetch_assoc($result)){
	...
	echo "<TR BGCOLOR=\"F5DEB3\">
					...
					<TD align=\"right\">".$arr["price"]."</TD>
						<TD align=\"right\">".$arr["yprice"]."</TD>
						<TD align=\"right\">".$arr["nprice"]."</TD>
				</TR>";
$sum += $arr["price"];
$i++;
}
...
<A HREF="list_druglab3.php?search_hn=<?php echo $_REQUEST["search_hn"];?>&search_date=<?php echo $_REQUEST["search_date"];?>" target="_blank">พิมพ์ สติกเกอร์ เฉพาะยา</A>
