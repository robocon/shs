...
$sql = "Select a.date, a.detail, a.amount, a.price, b.price as price2, a.part , a.yprice, a.nprice From patdata as a LEFT JOIN labcare as b ON a.code = b.code where a.date like '".$select_day."%' AND a.hn = '".$_REQUEST["search_hn"]."' ";
