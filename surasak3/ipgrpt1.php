<?php
    $yrmonth="2548";
    include("connect.inc");
    $query="CREATE TEMPORARY TABLE ipgroup SELECT * FROM ipcard WHERE date LIKE '$yrmonth%'";
...
//G11
    ...
    $daysG1=0;
    $daysG11=0;
    $query = "SELECT icd10,date,dcdate,days,an,result,camp FROM ipgroup WHERE goup LIKE 'G11%' ORDER BY icd10"; 
...
//G12
    ...
    $num=0;
    $daysG12=0;
    $query = "SELECT icd10,date,dcdate,days,an,result,camp,goup FROM ipgroup WHERE goup LIKE 'G12%' ORDER BY icd10";
    $ans = mysql_query($query) or die("Query failed");
    while (list ($icd10,$date,$dcdate,$days,$an,$result,$camp) = mysql_fetch_row ($ans)) {
    $num++;
...
//G13
    ...
    $num=0;
    $daysG13=0;
    $query = "SELECT icd10,date,dcdate,days,an,result,camp,goup FROM ipgroup WHERE goup LIKE 'G13%' ORDER BY icd10";
    $ans = mysql_query($query) or die("Query failed");
    while (list ($icd10,$date,$dcdate,$days,$an,$result,$camp) = mysql_fetch_row ($ans)) {
    $num++;
...
//G14
    ...
    $num=0;
    $daysG14=0;
    $query = "SELECT icd10,date,dcdate,days,an,result,camp,goup FROM ipgroup WHERE goup LIKE 'G14%' ORDER BY icd10 ";
    $ans = mysql_query($query) or die("Query failed");
    while (list ($icd10,$date,$dcdate,$days,$an,$result,$camp) = mysql_fetch_row ($ans)) {
    $num++;
...
//G15
    ...
    $num=0;
    $daysG15=0;
    $query = "SELECT icd10,date,dcdate,days,an,result,camp,goup FROM ipgroup WHERE goup LIKE 'G15%' ORDER BY icd10";
    $ans = mysql_query($query) or die("Query failed");
    while (list ($icd10,$date,$dcdate,$days,$an,$result,$camp) = mysql_fetch_row ($ans)) {
    $num++;
...
//G21
    ...
    $daysG2=0;
    $daysG21=0;
    $query = "SELECT icd10,date,dcdate,days,an,result,camp,goup FROM ipgroup WHERE goup LIKE 'G21%' ORDER BY icd10";
    $ans = mysql_query($query) or die("Query failed");
    while (list ($icd10,$date,$dcdate,$days,$an,$result,$camp) = mysql_fetch_row ($ans)) {
    $num++;
...
//G22
    ...
    $num=0;
    $daysG22=0;
    $query = "SELECT icd10,date,dcdate,days,an,result,camp,goup FROM ipgroup WHERE goup LIKE 'G22%' ORDER BY icd10";
    $ans = mysql_query($query) or die("Query failed");
    while (list ($icd10,$date,$dcdate,$days,$an,$result,$camp) = mysql_fetch_row ($ans)) {
    $num++;
...
//G23
    ...
    $num=0;
    $daysG23=0;
    $query = "SELECT icd10,date,dcdate,days,an,result,camp,goup FROM ipgroup WHERE goup LIKE 'G23%' ORDER BY icd10";
    $ans = mysql_query($query) or die("Query failed");
    while (list ($icd10,$date,$dcdate,$days,$an,$result,$camp) = mysql_fetch_row ($ans)) {
    $num++;
...
//G24
    ...
    $num=0;
    $daysG24=0;
    $query = "SELECT icd10,date,dcdate,days,an,result,camp,goup FROM ipgroup WHERE goup LIKE 'G24%' ORDER BY icd10";
    $ans = mysql_query($query) or die("Query failed");
    while (list ($icd10,$date,$dcdate,$days,$an,$result,$camp) = mysql_fetch_row ($ans)) {
    $num++;
...
//G31
    ...
    $daysG3=0;
    $daysG31=0;
    $query = "SELECT icd10,date,dcdate,days,an,result,camp,goup FROM ipgroup WHERE goup LIKE 'G31%' ORDER BY icd10";
    $ans = mysql_query($query) or die("Query failed");
    while (list ($icd10,$date,$dcdate,$days,$an,$result,$camp) = mysql_fetch_row ($ans)) {
    $num++;
...
//G32
    ...
    $num=0;
    $daysG32=0;
    $query = "SELECT icd10,date,dcdate,days,an,result,camp,goup FROM ipgroup WHERE goup LIKE 'G32%' ORDER BY icd10";
    $ans = mysql_query($query) or die("Query failed");
    while (list ($icd10,$date,$dcdate,$days,$an,$result,$camp) = mysql_fetch_row ($ans)) {
    $num++;
...
//G33
    ...
    $num=0;
    $daysG33=0;
    $query = "SELECT icd10,date,dcdate,days,an,result,camp,goup FROM ipgroup WHERE goup LIKE 'G33%' ORDER BY icd10";
    $ans = mysql_query($query) or die("Query failed");
    while (list ($icd10,$date,$dcdate,$days,$an,$result,$camp) = mysql_fetch_row ($ans)) {
    $num++;
...
//G34
    ...
    $num=0;
    $daysG34=0;
    $query = "SELECT icd10,date,dcdate,days,an,result,camp,goup FROM ipgroup WHERE goup LIKE 'G34%' ORDER BY icd10";
    $ans = mysql_query($query) or die("Query failed");
    while (list ($icd10,$date,$dcdate,$days,$an,$result,$camp) = mysql_fetch_row ($ans)) {
    $num++;
...
//G35
    ...
    $num=0;
    $daysG35=0;
    $query = "SELECT icd10,date,dcdate,days,an,result,camp,goup FROM ipgroup WHERE goup LIKE 'G35%' ORDER BY icd10";
    $ans = mysql_query($query) or die("Query failed");
    while (list ($icd10,$date,$dcdate,$days,$an,$result,$camp) = mysql_fetch_row ($ans)) {
    $num++;
...
//G36
    ...
    $num=0;
    $daysG36=0;
    $query = "SELECT icd10,date,dcdate,days,an,result,camp,goup FROM ipgroup WHERE goup LIKE 'G36%' ORDER BY icd10";
    $ans = mysql_query($query) or die("Query failed");
    while (list ($icd10,$date,$dcdate,$days,$an,$result,$camp) = mysql_fetch_row ($ans)) {
    $num++;
...
//G37
    ...
    $num=0;
    $daysG37=0;
    $query = "SELECT icd10,date,dcdate,days,an,result,camp,goup FROM ipgroup WHERE goup LIKE 'G37%' ORDER BY icd10";
    $ans = mysql_query($query) or die("Query failed");
    while (list ($icd10,$date,$dcdate,$days,$an,$result,$camp) = mysql_fetch_row ($ans)) {
    $num++;
...
//G38
    ...
    $num=0;
    $daysG38=0;
    $query = "SELECT icd10,date,dcdate,days,an,result,camp,goup FROM ipgroup WHERE goup LIKE 'G38%' ORDER BY icd10";
    $ans = mysql_query($query) or die("Query failed");
    while (list ($icd10,$date,$dcdate,$days,$an,$result,$camp) = mysql_fetch_row ($ans)) {
    $num++;
...
//G39
    ...
    $num=0;
    $daysG39=0;
    $query = "SELECT icd10,date,dcdate,days,an,result,camp,goup FROM ipgroup WHERE goup LIKE 'G39%' ORDER BY icd10";
    $ans = mysql_query($query) or die("Query failed");
    while (list ($icd10,$date,$dcdate,$days,$an,$result,$camp) = mysql_fetch_row ($ans)) {
    $num++;
