...
-->
</style><a href ="labemployee.php" >&lt;&lt; สั่งรายการใหม่</a><br />
<style type="text/css">
.font5 {
...
<div style="font-size:28px"><strong>สั่ง LAB ตรวจสุขภาพลูกจ้างประจำปี</strong></div>
<hr />
<?
session_start();
include("connect.inc");
...
if(isset($_GET['id'])){
	...
	echo "อายุ : ".$age."<br>";
	echo "โรค : ตรวจสุขภาพ &nbsp;&nbsp;สิทธิ : R42 ตรวจสุขภาพลูกจ้างประจำปี</span>";
?>
<hr />
...
<input name="pro" type="radio" id="pro3" value="3" <? if(substr($age,0,2) >= 35){ echo "checked='checked'";}?> /> โปรแกรม 3 (อายุตั้งแต่ 35 ปีขึ้นไป)<br />
...
<?
	...
	$vnlab = 'ตรวจสุขภาพลูกจ้างประจำปี';   
...
//หาข้อมูลจาก opcard ของ $cHn เพื่อใช้ทั้งในกรณีลงทะเบียนแล้ว หรือยังไม่ลง
	...
	echo "โรค : ตรวจสุขภาพ &nbsp;&nbsp;สิทธิ : R42 ตรวจสุขภาพลูกจ้างประจำปี<br><br>";
	echo "<fieldset><legend><strong>รายการตรวจ</strong></legend>";
	$i=0;
	if($_POST['pro']=="3" || $_POST['pro']=="4"){
		$sql = "select * from labcare where (code='CBC' OR code='UA' OR code='BS' OR code='LDL'  OR code='BUN' OR code='CR' OR code='SGOT' OR code='SGPT' OR code='ALK')";  //ค้นหา lab ที่ตรวจ
	}else{
		$sql = "select * from labcare where (code='CBC' OR code='UA')";  //ค้นหา lab ที่ตรวจ
	}
	$row = mysql_query($sql);
	...
	echo "<a href='labofyeartranx_employee.php?pro=$_POST[pro]' target='_blank'>หมดรายการใบแจ้งหนี้</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='labslip4bc_chkup_employee.php' target='_blank'>สติ๊กเกอร์</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='labslip4cbc_chkup_employee.php' target='_blank'>สติ๊กเกอร์ CBC</a>
&nbsp;&nbsp;&nbsp;&nbsp;<a href='labslip4ua_chkup_employee.php' target='_blank'>สติ๊กเกอร์ UA</a><br><br></span>";
...
<a href ="labemployee.php" >&lt;&lt; สั่งรายการใหม่</a><br />
