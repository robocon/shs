  ...
  <p>&nbsp;<font face="Angsana New">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="4"><b>
   เลือก เดือน-ปี ที่ต้องการตูข้อมูล (type of discharge=dead)</b></font></font></p>
...
<table>
 <tr>
  ...
  <th bgcolor=6495ED><font face='Angsana New'>ICD10 โรคหลัก</th>
...
If (!empty($month)){
   ...
   //print"$month<br>";
   //print"$yrmn<br>";
   print" อัตราการเสียชีวิตรายโรค/หัตถการ (หรือกลุ่มโรค/กลุ่มหัตถการ) โดยเฉพาะอย่างยิ่งในกลุ่มมารดาที่มาคลอดบุตร/ผู้ป่วยผ่าตัด เดือน    $month ปี$year";
    include("connect.inc");
    $query = "SELECT ptname,hn,an,diag,icd10,date,dcdate,days,price,bedcode,doctor FROM ipcard  WHERE date LIKE     '$yrmn%' and dctype='dead'";  
    $result = mysql_query($query) or die("Query failed");
//    echo mysql_errno() . ": " . mysql_error(). "\n";
//    echo "<br>";
   $n=0;
     while (list ($ptname,$hn,$an,$diag,$icd10,$date,$dcdate,$days,$price,$bedcode,$doctor 
