...
<input name="act" type="hidden" value="edit" />
  <div align="left">
    <table border="0" cellpadding="3" cellspacing="0" width="100%" height="202">
      ...
      <tr>
        <td align="right">&nbsp;</td>
        <td align="left"><input name="B1" type="submit" class="forntsarabun" value="เปลี่ยนรหัสผ่าน"  onClick="JavaScript:return fncSubmit()">
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="button" name="button" id="button" value="กลับหน้าหลัก" onclick="window.location='../nindex.htm' " class="forntsarabun" />
		</td>
      </tr>
    </table>
  </div>
