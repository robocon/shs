...
if($row){	
	...
	if(substr($zzz,0,3)=='R07'){
			...
			print "<br><a href='hnlab_not.php?hn=".$xxx."&confirm=true'>!ชื่อถูกต้อง ทำรายการต่อไป...</a>";
			print "<br>";
			print "<br><a href='hnlab_not.php?hn=".$xxx."&confirm=true&chk=sso'>! ชื่อถูกต้อง และต้องการ ตรวจสุขภาพสิทธิประกันสังคม</a>";
