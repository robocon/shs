<title>รายงานผลการปรับปรุงข้อมูลชั้นยศ</title>
<style type="text/css">
<!--
body,td,th {
...
$sql="SELECT * FROM condxofyear_so WHERE chunyot1 !='' AND yearcheck = '$showyear'";
$query=mysql_query($sql) or die("Query condxofyear_so line 27 Error");
$total=mysql_num_rows($query);

$sql1="SELECT * FROM condxofyear_so WHERE chunyot1 ='' AND yearcheck = '$showyear' order by camp";
$result=mysql_query($sql1) or die("Query condxofyear_so line 31 Error");
$num=mysql_num_rows($result);
?>
<a href ="../nindex.htm" >&lt;&lt; กลับหน้าหลัก</a>
<p align="center" style="font-weight:bold;">รายงานผลการปรับปรุงข้อมูลชั้นยศของกำลังพลที่ตรวจสุขภาพประจำปี <?=$showyear;?></p>
...
<table width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse;">
  <tr>
    ...
    <td width="19%" align="center" bgcolor="#66CC99">วันที่ตรวจ</td>
    <td width="11%" align="center" bgcolor="#66CC99">HN</td>
    <td width="25%" align="center" bgcolor="#66CC99">ชื่อ-นามสกุล</td>
    <td width="25%" align="center" bgcolor="#66CC99">สังกัด</td>
    <td width="16%" align="center" bgcolor="#66CC99">อายุ</td>
  </tr>
  <?
  $i=0;
