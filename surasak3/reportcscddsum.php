...
<form method="POST" action="reportcscdsum1.php" target="_blank">
	...
	<TABLE width="497">
<TR>
		<TD colspan="2">ใบสรุปรวมลูกหนี้จ่ายตรง || <a href="reportlgosum.php">ใบสรุปรวมลูกหนี้จ่ายตรง อปท.</a></TD>
	</TR>
	<TR>
		<TD width="161" align="right">ตั้งแต่วันที่: </TD>
	  <TD width="211"><INPUT TYPE="text" NAME="start_day" value="<?php echo date("d");?>" size="2" maxlength="2"> / 
		...
		<INPUT TYPE="text" NAME="start_year" value="<?php echo date("Y")+543;?>"  size="4" maxlength="4"></TD><TD width="109">&nbsp;</TD>
	</TR>
	<TR>
