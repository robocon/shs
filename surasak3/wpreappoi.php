...
<<<<<<< HEAD
	<TR valign="top">
		<TD width="50%">
			<form method="POST"
				action="wappinsert1.php?an=<?= $an; ?>&cBed=<?= $bed; ?>& cBedcode=<?= $bedcode; ?>&cbedname=หอผู้ป่วยหญิง">
=======
<TR valign="top">
	<TD width="50%">
...
>>>>>>> other-opd
				...
				<div id="list_patho">
					<font class="forntsarabun"><A HREF="javascript:show_bock();">เจาะเลือด</A></font>
				</div>
		...
		<TD>
			...
			<TABLE id="bock_lab" width="100%" border="1" bordercolor='#000000' cellpadding="3" cellspacing="0"
				style="display:none;">
				<TR valign="top">
					<TD width="500">
						...
						<TABLE width="100%" align="left" border="0">
							<TR valign="top">
								<TD colspan="<?php echo $r * 2; ?>" align='left'>ตรวจLAB อื่นๆ ระบุ : <INPUT TYPE="text"
										NAME="" size="13" onkeypress="searchSuggest('lab',this.value,2);">
									<Div id="list"></Div>
								</TD>
							</TR>
							<TR>
