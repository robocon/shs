...
<form method="POST" action="wappinsert1.php?an=<?=$an;?>&cBed=<?=$bed;?>& cBedcode=<?=$bedcode;?>&cbedname=หอผู้ป่วยหญิง">
  ...
  &nbsp;&nbsp;<input type="submit" value="     ยืนยันการสั่ง LAB     " name="B1" class="forntsarabun">
...
<TABLE id="bock_lab" width="100%" border="1" bordercolor='#000000' cellpadding="3" cellspacing="0" style="display:none; font-size: 28px;">
  <TR valign="top">
	<TD width="500" ><div align="center"><B>รายการตรวจทางพยาธิ</B></div>
	<TABLE width="100%" align="left" border="0" cellpadding="5" style="font-size: 20px;">
	  <TR  valign="top">
		<TD  colspan="<?php echo $r*2;?>" align='left' >ตรวจLAB อื่นๆ ระบุ : <INPUT TYPE="text" NAME="" size="13" onkeypress="searchSuggest('lab',this.value,3);"><Div id="list"></Div></TD>
	  </TR>
	  <TR>
		<?php
			for($i=1;$i<=$count;$i++){
