...
if(isset($_POST["Save_dgprofile"]) && $_POST["Save_dgprofile"] == "   จ่ายยา   " ){
	...
	$_SESSION["drughome"] = "<table style='font-size: 22px;font-family: Angsana New' bordercolor='#000000'  cellpadding='2' cellspacing='0' border='1' style='BORDER-COLLAPSE: collapse'>
		<tr align='center'>
			<td>#</td>
			<td>รหัส</td>
			<td>รายการ</td>
