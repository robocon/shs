...
<p align="center" style="font-weight:bold;">รายงานผลการตรวจสุขภาพกำลังพล ทบ. (ผสต.15) ประจำปี 
  <?=$showyear;?> (ใหม่)
</p>
<div align="center"><a href ="report_chkup15_armynew.php">รายงานกลุ่มย่อย</a> || <strong>รายงานกลุ่มใหญ่</strong></div>
...
<div align="left" style="margin-left:25%;"><strong>หน่วยทหารที่มารับการตรวจ</strong> <? if($_POST["camp"]=="all"){ echo $pcupart;}else{ echo $_POST["camp"];}?></div>
<br />
