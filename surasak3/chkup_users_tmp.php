  ...
  <table width="50%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	&nbsp;&nbsp;หน่วย :
        ...
        <select name="camp" id="camp" class="txtsarabun">
		 ...
		 <?
		 $sql="select distinct(camp) as camp from condxofyear_so where `yearcheck` = '$nPrefix2' and row_id > 12026";
...
$nPrefix=$_POST["year1"];
	...
	if($_POST["camp"]=="all"){
		$sql1="SELECT * FROM `condxofyear_so` WHERE `yearcheck` = '$nPrefix' and row_id > 12026
		GROUP BY hn 
