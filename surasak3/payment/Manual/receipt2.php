...
<option value="3">แบบกรอกข้อมูลตรวจสุขภาพประจำปี โปรแกรม 1</option>
<option value="4">แบบกรอกข้อมูลตรวจสุขภาพประจำปี โปรแกรม 2</option>
</select>
...
<form name="form1" method="post" action="receipt_action2.php?do=form1" onSubmit="JavaScript:return fncSubmit();">
...
<form name="form2" method="post" action="receipt_action2.php?do=form2">
<table  border="0" class="forntsarabun">
  <tr>
...
<form name="form3" method="post" action="receipt_action2.php?do=form3">
<table  border="0" class="forntsarabun">
  <tr>
    <td height="73" colspan="6" align="center" class="hd">ใบเสร็จรับเงิน <br /><hr /></td>
  </tr>
    ...
    <td colspan="6"><table  border="0">
      ...
      <tr>
        ...
        <td colspan="4"><select name="company" id="company" class="forntsarabun">
          ...
          <option value="บริษัท ธนาคารทหารไทย จำกัด (มหาชน)">บริษัท ธนาคารทหารไทย จำกัด (มหาชน)</option>
        </select></td>
        </tr>
    </table></td>
    </tr>
  ...
  <tr>
    <td align="center">1</td>
    <td colspan="2">ตรวจร่างกายโดยแพทย์</td>
    <td align="center"><input name="1n" type="text" id="1n" size="20"  class="forntsarabun" dir="rtl" value="0.00"/></td>
    <td align="center"><input name="1y" type="text" id="1y" size="20"  class="forntsarabun" dir="rtl" value="50.00"></td>
    <td align="center">&nbsp;</td>
  </tr>
  <tr>
    <td align="center">2</td>
    <td colspan="2">เอ็กซเรย์ปอด</td>
    <td align="center"><input name="2n" type="text" id="2n" size="20"  class="forntsarabun" dir="rtl" value="0.00"/></td>
    <td align="center"><input name="2y" type="text" id="2y" size="20"  class="forntsarabun" dir="rtl" value="170.00"/></td>
    <td align="center">&nbsp;</td>
  </tr>
  <tr>
    <td align="center">3</td>
    ...
    <td align="center"><input name="3y" type="text" id="3y" size="20"  class="forntsarabun" dir="rtl" value="90.00"/></td>
    <td align="center">&nbsp;</td>
  </tr>
  <tr>
    <td align="center">4</td>
    ...
    <td align="center"><input name="4y" type="text" id="4y" size="20"  class="forntsarabun" dir="rtl" value="50.00"/></td>
  ...
  <tr>
    ...
    <td align="center"><input name="6y" type="text" id="6y" size="20"  class="forntsarabun" dir="rtl" value="50.00"></td>
    <td align="center">&nbsp;</td>
  </tr>
  <tr>
    <td align="center">7</td>
  ...
  <tr>
    <td align="center">8</td>
    <td colspan="2"> ALT.PHOSPHATASE</td>
  ...
  <tr>
    ...
    <td align="center"><input name="10y" type="text" id="10y" size="20"  class="forntsarabun" dir="rtl" value="50.00"/></td>
    <td align="center">&nbsp;</td>
  </tr>
  <tr>
    <td align="center">11</td>
    ...
    <td align="center"><input name="11y" type="text"  class="forntsarabun" id="11y" dir="rtl" size="20" value="200.00"/></td>
    <td align="center">&nbsp;</td>
  </tr>
    <tr>
      <td align="center">&nbsp;</td>
...
<form name="formhn1" method="post" action="">
 <table>
 <tr>
 <td colspan="2" align="center" bgcolor="#0099FF">กรุณาใส่ HN</td>
 </tr>
  <tr>
  <td>HN</td>
  <td><input type="text" name="hn1" class="forntsarabun" value="<?=trim($_POST['hn1']);?>"></td>
  </tr>
   <tr>
 <td colspan="2" align="center"><input type="submit" name="posthn1" value="ตกลง" class="forntsarabun"></td>
 </tr>
 </table>
</form>   
<?
...
<form name="form3" method="post" action="receipt_action2.php?do=form4">
<table  border="0" class="forntsarabun">
  <tr>
    <td height="73" colspan="6" align="center" class="hd">ใบเสร็จรับเงิน <br /><hr /></td>
  </tr>
