<title>รายงานผลการปรับปรุงข้อมูล Exercise</title>
<style type="text/css">
<!--
body,td,th {
...
$sql="SELECT * FROM condxofyear_so WHERE exercise !='' AND yearcheck = '$showyear'";
$query=mysql_query($sql) or die("Query condxofyear_so line 27 Error");
$total=mysql_num_rows($query);

$sql1="SELECT * FROM condxofyear_so WHERE exercise ='' || exercise is null AND yearcheck = '$showyear' order by camp";
//echo $sql1;
$result=mysql_query($sql1) or die("Query condxofyear_so line 31 Error");
$num=mysql_num_rows($result);
?>
<a href ="../nindex.htm" >&lt;&lt; กลับหน้าหลัก</a>
<p align="center" style="font-weight:bold;">รายงานผลการปรับปรุงข้อมูล Exercise ของกำลังพลที่ตรวจสุขภาพประจำปี <?=$showyear;?></p>
...
<table width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse;">
  <tr>
    ...
    <td width="10%" align="center" bgcolor="#66CC99">exercise</td>
  ...
  <tr>
    ...
    <td align="center" bgcolor="#CCFFCC"><?=$rows["exercise"];?></td>
