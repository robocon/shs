<form method="POST" action="ptappoi_icd10.php">
  ...
  </select>&nbsp;&nbsp;&nbsp;&nbsp;<select name="appmo" class="forntsarabun">
        <option value="มกราคม" <?  $m=date("m"); if($m=='01'){ echo "selected"; }?>>มกราคม</option>
  ...
  <p>DM<input type="radio" name="b1" value="DM" /> HT <input type="radio" name="b1" value="HT" /></p>
