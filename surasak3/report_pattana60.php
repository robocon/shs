		...
		?>
          ...
          <tr>
            ...
            <table width="100%" border="0" cellpadding="1" cellspacing="0">
              <tr height="25">
                <td width="5%">&nbsp;</td>
                <td width="63%"><strong>จำนวนเม็ดเลือด (WBC)</strong></td>
                <td width="32%">
				<? 
		...
		?>
          ...
          <tr>
            <td colspan="3"><table width="100%" border="0" cellpadding="1" cellspacing="0">
              ...
              <tr height="25">
                <td>&nbsp;</td>
                <td><strong>ความถ่วงจำเพาะ (SPGR)</strong></td>
                <td><? 
...
if($objResult["labcode"]=='ANTIHB'){  //HBSAB
  ...
  <tr>
    <td colspan="2"  valign="top"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse; border-top-style:none">          
      ...
      <? } ?>         
        <tr>
          <td><strong class="text" style="font-size:18px"><u>ผลการตรวจเอกซ์เรย์ (X-RAY)</u></strong><strong class="text" style="margin-left: 9px;"> : <? if($result["cxr"]==""){ echo "ปกติ"; }else{ echo $result["cxr"]; } ?></strong></td>
        </tr>
        <tr>
...
&nbsp;พบแพทย์
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td>&nbsp;</td>
                <td align="left" class="text3"><div style="margin-left:20px;">ตรวจถูกต้อง พ.ท.</div></td>
                <td class="text3">&nbsp;</td>
              </tr>
              <tr>
                <td width="50%">&nbsp;</td>
