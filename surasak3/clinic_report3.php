...
<h2 class="font3 shs-header" align="center">วันที่ <?=$dateshow;?> เวลา <?=$_POST['time'];?> ห้องตรวจโรคศัลยกรรมทางเดินปัสสาวะ</h2>
...
<table class="shs-table" border="1" style="border-collapse:collapse; border-color:#000;" cellpadding="0" cellspacing="0" class="font2" width="100%" align="center">
	...
	if( $r=='31' ){
		...
		echo "<h2 class='font3 shs-header' align='center'>วันที่  $dateshow เวลา $_POST[time]  ห้องตรวจโรคศัลยกรรมทางเดินปัสสาวะ</h2>";
