...
//   print "จำนวนทั้งสิ้น $item รายการ ดังนี้<br>";
...
print "      <td width='20%'>วันที่&nbsp;$Thdate</td>";
print "      <td width='45%'>เวลา&nbsp;$time";
print "      <td width='25%'>";
print "       </td>";
print "    </tr>";
print "  </table>";
...
print "      <td width='30%'>วันที่จำหน่าย&nbsp;$dcdateALL";
print "      <td width='40%'>รวม&nbsp;$cDays&nbsp;วัน";
print "       </td>";
print "    </tr>";
print "    <tr>";
print "      <td width='10%'></td>";
...
print "      <td width='18%' align='right'>".number_format($Ysubtotal,2)."</td>";
print "      <td width='10%'></td>";
print "    </tr>";
print "    <tr>";
print "      <td width='5%'></td>";
...
print "      <td width='29%'>&nbsp;";
//print "        <p>&#3648;&#3592;&#3657;&#3634;&#3627;&#3609;&#3657;&#3634;&#3607;&#3637;&#3656;&#3648;&#3585;&#3655;&#3610;&#3648;&#3591;&#3636;&#3609;</td>";
print "    </tr>";
print "  </table>";
print "</div>";
