...
$sql = "Select  a.depart, sum(a.paidcscd),sum(a.price) From opacc as a where a.date LIKE '$date1%'  AND a.credit ='ประกันสังคม' group by  a.depart   ORDER by a.date";
...
echo "</table>";
			...
			*/
echo "<font face='Angsana New' size ='5'><br><br><center> <b>สรุปลูกหนี้ประกันสังคมประจำเดือน &nbsp;$date3 <br></b> ";
...
print "    <tr>";
print "      <td width='50%'></td>";
print "      <td width='50%'><center><font face='Angsana New'>(วัลยา &nbsp;&nbsp;คำปาเชื้อ)</font></td>";
print "    </tr>";
print "  </table>";
print "<div align='left'>";
print "  <table border='0' cellpadding='0' cellspacing='0' width='100%'>";
