...
<form name="f1" action="" method="post">
  ...
  <tr class="forntsarabun">
    <td colspan="2" bgcolor="#99CC99">รายงานประเภทผู้ป่วย   ตามการออก OPCARD</td>
    </tr>
  <tr class="forntsarabun">
...
print "<div><font class='forntsarabun' >ยอดผู้ป่วยนอกตามการออก OPCARD  $day   $dateshow</font></div><br>";
...
$tquery1 = mysql_query($tsql1);*/
	...
	$count=0;
	$k=0;
	$sql1="SELECT  toborow,count(*) as sum FROM opday WHERE thidate LIKE  '$date1%' group by substr(toborow,1,4)";
    ...
    <tr>
      ...
      <td><a href="report_exdetailall.php?thidate=<?=$date1;?>&toborow=<?=substr($arr1['toborow'],0,4)?>" target="_blank"><?=$arr1['toborow']?></a></td>
      <td align="center"><?=$arr1['sum']?></td>
     </tr>
     <?
	}
	 ?>
